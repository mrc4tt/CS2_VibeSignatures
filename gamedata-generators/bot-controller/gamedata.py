#!/usr/bin/env python3
"""
bot-controller Gamedata Update Module (weaponpaints pattern)

Updates bot-controller.json for the WeaponPaints CounterStrikeSharp plugin.
...
# Seed source: https://raw.githubusercontent.com/XBribo/CS2-Bot-Controller/main/configs/addons/BotController/gamedata.json
# Refresh: curl -o gamedata/bot-controller.json <url>

# Module metadata
MODULE_NAME = "bot-controller"
MODULE_ENABLED = True

# Relative path to the gamedata file within the module output directory
GAMEDATA_PATH = "gamedata/bot-controller.json"
