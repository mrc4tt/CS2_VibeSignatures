#!/usr/bin/env python3
"""
bot-hider Gamedata Update Module (weaponpaints pattern)

Updates bot-hider.json for the WeaponPaints CounterStrikeSharp plugin.
...
# Seed source: https://raw.githubusercontent.com/XBribo/CS2-Bot-Hider/main/configs/addons/BotHider/gamedata.json
# Refresh: curl -o gamedata/bot-hider.json <url>

# Module metadata
MODULE_NAME = "bot-hider"
MODULE_ENABLED = True

# Relative path to the gamedata file within the module output directory
GAMEDATA_PATH = "gamedata/bot-hider.json"
