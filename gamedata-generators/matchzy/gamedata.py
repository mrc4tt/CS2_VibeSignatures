#!/usr/bin/env python3
"""
matchzy Gamedata Update Module (weaponpaints pattern)

Updates matchzy.json for the WeaponPaints CounterStrikeSharp plugin.
...
GAMEDATA_PATH = "gamedata/matchzy.json"
