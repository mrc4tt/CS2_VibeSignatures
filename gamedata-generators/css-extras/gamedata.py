#!/usr/bin/env python3
"""
css-extras Gamedata Update Module (weaponpaints pattern)

Updates css-extras.json (CSS install HUD extras) for the WeaponPaints CounterStrikeSharp plugin.
...
# Seed source: community HUD gamedata (message.txt fra CSS-bruger).
# NB: windows-signaturer er TOMME i kilden - analysen udfylder dem.
# Keys deployeres til CSS-installens gamedata.json af update_css_gamedata.sh-mergen
# (install-only keys bevares) eller manuelt efter analyse.
