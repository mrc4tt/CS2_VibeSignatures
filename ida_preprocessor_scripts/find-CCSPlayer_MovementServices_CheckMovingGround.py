#!/usr/bin/env python3
"""Preprocess script for find-CCSPlayer_MovementServices_CheckMovingGround skill."""
...
LLM_DECOMPILE = [
    {
        "symbol_name": "CCSPlayer_MovementServices_CheckMovingGround",
...
FUNC_VTABLE_RELATIONS = [
    ...
    ("CCSPlayer_MovementServices_CheckMovingGround", "CCSPlayer_MovementServices"),
]
