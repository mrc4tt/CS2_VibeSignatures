...
CANONICAL_VTABLE_SYMBOLS_BY_PLATFORM = {
    "windows": {"CEntFireOutputAutoCompletionFunctor": "CEntFireOutputAutoCompletionFunctor_vtable"},
    "linux": {"CEntFireOutputAutoCompletionFunctor": "_ZTV35CEntFireOutputAutoCompletionFunctor + 0x10"},
}
