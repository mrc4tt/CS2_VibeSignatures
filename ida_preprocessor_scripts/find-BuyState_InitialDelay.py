#!/usr/bin/env python3
"""Relocate BuyState_InitialDelay using caller-supplied prior artifact signatures.
...
TARGET_STRUCT_MEMBER_NAMES = ["BuyState_InitialDelay"]
GENERATE_YAML_DESIRED_FIELDS = [
    ("BuyState_InitialDelay", ["struct_name", "member_name", "offset", "size", "offset_sig", "offset_sig_disp"])
]
