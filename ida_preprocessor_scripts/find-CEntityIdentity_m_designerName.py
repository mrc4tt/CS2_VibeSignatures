#!/usr/bin/env python3
"""Preprocess script for find-CEntityIdentity_m_designerName skill (auto-generated, structmember)."""

from ida_analyze_util import preprocess_gen_struct_member_via_mcp

TARGET_FUNCTION_NAMES = [
    "CEntityIdentity_m_designerName",
]
...
async def preprocess_skill(
    ...
    return await preprocess_gen_struct_member_via_mcp(
        ...
        target_name="CEntityIdentity_m_designerName",
        debug=debug,
    )
