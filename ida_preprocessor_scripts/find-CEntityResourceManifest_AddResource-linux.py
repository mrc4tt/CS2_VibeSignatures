#!/usr/bin/env python3
"""Preprocess script for find-CEntityResourceManifest_AddResource skill (vfunc, linux).
...
GENERATE_YAML_DESIRED_FIELDS = [
    (
        ...
        [
            ...
            "func_rva",
            "func_sig",
            # 15-byte thunk: a body-only sig cannot be unique, so let it reach padding.
