#!/usr/bin/env python3
"""Preprocess script for find-CEntitySaveRestoreBlockHandler_SaveInternal-decompiles skill."""
...
LLM_DECOMPILE = [
    {
        ...
        "dependency_policy": {
            "CEntitySaveRestoreBlockHandler_SaveInternal.{platform}.yaml": "required",
        },
    },
    {
