#!/usr/bin/env python3
"""Preprocess script for find-INetworkGameServer_ServerProcessNetworking skill."""

from ida_analyze_util import preprocess_common_skill

TARGET_FUNCTION_NAMES = [
    "INetworkGameServer_ServerProcessNetworking",
]

LLM_DECOMPILE = [
    {
        "symbol_name": "INetworkGameServer_ServerProcessNetworking",
...
FUNC_VTABLE_RELATIONS = [
    ...
    ("INetworkGameServer_ServerProcessNetworking", "INetworkGameServer"),
]
