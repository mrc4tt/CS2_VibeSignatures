#!/usr/bin/env python3
"""Preprocess script for find-ILoopType_AddEngineService skill."""
...
LLM_DECOMPILE = [
    {
        ...
        "dependency_policy": {
            "CLoopTypeClientServer_LoopTypeInit.{platform}.yaml": "required",
        },
    },
]

FUNC_VTABLE_RELATIONS = [
    ("ILoopType_AddEngineService", "ILoopType"),
]
