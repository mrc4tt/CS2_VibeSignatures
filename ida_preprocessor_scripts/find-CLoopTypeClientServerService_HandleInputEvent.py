#!/usr/bin/env python3
"""Preprocess script for find-CLoopTypeClientServerService_HandleInputEvent skill."""
...
FUNC_XREFS_WINDOWS = [
    {
        ...
        "xref_strings": [],
        "xref_gvs": [],
        "xref_signatures": ["48 8B ?? 48 FF 60 ??"],
        "xref_funcs": [],
        "exclude_funcs": [],
        "exclude_strings": [],
        "exclude_gvs": [],
...
FUNC_VTABLE_RELATIONS = [
    ...
    ("CLoopTypeClientServerService_HandleInputEvent", "CLoopTypeClientServerService_vtable2"),
]
