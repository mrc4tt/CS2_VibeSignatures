#!/usr/bin/env python3
"""Preprocess script for find-CEntitySystem_RegisterEntityClass-decompiles skill."""
...
LLM_DECOMPILE = [
    {
        "symbol_name": "CEntitySystem_m_entClassesByCPPClassname",
        ...
        "dependency_policy": {
            "CEntitySystem_RegisterEntityClass.{platform}.yaml": "required",
        },
    },
    {
