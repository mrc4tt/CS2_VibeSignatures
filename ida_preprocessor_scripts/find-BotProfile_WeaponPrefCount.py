#!/usr/bin/env python3
"""Preprocess script for find-BotProfile_WeaponPrefCount skill (auto-generated, structmember)."""

from ida_analyze_util import preprocess_gen_struct_member_via_mcp

TARGET_FUNCTION_NAMES = [
    "BotProfile_WeaponPrefCount",
]
...
async def preprocess_skill(
    ...
    return await preprocess_gen_struct_member_via_mcp(
        ...
        target_name="BotProfile_WeaponPrefCount",
        debug=debug,
    )
