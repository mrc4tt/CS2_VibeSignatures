...
the single caller of the standalone ``CNetworkGameServer_ChangeLevel``.  This
path only applies when ``CNetworkGameServer_ChangeLevel`` is NOT inlined into
...
FUNC_XREFS = [
    {
        ...
        "xref_signatures": [],
        "xref_funcs": [
            "CNetworkGameServer_ChangeLevel",
        ],
        "exclude_funcs": [],
        "exclude_strings": [],
        "exclude_gvs": [],
