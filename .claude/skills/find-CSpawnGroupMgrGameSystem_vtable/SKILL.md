...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_vtable (auto-generated, category: func). Locate
  CSpawnGroupMgrGameSystem_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_vtable, CSpawnGroupMgrGameSystem_vtable
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_vtable

Target: `CSpawnGroupMgrGameSystem_vtable` (func) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_vtable.{platform}.yaml` with EXACTLY these fields:
