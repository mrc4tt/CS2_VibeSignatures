...
description: |
  Agent fallback for CEntitySystem_vtable (auto-generated, category: func). Locate
  CEntitySystem_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_vtable, CEntitySystem_vtable
disable-model-invocation: true
---

# Find CEntitySystem_vtable

Target: `CEntitySystem_vtable` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_vtable.{platform}.yaml` with EXACTLY these fields:
