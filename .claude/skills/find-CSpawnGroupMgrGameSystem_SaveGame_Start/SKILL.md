...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_SaveGame_Start (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::SaveGame_Start in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SaveGame_Start, CSpawnGroupMgrGameSystem::SaveGame_Start
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SaveGame_Start

Target: `CSpawnGroupMgrGameSystem::SaveGame_Start` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_SaveGame_Start.{platform}.yaml` with EXACTLY these fields:
