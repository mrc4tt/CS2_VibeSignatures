...
description: |
  ...
  CSpawnGroupMgrGameSystem_SaveGame_Start in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SaveGame_Start, CSpawnGroupMgrGameSystem_SaveGame_Start
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SaveGame_Start

Target: `CSpawnGroupMgrGameSystem_SaveGame_Start` (vfunc) in the module loaded in THIS session.
