...
description: |
  ...
  CEntitySystem_OnSetDormant in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_OnSetDormant, CEntitySystem_OnSetDormant
disable-model-invocation: true
---

# Find CEntitySystem_OnSetDormant

Target: `CEntitySystem_OnSetDormant` (vfunc) in the module loaded in THIS session.
