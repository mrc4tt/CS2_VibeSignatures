...
description: |
  Agent fallback for CEntitySystem_OnSetDormant (auto-generated, category: vfunc). Locate
  CEntitySystem::OnSetDormant in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_OnSetDormant, CEntitySystem::OnSetDormant
disable-model-invocation: true
---

# Find CEntitySystem_OnSetDormant

Target: `CEntitySystem::OnSetDormant` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_OnSetDormant.{platform}.yaml` with EXACTLY these fields:
