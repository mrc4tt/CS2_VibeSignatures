...
description: |
  ...
  CEntitySystem_RegisterEntityClass-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_RegisterEntityClass-decompiles, CEntitySystem_RegisterEntityClass-decompiles
disable-model-invocation: true
---

# Find CEntitySystem_RegisterEntityClass-decompiles

Target: `CEntitySystem_RegisterEntityClass-decompiles` (func) in the module loaded in THIS session.
