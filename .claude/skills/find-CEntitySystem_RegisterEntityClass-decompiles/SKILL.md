---
name: find-CEntitySystem_RegisterEntityClass-decompiles
description: |
  Agent fallback for CEntitySystem_RegisterEntityClass-decompiles (auto-generated, category: func). Locate
  CEntitySystem::RegisterEntityClass in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_RegisterEntityClass-decompiles, CEntitySystem::RegisterEntityClass
disable-model-invocation: true
---

# Find CEntitySystem_RegisterEntityClass-decompiles

Target: `CEntitySystem::RegisterEntityClass` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_RegisterEntityClass.{platform}.yaml` with EXACTLY these fields:
