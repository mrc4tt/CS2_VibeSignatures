...
description: |
  ...
  CSplitScreenService_LoadUserConfiguration in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSplitScreenService_LoadUserConfiguration, CSplitScreenService_LoadUserConfiguration
disable-model-invocation: true
---

# Find CSplitScreenService_LoadUserConfiguration

Target: `CSplitScreenService_LoadUserConfiguration` (func) in the module loaded in THIS session.
