...
description: |
  Agent fallback for CSplitScreenService_LoadUserConfiguration (auto-generated, category: func). Locate
  CSplitScreenService::LoadUserConfiguration in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSplitScreenService_LoadUserConfiguration, CSplitScreenService::LoadUserConfiguration
disable-model-invocation: true
---

# Find CSplitScreenService_LoadUserConfiguration

Target: `CSplitScreenService::LoadUserConfiguration` (func) in the module loaded in THIS session.
...
Write `CSplitScreenService_LoadUserConfiguration.{platform}.yaml` with EXACTLY these fields:
