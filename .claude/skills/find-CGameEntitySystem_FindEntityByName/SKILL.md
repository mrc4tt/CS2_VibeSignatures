...
description: |
  ...
  CGameEntitySystem_FindEntityByName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_FindEntityByName, CGameEntitySystem_FindEntityByName
disable-model-invocation: true
---

# Find CGameEntitySystem_FindEntityByName

Target: `CGameEntitySystem_FindEntityByName` (func) in the module loaded in THIS session.
