...
description: |
  ...
  CSmokeGrenadeProjectile_Detonate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSmokeGrenadeProjectile_Detonate, CSmokeGrenadeProjectile_Detonate
disable-model-invocation: true
---

# Find CSmokeGrenadeProjectile_Detonate

Target: `CSmokeGrenadeProjectile_Detonate` (vfunc) in the module loaded in THIS session.
