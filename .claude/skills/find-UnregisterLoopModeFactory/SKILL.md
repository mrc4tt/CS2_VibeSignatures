---
name: find-UnregisterLoopModeFactory
description: |
  Agent fallback for UnregisterLoopModeFactory (auto-generated, category: func). Locate
  UnregisterLoopModeFactory in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: UnregisterLoopModeFactory, UnregisterLoopModeFactory
disable-model-invocation: true
---

# Find UnregisterLoopModeFactory

Target: `UnregisterLoopModeFactory` (func) in the module loaded in THIS session.
...
Write `UnregisterLoopModeFactory.{platform}.yaml` with EXACTLY these fields:
