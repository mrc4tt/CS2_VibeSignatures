...
description: |
  ...
  C_GameRules_ctor-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_GameRules_ctor-decompiles, C_GameRules_ctor-decompiles
disable-model-invocation: true
---

# Find C_GameRules_ctor-decompiles

Target: `C_GameRules_ctor-decompiles` (func) in the module loaded in THIS session.
