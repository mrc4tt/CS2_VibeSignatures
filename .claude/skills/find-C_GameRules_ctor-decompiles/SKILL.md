---
name: find-C_GameRules_ctor-decompiles
description: |
  Agent fallback for C_GameRules_ctor-decompiles (auto-generated, category: func). Locate
  C_GameRules::C_GameRules in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_GameRules_ctor-decompiles, C_GameRules::C_GameRules
disable-model-invocation: true
---

# Find C_GameRules_ctor-decompiles

Target: `C_GameRules::C_GameRules` (func) in the module loaded in THIS session.
...
Write `C_GameRules_ctor.{platform}.yaml` with EXACTLY these fields:
