---
name: find-CSmokeGrenadeProjectile_Detonate-decompiles
description: |
  Agent fallback for CSmokeGrenadeProjectile_Detonate-decompiles (auto-generated, category: vfunc). Locate
  CSmokeGrenadeProjectile::Detonate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSmokeGrenadeProjectile_Detonate-decompiles, CSmokeGrenadeProjectile::Detonate
disable-model-invocation: true
---

# Find CSmokeGrenadeProjectile_Detonate-decompiles

Target: `CSmokeGrenadeProjectile::Detonate` (vfunc) in the module loaded in THIS session.
...
Write `CSmokeGrenadeProjectile_Detonate.{platform}.yaml` with EXACTLY these fields:
