...
description: |
  ...
  CSmokeGrenadeProjectile_Detonate-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSmokeGrenadeProjectile_Detonate-decompiles, CSmokeGrenadeProjectile_Detonate-decompiles
disable-model-invocation: true
---

# Find CSmokeGrenadeProjectile_Detonate-decompiles

Target: `CSmokeGrenadeProjectile_Detonate-decompiles` (vfunc) in the module loaded in THIS session.
