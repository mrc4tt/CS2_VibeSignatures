...
description: |
  ...
  INetworkMessages_GetLoggingChannel-linux in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_GetLoggingChannel-linux, INetworkMessages_GetLoggingChannel-linux
disable-model-invocation: true
---

# Find INetworkMessages_GetLoggingChannel-linux

Target: `INetworkMessages_GetLoggingChannel-linux` (vfunc) in the module loaded in THIS session.
