...
description: |
  ...
  CDemoPlayer_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_vtable, CDemoPlayer_vtable
disable-model-invocation: true
---

# Find CDemoPlayer_vtable

Target: `CDemoPlayer_vtable` (func) in the module loaded in THIS session.
...
Write `CDemoPlayer_vtable.{platform}.yaml` with EXACTLY these fields:
