...
description: |
  Agent fallback for CSource2Server_GameCreateNetworkStringTables (auto-generated, category: vfunc). Locate
  CSource2Server::GameCreateNetworkStringTables in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameCreateNetworkStringTables, CSource2Server::GameCreateNetworkStringTables
disable-model-invocation: true
---

# Find CSource2Server_GameCreateNetworkStringTables

Target: `CSource2Server::GameCreateNetworkStringTables` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GameCreateNetworkStringTables.{platform}.yaml` with EXACTLY these fields:
