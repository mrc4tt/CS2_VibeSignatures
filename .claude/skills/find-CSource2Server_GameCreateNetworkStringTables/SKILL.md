...
description: |
  ...
  CSource2Server_GameCreateNetworkStringTables in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameCreateNetworkStringTables, CSource2Server_GameCreateNetworkStringTables
disable-model-invocation: true
---

# Find CSource2Server_GameCreateNetworkStringTables

Target: `CSource2Server_GameCreateNetworkStringTables` (vfunc) in the module loaded in THIS session.
