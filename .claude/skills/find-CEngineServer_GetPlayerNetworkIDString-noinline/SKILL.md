---
name: find-CEngineServer_GetPlayerNetworkIDString-noinline
description: |
  Agent fallback for CEngineServer_GetPlayerNetworkIDString-noinline (auto-generated, category: func). Locate
  CEngineServer_GetPlayerNetworkIDString in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetPlayerNetworkIDString-noinline, CEngineServer_GetPlayerNetworkIDString
disable-model-invocation: true
---

# Find CEngineServer_GetPlayerNetworkIDString-noinline

Target: `CEngineServer_GetPlayerNetworkIDString` (func) in the module loaded in THIS session.
...
Write `CEngineServer_GetPlayerNetworkIDString.{platform}.yaml` with EXACTLY these fields:
