...
description: |
  ...
  CEngineServer_GetPlayerNetworkIDString-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetPlayerNetworkIDString-noinline, CEngineServer_GetPlayerNetworkIDString-noinline
disable-model-invocation: true
---

# Find CEngineServer_GetPlayerNetworkIDString-noinline

Target: `CEngineServer_GetPlayerNetworkIDString-noinline` (func) in the module loaded in THIS session.
