---
name: find-CBaseEntity_UpdateOnRemove
description: |
  Agent fallback for CBaseEntity_UpdateOnRemove (auto-generated, category: vfunc). Locate
  CBaseEntity::UpdateOnRemove in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_UpdateOnRemove, CBaseEntity::UpdateOnRemove
disable-model-invocation: true
---

# Find CBaseEntity_UpdateOnRemove

Target: `CBaseEntity::UpdateOnRemove` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_UpdateOnRemove.{platform}.yaml` with EXACTLY these fields:
