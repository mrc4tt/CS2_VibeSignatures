...
description: |
  ...
  CBaseEntity_UpdateOnRemove in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_UpdateOnRemove, CBaseEntity_UpdateOnRemove
disable-model-invocation: true
---

# Find CBaseEntity_UpdateOnRemove

Target: `CBaseEntity_UpdateOnRemove` (vfunc) in the module loaded in THIS session.
