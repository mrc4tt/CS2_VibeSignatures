...
description: |
  ...
  INetworkSystem_RemoveNetChannel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_RemoveNetChannel, INetworkSystem_RemoveNetChannel
disable-model-invocation: true
---

# Find INetworkSystem_RemoveNetChannel

Target: `INetworkSystem_RemoveNetChannel` (vfunc) in the module loaded in THIS session.
