---
name: find-INetworkSystem_RemoveNetChannel
description: |
  Agent fallback for INetworkSystem_RemoveNetChannel (auto-generated, category: vfunc). Locate
  INetworkSystem::RemoveNetChannel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_RemoveNetChannel, INetworkSystem::RemoveNetChannel
disable-model-invocation: true
---

# Find INetworkSystem_RemoveNetChannel

Target: `INetworkSystem::RemoveNetChannel` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_RemoveNetChannel.{platform}.yaml` with EXACTLY these fields:
