...
description: |
  ...
  CNetworkGameServer_WriteClassInfosAndSerializesToBuffer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_WriteClassInfosAndSerializesToBuffer, CNetworkGameServer_WriteClassInfosAndSerializesToBuffer
disable-model-invocation: true
---

# Find CNetworkGameServer_WriteClassInfosAndSerializesToBuffer

Target: `CNetworkGameServer_WriteClassInfosAndSerializesToBuffer` (func) in the module loaded in THIS session.
