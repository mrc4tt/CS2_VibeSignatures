---
name: find-CNetworkGameServer_WriteClassInfosAndSerializesToBuffer
description: |
  Agent fallback for CNetworkGameServer_WriteClassInfosAndSerializesToBuffer (auto-generated, category: func). Locate
  CNetworkGameServer::WriteClassInfosAndSerializesToBuffer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_WriteClassInfosAndSerializesToBuffer, CNetworkGameServer::WriteClassInfosAndSerializesToBuffer
disable-model-invocation: true
---

# Find CNetworkGameServer_WriteClassInfosAndSerializesToBuffer

Target: `CNetworkGameServer::WriteClassInfosAndSerializesToBuffer` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServer_WriteClassInfosAndSerializesToBuffer.{platform}.yaml` with EXACTLY these fields:
