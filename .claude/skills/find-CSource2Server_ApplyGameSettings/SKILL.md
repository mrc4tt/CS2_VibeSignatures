...
description: |
  ...
  CSource2Server_ApplyGameSettings in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_ApplyGameSettings, CSource2Server_ApplyGameSettings
disable-model-invocation: true
---

# Find CSource2Server_ApplyGameSettings

Target: `CSource2Server_ApplyGameSettings` (vfunc) in the module loaded in THIS session.
