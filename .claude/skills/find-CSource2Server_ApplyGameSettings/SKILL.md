...
description: |
  Agent fallback for CSource2Server_ApplyGameSettings (auto-generated, category: vfunc). Locate
  CSource2Server::ApplyGameSettings in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_ApplyGameSettings, CSource2Server::ApplyGameSettings
disable-model-invocation: true
---

# Find CSource2Server_ApplyGameSettings

Target: `CSource2Server::ApplyGameSettings` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_ApplyGameSettings.{platform}.yaml` with EXACTLY these fields:
