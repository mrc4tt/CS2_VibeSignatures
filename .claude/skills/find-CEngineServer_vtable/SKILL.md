...
description: |
  Agent fallback for CEngineServer_vtable (auto-generated, category: func). Locate
  CEngineServer_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_vtable, CEngineServer_vtable
disable-model-invocation: true
---

# Find CEngineServer_vtable

Target: `CEngineServer_vtable` (func) in the module loaded in THIS session.
...
Write `CEngineServer_vtable.{platform}.yaml` with EXACTLY these fields:
