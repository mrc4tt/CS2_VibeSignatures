...
description: |
  ...
  CNetworkSystem_PollSocket-linux in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_PollSocket-linux, CNetworkSystem_PollSocket-linux
disable-model-invocation: true
---

# Find CNetworkSystem_PollSocket-linux

Target: `CNetworkSystem_PollSocket-linux` (func) in the module loaded in THIS session.
