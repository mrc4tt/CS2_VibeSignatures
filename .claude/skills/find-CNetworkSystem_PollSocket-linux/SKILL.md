---
name: find-CNetworkSystem_PollSocket-linux
description: |
  Agent fallback for CNetworkSystem_PollSocket-linux (auto-generated, category: func). Locate
  CNetworkSystem_PollSocket in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_PollSocket-linux, CNetworkSystem_PollSocket
disable-model-invocation: true
---

# Find CNetworkSystem_PollSocket-linux

Target: `CNetworkSystem_PollSocket` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_PollSocket.{platform}.yaml` with EXACTLY these fields:
