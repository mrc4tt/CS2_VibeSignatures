...
description: |
  ...
  CNetworkGameServerBase_Shutdown-linux in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_Shutdown-linux, CNetworkGameServerBase_Shutdown-linux
disable-model-invocation: true
---

# Find CNetworkGameServerBase_Shutdown-linux

Target: `CNetworkGameServerBase_Shutdown-linux` (vfunc) in the module loaded in THIS session.
