...
description: |
  Agent fallback for CNetworkGameServerBase_Shutdown-linux (auto-generated, category: vfunc). Locate
  ...
  Trigger: CNetworkGameServerBase_Shutdown-linux, CNetworkGameServerBase::Shutdown
disable-model-invocation: true
---

# Find CNetworkGameServerBase_Shutdown-linux
