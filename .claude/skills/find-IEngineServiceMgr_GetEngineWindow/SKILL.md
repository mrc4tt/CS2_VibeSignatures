---
name: find-IEngineServiceMgr_GetEngineWindow
description: |
  Agent fallback for IEngineServiceMgr_GetEngineWindow (auto-generated, category: func). Locate
  IEngineServiceMgr_GetEngineWindow in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_GetEngineWindow, IEngineServiceMgr_GetEngineWindow
disable-model-invocation: true
---

# Find IEngineServiceMgr_GetEngineWindow

Target: `IEngineServiceMgr_GetEngineWindow` (func) in the module loaded in THIS session.
...
Write `IEngineServiceMgr_GetEngineWindow.{platform}.yaml` with EXACTLY these fields:
