...
description: |
  ...
  ISource2Server_GetActiveWorldName in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ISource2Server_GetActiveWorldName, ISource2Server_GetActiveWorldName
disable-model-invocation: true
---

# Find ISource2Server_GetActiveWorldName

Target: `ISource2Server_GetActiveWorldName` (vfunc) in the module loaded in THIS session.
