...
description: |
  Agent fallback for ISource2Server_GetActiveWorldName (auto-generated, category: vfunc). Locate
  ISource2Server::GetActiveWorldName in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ISource2Server_GetActiveWorldName, ISource2Server::GetActiveWorldName
disable-model-invocation: true
---

# Find ISource2Server_GetActiveWorldName

Target: `ISource2Server::GetActiveWorldName` (vfunc) in the module loaded in THIS session.
...
Write `ISource2Server_GetActiveWorldName.{platform}.yaml` with EXACTLY these fields:
