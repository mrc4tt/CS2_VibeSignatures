...
description: |
  ...
  CNetworkGameServerBase_SetServerState in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SetServerState, CNetworkGameServerBase_SetServerState
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SetServerState

Target: `CNetworkGameServerBase_SetServerState` (vfunc) in the module loaded in THIS session.
