...
description: |
  Agent fallback for CNetworkGameServerBase_SetServerState (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::SetServerState in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SetServerState, CNetworkGameServerBase::SetServerState
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SetServerState

Target: `CNetworkGameServerBase::SetServerState` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_SetServerState.{platform}.yaml` with EXACTLY these fields:
