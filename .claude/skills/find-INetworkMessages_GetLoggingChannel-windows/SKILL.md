...
description: |
  ...
  INetworkMessages_GetLoggingChannel-windows in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_GetLoggingChannel-windows, INetworkMessages_GetLoggingChannel-windows
disable-model-invocation: true
---

# Find INetworkMessages_GetLoggingChannel-windows

Target: `INetworkMessages_GetLoggingChannel-windows` (vfunc) in the module loaded in THIS session.
