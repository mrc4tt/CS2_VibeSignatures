...
description: |
  Agent fallback for INetworkMessages_GetLoggingChannel-windows (auto-generated, category: vfunc). Locate
  INetworkMessages::GetLoggingChannel in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_GetLoggingChannel-windows, INetworkMessages::GetLoggingChannel
disable-model-invocation: true
---

# Find INetworkMessages_GetLoggingChannel-windows

Target: `INetworkMessages::GetLoggingChannel` (vfunc) in the module loaded in THIS session.
...
Write `INetworkMessages_GetLoggingChannel.{platform}.yaml` with EXACTLY these fields:
