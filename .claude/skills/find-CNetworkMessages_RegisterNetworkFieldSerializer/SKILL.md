...
description: |
  ...
  CNetworkMessages_RegisterNetworkFieldSerializer in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_RegisterNetworkFieldSerializer, CNetworkMessages_RegisterNetworkFieldSerializer
disable-model-invocation: true
---

# Find CNetworkMessages_RegisterNetworkFieldSerializer

Target: `CNetworkMessages_RegisterNetworkFieldSerializer` (vfunc) in the module loaded in THIS session.
