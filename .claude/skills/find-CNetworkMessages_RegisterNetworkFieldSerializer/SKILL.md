...
description: |
  Agent fallback for CNetworkMessages_RegisterNetworkFieldSerializer (auto-generated, category: vfunc). Locate
  CNetworkMessages::RegisterNetworkFieldSerializer in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_RegisterNetworkFieldSerializer, CNetworkMessages::RegisterNetworkFieldSerializer
disable-model-invocation: true
---

# Find CNetworkMessages_RegisterNetworkFieldSerializer

Target: `CNetworkMessages::RegisterNetworkFieldSerializer` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_RegisterNetworkFieldSerializer.{platform}.yaml` with EXACTLY these fields:
