...
description: |
  Agent fallback for CMomentaryRotButton_vtable (auto-generated, category: func). Locate
  CMomentaryRotButton_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMomentaryRotButton_vtable, CMomentaryRotButton_vtable
disable-model-invocation: true
---

# Find CMomentaryRotButton_vtable

Target: `CMomentaryRotButton_vtable` (func) in the module loaded in THIS session.
...
Write `CMomentaryRotButton_vtable.{platform}.yaml` with EXACTLY these fields:
