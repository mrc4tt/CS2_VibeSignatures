...
description: |
  Agent fallback for CNetworkMessages_RegisterFieldChangeCallbackPriority (auto-generated, category: vfunc). Locate
  CNetworkMessages::RegisterFieldChangeCallbackPriority in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_RegisterFieldChangeCallbackPriority, CNetworkMessages::RegisterFieldChangeCallbackPriority
disable-model-invocation: true
---

# Find CNetworkMessages_RegisterFieldChangeCallbackPriority

Target: `CNetworkMessages::RegisterFieldChangeCallbackPriority` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_RegisterFieldChangeCallbackPriority.{platform}.yaml` with EXACTLY these fields:
