...
description: |
  ...
  CSource2GameEntities_CheckTransmit-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameEntities_CheckTransmit-decompiles, CSource2GameEntities_CheckTransmit-decompiles
disable-model-invocation: true
---

# Find CSource2GameEntities_CheckTransmit-decompiles

Target: `CSource2GameEntities_CheckTransmit-decompiles` (vfunc) in the module loaded in THIS session.
