...
description: |
  Agent fallback for CSource2GameEntities_CheckTransmit-decompiles (auto-generated, category: vfunc). Locate
  CSource2GameEntities::CheckTransmit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameEntities_CheckTransmit-decompiles, CSource2GameEntities::CheckTransmit
disable-model-invocation: true
---

# Find CSource2GameEntities_CheckTransmit-decompiles

Target: `CSource2GameEntities::CheckTransmit` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameEntities_CheckTransmit.{platform}.yaml` with EXACTLY these fields:
