---
name: find-CNetworkGameClient_InstallStringTableCallback
description: |
  Agent fallback for CNetworkGameClient_InstallStringTableCallback (auto-generated, category: vfunc). Locate
  CNetworkGameClient::InstallStringTableCallback in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_InstallStringTableCallback, CNetworkGameClient::InstallStringTableCallback
disable-model-invocation: true
---

# Find CNetworkGameClient_InstallStringTableCallback

Target: `CNetworkGameClient::InstallStringTableCallback` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_InstallStringTableCallback.{platform}.yaml` with EXACTLY these fields:
