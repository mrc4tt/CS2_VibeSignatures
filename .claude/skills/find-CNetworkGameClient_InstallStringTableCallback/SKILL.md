...
description: |
  ...
  CNetworkGameClient_InstallStringTableCallback in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_InstallStringTableCallback, CNetworkGameClient_InstallStringTableCallback
disable-model-invocation: true
---

# Find CNetworkGameClient_InstallStringTableCallback

Target: `CNetworkGameClient_InstallStringTableCallback` (vfunc) in the module loaded in THIS session.
