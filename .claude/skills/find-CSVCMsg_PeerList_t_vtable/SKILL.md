...
description: |
  Agent fallback for CSVCMsg_PeerList_t_vtable (auto-generated, category: func). Locate
  CSVCMsg_PeerList_t_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSVCMsg_PeerList_t_vtable, CSVCMsg_PeerList_t_vtable
disable-model-invocation: true
---

# Find CSVCMsg_PeerList_t_vtable

Target: `CSVCMsg_PeerList_t_vtable` (func) in the module loaded in THIS session.
...
Write `CSVCMsg_PeerList_t_vtable.{platform}.yaml` with EXACTLY these fields:
