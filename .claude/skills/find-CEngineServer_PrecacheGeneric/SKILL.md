...
description: |
  ...
  CEngineServer_PrecacheGeneric in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_PrecacheGeneric, CEngineServer_PrecacheGeneric
disable-model-invocation: true
---

# Find CEngineServer_PrecacheGeneric

Target: `CEngineServer_PrecacheGeneric` (vfunc) in the module loaded in THIS session.
