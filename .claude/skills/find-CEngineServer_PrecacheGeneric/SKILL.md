...
description: |
  Agent fallback for CEngineServer_PrecacheGeneric (auto-generated, category: vfunc). Locate
  CEngineServer::PrecacheGeneric in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_PrecacheGeneric, CEngineServer::PrecacheGeneric
disable-model-invocation: true
---

# Find CEngineServer_PrecacheGeneric

Target: `CEngineServer::PrecacheGeneric` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_PrecacheGeneric.{platform}.yaml` with EXACTLY these fields:
