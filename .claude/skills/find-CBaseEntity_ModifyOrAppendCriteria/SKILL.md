...
description: |
  Agent fallback for CBaseEntity_ModifyOrAppendCriteria (auto-generated, category: vfunc). Locate
  CBaseEntity::ModifyOrAppendCriteria in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_ModifyOrAppendCriteria, CBaseEntity::ModifyOrAppendCriteria
disable-model-invocation: true
---

# Find CBaseEntity_ModifyOrAppendCriteria

Target: `CBaseEntity::ModifyOrAppendCriteria` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_ModifyOrAppendCriteria.{platform}.yaml` with EXACTLY these fields:
