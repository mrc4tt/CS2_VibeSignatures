...
description: |
  ...
  CBaseEntity_ModifyOrAppendCriteria in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_ModifyOrAppendCriteria, CBaseEntity_ModifyOrAppendCriteria
disable-model-invocation: true
---

# Find CBaseEntity_ModifyOrAppendCriteria

Target: `CBaseEntity_ModifyOrAppendCriteria` (vfunc) in the module loaded in THIS session.
