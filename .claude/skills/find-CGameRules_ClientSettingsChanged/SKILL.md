...
description: |
  Agent fallback for CGameRules_ClientSettingsChanged (auto-generated, category: vfunc). Locate
  CGameRules::ClientSettingsChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_ClientSettingsChanged, CGameRules::ClientSettingsChanged
disable-model-invocation: true
---

# Find CGameRules_ClientSettingsChanged

Target: `CGameRules::ClientSettingsChanged` (vfunc) in the module loaded in THIS session.
...
Write `CGameRules_ClientSettingsChanged.{platform}.yaml` with EXACTLY these fields:
