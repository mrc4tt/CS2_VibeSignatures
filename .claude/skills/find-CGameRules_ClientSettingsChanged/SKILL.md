...
description: |
  ...
  CGameRules_ClientSettingsChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_ClientSettingsChanged, CGameRules_ClientSettingsChanged
disable-model-invocation: true
---

# Find CGameRules_ClientSettingsChanged

Target: `CGameRules_ClientSettingsChanged` (vfunc) in the module loaded in THIS session.
