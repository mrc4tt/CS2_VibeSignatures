...
description: |
  ...
  CEngineServer_GetPlayerInfo-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetPlayerInfo-inlined, CEngineServer_GetPlayerInfo-inlined
disable-model-invocation: true
---

# Find CEngineServer_GetPlayerInfo-inlined

Target: `CEngineServer_GetPlayerInfo-inlined` (vfunc) in the module loaded in THIS session.
