...
description: |
  Agent fallback for CNETMsg_SpawnGroup_LoadCompleted_t_vtable (auto-generated, category: func). Locate
  CNETMsg_SpawnGroup_LoadCompleted_t_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNETMsg_SpawnGroup_LoadCompleted_t_vtable, CNETMsg_SpawnGroup_LoadCompleted_t_vtable
disable-model-invocation: true
---

# Find CNETMsg_SpawnGroup_LoadCompleted_t_vtable

Target: `CNETMsg_SpawnGroup_LoadCompleted_t_vtable` (func) in the module loaded in THIS session.
...
Write `CNETMsg_SpawnGroup_LoadCompleted_t_vtable.{platform}.yaml` with EXACTLY these fields:
