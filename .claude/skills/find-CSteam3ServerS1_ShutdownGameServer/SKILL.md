---
name: find-CSteam3ServerS1_ShutdownGameServer
description: |
  Agent fallback for CSteam3ServerS1_ShutdownGameServer (auto-generated, category: func). Locate
  CSteam3ServerS1::ShutdownGameServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSteam3ServerS1_ShutdownGameServer, CSteam3ServerS1::ShutdownGameServer
disable-model-invocation: true
---

# Find CSteam3ServerS1_ShutdownGameServer

Target: `CSteam3ServerS1::ShutdownGameServer` (func) in the module loaded in THIS session.
...
Write `CSteam3ServerS1_ShutdownGameServer.{platform}.yaml` with EXACTLY these fields:
