...
description: |
  ...
  CSteam3ServerS1_ShutdownGameServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSteam3ServerS1_ShutdownGameServer, CSteam3ServerS1_ShutdownGameServer
disable-model-invocation: true
---

# Find CSteam3ServerS1_ShutdownGameServer

Target: `CSteam3ServerS1_ShutdownGameServer` (func) in the module loaded in THIS session.
