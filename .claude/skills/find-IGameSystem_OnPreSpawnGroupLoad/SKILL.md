...
description: |
  ...
  IGameSystem_OnPreSpawnGroupLoad in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnPreSpawnGroupLoad, IGameSystem_OnPreSpawnGroupLoad
disable-model-invocation: true
---

# Find IGameSystem_OnPreSpawnGroupLoad

Target: `IGameSystem_OnPreSpawnGroupLoad` (vfunc) in the module loaded in THIS session.
