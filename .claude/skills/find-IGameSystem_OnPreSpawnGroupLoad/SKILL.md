...
description: |
  Agent fallback for IGameSystem_OnPreSpawnGroupLoad (auto-generated, category: vfunc). Locate
  IGameSystem::OnPreSpawnGroupLoad in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnPreSpawnGroupLoad, IGameSystem::OnPreSpawnGroupLoad
disable-model-invocation: true
---

# Find IGameSystem_OnPreSpawnGroupLoad

Target: `IGameSystem::OnPreSpawnGroupLoad` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnPreSpawnGroupLoad.{platform}.yaml` with EXACTLY these fields:
