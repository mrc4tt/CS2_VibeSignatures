---
name: find-CEngineServiceMgr_OnFrameRenderingFinished
description: |
  Agent fallback for CEngineServiceMgr_OnFrameRenderingFinished (auto-generated, category: vfunc). Locate
  CEngineServiceMgr::OnFrameRenderingFinished in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_OnFrameRenderingFinished, CEngineServiceMgr::OnFrameRenderingFinished
disable-model-invocation: true
---

# Find CEngineServiceMgr_OnFrameRenderingFinished

Target: `CEngineServiceMgr::OnFrameRenderingFinished` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_OnFrameRenderingFinished.{platform}.yaml` with EXACTLY these fields:
