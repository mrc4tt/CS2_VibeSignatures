...
description: |
  ...
  CEngineServiceMgr_OnFrameRenderingFinished in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_OnFrameRenderingFinished, CEngineServiceMgr_OnFrameRenderingFinished
disable-model-invocation: true
---

# Find CEngineServiceMgr_OnFrameRenderingFinished

Target: `CEngineServiceMgr_OnFrameRenderingFinished` (vfunc) in the module loaded in THIS session.
