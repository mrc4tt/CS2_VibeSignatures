---
name: find-CMultiplayRules_ctor-decompiles
description: |
  Agent fallback for CMultiplayRules_ctor-decompiles (auto-generated, category: func). Locate
  CMultiplayRules::CMultiplayRules in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMultiplayRules_ctor-decompiles, CMultiplayRules::CMultiplayRules
disable-model-invocation: true
---

# Find CMultiplayRules_ctor-decompiles

Target: `CMultiplayRules::CMultiplayRules` (func) in the module loaded in THIS session.
...
Write `CMultiplayRules_ctor.{platform}.yaml` with EXACTLY these fields:
