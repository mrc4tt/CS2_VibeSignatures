...
description: |
  ...
  CMultiplayRules_ctor-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMultiplayRules_ctor-decompiles, CMultiplayRules_ctor-decompiles
disable-model-invocation: true
---

# Find CMultiplayRules_ctor-decompiles

Target: `CMultiplayRules_ctor-decompiles` (func) in the module loaded in THIS session.
