...
description: |
  ...
  CRenderingWorldSession_FindOrCreateWorldSession in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRenderingWorldSession_FindOrCreateWorldSession, CRenderingWorldSession_FindOrCreateWorldSession
disable-model-invocation: true
---

# Find CRenderingWorldSession_FindOrCreateWorldSession

Target: `CRenderingWorldSession_FindOrCreateWorldSession` (func) in the module loaded in THIS session.
