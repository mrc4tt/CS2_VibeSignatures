...
description: |
  Agent fallback for CRenderingWorldSession_FindOrCreateWorldSession (auto-generated, category: func). Locate
  CRenderingWorldSession::FindOrCreateWorldSession in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRenderingWorldSession_FindOrCreateWorldSession, CRenderingWorldSession::FindOrCreateWorldSession
disable-model-invocation: true
---

# Find CRenderingWorldSession_FindOrCreateWorldSession

Target: `CRenderingWorldSession::FindOrCreateWorldSession` (func) in the module loaded in THIS session.
...
Write `CRenderingWorldSession_FindOrCreateWorldSession.{platform}.yaml` with EXACTLY these fields:
