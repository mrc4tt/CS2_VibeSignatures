...
description: |
  Agent fallback for CGameResourceService_GetResourceManifestDebugName (auto-generated, category: vfunc). Locate
  CGameResourceService::GetResourceManifestDebugName in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_GetResourceManifestDebugName, CGameResourceService::GetResourceManifestDebugName
disable-model-invocation: true
---

# Find CGameResourceService_GetResourceManifestDebugName

Target: `CGameResourceService::GetResourceManifestDebugName` (vfunc) in the module loaded in THIS session.
...
Write `CGameResourceService_GetResourceManifestDebugName.{platform}.yaml` with EXACTLY these fields:
