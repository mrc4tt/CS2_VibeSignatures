...
description: |
  ...
  CGameResourceService_GetResourceManifestDebugName in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_GetResourceManifestDebugName, CGameResourceService_GetResourceManifestDebugName
disable-model-invocation: true
---

# Find CGameResourceService_GetResourceManifestDebugName

Target: `CGameResourceService_GetResourceManifestDebugName` (vfunc) in the module loaded in THIS session.
