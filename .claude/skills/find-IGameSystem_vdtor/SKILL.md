---
name: find-IGameSystem_vdtor
description: |
  Agent fallback for IGameSystem_vdtor (auto-generated, category: vfunc). Locate
  IGameSystem::~IGameSystem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_vdtor, IGameSystem::~IGameSystem
disable-model-invocation: true
---

# Find IGameSystem_vdtor

Target: `IGameSystem::~IGameSystem` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_vdtor.{platform}.yaml` with EXACTLY these fields:
