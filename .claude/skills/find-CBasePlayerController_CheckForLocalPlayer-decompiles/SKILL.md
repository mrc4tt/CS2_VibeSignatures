...
description: |
  Agent fallback for CBasePlayerController_CheckForLocalPlayer-decompiles (auto-generated, category: func). Locate
  CBasePlayerController::CheckForLocalPlayer in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_CheckForLocalPlayer-decompiles, CBasePlayerController::CheckForLocalPlayer
disable-model-invocation: true
---

# Find CBasePlayerController_CheckForLocalPlayer-decompiles

Target: `CBasePlayerController::CheckForLocalPlayer` (func) in the module loaded in THIS session.
...
Write `CBasePlayerController_CheckForLocalPlayer.{platform}.yaml` with EXACTLY these fields:
