...
description: |
  ...
  CBasePlayerController_CheckForLocalPlayer-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_CheckForLocalPlayer-decompiles, CBasePlayerController_CheckForLocalPlayer-decompiles
disable-model-invocation: true
---

# Find CBasePlayerController_CheckForLocalPlayer-decompiles

Target: `CBasePlayerController_CheckForLocalPlayer-decompiles` (func) in the module loaded in THIS session.
