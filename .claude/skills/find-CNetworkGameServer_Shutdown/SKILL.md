...
description: |
  ...
  CNetworkGameServer_Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_Shutdown, CNetworkGameServer_Shutdown
disable-model-invocation: true
---

# Find CNetworkGameServer_Shutdown

Target: `CNetworkGameServer_Shutdown` (vfunc) in the module loaded in THIS session.
