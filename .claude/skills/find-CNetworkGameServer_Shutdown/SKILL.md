...
description: |
  Agent fallback for CNetworkGameServer_Shutdown (auto-generated, category: vfunc). Locate
  CNetworkGameServer::Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_Shutdown, CNetworkGameServer::Shutdown
disable-model-invocation: true
---

# Find CNetworkGameServer_Shutdown

Target: `CNetworkGameServer::Shutdown` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_Shutdown.{platform}.yaml` with EXACTLY these fields:
