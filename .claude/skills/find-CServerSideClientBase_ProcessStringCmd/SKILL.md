...
description: |
  Agent fallback for CServerSideClientBase_ProcessStringCmd (auto-generated, category: vfunc). Locate
  CServerSideClientBase::ProcessStringCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessStringCmd, CServerSideClientBase::ProcessStringCmd
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessStringCmd

Target: `CServerSideClientBase::ProcessStringCmd` (vfunc) in the module loaded in THIS session.
...
Write `CServerSideClientBase_ProcessStringCmd.{platform}.yaml` with EXACTLY these fields:
