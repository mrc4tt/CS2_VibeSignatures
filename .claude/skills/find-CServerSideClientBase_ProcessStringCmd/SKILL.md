...
description: |
  ...
  CServerSideClientBase_ProcessStringCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessStringCmd, CServerSideClientBase_ProcessStringCmd
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessStringCmd

Target: `CServerSideClientBase_ProcessStringCmd` (vfunc) in the module loaded in THIS session.
