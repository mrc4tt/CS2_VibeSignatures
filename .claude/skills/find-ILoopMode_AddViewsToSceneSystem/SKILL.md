...
description: |
  ...
  ILoopMode_AddViewsToSceneSystem in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_AddViewsToSceneSystem, ILoopMode_AddViewsToSceneSystem
disable-model-invocation: true
---

# Find ILoopMode_AddViewsToSceneSystem

Target: `ILoopMode_AddViewsToSceneSystem` (vfunc) in the module loaded in THIS session.
