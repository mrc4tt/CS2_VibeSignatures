...
description: |
  Agent fallback for ILoopMode_AddViewsToSceneSystem (auto-generated, category: vfunc). Locate
  ILoopMode::AddViewsToSceneSystem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_AddViewsToSceneSystem, ILoopMode::AddViewsToSceneSystem
disable-model-invocation: true
---

# Find ILoopMode_AddViewsToSceneSystem

Target: `ILoopMode::AddViewsToSceneSystem` (vfunc) in the module loaded in THIS session.
...
Write `ILoopMode_AddViewsToSceneSystem.{platform}.yaml` with EXACTLY these fields:
