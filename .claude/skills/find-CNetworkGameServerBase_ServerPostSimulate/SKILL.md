...
description: |
  Agent fallback for CNetworkGameServerBase_ServerPostSimulate (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::ServerPostSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerPostSimulate, CNetworkGameServerBase::ServerPostSimulate
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerPostSimulate

Target: `CNetworkGameServerBase::ServerPostSimulate` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_ServerPostSimulate.{platform}.yaml` with EXACTLY these fields:
