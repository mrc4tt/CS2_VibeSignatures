...
description: |
  ...
  CNetworkGameServerBase_ServerPostSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerPostSimulate, CNetworkGameServerBase_ServerPostSimulate
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerPostSimulate

Target: `CNetworkGameServerBase_ServerPostSimulate` (vfunc) in the module loaded in THIS session.
