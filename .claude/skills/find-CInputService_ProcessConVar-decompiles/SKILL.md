---
name: find-CInputService_ProcessConVar-decompiles
description: |
  Agent fallback for CInputService_ProcessConVar-decompiles (auto-generated, category: func). Locate
  CInputService_ProcessConVar in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_ProcessConVar-decompiles, CInputService_ProcessConVar
disable-model-invocation: true
---

# Find CInputService_ProcessConVar-decompiles

Target: `CInputService_ProcessConVar` (func) in the module loaded in THIS session.
...
Write `CInputService_ProcessConVar.{platform}.yaml` with EXACTLY these fields:
