...
description: |
  ...
  CInputService_ProcessConVar-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_ProcessConVar-decompiles, CInputService_ProcessConVar-decompiles
disable-model-invocation: true
---

# Find CInputService_ProcessConVar-decompiles

Target: `CInputService_ProcessConVar-decompiles` (func) in the module loaded in THIS session.
