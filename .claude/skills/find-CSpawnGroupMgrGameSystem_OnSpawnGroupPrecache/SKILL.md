...
description: |
  ...
  CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache, CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache

Target: `CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache` (vfunc) in the module loaded in THIS session.
