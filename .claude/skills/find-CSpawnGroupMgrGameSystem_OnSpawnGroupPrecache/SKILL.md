...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::OnSpawnGroupPrecache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache, CSpawnGroupMgrGameSystem::OnSpawnGroupPrecache
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache

Target: `CSpawnGroupMgrGameSystem::OnSpawnGroupPrecache` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_OnSpawnGroupPrecache.{platform}.yaml` with EXACTLY these fields:
