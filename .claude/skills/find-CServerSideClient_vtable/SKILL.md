...
description: |
  Agent fallback for CServerSideClient_vtable (auto-generated, category: func). Locate
  CServerSideClient_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClient_vtable, CServerSideClient_vtable
disable-model-invocation: true
---

# Find CServerSideClient_vtable

Target: `CServerSideClient_vtable` (func) in the module loaded in THIS session.
...
Write `CServerSideClient_vtable.{platform}.yaml` with EXACTLY these fields:
