...
description: |
  Agent fallback for CUserMessage_ExtraUserData_vtable (auto-generated, category: func). Locate
  CUserMessage_ExtraUserData_vtable in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CUserMessage_ExtraUserData_vtable, CUserMessage_ExtraUserData_vtable
disable-model-invocation: true
---

# Find CUserMessage_ExtraUserData_vtable

Target: `CUserMessage_ExtraUserData_vtable` (func) in the module loaded in THIS session.
...
Write `CUserMessage_ExtraUserData_vtable.{platform}.yaml` with EXACTLY these fields:
