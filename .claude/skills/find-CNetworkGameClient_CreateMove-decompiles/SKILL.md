...
description: |
  ...
  CNetworkGameClient_CreateMove-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_CreateMove-decompiles, CNetworkGameClient_CreateMove-decompiles
disable-model-invocation: true
---

# Find CNetworkGameClient_CreateMove-decompiles

Target: `CNetworkGameClient_CreateMove-decompiles` (vfunc) in the module loaded in THIS session.
