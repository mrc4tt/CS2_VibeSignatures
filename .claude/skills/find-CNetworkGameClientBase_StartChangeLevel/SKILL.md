...
description: |
  Agent fallback for CNetworkGameClientBase_StartChangeLevel (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::StartChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_StartChangeLevel, CNetworkGameClientBase::StartChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameClientBase_StartChangeLevel

Target: `CNetworkGameClientBase::StartChangeLevel` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_StartChangeLevel.{platform}.yaml` with EXACTLY these fields:
