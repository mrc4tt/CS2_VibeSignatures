...
description: |
  ...
  CNetworkGameClientBase_StartChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_StartChangeLevel, CNetworkGameClientBase_StartChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameClientBase_StartChangeLevel

Target: `CNetworkGameClientBase_StartChangeLevel` (vfunc) in the module loaded in THIS session.
