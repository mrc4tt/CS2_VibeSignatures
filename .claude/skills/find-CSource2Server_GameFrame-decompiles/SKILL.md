---
name: find-CSource2Server_GameFrame-decompiles
description: |
  Agent fallback for CSource2Server_GameFrame-decompiles (auto-generated, category: vfunc). Locate
  CSource2Server::GameFrame in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameFrame-decompiles, CSource2Server::GameFrame
disable-model-invocation: true
---

# Find CSource2Server_GameFrame-decompiles

Target: `CSource2Server::GameFrame` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GameFrame.{platform}.yaml` with EXACTLY these fields:
