...
description: |
  ...
  CSource2Server_GameFrame-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameFrame-decompiles, CSource2Server_GameFrame-decompiles
disable-model-invocation: true
---

# Find CSource2Server_GameFrame-decompiles

Target: `CSource2Server_GameFrame-decompiles` (vfunc) in the module loaded in THIS session.
