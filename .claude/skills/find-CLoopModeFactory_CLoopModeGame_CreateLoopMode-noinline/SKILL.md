...
description: |
  ...
  CLoopModeFactory_CLoopModeGame_CreateLoopMode-noinline in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeFactory_CLoopModeGame_CreateLoopMode-noinline, CLoopModeFactory_CLoopModeGame_CreateLoopMode-noinline
disable-model-invocation: true
---

# Find CLoopModeFactory_CLoopModeGame_CreateLoopMode-noinline

Target: `CLoopModeFactory_CLoopModeGame_CreateLoopMode-noinline` (vfunc) in the module loaded in THIS session.
