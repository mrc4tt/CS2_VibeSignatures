...
description: |
  Agent fallback for NET_ReloadGameEvents_CommandHandler (auto-generated, category: func). Locate
  NET_ReloadGameEvents_CommandHandler in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: NET_ReloadGameEvents_CommandHandler, NET_ReloadGameEvents_CommandHandler
disable-model-invocation: true
---

# Find NET_ReloadGameEvents_CommandHandler

Target: `NET_ReloadGameEvents_CommandHandler` (func) in the module loaded in THIS session.
