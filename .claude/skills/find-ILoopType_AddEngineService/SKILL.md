...
description: |
  Agent fallback for ILoopType_AddEngineService (auto-generated, category: vfunc). Locate
  ILoopType::AddEngineService in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopType_AddEngineService, ILoopType::AddEngineService
disable-model-invocation: true
---

# Find ILoopType_AddEngineService

Target: `ILoopType::AddEngineService` (vfunc) in the module loaded in THIS session.
...
Write `ILoopType_AddEngineService.{platform}.yaml` with EXACTLY these fields:
