...
description: |
  ...
  ILoopType_AddEngineService in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopType_AddEngineService, ILoopType_AddEngineService
disable-model-invocation: true
---

# Find ILoopType_AddEngineService

Target: `ILoopType_AddEngineService` (vfunc) in the module loaded in THIS session.
