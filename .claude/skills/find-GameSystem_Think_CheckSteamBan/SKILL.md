...
description: |
  Agent fallback for GameSystem_Think_CheckSteamBan (auto-generated, category: func). Locate
  GameSystem_Think_CheckSteamBan in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GameSystem_Think_CheckSteamBan, GameSystem_Think_CheckSteamBan
disable-model-invocation: true
---

# Find GameSystem_Think_CheckSteamBan

Target: `GameSystem_Think_CheckSteamBan` (func) in the module loaded in THIS session.
...
Write `GameSystem_Think_CheckSteamBan.{platform}.yaml` with EXACTLY these fields:
