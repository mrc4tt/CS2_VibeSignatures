...
description: |
  ...
  INetworkGameServer_PreWorldUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_PreWorldUpdate, INetworkGameServer_PreWorldUpdate
disable-model-invocation: true
---

# Find INetworkGameServer_PreWorldUpdate

Target: `INetworkGameServer_PreWorldUpdate` (vfunc) in the module loaded in THIS session.
