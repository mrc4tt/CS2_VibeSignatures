...
description: |
  Agent fallback for INetworkGameServer_PreWorldUpdate (auto-generated, category: vfunc). Locate
  INetworkGameServer::PreWorldUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_PreWorldUpdate, INetworkGameServer::PreWorldUpdate
disable-model-invocation: true
---

# Find INetworkGameServer_PreWorldUpdate

Target: `INetworkGameServer::PreWorldUpdate` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_PreWorldUpdate.{platform}.yaml` with EXACTLY these fields:
