...
description: |
  Agent fallback for CMapListService_vtable (auto-generated, category: func). Locate
  CMapListService_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMapListService_vtable, CMapListService_vtable
disable-model-invocation: true
---

# Find CMapListService_vtable

Target: `CMapListService_vtable` (func) in the module loaded in THIS session.
...
Write `CMapListService_vtable.{platform}.yaml` with EXACTLY these fields:
