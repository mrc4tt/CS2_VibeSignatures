---
name: find-CNetworkGameClientBase_ProcessCmdKeyValues
description: |
  Agent fallback for CNetworkGameClientBase_ProcessCmdKeyValues (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::ProcessCmdKeyValues in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessCmdKeyValues, CNetworkGameClientBase::ProcessCmdKeyValues
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessCmdKeyValues

Target: `CNetworkGameClientBase::ProcessCmdKeyValues` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ProcessCmdKeyValues.{platform}.yaml` with EXACTLY these fields:
