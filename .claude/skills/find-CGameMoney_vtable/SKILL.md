...
description: |
  Agent fallback for CGameMoney_vtable (auto-generated, category: func). Locate
  CGameMoney_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameMoney_vtable, CGameMoney_vtable
disable-model-invocation: true
---

# Find CGameMoney_vtable

Target: `CGameMoney_vtable` (func) in the module loaded in THIS session.
...
Write `CGameMoney_vtable.{platform}.yaml` with EXACTLY these fields:
