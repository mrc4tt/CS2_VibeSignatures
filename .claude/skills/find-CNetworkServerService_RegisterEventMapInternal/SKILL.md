...
description: |
  ...
  CNetworkServerService_RegisterEventMapInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_RegisterEventMapInternal, CNetworkServerService_RegisterEventMapInternal
disable-model-invocation: true
---

# Find CNetworkServerService_RegisterEventMapInternal

Target: `CNetworkServerService_RegisterEventMapInternal` (func) in the module loaded in THIS session.
