...
description: |
  Agent fallback for CNetworkServerService_RegisterEventMapInternal (auto-generated, category: func). Locate
  CNetworkServerService::RegisterEventMapInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_RegisterEventMapInternal, CNetworkServerService::RegisterEventMapInternal
disable-model-invocation: true
---

# Find CNetworkServerService_RegisterEventMapInternal

Target: `CNetworkServerService::RegisterEventMapInternal` (func) in the module loaded in THIS session.
...
Write `CNetworkServerService_RegisterEventMapInternal.{platform}.yaml` with EXACTLY these fields:
