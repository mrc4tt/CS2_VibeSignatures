...
description: |
  Agent fallback for CGameRulesGameSystem_OnGameShutdown (auto-generated, category: vfunc). Locate
  CGameRulesGameSystem::GameShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRulesGameSystem_OnGameShutdown, CGameRulesGameSystem::GameShutdown
disable-model-invocation: true
---

# Find CGameRulesGameSystem_OnGameShutdown

Target: `CGameRulesGameSystem::GameShutdown` (vfunc) in the module loaded in THIS session.
...
Write `CGameRulesGameSystem_OnGameShutdown.{platform}.yaml` with EXACTLY these fields:
