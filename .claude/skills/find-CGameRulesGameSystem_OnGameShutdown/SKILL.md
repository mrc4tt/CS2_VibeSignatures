...
description: |
  ...
  CGameRulesGameSystem_OnGameShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRulesGameSystem_OnGameShutdown, CGameRulesGameSystem_OnGameShutdown
disable-model-invocation: true
---

# Find CGameRulesGameSystem_OnGameShutdown

Target: `CGameRulesGameSystem_OnGameShutdown` (vfunc) in the module loaded in THIS session.
