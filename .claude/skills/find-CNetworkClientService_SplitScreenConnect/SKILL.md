...
description: |
  Agent fallback for CNetworkClientService_SplitScreenConnect (auto-generated, category: vfunc). Locate
  CNetworkClientService::SplitScreenConnect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_SplitScreenConnect, CNetworkClientService::SplitScreenConnect
disable-model-invocation: true
---

# Find CNetworkClientService_SplitScreenConnect

Target: `CNetworkClientService::SplitScreenConnect` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_SplitScreenConnect.{platform}.yaml` with EXACTLY these fields:
