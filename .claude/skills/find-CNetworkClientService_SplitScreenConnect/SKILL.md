...
description: |
  ...
  CNetworkClientService_SplitScreenConnect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_SplitScreenConnect, CNetworkClientService_SplitScreenConnect
disable-model-invocation: true
---

# Find CNetworkClientService_SplitScreenConnect

Target: `CNetworkClientService_SplitScreenConnect` (vfunc) in the module loaded in THIS session.
