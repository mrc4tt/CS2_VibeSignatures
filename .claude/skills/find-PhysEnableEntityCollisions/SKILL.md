---
name: find-PhysEnableEntityCollisions
description: |
  Agent fallback for PhysEnableEntityCollisions (auto-generated, category: func). Locate
  PhysEnableEntityCollisions in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: PhysEnableEntityCollisions, PhysEnableEntityCollisions
disable-model-invocation: true
---

# Find PhysEnableEntityCollisions

Target: `PhysEnableEntityCollisions` (func) in the module loaded in THIS session.
...
Write `PhysEnableEntityCollisions.{platform}.yaml` with EXACTLY these fields:
