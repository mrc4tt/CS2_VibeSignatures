...
description: |
  Agent fallback for CLoopModeGame_ctor (auto-generated, category: func). Locate
  ...
  Trigger: CLoopModeGame_ctor, CLoopModeGame::CLoopModeGame
...
Write `CLoopModeGame_ctor.{platform}.yaml` with EXACTLY these fields:
