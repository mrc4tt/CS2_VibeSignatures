...
description: |
  ...
  CLoopModeGame_ctor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_ctor, CLoopModeGame_ctor
disable-model-invocation: true
---

# Find CLoopModeGame_ctor

Target: `CLoopModeGame_ctor` (func) in the module loaded in THIS session.
