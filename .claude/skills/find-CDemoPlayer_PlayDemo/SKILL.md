...
description: |
  Agent fallback for CDemoPlayer_PlayDemo (auto-generated, category: vfunc). Locate
  CDemoPlayer::PlayDemo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_PlayDemo, CDemoPlayer::PlayDemo
disable-model-invocation: true
---

# Find CDemoPlayer_PlayDemo

Target: `CDemoPlayer::PlayDemo` (vfunc) in the module loaded in THIS session.
...
Write `CDemoPlayer_PlayDemo.{platform}.yaml` with EXACTLY these fields:
