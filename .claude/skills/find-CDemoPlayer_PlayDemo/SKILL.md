...
description: |
  ...
  CDemoPlayer_PlayDemo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_PlayDemo, CDemoPlayer_PlayDemo
disable-model-invocation: true
---

# Find CDemoPlayer_PlayDemo

Target: `CDemoPlayer_PlayDemo` (vfunc) in the module loaded in THIS session.
