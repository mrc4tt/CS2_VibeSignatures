...
description: |
  Agent fallback for CEntityInstance_m_iszPrivateVScripts (auto-generated, category: structmember). Locate
  CEntityInstance::m_iszPrivateVScripts in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_m_iszPrivateVScripts, CEntityInstance::m_iszPrivateVScripts
disable-model-invocation: true
---

# Find CEntityInstance_m_iszPrivateVScripts

Target: `CEntityInstance::m_iszPrivateVScripts` (structmember) in the module loaded in THIS session.
...
Write `CEntityInstance_m_iszPrivateVScripts.{platform}.yaml` with EXACTLY these fields:
