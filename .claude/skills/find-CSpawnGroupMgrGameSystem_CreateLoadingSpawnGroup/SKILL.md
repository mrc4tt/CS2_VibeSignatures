...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::CreateLoadingSpawnGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup, CSpawnGroupMgrGameSystem::CreateLoadingSpawnGroup
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup

Target: `CSpawnGroupMgrGameSystem::CreateLoadingSpawnGroup` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup.{platform}.yaml` with EXACTLY these fields:
