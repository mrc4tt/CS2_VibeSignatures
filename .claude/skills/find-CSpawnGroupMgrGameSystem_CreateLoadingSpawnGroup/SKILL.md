...
description: |
  ...
  CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup, CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup

Target: `CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroup` (vfunc) in the module loaded in THIS session.
