...
description: |
  ...
  INetworkSystem_PrintNetworkStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_PrintNetworkStats, INetworkSystem_PrintNetworkStats
disable-model-invocation: true
---

# Find INetworkSystem_PrintNetworkStats

Target: `INetworkSystem_PrintNetworkStats` (vfunc) in the module loaded in THIS session.
