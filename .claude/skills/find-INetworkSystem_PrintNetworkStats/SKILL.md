---
name: find-INetworkSystem_PrintNetworkStats
description: |
  Agent fallback for INetworkSystem_PrintNetworkStats (auto-generated, category: vfunc). Locate
  INetworkSystem::PrintNetworkStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_PrintNetworkStats, INetworkSystem::PrintNetworkStats
disable-model-invocation: true
---

# Find INetworkSystem_PrintNetworkStats

Target: `INetworkSystem::PrintNetworkStats` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_PrintNetworkStats.{platform}.yaml` with EXACTLY these fields:
