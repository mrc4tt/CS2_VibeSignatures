...
description: |
  ...
  SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call, SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call
disable-model-invocation: true
---

# Find SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call

Target: `SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call` (func) in the module loaded in THIS session.
