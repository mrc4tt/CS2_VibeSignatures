---
name: find-CNetworkSystem_InitNetworkSystem
description: |
  Agent fallback for CNetworkSystem_InitNetworkSystem (auto-generated, category: func). Locate
  CNetworkSystem_InitNetworkSystem in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_InitNetworkSystem, CNetworkSystem_InitNetworkSystem
disable-model-invocation: true
---

# Find CNetworkSystem_InitNetworkSystem

Target: `CNetworkSystem_InitNetworkSystem` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_InitNetworkSystem.{platform}.yaml` with EXACTLY these fields:
