...
description: |
  Agent fallback for CNetworkSystem_InitNetworkSystem (auto-generated, category: vfunc). Locate
...
Target: `CNetworkSystem_InitNetworkSystem` (vfunc) in the module loaded in THIS session.
