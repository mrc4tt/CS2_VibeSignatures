...
description: |
  ...
  CBaseEntity_DrawDebugTextOverlays in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_DrawDebugTextOverlays, CBaseEntity_DrawDebugTextOverlays
disable-model-invocation: true
---

# Find CBaseEntity_DrawDebugTextOverlays

Target: `CBaseEntity_DrawDebugTextOverlays` (vfunc) in the module loaded in THIS session.
