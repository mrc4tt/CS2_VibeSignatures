...
description: |
  Agent fallback for CBaseEntity_DrawDebugTextOverlays (auto-generated, category: vfunc). Locate
  CBaseEntity::DrawDebugTextOverlays in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_DrawDebugTextOverlays, CBaseEntity::DrawDebugTextOverlays
disable-model-invocation: true
---

# Find CBaseEntity_DrawDebugTextOverlays

Target: `CBaseEntity::DrawDebugTextOverlays` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_DrawDebugTextOverlays.{platform}.yaml` with EXACTLY these fields:
