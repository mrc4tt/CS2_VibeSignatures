...
description: |
  ...
  CFlashbangProjectile_Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlashbangProjectile_Spawn, CFlashbangProjectile_Spawn
disable-model-invocation: true
---

# Find CFlashbangProjectile_Spawn

Target: `CFlashbangProjectile_Spawn` (vfunc) in the module loaded in THIS session.
