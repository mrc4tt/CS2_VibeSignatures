...
description: |
  Agent fallback for CFlashbangProjectile_Spawn (auto-generated, category: vfunc). Locate
  CFlashbangProjectile::Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlashbangProjectile_Spawn, CFlashbangProjectile::Spawn
disable-model-invocation: true
---

# Find CFlashbangProjectile_Spawn

Target: `CFlashbangProjectile::Spawn` (vfunc) in the module loaded in THIS session.
...
Write `CFlashbangProjectile_Spawn.{platform}.yaml` with EXACTLY these fields:
