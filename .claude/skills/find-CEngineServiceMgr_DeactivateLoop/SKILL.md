...
description: |
  Agent fallback for CEngineServiceMgr_DeactivateLoop (auto-generated, category: func). Locate
  CEngineServiceMgr::DeactivateLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_DeactivateLoop, CEngineServiceMgr::DeactivateLoop
disable-model-invocation: true
---

# Find CEngineServiceMgr_DeactivateLoop

Target: `CEngineServiceMgr::DeactivateLoop` (func) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_DeactivateLoop.{platform}.yaml` with EXACTLY these fields:
