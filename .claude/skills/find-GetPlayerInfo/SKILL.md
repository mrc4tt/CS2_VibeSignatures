---
name: find-GetPlayerInfo
description: |
  Agent fallback for GetPlayerInfo (auto-generated, category: func). Locate
  GetPlayerInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GetPlayerInfo, GetPlayerInfo
disable-model-invocation: true
---

# Find GetPlayerInfo

Target: `GetPlayerInfo` (func) in the module loaded in THIS session.
...
Write `GetPlayerInfo.{platform}.yaml` with EXACTLY these fields:
