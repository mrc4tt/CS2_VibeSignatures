...
description: |
  ...
  CBasePlayerPawn_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_vtable, CBasePlayerPawn_vtable
disable-model-invocation: true
---

# Find CBasePlayerPawn_vtable

Target: `CBasePlayerPawn_vtable` (func) in the module loaded in THIS session.
...
Write `CBasePlayerPawn_vtable.{platform}.yaml` with EXACTLY these fields:
