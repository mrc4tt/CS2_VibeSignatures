...
description: |
  Agent fallback for CSource2GameClients_ClientSettingsChanged (auto-generated, category: vfunc). Locate
  CSource2GameClients::ClientSettingsChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientSettingsChanged, CSource2GameClients::ClientSettingsChanged
disable-model-invocation: true
---

# Find CSource2GameClients_ClientSettingsChanged

Target: `CSource2GameClients::ClientSettingsChanged` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientSettingsChanged.{platform}.yaml` with EXACTLY these fields:
