...
description: |
  ...
  CSource2GameClients_ClientSettingsChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientSettingsChanged, CSource2GameClients_ClientSettingsChanged
disable-model-invocation: true
---

# Find CSource2GameClients_ClientSettingsChanged

Target: `CSource2GameClients_ClientSettingsChanged` (vfunc) in the module loaded in THIS session.
