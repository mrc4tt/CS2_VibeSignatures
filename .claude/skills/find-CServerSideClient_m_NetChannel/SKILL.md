---
name: find-CServerSideClient_m_NetChannel
description: |
  Locate CServerSideClient::m_NetChannel in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "CServerSideClient::m_NetChannel" (symbol CServerSideClient_m_NetChannel). This is a STRUCT MEMBER OFFSET (schema netvar), not a function. Resolve the
  ...
  Trigger: CServerSideClient_m_NetChannel, CServerSideClient::m_NetChannel
disable-model-invocation: true
---

# Find CServerSideClient_m_NetChannel

Target: `CServerSideClient::m_NetChannel` (structmember) in the CS2 server module.
