...
description: |
  Agent fallback for CNetworkGameServer_IsPausable_OfflineCheck (auto-generated, category: func). Locate
  CNetworkGameServer_IsPausable_OfflineCheck in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_IsPausable_OfflineCheck, CNetworkGameServer_IsPausable_OfflineCheck
disable-model-invocation: true
---

# Find CNetworkGameServer_IsPausable_OfflineCheck

Target: `CNetworkGameServer_IsPausable_OfflineCheck` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServer_IsPausable_OfflineCheck.{platform}.yaml` with EXACTLY these fields:
