...
description: |
  Agent fallback for CDemoPlayer_SkipToTick (auto-generated, category: vfunc). Locate
  CDemoPlayer::SkipToTick in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_SkipToTick, CDemoPlayer::SkipToTick
disable-model-invocation: true
---

# Find CDemoPlayer_SkipToTick

Target: `CDemoPlayer::SkipToTick` (vfunc) in the module loaded in THIS session.
...
Write `CDemoPlayer_SkipToTick.{platform}.yaml` with EXACTLY these fields:
