...
description: |
  ...
  CDemoPlayer_SkipToTick in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_SkipToTick, CDemoPlayer_SkipToTick
disable-model-invocation: true
---

# Find CDemoPlayer_SkipToTick

Target: `CDemoPlayer_SkipToTick` (vfunc) in the module loaded in THIS session.
