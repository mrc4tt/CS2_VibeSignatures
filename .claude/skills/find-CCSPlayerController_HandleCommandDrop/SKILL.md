...
description: |
  ...
  CCSPlayerController_HandleCommandDrop in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_HandleCommandDrop, CCSPlayerController_HandleCommandDrop
disable-model-invocation: true
---

# Find CCSPlayerController_HandleCommandDrop

Target: `CCSPlayerController_HandleCommandDrop` (func) in the module loaded in THIS session.
