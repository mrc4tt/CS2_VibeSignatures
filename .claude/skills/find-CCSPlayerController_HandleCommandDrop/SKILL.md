...
description: |
  Agent fallback for CCSPlayerController_HandleCommandDrop (auto-generated, category: func). Locate
  CCSPlayerController::HandleCommandDrop in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_HandleCommandDrop, CCSPlayerController::HandleCommandDrop
disable-model-invocation: true
---

# Find CCSPlayerController_HandleCommandDrop

Target: `CCSPlayerController::HandleCommandDrop` (func) in the module loaded in THIS session.
...
Write `CCSPlayerController_HandleCommandDrop.{platform}.yaml` with EXACTLY these fields:
