...
description: |
  Agent fallback for CNetworkServerService_SetFinalSimulationTickThisFrame (auto-generated, category: func). Locate
  CNetworkServerService_SetFinalSimulationTickThisFrame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_SetFinalSimulationTickThisFrame, CNetworkServerService_SetFinalSimulationTickThisFrame
disable-model-invocation: true
---

# Find CNetworkServerService_SetFinalSimulationTickThisFrame

Target: `CNetworkServerService_SetFinalSimulationTickThisFrame` (func) in the module loaded in THIS session.
...
Write `CNetworkServerService_SetFinalSimulationTickThisFrame.{platform}.yaml` with EXACTLY these fields:
