...
GAMEDATA = {
    "CSS": os.path.expanduser("~/CounterStrikeSharp/configs/addons/counterstrikesharp/gamedata/gamedata.json"),
...
CURATED = {
    ...
    "CEntityResourceManifest_AddResource": {
        "kind": "vtable",
        "vtable_class": "IEntityResourceManifest",
        "source_script": None,
...
def build():
    ...
    out = {
        "_comment": "Re-find recipe per offsets entry. kind: vtable|structoffset|global. "
