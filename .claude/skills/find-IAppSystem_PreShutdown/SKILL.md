...
description: |
  Agent fallback for IAppSystem_PreShutdown (auto-generated, category: vfunc). Locate
  IAppSystem::PreShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IAppSystem_PreShutdown, IAppSystem::PreShutdown
disable-model-invocation: true
---

# Find IAppSystem_PreShutdown

Target: `IAppSystem::PreShutdown` (vfunc) in the module loaded in THIS session.
...
Write `IAppSystem_PreShutdown.{platform}.yaml` with EXACTLY these fields:
