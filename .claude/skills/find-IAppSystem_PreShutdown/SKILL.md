...
description: |
  ...
  IAppSystem_PreShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IAppSystem_PreShutdown, IAppSystem_PreShutdown
disable-model-invocation: true
---

# Find IAppSystem_PreShutdown

Target: `IAppSystem_PreShutdown` (vfunc) in the module loaded in THIS session.
