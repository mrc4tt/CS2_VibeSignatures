---
name: find-CNetworkGameServerBase_m_Clients
description: |
...
# Find CNetworkGameServerBase_m_Clients

Target: `CNetworkGameServerBase::m_Clients` (structmember) in the CS2 server module.
