...
description: |
  ...
  C_GameRules_ctor in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_GameRules_ctor, C_GameRules_ctor
disable-model-invocation: true
---

# Find C_GameRules_ctor

Target: `C_GameRules_ctor` (func) in the module loaded in THIS session.
