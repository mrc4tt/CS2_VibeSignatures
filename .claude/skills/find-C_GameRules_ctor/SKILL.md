---
name: find-C_GameRules_ctor
description: |
  Agent fallback for C_GameRules_ctor (auto-generated, category: func). Locate
  ...
  Trigger: C_GameRules_ctor, C_GameRules::C_GameRules
disable-model-invocation: true
---

# Find C_GameRules_ctor
