---
name: find-g_pGameResourceService
description: |
  Agent fallback for g_pGameResourceService (auto-generated, category: func). Locate
  g_pGameResourceService in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: g_pGameResourceService, g_pGameResourceService
disable-model-invocation: true
---

# Find g_pGameResourceService

Target: `g_pGameResourceService` (func) in the module loaded in THIS session.
...
Write `g_pGameResourceService.{platform}.yaml` with EXACTLY these fields:
