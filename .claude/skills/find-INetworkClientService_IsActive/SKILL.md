...
description: |
  Agent fallback for INetworkClientService_IsActive (auto-generated, category: vfunc). Locate
  INetworkClientService::IsActive in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkClientService_IsActive, INetworkClientService::IsActive
disable-model-invocation: true
---

# Find INetworkClientService_IsActive

Target: `INetworkClientService::IsActive` (vfunc) in the module loaded in THIS session.
...
Write `INetworkClientService_IsActive.{platform}.yaml` with EXACTLY these fields:
