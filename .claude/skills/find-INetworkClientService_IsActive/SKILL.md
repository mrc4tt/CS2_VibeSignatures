...
description: |
  ...
  INetworkClientService_IsActive in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkClientService_IsActive, INetworkClientService_IsActive
disable-model-invocation: true
---

# Find INetworkClientService_IsActive

Target: `INetworkClientService_IsActive` (vfunc) in the module loaded in THIS session.
