...
description: |
  Agent fallback for CPrediction_vtable (auto-generated, category: func). Locate
  CPrediction_vtable in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPrediction_vtable, CPrediction_vtable
disable-model-invocation: true
---

# Find CPrediction_vtable

Target: `CPrediction_vtable` (func) in the module loaded in THIS session.
...
Write `CPrediction_vtable.{platform}.yaml` with EXACTLY these fields:
