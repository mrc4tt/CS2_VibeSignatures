...
description: |
  ...
  CLoopTypeSimple_FrameUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeSimple_FrameUpdate, CLoopTypeSimple_FrameUpdate
disable-model-invocation: true
---

# Find CLoopTypeSimple_FrameUpdate

Target: `CLoopTypeSimple_FrameUpdate` (vfunc) in the module loaded in THIS session.
