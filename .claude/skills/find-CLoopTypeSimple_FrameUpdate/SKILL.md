...
description: |
  Agent fallback for CLoopTypeSimple_FrameUpdate (auto-generated, category: vfunc). Locate
  CLoopTypeSimple::FrameUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeSimple_FrameUpdate, CLoopTypeSimple::FrameUpdate
disable-model-invocation: true
---

# Find CLoopTypeSimple_FrameUpdate

Target: `CLoopTypeSimple::FrameUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeSimple_FrameUpdate.{platform}.yaml` with EXACTLY these fields:
