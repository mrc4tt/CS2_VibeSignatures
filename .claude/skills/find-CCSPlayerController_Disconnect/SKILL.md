...
description: |
  ...
  CCSPlayerController_Disconnect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_Disconnect, CCSPlayerController_Disconnect
disable-model-invocation: true
---

# Find CCSPlayerController_Disconnect

Target: `CCSPlayerController_Disconnect` (vfunc) in the module loaded in THIS session.
