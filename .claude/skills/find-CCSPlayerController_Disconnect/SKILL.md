---
name: find-CCSPlayerController_Disconnect
description: |
  Agent fallback for CCSPlayerController_Disconnect (auto-generated, category: vfunc). Locate
  CCSPlayerController::Disconnect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_Disconnect, CCSPlayerController::Disconnect
disable-model-invocation: true
---

# Find CCSPlayerController_Disconnect

Target: `CCSPlayerController::Disconnect` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayerController_Disconnect.{platform}.yaml` with EXACTLY these fields:
