...
description: |
  Agent fallback for g_CSGOInput (auto-generated, category: func). Locate
  g_CSGOInput in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: g_CSGOInput, g_CSGOInput
disable-model-invocation: true
---

# Find g_CSGOInput

Target: `g_CSGOInput` (func) in the module loaded in THIS session.
...
Write `g_CSGOInput.{platform}.yaml` with EXACTLY these fields:
