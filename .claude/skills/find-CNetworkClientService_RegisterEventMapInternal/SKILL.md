...
description: |
  ...
  CNetworkClientService_RegisterEventMapInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_RegisterEventMapInternal, CNetworkClientService_RegisterEventMapInternal
disable-model-invocation: true
---

# Find CNetworkClientService_RegisterEventMapInternal

Target: `CNetworkClientService_RegisterEventMapInternal` (func) in the module loaded in THIS session.
