...
description: |
  Agent fallback for CNetworkClientService_RegisterEventMapInternal (auto-generated, category: func). Locate
  CNetworkClientService::RegisterEventMapInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_RegisterEventMapInternal, CNetworkClientService::RegisterEventMapInternal
disable-model-invocation: true
---

# Find CNetworkClientService_RegisterEventMapInternal

Target: `CNetworkClientService::RegisterEventMapInternal` (func) in the module loaded in THIS session.
...
Write `CNetworkClientService_RegisterEventMapInternal.{platform}.yaml` with EXACTLY these fields:
