...
description: |
  ...
  CLoopTypeBase_LoadDependentServices-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_LoadDependentServices-noinline, CLoopTypeBase_LoadDependentServices-noinline
disable-model-invocation: true
---

# Find CLoopTypeBase_LoadDependentServices-noinline

Target: `CLoopTypeBase_LoadDependentServices-noinline` (func) in the module loaded in THIS session.
