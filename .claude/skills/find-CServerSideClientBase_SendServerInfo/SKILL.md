...
description: |
  Agent fallback for CServerSideClientBase_SendServerInfo (auto-generated, category: vfunc). Locate
  ...
  Trigger: CServerSideClientBase_SendServerInfo, CServerSideClientBase::SendServerInfo
disable-model-invocation: true
---

# Find CServerSideClientBase_SendServerInfo
