...
description: |
  ...
  CServerSideClientBase_SendServerInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_SendServerInfo, CServerSideClientBase_SendServerInfo
disable-model-invocation: true
---

# Find CServerSideClientBase_SendServerInfo

Target: `CServerSideClientBase_SendServerInfo` (vfunc) in the module loaded in THIS session.
