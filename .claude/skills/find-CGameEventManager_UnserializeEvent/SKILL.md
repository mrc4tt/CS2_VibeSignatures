...
description: |
  ...
  CGameEventManager_UnserializeEvent in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEventManager_UnserializeEvent, CGameEventManager_UnserializeEvent
disable-model-invocation: true
---

# Find CGameEventManager_UnserializeEvent

Target: `CGameEventManager_UnserializeEvent` (vfunc) in the module loaded in THIS session.
