...
description: |
  Agent fallback for CGameEventManager_UnserializeEvent (auto-generated, category: vfunc). Locate
  CGameEventManager::UnserializeEvent in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEventManager_UnserializeEvent, CGameEventManager::UnserializeEvent
disable-model-invocation: true
---

# Find CGameEventManager_UnserializeEvent

Target: `CGameEventManager::UnserializeEvent` (vfunc) in the module loaded in THIS session.
...
Write `CGameEventManager_UnserializeEvent.{platform}.yaml` with EXACTLY these fields:
