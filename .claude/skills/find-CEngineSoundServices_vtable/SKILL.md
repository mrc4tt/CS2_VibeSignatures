---
name: find-CEngineSoundServices_vtable
description: |
  Agent fallback for CEngineSoundServices_vtable (auto-generated, category: func). Locate
  CEngineSoundServices_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineSoundServices_vtable, CEngineSoundServices_vtable
disable-model-invocation: true
---

# Find CEngineSoundServices_vtable

Target: `CEngineSoundServices_vtable` (func) in the module loaded in THIS session.
...
Write `CEngineSoundServices_vtable.{platform}.yaml` with EXACTLY these fields:
