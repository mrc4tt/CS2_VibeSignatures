...
description: |
  Agent fallback for CLoopModeGame_StaticInit (auto-generated, category: func). Locate
  CLoopModeGame::StaticInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_StaticInit, CLoopModeGame::StaticInit
disable-model-invocation: true
---

# Find CLoopModeGame_StaticInit

Target: `CLoopModeGame::StaticInit` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_StaticInit.{platform}.yaml` with EXACTLY these fields:
