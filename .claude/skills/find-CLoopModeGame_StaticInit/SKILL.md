...
description: |
  ...
  CLoopModeGame_StaticInit in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_StaticInit, CLoopModeGame_StaticInit
disable-model-invocation: true
---

# Find CLoopModeGame_StaticInit

Target: `CLoopModeGame_StaticInit` (func) in the module loaded in THIS session.
