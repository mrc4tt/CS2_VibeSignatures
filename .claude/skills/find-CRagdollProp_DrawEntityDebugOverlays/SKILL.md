...
description: |
  ...
  CRagdollProp_DrawEntityDebugOverlays in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRagdollProp_DrawEntityDebugOverlays, CRagdollProp_DrawEntityDebugOverlays
disable-model-invocation: true
---

# Find CRagdollProp_DrawEntityDebugOverlays

Target: `CRagdollProp_DrawEntityDebugOverlays` (vfunc) in the module loaded in THIS session.
