...
description: |
  Agent fallback for CRagdollProp_DrawEntityDebugOverlays (auto-generated, category: vfunc). Locate
  CRagdollProp::DrawEntityDebugOverlays in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRagdollProp_DrawEntityDebugOverlays, CRagdollProp::DrawEntityDebugOverlays
disable-model-invocation: true
---

# Find CRagdollProp_DrawEntityDebugOverlays

Target: `CRagdollProp::DrawEntityDebugOverlays` (vfunc) in the module loaded in THIS session.
...
Write `CRagdollProp_DrawEntityDebugOverlays.{platform}.yaml` with EXACTLY these fields:
