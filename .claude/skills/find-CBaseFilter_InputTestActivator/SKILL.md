...
description: |
  ...
  CBaseFilter_InputTestActivator in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseFilter_InputTestActivator, CBaseFilter_InputTestActivator
disable-model-invocation: true
---

# Find CBaseFilter_InputTestActivator

Target: `CBaseFilter_InputTestActivator` (func) in the module loaded in THIS session.
