...
description: |
  Agent fallback for CBaseFilter_InputTestActivator (auto-generated, category: func). Locate
  CBaseFilter::InputTestActivator in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseFilter_InputTestActivator, CBaseFilter::InputTestActivator
disable-model-invocation: true
---

# Find CBaseFilter_InputTestActivator

Target: `CBaseFilter::InputTestActivator` (func) in the module loaded in THIS session.
...
Write `CBaseFilter_InputTestActivator.{platform}.yaml` with EXACTLY these fields:
