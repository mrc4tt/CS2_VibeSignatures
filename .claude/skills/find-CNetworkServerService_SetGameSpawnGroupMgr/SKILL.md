...
description: |
  Agent fallback for CNetworkServerService_SetGameSpawnGroupMgr (auto-generated, category: func). Locate
  CNetworkServerService_SetGameSpawnGroupMgr in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_SetGameSpawnGroupMgr, CNetworkServerService_SetGameSpawnGroupMgr
disable-model-invocation: true
---

# Find CNetworkServerService_SetGameSpawnGroupMgr

Target: `CNetworkServerService_SetGameSpawnGroupMgr` (func) in the module loaded in THIS session.
...
Write `CNetworkServerService_SetGameSpawnGroupMgr.{platform}.yaml` with EXACTLY these fields:
