...
description: |
  Agent fallback for CRenderingWorldSession_GetEntityLumpForTemplate (auto-generated, category: func). Locate
  CRenderingWorldSession::GetEntityLumpForTemplate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRenderingWorldSession_GetEntityLumpForTemplate, CRenderingWorldSession::GetEntityLumpForTemplate
disable-model-invocation: true
---

# Find CRenderingWorldSession_GetEntityLumpForTemplate

Target: `CRenderingWorldSession::GetEntityLumpForTemplate` (func) in the module loaded in THIS session.
...
Write `CRenderingWorldSession_GetEntityLumpForTemplate.{platform}.yaml` with EXACTLY these fields:
