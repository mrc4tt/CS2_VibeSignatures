...
description: |
  ...
  CRenderingWorldSession_GetEntityLumpForTemplate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRenderingWorldSession_GetEntityLumpForTemplate, CRenderingWorldSession_GetEntityLumpForTemplate
disable-model-invocation: true
---

# Find CRenderingWorldSession_GetEntityLumpForTemplate

Target: `CRenderingWorldSession_GetEntityLumpForTemplate` (func) in the module loaded in THIS session.
