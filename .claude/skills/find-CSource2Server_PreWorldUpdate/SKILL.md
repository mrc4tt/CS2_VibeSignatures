...
description: |
  ...
  CSource2Server_PreWorldUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_PreWorldUpdate, CSource2Server_PreWorldUpdate
disable-model-invocation: true
---

# Find CSource2Server_PreWorldUpdate

Target: `CSource2Server_PreWorldUpdate` (vfunc) in the module loaded in THIS session.
