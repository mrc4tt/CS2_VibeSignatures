...
description: |
  Agent fallback for CSource2Server_PreWorldUpdate (auto-generated, category: vfunc). Locate
  CSource2Server::PreWorldUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_PreWorldUpdate, CSource2Server::PreWorldUpdate
disable-model-invocation: true
---

# Find CSource2Server_PreWorldUpdate

Target: `CSource2Server::PreWorldUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_PreWorldUpdate.{platform}.yaml` with EXACTLY these fields:
