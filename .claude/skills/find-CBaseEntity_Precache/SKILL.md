...
description: |
  ...
  CBaseEntity_Precache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_Precache, CBaseEntity_Precache
disable-model-invocation: true
---

# Find CBaseEntity_Precache

Target: `CBaseEntity_Precache` (vfunc) in the module loaded in THIS session.
