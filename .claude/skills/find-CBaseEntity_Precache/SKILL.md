...
description: |
  Agent fallback for CBaseEntity_Precache (auto-generated, category: vfunc). Locate
  CBaseEntity::Precache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_Precache, CBaseEntity::Precache
disable-model-invocation: true
---

# Find CBaseEntity_Precache

Target: `CBaseEntity::Precache` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_Precache.{platform}.yaml` with EXACTLY these fields:
