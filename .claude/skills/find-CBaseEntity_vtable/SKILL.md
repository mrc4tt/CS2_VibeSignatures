...
description: |
  ...
  CBaseEntity_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_vtable, CBaseEntity_vtable
disable-model-invocation: true
---

# Find CBaseEntity_vtable

Target: `CBaseEntity_vtable` (func) in the module loaded in THIS session.
...
Write `CBaseEntity_vtable.{platform}.yaml` with EXACTLY these fields:
