...
description: |
  ...
  CCSPlayerPawnBase_OnSetDormant in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawnBase_OnSetDormant, CCSPlayerPawnBase_OnSetDormant
disable-model-invocation: true
---

# Find CCSPlayerPawnBase_OnSetDormant

Target: `CCSPlayerPawnBase_OnSetDormant` (vfunc) in the module loaded in THIS session.
