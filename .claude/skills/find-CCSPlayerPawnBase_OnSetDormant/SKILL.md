...
description: |
  Agent fallback for CCSPlayerPawnBase_OnSetDormant (auto-generated, category: vfunc). Locate
  CCSPlayerPawnBase::OnSetDormant in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawnBase_OnSetDormant, CCSPlayerPawnBase::OnSetDormant
disable-model-invocation: true
---

# Find CCSPlayerPawnBase_OnSetDormant

Target: `CCSPlayerPawnBase::OnSetDormant` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayerPawnBase_OnSetDormant.{platform}.yaml` with EXACTLY these fields:
