...
description: |
  Agent fallback for CUserMessageServerFrameTime_t_vtable (auto-generated, category: func). Locate
  CUserMessageServerFrameTime_t_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CUserMessageServerFrameTime_t_vtable, CUserMessageServerFrameTime_t_vtable
disable-model-invocation: true
---

# Find CUserMessageServerFrameTime_t_vtable

Target: `CUserMessageServerFrameTime_t_vtable` (func) in the module loaded in THIS session.
...
Write `CUserMessageServerFrameTime_t_vtable.{platform}.yaml` with EXACTLY these fields:
