...
description: |
  Agent fallback for CEngineServiceMgr_PrintStatus (auto-generated, category: vfunc). Locate
  CEngineServiceMgr::PrintStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_PrintStatus, CEngineServiceMgr::PrintStatus
disable-model-invocation: true
---

# Find CEngineServiceMgr_PrintStatus

Target: `CEngineServiceMgr::PrintStatus` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_PrintStatus.{platform}.yaml` with EXACTLY these fields:
