...
description: |
  ...
  CEngineServiceMgr_PrintStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_PrintStatus, CEngineServiceMgr_PrintStatus
disable-model-invocation: true
---

# Find CEngineServiceMgr_PrintStatus

Target: `CEngineServiceMgr_PrintStatus` (vfunc) in the module loaded in THIS session.
