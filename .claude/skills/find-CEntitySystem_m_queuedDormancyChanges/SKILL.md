...
description: |
  Agent fallback for CEntitySystem_m_queuedDormancyChanges (auto-generated, category: structmember). Locate
  CEntitySystem::m_queuedDormancyChanges in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_queuedDormancyChanges, CEntitySystem::m_queuedDormancyChanges
disable-model-invocation: true
---

# Find CEntitySystem_m_queuedDormancyChanges

Target: `CEntitySystem::m_queuedDormancyChanges` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_queuedDormancyChanges.{platform}.yaml` with EXACTLY these fields:
