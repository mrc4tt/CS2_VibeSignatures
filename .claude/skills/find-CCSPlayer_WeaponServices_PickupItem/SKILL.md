...
description: |
  Agent fallback for CCSPlayer_WeaponServices_PickupItem (auto-generated, category: vfunc). Locate
  ...
  Trigger: CCSPlayer_WeaponServices_PickupItem, CCSPlayer_WeaponServices::PickupItem
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_PickupItem
