...
description: |
  ...
  CCSPlayer_WeaponServices_PickupItem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_WeaponServices_PickupItem, CCSPlayer_WeaponServices_PickupItem
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_PickupItem

Target: `CCSPlayer_WeaponServices_PickupItem` (vfunc) in the module loaded in THIS session.
