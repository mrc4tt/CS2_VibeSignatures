...
description: |
  ...
  CCSPlayerPawn_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_vtable, CCSPlayerPawn_vtable
disable-model-invocation: true
---

# Find CCSPlayerPawn_vtable

Target: `CCSPlayerPawn_vtable` (func) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_vtable.{platform}.yaml` with EXACTLY these fields:
