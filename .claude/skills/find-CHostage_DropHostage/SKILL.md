...
description: |
  ...
  CHostage_DropHostage in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHostage_DropHostage, CHostage_DropHostage
disable-model-invocation: true
---

# Find CHostage_DropHostage

Target: `CHostage_DropHostage` (func) in the module loaded in THIS session.
