...
description: |
  Agent fallback for CHostage_DropHostage (auto-generated, category: func). Locate
  CHostage::DropHostage in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHostage_DropHostage, CHostage::DropHostage
disable-model-invocation: true
---

# Find CHostage_DropHostage

Target: `CHostage::DropHostage` (func) in the module loaded in THIS session.
...
Write `CHostage_DropHostage.{platform}.yaml` with EXACTLY these fields:
