...
description: |
  ...
  IGameSystem_OnClientPostRender in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPostRender, IGameSystem_OnClientPostRender
disable-model-invocation: true
---

# Find IGameSystem_OnClientPostRender

Target: `IGameSystem_OnClientPostRender` (vfunc) in the module loaded in THIS session.
