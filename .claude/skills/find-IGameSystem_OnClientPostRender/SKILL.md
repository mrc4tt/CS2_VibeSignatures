...
description: |
  Agent fallback for IGameSystem_OnClientPostRender (auto-generated, category: vfunc). Locate
  IGameSystem::OnClientPostRender in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPostRender, IGameSystem::OnClientPostRender
disable-model-invocation: true
---

# Find IGameSystem_OnClientPostRender

Target: `IGameSystem::OnClientPostRender` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientPostRender.{platform}.yaml` with EXACTLY these fields:
