...
description: |
  ...
  CPhysicsGameSystem_ProcessContactEvents-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysicsGameSystem_ProcessContactEvents-decompiles, CPhysicsGameSystem_ProcessContactEvents-decompiles
disable-model-invocation: true
---

# Find CPhysicsGameSystem_ProcessContactEvents-decompiles

Target: `CPhysicsGameSystem_ProcessContactEvents-decompiles` (func) in the module loaded in THIS session.
