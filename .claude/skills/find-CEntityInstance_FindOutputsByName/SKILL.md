...
description: |
  Agent fallback for CEntityInstance_FindOutputsByName (auto-generated, category: func). Locate
  CEntityInstance::FindOutputsByName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_FindOutputsByName, CEntityInstance::FindOutputsByName
disable-model-invocation: true
---

# Find CEntityInstance_FindOutputsByName

Target: `CEntityInstance::FindOutputsByName` (func) in the module loaded in THIS session.
...
Write `CEntityInstance_FindOutputsByName.{platform}.yaml` with EXACTLY these fields:
