...
description: |
  ...
  CEntityInstance_FindOutputsByName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_FindOutputsByName, CEntityInstance_FindOutputsByName
disable-model-invocation: true
---

# Find CEntityInstance_FindOutputsByName

Target: `CEntityInstance_FindOutputsByName` (func) in the module loaded in THIS session.
