...
description: |
  Agent fallback for CNetworkSystem_RemoveNetChannelByAddress (auto-generated, category: vfunc). Locate
...
Target: `CNetworkSystem_RemoveNetChannelByAddress` (vfunc) in the module loaded in THIS session.
