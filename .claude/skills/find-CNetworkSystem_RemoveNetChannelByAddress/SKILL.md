---
name: find-CNetworkSystem_RemoveNetChannelByAddress
description: |
  Agent fallback for CNetworkSystem_RemoveNetChannelByAddress (auto-generated, category: func). Locate
  CNetworkSystem_RemoveNetChannelByAddress in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_RemoveNetChannelByAddress, CNetworkSystem_RemoveNetChannelByAddress
disable-model-invocation: true
---

# Find CNetworkSystem_RemoveNetChannelByAddress

Target: `CNetworkSystem_RemoveNetChannelByAddress` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_RemoveNetChannelByAddress.{platform}.yaml` with EXACTLY these fields:
