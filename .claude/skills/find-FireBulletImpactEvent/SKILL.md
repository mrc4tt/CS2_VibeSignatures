...
description: |
  Agent fallback for FireBulletImpactEvent (auto-generated, category: func). Locate
  FireBulletImpactEvent in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: FireBulletImpactEvent, FireBulletImpactEvent
disable-model-invocation: true
---

# Find FireBulletImpactEvent

Target: `FireBulletImpactEvent` (func) in the module loaded in THIS session.
...
Write `FireBulletImpactEvent.{platform}.yaml` with EXACTLY these fields:
