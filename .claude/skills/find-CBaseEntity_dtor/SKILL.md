...
description: |
  ...
  CBaseEntity_dtor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_dtor, CBaseEntity_dtor
disable-model-invocation: true
---

# Find CBaseEntity_dtor

Target: `CBaseEntity_dtor` (func) in the module loaded in THIS session.
