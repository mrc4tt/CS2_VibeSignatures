...
description: |
  ...
  CMapListService_IsMapValid-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMapListService_IsMapValid-noinline, CMapListService_IsMapValid-noinline
disable-model-invocation: true
---

# Find CMapListService_IsMapValid-noinline

Target: `CMapListService_IsMapValid-noinline` (vfunc) in the module loaded in THIS session.
