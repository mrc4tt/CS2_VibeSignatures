---
name: find-CMapListService_IsMapValid-noinline
description: |
  Agent fallback for CMapListService_IsMapValid-noinline (auto-generated, category: vfunc). Locate
  CMapListService::IsMapValid in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMapListService_IsMapValid-noinline, CMapListService::IsMapValid
disable-model-invocation: true
---

# Find CMapListService_IsMapValid-noinline

Target: `CMapListService::IsMapValid` (vfunc) in the module loaded in THIS session.
...
Write `CMapListService_IsMapValid.{platform}.yaml` with EXACTLY these fields:
