...
description: |
  Agent fallback for CEntitySystem_ClearEntityDatabase (auto-generated, category: vfunc). Locate
  CEntitySystem::ClearEntityDatabase in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ClearEntityDatabase, CEntitySystem::ClearEntityDatabase
disable-model-invocation: true
---

# Find CEntitySystem_ClearEntityDatabase

Target: `CEntitySystem::ClearEntityDatabase` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_ClearEntityDatabase.{platform}.yaml` with EXACTLY these fields:
