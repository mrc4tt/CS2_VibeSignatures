...
description: |
  ...
  CEntitySystem_ClearEntityDatabase in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ClearEntityDatabase, CEntitySystem_ClearEntityDatabase
disable-model-invocation: true
---

# Find CEntitySystem_ClearEntityDatabase

Target: `CEntitySystem_ClearEntityDatabase` (vfunc) in the module loaded in THIS session.
