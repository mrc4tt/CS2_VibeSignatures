...
description: |
  ...
  CLoopModeGame_ReceivedServerInfo in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_ReceivedServerInfo, CLoopModeGame_ReceivedServerInfo
disable-model-invocation: true
---

# Find CLoopModeGame_ReceivedServerInfo

Target: `CLoopModeGame_ReceivedServerInfo` (func) in the module loaded in THIS session.
