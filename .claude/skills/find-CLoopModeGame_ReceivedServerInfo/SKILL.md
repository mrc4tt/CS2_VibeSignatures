...
description: |
  Agent fallback for CLoopModeGame_ReceivedServerInfo (auto-generated, category: func). Locate
  CLoopModeGame::ReceivedServerInfo in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_ReceivedServerInfo, CLoopModeGame::ReceivedServerInfo
disable-model-invocation: true
---

# Find CLoopModeGame_ReceivedServerInfo
