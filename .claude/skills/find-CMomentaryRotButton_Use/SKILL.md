...
description: |
  Agent fallback for CMomentaryRotButton_Use (auto-generated, category: vfunc). Locate
  ...
  Trigger: CMomentaryRotButton_Use, CMomentaryRotButton::Use
disable-model-invocation: true
---

# Find CMomentaryRotButton_Use
