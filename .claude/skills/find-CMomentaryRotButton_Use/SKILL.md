...
description: |
  ...
  CMomentaryRotButton_Use in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMomentaryRotButton_Use, CMomentaryRotButton_Use
disable-model-invocation: true
---

# Find CMomentaryRotButton_Use

Target: `CMomentaryRotButton_Use` (vfunc) in the module loaded in THIS session.
