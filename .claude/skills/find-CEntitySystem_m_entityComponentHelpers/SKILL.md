...
description: |
  Agent fallback for CEntitySystem_m_entityComponentHelpers (auto-generated, category: structmember). Locate
  CEntitySystem::m_entityComponentHelpers in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_entityComponentHelpers, CEntitySystem::m_entityComponentHelpers
disable-model-invocation: true
---

# Find CEntitySystem_m_entityComponentHelpers

Target: `CEntitySystem::m_entityComponentHelpers` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_entityComponentHelpers.{platform}.yaml` with EXACTLY these fields:
