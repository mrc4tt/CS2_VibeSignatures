---
name: find-CSource2Server_SetGlobals
description: |
  Agent fallback for CSource2Server_SetGlobals (auto-generated, category: func). Locate
  CSource2Server_SetGlobals in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_SetGlobals, CSource2Server_SetGlobals
disable-model-invocation: true
---

# Find CSource2Server_SetGlobals

Target: `CSource2Server_SetGlobals` (func) in the module loaded in THIS session.
...
Write `CSource2Server_SetGlobals.{platform}.yaml` with EXACTLY these fields:
