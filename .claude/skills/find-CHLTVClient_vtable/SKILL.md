...
description: |
  Agent fallback for CHLTVClient_vtable (auto-generated, category: func). Locate
  CHLTVClient_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHLTVClient_vtable, CHLTVClient_vtable
disable-model-invocation: true
---

# Find CHLTVClient_vtable

Target: `CHLTVClient_vtable` (func) in the module loaded in THIS session.
...
Write `CHLTVClient_vtable.{platform}.yaml` with EXACTLY these fields:
