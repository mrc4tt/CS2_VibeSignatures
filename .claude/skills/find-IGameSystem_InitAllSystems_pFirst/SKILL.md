...
description: |
  ...
  IGameSystem_InitAllSystems_pFirst in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_InitAllSystems_pFirst, IGameSystem_InitAllSystems_pFirst
disable-model-invocation: true
---

# Find IGameSystem_InitAllSystems_pFirst

Target: `IGameSystem_InitAllSystems_pFirst` (func) in the module loaded in THIS session.
