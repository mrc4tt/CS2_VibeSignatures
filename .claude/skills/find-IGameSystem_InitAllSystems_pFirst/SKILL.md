...
description: |
  Agent fallback for IGameSystem_InitAllSystems_pFirst (auto-generated, category: func). Locate
  IGameSystem::InitAllSystems::pFirst in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_InitAllSystems_pFirst, IGameSystem::InitAllSystems::pFirst
disable-model-invocation: true
---

# Find IGameSystem_InitAllSystems_pFirst

Target: `IGameSystem::InitAllSystems::pFirst` (func) in the module loaded in THIS session.
...
Write `IGameSystem_InitAllSystems_pFirst.{platform}.yaml` with EXACTLY these fields:
