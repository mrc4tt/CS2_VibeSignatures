...
description: |
  ...
  CEntityInstance_ValidatePrivateScriptScope in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ValidatePrivateScriptScope, CEntityInstance_ValidatePrivateScriptScope
disable-model-invocation: true
---

# Find CEntityInstance_ValidatePrivateScriptScope

Target: `CEntityInstance_ValidatePrivateScriptScope` (func) in the module loaded in THIS session.
