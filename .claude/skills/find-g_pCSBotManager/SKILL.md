...
description: |
  Agent fallback for g_pCSBotManager (auto-generated, category: func). Locate
  g_pCSBotManager in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: g_pCSBotManager, g_pCSBotManager
disable-model-invocation: true
---

# Find g_pCSBotManager

Target: `g_pCSBotManager` (func) in the module loaded in THIS session.
...
Write `g_pCSBotManager.{platform}.yaml` with EXACTLY these fields:
