...
description: |
  ...
  CLoopTypeClientServerService_HandleInputEvent in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServerService_HandleInputEvent, CLoopTypeClientServerService_HandleInputEvent
disable-model-invocation: true
---

# Find CLoopTypeClientServerService_HandleInputEvent

Target: `CLoopTypeClientServerService_HandleInputEvent` (vfunc) in the module loaded in THIS session.
