...
description: |
  Agent fallback for CLoopTypeClientServerService_HandleInputEvent (auto-generated, category: vfunc). Locate
  CLoopTypeClientServerService::HandleInputEvent in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServerService_HandleInputEvent, CLoopTypeClientServerService::HandleInputEvent
disable-model-invocation: true
---

# Find CLoopTypeClientServerService_HandleInputEvent

Target: `CLoopTypeClientServerService::HandleInputEvent` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeClientServerService_HandleInputEvent.{platform}.yaml` with EXACTLY these fields:
