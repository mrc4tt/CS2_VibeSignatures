...
description: |
  Agent fallback for CCSGameRules_PlayerSpawn (auto-generated, category: vfunc). Locate
  CCSGameRules::PlayerSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_PlayerSpawn, CCSGameRules::PlayerSpawn
disable-model-invocation: true
---

# Find CCSGameRules_PlayerSpawn

Target: `CCSGameRules::PlayerSpawn` (vfunc) in the module loaded in THIS session.
...
Write `CCSGameRules_PlayerSpawn.{platform}.yaml` with EXACTLY these fields:
