...
description: |
  ...
  CCSGameRules_PlayerSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_PlayerSpawn, CCSGameRules_PlayerSpawn
disable-model-invocation: true
---

# Find CCSGameRules_PlayerSpawn

Target: `CCSGameRules_PlayerSpawn` (vfunc) in the module loaded in THIS session.
