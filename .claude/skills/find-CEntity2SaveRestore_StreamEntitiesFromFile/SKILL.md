...
description: |
  ...
  CEntity2SaveRestore_StreamEntitiesFromFile in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntity2SaveRestore_StreamEntitiesFromFile, CEntity2SaveRestore_StreamEntitiesFromFile
disable-model-invocation: true
---

# Find CEntity2SaveRestore_StreamEntitiesFromFile

Target: `CEntity2SaveRestore_StreamEntitiesFromFile` (vfunc) in the module loaded in THIS session.
