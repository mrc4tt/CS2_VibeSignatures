...
description: |
  ...
  CLoopTypeClientServer_AllocateLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_AllocateLoopMode, CLoopTypeClientServer_AllocateLoopMode
disable-model-invocation: true
---

# Find CLoopTypeClientServer_AllocateLoopMode

Target: `CLoopTypeClientServer_AllocateLoopMode` (vfunc) in the module loaded in THIS session.
