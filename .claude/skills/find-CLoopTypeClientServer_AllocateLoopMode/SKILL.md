...
description: |
  Agent fallback for CLoopTypeClientServer_AllocateLoopMode (auto-generated, category: vfunc). Locate
  CLoopTypeClientServer::AllocateLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_AllocateLoopMode, CLoopTypeClientServer::AllocateLoopMode
disable-model-invocation: true
---

# Find CLoopTypeClientServer_AllocateLoopMode

Target: `CLoopTypeClientServer::AllocateLoopMode` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_AllocateLoopMode.{platform}.yaml` with EXACTLY these fields:
