...
description: |
  Agent fallback for CLoopModeFactory_CLoopModeGame_CreateLoopMode-inlined (auto-generated, category: vfunc). Locate
  CLoopModeFactory<CLoopModeGame>::CreateLoopMode in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeFactory_CLoopModeGame_CreateLoopMode-inlined, CLoopModeFactory<CLoopModeGame>::CreateLoopMode
disable-model-invocation: true
---

# Find CLoopModeFactory_CLoopModeGame_CreateLoopMode-inlined

Target: `CLoopModeFactory<CLoopModeGame>::CreateLoopMode` (vfunc) in the module loaded in THIS session.
...
Write `CLoopModeFactory_CLoopModeGame_CreateLoopMode.{platform}.yaml` with EXACTLY these fields:
