...
description: |
  ...
  CLoopModeFactory_CLoopModeGame_CreateLoopMode-inlined in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeFactory_CLoopModeGame_CreateLoopMode-inlined, CLoopModeFactory_CLoopModeGame_CreateLoopMode-inlined
disable-model-invocation: true
---

# Find CLoopModeFactory_CLoopModeGame_CreateLoopMode-inlined

Target: `CLoopModeFactory_CLoopModeGame_CreateLoopMode-inlined` (vfunc) in the module loaded in THIS session.
