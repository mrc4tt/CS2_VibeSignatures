...
description: |
  Agent fallback for CTakeDamageInfo_vtable (auto-generated, category: func). Locate
  CTakeDamageInfo_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTakeDamageInfo_vtable, CTakeDamageInfo_vtable
disable-model-invocation: true
---

# Find CTakeDamageInfo_vtable

Target: `CTakeDamageInfo_vtable` (func) in the module loaded in THIS session.
...
Write `CTakeDamageInfo_vtable.{platform}.yaml` with EXACTLY these fields:
