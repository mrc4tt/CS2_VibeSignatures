...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_GetSpawnGroups (auto-generated, category: func). Locate
  CSpawnGroupMgrGameSystem::GetSpawnGroups in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_GetSpawnGroups, CSpawnGroupMgrGameSystem::GetSpawnGroups
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_GetSpawnGroups

Target: `CSpawnGroupMgrGameSystem::GetSpawnGroups` (func) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_GetSpawnGroups.{platform}.yaml` with EXACTLY these fields:
