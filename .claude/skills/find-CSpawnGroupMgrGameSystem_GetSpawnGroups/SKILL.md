...
description: |
  ...
  CSpawnGroupMgrGameSystem_GetSpawnGroups in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_GetSpawnGroups, CSpawnGroupMgrGameSystem_GetSpawnGroups
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_GetSpawnGroups

Target: `CSpawnGroupMgrGameSystem_GetSpawnGroups` (func) in the module loaded in THIS session.
