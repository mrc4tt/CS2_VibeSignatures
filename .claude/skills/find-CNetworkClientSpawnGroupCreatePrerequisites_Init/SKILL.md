---
name: find-CNetworkClientSpawnGroupCreatePrerequisites_Init
description: |
  Agent fallback for CNetworkClientSpawnGroupCreatePrerequisites_Init (auto-generated, category: func). Locate
  CNetworkClientSpawnGroupCreatePrerequisites_Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientSpawnGroupCreatePrerequisites_Init, CNetworkClientSpawnGroupCreatePrerequisites_Init
disable-model-invocation: true
---

# Find CNetworkClientSpawnGroupCreatePrerequisites_Init

Target: `CNetworkClientSpawnGroupCreatePrerequisites_Init` (func) in the module loaded in THIS session.
...
Write `CNetworkClientSpawnGroupCreatePrerequisites_Init.{platform}.yaml` with EXACTLY these fields:
