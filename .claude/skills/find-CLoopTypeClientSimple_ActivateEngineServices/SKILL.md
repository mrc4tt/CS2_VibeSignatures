...
description: |
  ...
  CLoopTypeClientSimple_ActivateEngineServices in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientSimple_ActivateEngineServices, CLoopTypeClientSimple_ActivateEngineServices
disable-model-invocation: true
---

# Find CLoopTypeClientSimple_ActivateEngineServices

Target: `CLoopTypeClientSimple_ActivateEngineServices` (func) in the module loaded in THIS session.
