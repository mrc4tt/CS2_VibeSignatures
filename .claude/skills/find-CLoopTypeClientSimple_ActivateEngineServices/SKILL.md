...
description: |
  Agent fallback for CLoopTypeClientSimple_ActivateEngineServices (auto-generated, category: func). Locate
  CLoopTypeClientServer::ActivateEngineServices in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientSimple_ActivateEngineServices, CLoopTypeClientServer::ActivateEngineServices
disable-model-invocation: true
---

# Find CLoopTypeClientSimple_ActivateEngineServices

Target: `CLoopTypeClientServer::ActivateEngineServices` (func) in the module loaded in THIS session.
...
Write `CLoopTypeClientSimple_ActivateEngineServices.{platform}.yaml` with EXACTLY these fields:
