...
description: |
  ...
  IGameSystem_OnClientFrameSimulate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientFrameSimulate, IGameSystem_OnClientFrameSimulate
disable-model-invocation: true
---

# Find IGameSystem_OnClientFrameSimulate

Target: `IGameSystem_OnClientFrameSimulate` (vfunc) in the module loaded in THIS session.
