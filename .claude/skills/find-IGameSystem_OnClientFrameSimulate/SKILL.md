...
description: |
  Agent fallback for IGameSystem_OnClientFrameSimulate (auto-generated, category: vfunc). Locate
  IGameSystem::OnClientFrameSimulate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientFrameSimulate, IGameSystem::OnClientFrameSimulate
disable-model-invocation: true
---

# Find IGameSystem_OnClientFrameSimulate

Target: `IGameSystem::OnClientFrameSimulate` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientFrameSimulate.{platform}.yaml` with EXACTLY these fields:
