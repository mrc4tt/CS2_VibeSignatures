...
description: |
  Agent fallback for CBaseEntity_GetEyeAngles (auto-generated, category: vfunc). Locate
  CBaseEntity::GetEyeAngles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_GetEyeAngles, CBaseEntity::GetEyeAngles
disable-model-invocation: true
---

# Find CBaseEntity_GetEyeAngles

Target: `CBaseEntity::GetEyeAngles` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_GetEyeAngles.{platform}.yaml` with EXACTLY these fields:
