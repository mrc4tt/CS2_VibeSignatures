...
description: |
  ...
  CBaseEntity_GetEyeAngles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_GetEyeAngles, CBaseEntity_GetEyeAngles
disable-model-invocation: true
---

# Find CBaseEntity_GetEyeAngles

Target: `CBaseEntity_GetEyeAngles` (vfunc) in the module loaded in THIS session.
