...
description: |
  ...
  CNetworkSystem_CloseSocketInternal-linux in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_CloseSocketInternal-linux, CNetworkSystem_CloseSocketInternal-linux
disable-model-invocation: true
---

# Find CNetworkSystem_CloseSocketInternal-linux

Target: `CNetworkSystem_CloseSocketInternal-linux` (func) in the module loaded in THIS session.
