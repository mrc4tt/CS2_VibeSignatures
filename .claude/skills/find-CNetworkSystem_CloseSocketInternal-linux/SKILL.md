---
name: find-CNetworkSystem_CloseSocketInternal-linux
description: |
  Agent fallback for CNetworkSystem_CloseSocketInternal-linux (auto-generated, category: func). Locate
  CNetworkSystem_CloseSocketInternal in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_CloseSocketInternal-linux, CNetworkSystem_CloseSocketInternal
disable-model-invocation: true
---

# Find CNetworkSystem_CloseSocketInternal-linux

Target: `CNetworkSystem_CloseSocketInternal` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_CloseSocketInternal.{platform}.yaml` with EXACTLY these fields:
