...
description: |
  ...
  IAppSystem_Connect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IAppSystem_Connect, IAppSystem_Connect
disable-model-invocation: true
---

# Find IAppSystem_Connect

Target: `IAppSystem_Connect` (vfunc) in the module loaded in THIS session.
