...
description: |
  Agent fallback for IAppSystem_Connect (auto-generated, category: vfunc). Locate
  IAppSystem::Connect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IAppSystem_Connect, IAppSystem::Connect
disable-model-invocation: true
---

# Find IAppSystem_Connect

Target: `IAppSystem::Connect` (vfunc) in the module loaded in THIS session.
...
Write `IAppSystem_Connect.{platform}.yaml` with EXACTLY these fields:
