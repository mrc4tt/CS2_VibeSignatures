---
name: find-SetFrameTimeAmnesty
description: |
  Agent fallback for SetFrameTimeAmnesty (auto-generated, category: func). Locate
  SetFrameTimeAmnesty in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SetFrameTimeAmnesty, SetFrameTimeAmnesty
disable-model-invocation: true
---

# Find SetFrameTimeAmnesty

Target: `SetFrameTimeAmnesty` (func) in the module loaded in THIS session.
...
Write `SetFrameTimeAmnesty.{platform}.yaml` with EXACTLY these fields:
