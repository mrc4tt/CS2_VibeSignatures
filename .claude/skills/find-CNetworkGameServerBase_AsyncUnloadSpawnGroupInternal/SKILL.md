...
description: |
  Agent fallback for CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal (auto-generated, category: func). Locate
  CNetworkGameServerBase::AsyncUnloadSpawnGroupInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal, CNetworkGameServerBase::AsyncUnloadSpawnGroupInternal
disable-model-invocation: true
---

# Find CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal

Target: `CNetworkGameServerBase::AsyncUnloadSpawnGroupInternal` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal.{platform}.yaml` with EXACTLY these fields:
