...
description: |
  ...
  CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal, CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal
disable-model-invocation: true
---

# Find CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal

Target: `CNetworkGameServerBase_AsyncUnloadSpawnGroupInternal` (func) in the module loaded in THIS session.
