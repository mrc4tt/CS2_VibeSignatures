...
description: |
  ...
  CEntityInstance_Restore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Restore, CEntityInstance_Restore
disable-model-invocation: true
---

# Find CEntityInstance_Restore

Target: `CEntityInstance_Restore` (vfunc) in the module loaded in THIS session.
