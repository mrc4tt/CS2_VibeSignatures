...
description: |
  Agent fallback for CEntityInstance_Restore (auto-generated, category: vfunc). Locate
  CEntityInstance::Restore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Restore, CEntityInstance::Restore
disable-model-invocation: true
---

# Find CEntityInstance_Restore

Target: `CEntityInstance::Restore` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_Restore.{platform}.yaml` with EXACTLY these fields:
