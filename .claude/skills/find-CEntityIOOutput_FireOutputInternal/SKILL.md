...
description: |
  ...
  CEntityIOOutput_FireOutputInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityIOOutput_FireOutputInternal, CEntityIOOutput_FireOutputInternal
disable-model-invocation: true
---

# Find CEntityIOOutput_FireOutputInternal

Target: `CEntityIOOutput_FireOutputInternal` (func) in the module loaded in THIS session.
