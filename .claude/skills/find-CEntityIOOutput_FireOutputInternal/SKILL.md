...
description: |
  Agent fallback for CEntityIOOutput_FireOutputInternal (auto-generated, category: func). Locate
  CEntityIOOutput::FireOutputInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityIOOutput_FireOutputInternal, CEntityIOOutput::FireOutputInternal
disable-model-invocation: true
---

# Find CEntityIOOutput_FireOutputInternal

Target: `CEntityIOOutput::FireOutputInternal` (func) in the module loaded in THIS session.
...
Write `CEntityIOOutput_FireOutputInternal.{platform}.yaml` with EXACTLY these fields:
