---
name: find-CWaitForInitialSpawnGroupsPrerequisite_GetStatus
description: |
  Agent fallback for CWaitForInitialSpawnGroupsPrerequisite_GetStatus (auto-generated, category: vfunc). Locate
  CWaitForInitialSpawnGroupsPrerequisite::GetStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CWaitForInitialSpawnGroupsPrerequisite_GetStatus, CWaitForInitialSpawnGroupsPrerequisite::GetStatus
disable-model-invocation: true
---

# Find CWaitForInitialSpawnGroupsPrerequisite_GetStatus

Target: `CWaitForInitialSpawnGroupsPrerequisite::GetStatus` (vfunc) in the module loaded in THIS session.
...
Write `CWaitForInitialSpawnGroupsPrerequisite_GetStatus.{platform}.yaml` with EXACTLY these fields:
