...
description: |
  ...
  CWaitForInitialSpawnGroupsPrerequisite_GetStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CWaitForInitialSpawnGroupsPrerequisite_GetStatus, CWaitForInitialSpawnGroupsPrerequisite_GetStatus
disable-model-invocation: true
---

# Find CWaitForInitialSpawnGroupsPrerequisite_GetStatus

Target: `CWaitForInitialSpawnGroupsPrerequisite_GetStatus` (vfunc) in the module loaded in THIS session.
