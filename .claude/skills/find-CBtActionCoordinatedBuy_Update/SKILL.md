...
description: |
  ...
  CBtActionCoordinatedBuy_Update in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBtActionCoordinatedBuy_Update, CBtActionCoordinatedBuy_Update
disable-model-invocation: true
---

# Find CBtActionCoordinatedBuy_Update

Target: `CBtActionCoordinatedBuy_Update` (vfunc) in the module loaded in THIS session.
