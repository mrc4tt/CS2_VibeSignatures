...
description: |
  Agent fallback for CBtActionCoordinatedBuy_Update (auto-generated, category: vfunc). Locate
  CBtActionCoordinatedBuy::Update in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBtActionCoordinatedBuy_Update, CBtActionCoordinatedBuy::Update
disable-model-invocation: true
---

# Find CBtActionCoordinatedBuy_Update

Target: `CBtActionCoordinatedBuy::Update` (vfunc) in the module loaded in THIS session.
...
Write `CBtActionCoordinatedBuy_Update.{platform}.yaml` with EXACTLY these fields:
