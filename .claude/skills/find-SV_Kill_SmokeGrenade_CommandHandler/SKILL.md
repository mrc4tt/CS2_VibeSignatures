...
description: |
  Agent fallback for SV_Kill_SmokeGrenade_CommandHandler (auto-generated, category: func). Locate
  SV_Kill_SmokeGrenade_CommandHandler in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SV_Kill_SmokeGrenade_CommandHandler, SV_Kill_SmokeGrenade_CommandHandler
disable-model-invocation: true
---

# Find SV_Kill_SmokeGrenade_CommandHandler

Target: `SV_Kill_SmokeGrenade_CommandHandler` (func) in the module loaded in THIS session.
...
Write `SV_Kill_SmokeGrenade_CommandHandler.{platform}.yaml` with EXACTLY these fields:
