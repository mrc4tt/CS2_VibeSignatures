...
description: |
  ...
  CBaseModelEntity::SetRenderAttribute in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseModelEntity_SetRenderAttribute, CBaseModelEntity::SetRenderAttribute
disable-model-invocation: true
---

# Find CBaseModelEntity_SetRenderAttribute

Target: `CBaseModelEntity::SetRenderAttribute` (func) in the module loaded in THIS session.
...
Write `CBaseModelEntity_SetRenderAttribute.{platform}.yaml` with EXACTLY these fields:
