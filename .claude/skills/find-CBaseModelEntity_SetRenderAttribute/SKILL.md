...
description: |
  ...
  CBaseModelEntity_SetRenderAttribute in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseModelEntity_SetRenderAttribute, CBaseModelEntity_SetRenderAttribute
disable-model-invocation: true
---

# Find CBaseModelEntity_SetRenderAttribute

Target: `CBaseModelEntity_SetRenderAttribute` (func) in the module loaded in THIS session.
