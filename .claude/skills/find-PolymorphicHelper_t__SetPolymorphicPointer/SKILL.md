...
description: |
  ...
  PolymorphicHelper_t__SetPolymorphicPointer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: PolymorphicHelper_t__SetPolymorphicPointer, PolymorphicHelper_t__SetPolymorphicPointer
disable-model-invocation: true
---

# Find PolymorphicHelper_t__SetPolymorphicPointer

Target: `PolymorphicHelper_t__SetPolymorphicPointer` (func) in the module loaded in THIS session.
