---
name: find-CNetworkGameClient_FullConnect
description: |
  Agent fallback for CNetworkGameClient_FullConnect (auto-generated, category: vfunc). Locate
  CNetworkGameClient::FullConnect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_FullConnect, CNetworkGameClient::FullConnect
disable-model-invocation: true
---

# Find CNetworkGameClient_FullConnect

Target: `CNetworkGameClient::FullConnect` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_FullConnect.{platform}.yaml` with EXACTLY these fields:
