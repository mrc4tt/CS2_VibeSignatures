...
description: |
  ...
  CNetworkGameClient_FullConnect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_FullConnect, CNetworkGameClient_FullConnect
disable-model-invocation: true
---

# Find CNetworkGameClient_FullConnect

Target: `CNetworkGameClient_FullConnect` (vfunc) in the module loaded in THIS session.
