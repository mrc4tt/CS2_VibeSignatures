---
name: find-CTakeDamageInfo_ctor
description: |
  Agent fallback for CTakeDamageInfo_ctor (auto-generated, category: func). Locate
  CTakeDamageInfo in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTakeDamageInfo_ctor, CTakeDamageInfo
disable-model-invocation: true
---

# Find CTakeDamageInfo_ctor

Target: `CTakeDamageInfo` (func) in the module loaded in THIS session.
...
Write `CTakeDamageInfo_ctor.{platform}.yaml` with EXACTLY these fields:
