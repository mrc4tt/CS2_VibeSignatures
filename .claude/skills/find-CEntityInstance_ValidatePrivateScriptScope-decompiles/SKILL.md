---
name: find-CEntityInstance_ValidatePrivateScriptScope-decompiles
description: |
  Agent fallback for CEntityInstance_ValidatePrivateScriptScope-decompiles (auto-generated, category: func). Locate
  CEntityInstance::ValidatePrivateScriptScope in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ValidatePrivateScriptScope-decompiles, CEntityInstance::ValidatePrivateScriptScope
disable-model-invocation: true
---

# Find CEntityInstance_ValidatePrivateScriptScope-decompiles

Target: `CEntityInstance::ValidatePrivateScriptScope` (func) in the module loaded in THIS session.
...
Write `CEntityInstance_ValidatePrivateScriptScope.{platform}.yaml` with EXACTLY these fields:
