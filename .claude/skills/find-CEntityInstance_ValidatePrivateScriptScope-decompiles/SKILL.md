...
description: |
  ...
  CEntityInstance_ValidatePrivateScriptScope-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ValidatePrivateScriptScope-decompiles, CEntityInstance_ValidatePrivateScriptScope-decompiles
disable-model-invocation: true
---

# Find CEntityInstance_ValidatePrivateScriptScope-decompiles

Target: `CEntityInstance_ValidatePrivateScriptScope-decompiles` (func) in the module loaded in THIS session.
