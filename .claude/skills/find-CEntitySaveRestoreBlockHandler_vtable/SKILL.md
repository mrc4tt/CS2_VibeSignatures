...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_vtable (auto-generated, category: func). Locate
  CEntitySaveRestoreBlockHandler_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_vtable, CEntitySaveRestoreBlockHandler_vtable
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_vtable

Target: `CEntitySaveRestoreBlockHandler_vtable` (func) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_vtable.{platform}.yaml` with EXACTLY these fields:
