...
description: |
  Agent fallback for CEntityInstance_UpdateOnRemove (auto-generated, category: vfunc). Locate
  ...
  Trigger: CEntityInstance_UpdateOnRemove, CEntityInstance::UpdateOnRemove
disable-model-invocation: true
---

# Find CEntityInstance_UpdateOnRemove
