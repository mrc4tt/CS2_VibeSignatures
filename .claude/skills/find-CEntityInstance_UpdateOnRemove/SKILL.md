...
description: |
  ...
  CEntityInstance_UpdateOnRemove in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_UpdateOnRemove, CEntityInstance_UpdateOnRemove
disable-model-invocation: true
---

# Find CEntityInstance_UpdateOnRemove

Target: `CEntityInstance_UpdateOnRemove` (vfunc) in the module loaded in THIS session.
