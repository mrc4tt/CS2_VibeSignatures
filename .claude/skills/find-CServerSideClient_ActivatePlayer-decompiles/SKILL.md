...
description: |
  ...
  CServerSideClient_ActivatePlayer-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClient_ActivatePlayer-decompiles, CServerSideClient_ActivatePlayer-decompiles
disable-model-invocation: true
---

# Find CServerSideClient_ActivatePlayer-decompiles

Target: `CServerSideClient_ActivatePlayer-decompiles` (vfunc) in the module loaded in THIS session.
