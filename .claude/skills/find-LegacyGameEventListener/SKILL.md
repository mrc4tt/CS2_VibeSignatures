...
description: |
  Agent fallback for LegacyGameEventListener (auto-generated, category: func). Locate
  GetLegacyGameEventListener in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: LegacyGameEventListener, GetLegacyGameEventListener
disable-model-invocation: true
---

# Find LegacyGameEventListener

Target: `GetLegacyGameEventListener` (func) in the module loaded in THIS session.
...
Write `LegacyGameEventListener.{platform}.yaml` with EXACTLY these fields:
