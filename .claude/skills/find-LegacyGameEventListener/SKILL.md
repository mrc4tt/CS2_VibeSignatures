...
description: |
  ...
  LegacyGameEventListener in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: LegacyGameEventListener, LegacyGameEventListener
disable-model-invocation: true
---

# Find LegacyGameEventListener

Target: `LegacyGameEventListener` (func) in the module loaded in THIS session.
