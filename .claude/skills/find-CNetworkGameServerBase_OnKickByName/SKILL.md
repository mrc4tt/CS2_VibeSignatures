...
description: |
  Agent fallback for CNetworkGameServerBase_OnKickByName (auto-generated, category: func). Locate
  CNetworkGameServerBase::OnKickByName in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_OnKickByName, CNetworkGameServerBase::OnKickByName
disable-model-invocation: true
---

# Find CNetworkGameServerBase_OnKickByName

Target: `CNetworkGameServerBase::OnKickByName` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_OnKickByName.{platform}.yaml` with EXACTLY these fields:
