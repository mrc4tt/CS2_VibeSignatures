...
description: |
  ...
  CNetworkGameServerBase_OnKickByName in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_OnKickByName, CNetworkGameServerBase_OnKickByName
disable-model-invocation: true
---

# Find CNetworkGameServerBase_OnKickByName

Target: `CNetworkGameServerBase_OnKickByName` (func) in the module loaded in THIS session.
