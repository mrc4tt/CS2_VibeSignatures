...
description: |
  ...
  CEntitySystem_BuildResourceManifestForEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_BuildResourceManifestForEntity, CEntitySystem_BuildResourceManifestForEntity
disable-model-invocation: true
---

# Find CEntitySystem_BuildResourceManifestForEntity

Target: `CEntitySystem_BuildResourceManifestForEntity` (vfunc) in the module loaded in THIS session.
