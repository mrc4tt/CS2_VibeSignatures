...
description: |
  Agent fallback for CEntitySystem_BuildResourceManifestForEntity (auto-generated, category: vfunc). Locate
  CEntitySystem::BuildResourceManifestForEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_BuildResourceManifestForEntity, CEntitySystem::BuildResourceManifestForEntity
disable-model-invocation: true
---

# Find CEntitySystem_BuildResourceManifestForEntity

Target: `CEntitySystem::BuildResourceManifestForEntity` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_BuildResourceManifestForEntity.{platform}.yaml` with EXACTLY these fields:
