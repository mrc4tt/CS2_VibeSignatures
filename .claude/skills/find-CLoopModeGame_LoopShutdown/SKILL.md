...
description: |
  ...
  CLoopModeGame_LoopShutdown in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopShutdown, CLoopModeGame_LoopShutdown
disable-model-invocation: true
---

# Find CLoopModeGame_LoopShutdown

Target: `CLoopModeGame_LoopShutdown` (vfunc) in the module loaded in THIS session.
