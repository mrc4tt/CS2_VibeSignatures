...
description: |
  Agent fallback for CLoopModeGame_LoopShutdown (auto-generated, category: vfunc). Locate
  CLoopModeGame::LoopShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopShutdown, CLoopModeGame::LoopShutdown
disable-model-invocation: true
---

# Find CLoopModeGame_LoopShutdown

Target: `CLoopModeGame::LoopShutdown` (vfunc) in the module loaded in THIS session.
...
Write `CLoopModeGame_LoopShutdown.{platform}.yaml` with EXACTLY these fields:
