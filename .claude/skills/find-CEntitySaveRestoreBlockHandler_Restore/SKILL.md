...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_Restore (auto-generated, category: vfunc). Locate
  CEntitySaveRestoreBlockHandler::Restore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_Restore, CEntitySaveRestoreBlockHandler::Restore
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_Restore

Target: `CEntitySaveRestoreBlockHandler::Restore` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_Restore.{platform}.yaml` with EXACTLY these fields:
