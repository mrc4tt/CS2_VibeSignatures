...
description: |
  ...
  CEntitySaveRestoreBlockHandler_Restore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_Restore, CEntitySaveRestoreBlockHandler_Restore
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_Restore

Target: `CEntitySaveRestoreBlockHandler_Restore` (vfunc) in the module loaded in THIS session.
