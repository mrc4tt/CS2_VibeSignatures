...
description: |
  ...
  CBasePlayerController_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_vtable, CBasePlayerController_vtable
disable-model-invocation: true
---

# Find CBasePlayerController_vtable

Target: `CBasePlayerController_vtable` (func) in the module loaded in THIS session.
...
Write `CBasePlayerController_vtable.{platform}.yaml` with EXACTLY these fields:
