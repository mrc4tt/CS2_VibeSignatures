...
description: |
  Agent fallback for CNetworkGameClientBase_FinishChangeLevel (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::FinishChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_FinishChangeLevel, CNetworkGameClientBase::FinishChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameClientBase_FinishChangeLevel

Target: `CNetworkGameClientBase::FinishChangeLevel` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_FinishChangeLevel.{platform}.yaml` with EXACTLY these fields:
