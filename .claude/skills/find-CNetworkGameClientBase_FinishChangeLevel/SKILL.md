...
description: |
  ...
  CNetworkGameClientBase_FinishChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_FinishChangeLevel, CNetworkGameClientBase_FinishChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameClientBase_FinishChangeLevel

Target: `CNetworkGameClientBase_FinishChangeLevel` (vfunc) in the module loaded in THIS session.
