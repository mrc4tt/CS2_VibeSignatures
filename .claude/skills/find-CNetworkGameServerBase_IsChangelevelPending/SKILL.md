...
description: |
  ...
  CNetworkGameServerBase_IsChangelevelPending in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_IsChangelevelPending, CNetworkGameServerBase_IsChangelevelPending
disable-model-invocation: true
---

# Find CNetworkGameServerBase_IsChangelevelPending

Target: `CNetworkGameServerBase_IsChangelevelPending` (vfunc) in the module loaded in THIS session.
