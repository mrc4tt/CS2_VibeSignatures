...
description: |
  Agent fallback for CNetworkGameServerBase_IsChangelevelPending (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::IsChangelevelPending in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_IsChangelevelPending, CNetworkGameServerBase::IsChangelevelPending
disable-model-invocation: true
---

# Find CNetworkGameServerBase_IsChangelevelPending

Target: `CNetworkGameServerBase::IsChangelevelPending` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_IsChangelevelPending.{platform}.yaml` with EXACTLY these fields:
