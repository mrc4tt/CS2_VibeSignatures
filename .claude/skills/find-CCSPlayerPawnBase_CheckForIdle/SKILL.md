...
description: |
  Agent fallback for CCSPlayerPawnBase_CheckForIdle (auto-generated, category: vfunc). Locate
  CCSPlayerPawnBase::CheckForIdle in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawnBase_CheckForIdle, CCSPlayerPawnBase::CheckForIdle
disable-model-invocation: true
---

# Find CCSPlayerPawnBase_CheckForIdle

Target: `CCSPlayerPawnBase::CheckForIdle` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayerPawnBase_CheckForIdle.{platform}.yaml` with EXACTLY these fields:
