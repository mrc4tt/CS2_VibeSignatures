...
description: |
  ...
  CCSPlayerPawnBase_CheckForIdle in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawnBase_CheckForIdle, CCSPlayerPawnBase_CheckForIdle
disable-model-invocation: true
---

# Find CCSPlayerPawnBase_CheckForIdle

Target: `CCSPlayerPawnBase_CheckForIdle` (vfunc) in the module loaded in THIS session.
