...
description: |
  ...
  CBaseEntity_ReloadPrivateScripts in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_ReloadPrivateScripts, CBaseEntity_ReloadPrivateScripts
disable-model-invocation: true
---

# Find CBaseEntity_ReloadPrivateScripts

Target: `CBaseEntity_ReloadPrivateScripts` (vfunc) in the module loaded in THIS session.
