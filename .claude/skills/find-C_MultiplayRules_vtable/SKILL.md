---
name: find-C_MultiplayRules_vtable
description: |
  Agent fallback for C_MultiplayRules_vtable (auto-generated, category: func). Locate
  C_MultiplayRules_vtable in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_MultiplayRules_vtable, C_MultiplayRules_vtable
disable-model-invocation: true
---

# Find C_MultiplayRules_vtable

Target: `C_MultiplayRules_vtable` (func) in the module loaded in THIS session.
...
Write `C_MultiplayRules_vtable.{platform}.yaml` with EXACTLY these fields:
