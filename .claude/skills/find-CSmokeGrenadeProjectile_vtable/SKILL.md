---
name: find-CSmokeGrenadeProjectile_vtable
description: |
  Agent fallback for CSmokeGrenadeProjectile_vtable (auto-generated, category: func). Locate
  CSmokeGrenadeProjectile_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSmokeGrenadeProjectile_vtable, CSmokeGrenadeProjectile_vtable
disable-model-invocation: true
---

# Find CSmokeGrenadeProjectile_vtable

Target: `CSmokeGrenadeProjectile_vtable` (func) in the module loaded in THIS session.
...
Write `CSmokeGrenadeProjectile_vtable.{platform}.yaml` with EXACTLY these fields:
