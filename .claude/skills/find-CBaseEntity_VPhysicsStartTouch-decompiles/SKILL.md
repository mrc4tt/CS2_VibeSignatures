...
description: |
  ...
  CBaseEntity_VPhysicsStartTouch-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_VPhysicsStartTouch-decompiles, CBaseEntity_VPhysicsStartTouch-decompiles
disable-model-invocation: true
---

# Find CBaseEntity_VPhysicsStartTouch-decompiles

Target: `CBaseEntity_VPhysicsStartTouch-decompiles` (func) in the module loaded in THIS session.
