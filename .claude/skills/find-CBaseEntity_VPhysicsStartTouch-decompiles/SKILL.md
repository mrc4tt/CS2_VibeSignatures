---
name: find-CBaseEntity_VPhysicsStartTouch-decompiles
description: |
  Agent fallback for CBaseEntity_VPhysicsStartTouch-decompiles (auto-generated, category: func). Locate
  CBaseEntity::VPhysicsStartTouch in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_VPhysicsStartTouch-decompiles, CBaseEntity::VPhysicsStartTouch
disable-model-invocation: true
---

# Find CBaseEntity_VPhysicsStartTouch-decompiles

Target: `CBaseEntity::VPhysicsStartTouch` (func) in the module loaded in THIS session.
...
Write `CBaseEntity_VPhysicsStartTouch.{platform}.yaml` with EXACTLY these fields:
