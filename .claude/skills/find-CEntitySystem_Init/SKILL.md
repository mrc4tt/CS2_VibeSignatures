...
description: |
  ...
  CEntitySystem_Init in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_Init, CEntitySystem_Init
disable-model-invocation: true
---

# Find CEntitySystem_Init

Target: `CEntitySystem_Init` (func) in the module loaded in THIS session.
