...
description: |
  Agent fallback for CSource2GameClients_ClientConnect (auto-generated, category: vfunc). Locate
  CSource2GameClients::ClientConnect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientConnect, CSource2GameClients::ClientConnect
disable-model-invocation: true
---

# Find CSource2GameClients_ClientConnect

Target: `CSource2GameClients::ClientConnect` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientConnect.{platform}.yaml` with EXACTLY these fields:
