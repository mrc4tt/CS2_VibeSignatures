...
description: |
  ...
  CSource2GameClients_ClientConnect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientConnect, CSource2GameClients_ClientConnect
disable-model-invocation: true
---

# Find CSource2GameClients_ClientConnect

Target: `CSource2GameClients_ClientConnect` (vfunc) in the module loaded in THIS session.
