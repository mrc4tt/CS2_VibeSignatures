...
description: |
  Agent fallback for CNetworkMessages_vtable (auto-generated, category: func). Locate
  CNetworkMessages_vtable in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_vtable, CNetworkMessages_vtable
disable-model-invocation: true
---

# Find CNetworkMessages_vtable

Target: `CNetworkMessages_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkMessages_vtable.{platform}.yaml` with EXACTLY these fields:
