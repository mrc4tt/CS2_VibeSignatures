...
description: |
  ...
  CBasePlayerController_ClientSettingsChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_ClientSettingsChanged, CBasePlayerController_ClientSettingsChanged
disable-model-invocation: true
---

# Find CBasePlayerController_ClientSettingsChanged

Target: `CBasePlayerController_ClientSettingsChanged` (vfunc) in the module loaded in THIS session.
