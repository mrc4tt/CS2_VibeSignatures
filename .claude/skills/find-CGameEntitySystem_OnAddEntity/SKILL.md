...
description: |
  Agent fallback for CGameEntitySystem_OnAddEntity (auto-generated, category: vfunc). Locate
  ...
  Trigger: CGameEntitySystem_OnAddEntity, CGameEntitySystem::OnAddEntity
disable-model-invocation: true
---

# Find CGameEntitySystem_OnAddEntity
