...
description: |
  ...
  CGameEntitySystem_OnAddEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_OnAddEntity, CGameEntitySystem_OnAddEntity
disable-model-invocation: true
---

# Find CGameEntitySystem_OnAddEntity

Target: `CGameEntitySystem_OnAddEntity` (vfunc) in the module loaded in THIS session.
