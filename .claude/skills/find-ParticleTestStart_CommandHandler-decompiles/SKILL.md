---
name: find-ParticleTestStart_CommandHandler-decompiles
description: |
  Agent fallback for ParticleTestStart_CommandHandler-decompiles (auto-generated, category: func). Locate
  ParticleTestStart_CommandHandler in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ParticleTestStart_CommandHandler-decompiles, ParticleTestStart_CommandHandler
disable-model-invocation: true
---

# Find ParticleTestStart_CommandHandler-decompiles

Target: `ParticleTestStart_CommandHandler` (func) in the module loaded in THIS session.
...
Write `ParticleTestStart_CommandHandler.{platform}.yaml` with EXACTLY these fields:
