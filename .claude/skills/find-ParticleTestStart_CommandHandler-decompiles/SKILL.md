...
description: |
  ...
  ParticleTestStart_CommandHandler-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ParticleTestStart_CommandHandler-decompiles, ParticleTestStart_CommandHandler-decompiles
disable-model-invocation: true
---

# Find ParticleTestStart_CommandHandler-decompiles

Target: `ParticleTestStart_CommandHandler-decompiles` (func) in the module loaded in THIS session.
