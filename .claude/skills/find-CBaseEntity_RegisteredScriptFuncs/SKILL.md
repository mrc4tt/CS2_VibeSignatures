...
description: |
  ...
  CBaseEntity_RegisteredScriptFuncs in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_RegisteredScriptFuncs, CBaseEntity_RegisteredScriptFuncs
disable-model-invocation: true
---

# Find CBaseEntity_RegisteredScriptFuncs

Target: `CBaseEntity_RegisteredScriptFuncs` (func) in the module loaded in THIS session.
...
Write `CBaseEntity_RegisteredScriptFuncs.{platform}.yaml` with EXACTLY these fields:
