...
description: |
  Agent fallback for CSceneEntity_vtable (auto-generated, category: func). Locate
  CSceneEntity_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSceneEntity_vtable, CSceneEntity_vtable
disable-model-invocation: true
---

# Find CSceneEntity_vtable

Target: `CSceneEntity_vtable` (func) in the module loaded in THIS session.
...
Write `CSceneEntity_vtable.{platform}.yaml` with EXACTLY these fields:
