...
description: |
  ...
  CNavMesh_GetNearestNavArea in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNavMesh_GetNearestNavArea, CNavMesh_GetNearestNavArea
disable-model-invocation: true
---

# Find CNavMesh_GetNearestNavArea

Target: `CNavMesh_GetNearestNavArea` (func) in the module loaded in THIS session.
