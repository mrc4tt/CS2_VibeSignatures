...
description: |
  Agent fallback for CNavMesh_GetNearestNavArea (auto-generated, category: func). Locate
  CNavMesh::GetNearestNavArea in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNavMesh_GetNearestNavArea, CNavMesh::GetNearestNavArea
disable-model-invocation: true
---

# Find CNavMesh_GetNearestNavArea

Target: `CNavMesh::GetNearestNavArea` (func) in the module loaded in THIS session.
...
Write `CNavMesh_GetNearestNavArea.{platform}.yaml` with EXACTLY these fields:
