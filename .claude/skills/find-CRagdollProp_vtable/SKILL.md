...
description: |
  Agent fallback for CRagdollProp_vtable (auto-generated, category: func). Locate
  CRagdollProp_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRagdollProp_vtable, CRagdollProp_vtable
disable-model-invocation: true
---

# Find CRagdollProp_vtable

Target: `CRagdollProp_vtable` (func) in the module loaded in THIS session.
...
Write `CRagdollProp_vtable.{platform}.yaml` with EXACTLY these fields:
