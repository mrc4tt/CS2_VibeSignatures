...
description: |
  ...
  CServerSideClientBase_dtor-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_dtor-decompiles, CServerSideClientBase_dtor-decompiles
disable-model-invocation: true
---

# Find CServerSideClientBase_dtor-decompiles

Target: `CServerSideClientBase_dtor-decompiles` (func) in the module loaded in THIS session.
