---
name: find-CServerSideClientBase_dtor-decompiles
description: |
  Agent fallback for CServerSideClientBase_dtor-decompiles (auto-generated, category: func). Locate
  CServerSideClientBase_dtor in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_dtor-decompiles, CServerSideClientBase_dtor
disable-model-invocation: true
---

# Find CServerSideClientBase_dtor-decompiles

Target: `CServerSideClientBase_dtor` (func) in the module loaded in THIS session.
