---
name: find-CSource2GameClients_ClientSetConVarUserInfoSet
description: |
  Agent fallback for CSource2GameClients_ClientSetConVarUserInfoSet (auto-generated, category: func). Locate
  CSource2GameClients_ClientSetConVarUserInfoSet in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientSetConVarUserInfoSet, CSource2GameClients_ClientSetConVarUserInfoSet
disable-model-invocation: true
---

# Find CSource2GameClients_ClientSetConVarUserInfoSet

Target: `CSource2GameClients_ClientSetConVarUserInfoSet` (func) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientSetConVarUserInfoSet.{platform}.yaml` with EXACTLY these fields:
