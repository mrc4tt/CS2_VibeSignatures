...
description: |
  ...
  CSource2Client_CreateMove-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_CreateMove-decompiles, CSource2Client_CreateMove-decompiles
disable-model-invocation: true
---

# Find CSource2Client_CreateMove-decompiles

Target: `CSource2Client_CreateMove-decompiles` (vfunc) in the module loaded in THIS session.
