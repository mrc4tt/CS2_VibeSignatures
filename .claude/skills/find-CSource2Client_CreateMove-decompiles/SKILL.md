...
description: |
  Agent fallback for CSource2Client_CreateMove-decompiles (auto-generated, category: vfunc). Locate
  CSource2Client::CreateMove in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_CreateMove-decompiles, CSource2Client::CreateMove
disable-model-invocation: true
---

# Find CSource2Client_CreateMove-decompiles

Target: `CSource2Client::CreateMove` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Client_CreateMove.{platform}.yaml` with EXACTLY these fields:
