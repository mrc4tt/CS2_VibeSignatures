...
description: |
  Agent fallback for CGameResourceService_LoadGameResourceManifestGroup (auto-generated, category: vfunc). Locate
  CGameResourceService::LoadGameResourceManifestGroup in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_LoadGameResourceManifestGroup, CGameResourceService::LoadGameResourceManifestGroup
disable-model-invocation: true
---

# Find CGameResourceService_LoadGameResourceManifestGroup

Target: `CGameResourceService::LoadGameResourceManifestGroup` (vfunc) in the module loaded in THIS session.
...
Write `CGameResourceService_LoadGameResourceManifestGroup.{platform}.yaml` with EXACTLY these fields:
