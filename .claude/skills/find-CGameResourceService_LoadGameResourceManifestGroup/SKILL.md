...
description: |
  ...
  CGameResourceService_LoadGameResourceManifestGroup in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_LoadGameResourceManifestGroup, CGameResourceService_LoadGameResourceManifestGroup
disable-model-invocation: true
---

# Find CGameResourceService_LoadGameResourceManifestGroup

Target: `CGameResourceService_LoadGameResourceManifestGroup` (vfunc) in the module loaded in THIS session.
