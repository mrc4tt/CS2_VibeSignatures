...
description: |
  Agent fallback for CEntFireOutputAutoCompletionFunctor_FireOutput (auto-generated, category: vfunc). Locate
  CEntFireOutputAutoCompletionFunctor::FireOutput in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntFireOutputAutoCompletionFunctor_FireOutput, CEntFireOutputAutoCompletionFunctor::FireOutput
disable-model-invocation: true
---

# Find CEntFireOutputAutoCompletionFunctor_FireOutput

Target: `CEntFireOutputAutoCompletionFunctor::FireOutput` (vfunc) in the module loaded in THIS session.
...
Write `CEntFireOutputAutoCompletionFunctor_FireOutput.{platform}.yaml` with EXACTLY these fields:
