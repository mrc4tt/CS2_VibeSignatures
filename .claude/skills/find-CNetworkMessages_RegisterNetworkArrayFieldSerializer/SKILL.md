...
description: |
  ...
  CNetworkMessages_RegisterNetworkArrayFieldSerializer in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_RegisterNetworkArrayFieldSerializer, CNetworkMessages_RegisterNetworkArrayFieldSerializer
disable-model-invocation: true
---

# Find CNetworkMessages_RegisterNetworkArrayFieldSerializer

Target: `CNetworkMessages_RegisterNetworkArrayFieldSerializer` (vfunc) in the module loaded in THIS session.
