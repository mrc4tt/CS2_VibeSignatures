...
description: |
  Agent fallback for CNetworkMessages_RegisterNetworkArrayFieldSerializer (auto-generated, category: vfunc). Locate
  CNetworkMessages::RegisterNetworkArrayFieldSerializer in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_RegisterNetworkArrayFieldSerializer, CNetworkMessages::RegisterNetworkArrayFieldSerializer
disable-model-invocation: true
---

# Find CNetworkMessages_RegisterNetworkArrayFieldSerializer

Target: `CNetworkMessages::RegisterNetworkArrayFieldSerializer` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_RegisterNetworkArrayFieldSerializer.{platform}.yaml` with EXACTLY these fields:
