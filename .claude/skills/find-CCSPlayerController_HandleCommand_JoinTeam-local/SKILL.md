---
name: find-CCSPlayerController_HandleCommand_JoinTeam-local
description: |
  Agent fallback for CCSPlayerController_HandleCommand_JoinTeam-local (auto-generated, category: func). Locate
  CCSPlayerController::HandleCommand_JoinTeam in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_HandleCommand_JoinTeam-local, CCSPlayerController::HandleCommand_JoinTeam
disable-model-invocation: true
---

# Find CCSPlayerController_HandleCommand_JoinTeam-local

Target: `CCSPlayerController::HandleCommand_JoinTeam` (func) in the module loaded in THIS session.
...
Write `CCSPlayerController_HandleCommand_JoinTeam.{platform}.yaml` with EXACTLY these fields:
