...
description: |
  ...
  CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName, CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName
disable-model-invocation: true
---

# Find CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName

Target: `CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName` (vfunc) in the module loaded in THIS session.
