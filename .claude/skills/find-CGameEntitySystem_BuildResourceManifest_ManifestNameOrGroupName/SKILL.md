...
description: |
  Agent fallback for CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName (auto-generated, category: vfunc). Locate
  CGameEntitySystem::BuildResourceManifest_ManifestNameOrGroupName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName, CGameEntitySystem::BuildResourceManifest_ManifestNameOrGroupName
disable-model-invocation: true
---

# Find CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName

Target: `CGameEntitySystem::BuildResourceManifest_ManifestNameOrGroupName` (vfunc) in the module loaded in THIS session.
...
Write `CGameEntitySystem_BuildResourceManifest_ManifestNameOrGroupName.{platform}.yaml` with EXACTLY these fields:
