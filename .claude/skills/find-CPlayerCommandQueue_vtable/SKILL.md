...
description: |
  Agent fallback for CPlayerCommandQueue_vtable (auto-generated, category: func). Locate
  CPlayerCommandQueue_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayerCommandQueue_vtable, CPlayerCommandQueue_vtable
disable-model-invocation: true
---

# Find CPlayerCommandQueue_vtable

Target: `CPlayerCommandQueue_vtable` (func) in the module loaded in THIS session.
...
Write `CPlayerCommandQueue_vtable.{platform}.yaml` with EXACTLY these fields:
