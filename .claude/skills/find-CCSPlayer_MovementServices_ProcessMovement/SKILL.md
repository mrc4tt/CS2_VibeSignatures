...
description: |
  ...
  CCSPlayer_MovementServices_ProcessMovement in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_MovementServices_ProcessMovement, CCSPlayer_MovementServices_ProcessMovement
disable-model-invocation: true
---

# Find CCSPlayer_MovementServices_ProcessMovement

Target: `CCSPlayer_MovementServices_ProcessMovement` (func) in the module loaded in THIS session.
