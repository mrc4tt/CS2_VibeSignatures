...
description: |
  ...
  CLoopTypeClientServer_AdvanceTime in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_AdvanceTime, CLoopTypeClientServer_AdvanceTime
disable-model-invocation: true
---

# Find CLoopTypeClientServer_AdvanceTime

Target: `CLoopTypeClientServer_AdvanceTime` (func) in the module loaded in THIS session.
