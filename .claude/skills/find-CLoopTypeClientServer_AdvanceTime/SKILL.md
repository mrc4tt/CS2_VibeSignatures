---
name: find-CLoopTypeClientServer_AdvanceTime
description: |
  Agent fallback for CLoopTypeClientServer_AdvanceTime (auto-generated, category: func). Locate
  CLoopTypeClientServer::AdvanceTime in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_AdvanceTime, CLoopTypeClientServer::AdvanceTime
disable-model-invocation: true
---

# Find CLoopTypeClientServer_AdvanceTime

Target: `CLoopTypeClientServer::AdvanceTime` (func) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_AdvanceTime.{platform}.yaml` with EXACTLY these fields:
