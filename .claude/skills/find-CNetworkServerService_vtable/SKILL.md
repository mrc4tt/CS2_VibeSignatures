...
description: |
  Agent fallback for CNetworkServerService_vtable (auto-generated, category: func). Locate
  CNetworkServerService_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_vtable, CNetworkServerService_vtable
disable-model-invocation: true
---

# Find CNetworkServerService_vtable

Target: `CNetworkServerService_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkServerService_vtable.{platform}.yaml` with EXACTLY these fields:
