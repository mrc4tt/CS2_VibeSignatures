...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_DumpSpawnGroups (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::DumpSpawnGroups in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_DumpSpawnGroups, CSpawnGroupMgrGameSystem::DumpSpawnGroups
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_DumpSpawnGroups

Target: `CSpawnGroupMgrGameSystem::DumpSpawnGroups` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_DumpSpawnGroups.{platform}.yaml` with EXACTLY these fields:
