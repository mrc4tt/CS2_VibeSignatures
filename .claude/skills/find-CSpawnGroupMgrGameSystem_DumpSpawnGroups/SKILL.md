...
description: |
  ...
  CSpawnGroupMgrGameSystem_DumpSpawnGroups in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_DumpSpawnGroups, CSpawnGroupMgrGameSystem_DumpSpawnGroups
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_DumpSpawnGroups

Target: `CSpawnGroupMgrGameSystem_DumpSpawnGroups` (vfunc) in the module loaded in THIS session.
