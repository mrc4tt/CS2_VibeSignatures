---
name: find-CServerSideClient_m_bFakePlayer
description: |
  Locate CServerSideClient::m_bFakePlayer in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "CServerSideClient::m_bFakePlayer" (symbol CServerSideClient_m_bFakePlayer). This is a STRUCT MEMBER OFFSET (schema netvar), not a function. Resolve the
  ...
  Trigger: CServerSideClient_m_bFakePlayer, CServerSideClient::m_bFakePlayer
disable-model-invocation: true
---

# Find CServerSideClient_m_bFakePlayer

Target: `CServerSideClient::m_bFakePlayer` (structmember) in the CS2 server module.
