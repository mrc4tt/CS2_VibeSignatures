...
description: |
  ...
  CEntityInstance_OnSetDormant in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_OnSetDormant, CEntityInstance_OnSetDormant
disable-model-invocation: true
---

# Find CEntityInstance_OnSetDormant

Target: `CEntityInstance_OnSetDormant` (vfunc) in the module loaded in THIS session.
