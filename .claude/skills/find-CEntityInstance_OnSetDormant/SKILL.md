...
description: |
  Agent fallback for CEntityInstance_OnSetDormant (auto-generated, category: vfunc). Locate
  CEntityInstance::OnSetDormant in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_OnSetDormant, CEntityInstance::OnSetDormant
disable-model-invocation: true
---

# Find CEntityInstance_OnSetDormant

Target: `CEntityInstance::OnSetDormant` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_OnSetDormant.{platform}.yaml` with EXACTLY these fields:
