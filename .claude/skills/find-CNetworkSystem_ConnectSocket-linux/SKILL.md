---
name: find-CNetworkSystem_ConnectSocket-linux
description: |
  Agent fallback for CNetworkSystem_ConnectSocket-linux (auto-generated, category: func). Locate
  CNetworkSystem_ConnectSocket-linux in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_ConnectSocket-linux, CNetworkSystem_ConnectSocket-linux
disable-model-invocation: true
---

# Find CNetworkSystem_ConnectSocket-linux

Target: `CNetworkSystem_ConnectSocket-linux` (func) in the module loaded in THIS session.
