...
description: |
  Agent fallback for CLoopModeGame_SetWorldSession (auto-generated, category: func). Locate
  CLoopModeGame::SetWorldSession in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_SetWorldSession, CLoopModeGame::SetWorldSession
disable-model-invocation: true
---

# Find CLoopModeGame_SetWorldSession

Target: `CLoopModeGame::SetWorldSession` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_SetWorldSession.{platform}.yaml` with EXACTLY these fields:
