...
description: |
  ...
  CLoopModeGame_SetWorldSession in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_SetWorldSession, CLoopModeGame_SetWorldSession
disable-model-invocation: true
---

# Find CLoopModeGame_SetWorldSession

Target: `CLoopModeGame_SetWorldSession` (func) in the module loaded in THIS session.
