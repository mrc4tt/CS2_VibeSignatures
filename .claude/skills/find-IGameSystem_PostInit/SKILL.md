...
description: |
  ...
  IGameSystem_PostInit in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_PostInit, IGameSystem_PostInit
disable-model-invocation: true
---

# Find IGameSystem_PostInit

Target: `IGameSystem_PostInit` (func) in the module loaded in THIS session.
