...
description: |
  ...
  INetworkSystem_ShutdownGameServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_ShutdownGameServer, INetworkSystem_ShutdownGameServer
disable-model-invocation: true
---

# Find INetworkSystem_ShutdownGameServer

Target: `INetworkSystem_ShutdownGameServer` (vfunc) in the module loaded in THIS session.
