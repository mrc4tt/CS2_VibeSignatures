---
name: find-INetworkSystem_ShutdownGameServer
description: |
  Agent fallback for INetworkSystem_ShutdownGameServer (auto-generated, category: vfunc). Locate
  INetworkSystem::ShutdownGameServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_ShutdownGameServer, INetworkSystem::ShutdownGameServer
disable-model-invocation: true
---

# Find INetworkSystem_ShutdownGameServer

Target: `INetworkSystem::ShutdownGameServer` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_ShutdownGameServer.{platform}.yaml` with EXACTLY these fields:
