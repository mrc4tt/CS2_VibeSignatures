...
description: |
  ...
  CNetworkGameServer_ServerPostSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_ServerPostSimulate, CNetworkGameServer_ServerPostSimulate
disable-model-invocation: true
---

# Find CNetworkGameServer_ServerPostSimulate

Target: `CNetworkGameServer_ServerPostSimulate` (vfunc) in the module loaded in THIS session.
