---
name: find-CNetworkGameServer_ServerPostSimulate
description: |
  Agent fallback for CNetworkGameServer_ServerPostSimulate (auto-generated, category: vfunc). Locate
  CNetworkGameServer::ServerPostSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_ServerPostSimulate, CNetworkGameServer::ServerPostSimulate
disable-model-invocation: true
---

# Find CNetworkGameServer_ServerPostSimulate

Target: `CNetworkGameServer::ServerPostSimulate` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_ServerPostSimulate.{platform}.yaml` with EXACTLY these fields:
