...
description: |
  ...
  CDemoPlayer_StopPlayback in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_StopPlayback, CDemoPlayer_StopPlayback
disable-model-invocation: true
---

# Find CDemoPlayer_StopPlayback

Target: `CDemoPlayer_StopPlayback` (vfunc) in the module loaded in THIS session.
