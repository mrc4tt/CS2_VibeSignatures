...
description: |
  Agent fallback for CDemoPlayer_StopPlayback (auto-generated, category: vfunc). Locate
  CDemoPlayer::StopPlayback in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_StopPlayback, CDemoPlayer::StopPlayback
disable-model-invocation: true
---

# Find CDemoPlayer_StopPlayback

Target: `CDemoPlayer::StopPlayback` (vfunc) in the module loaded in THIS session.
...
Write `CDemoPlayer_StopPlayback.{platform}.yaml` with EXACTLY these fields:
