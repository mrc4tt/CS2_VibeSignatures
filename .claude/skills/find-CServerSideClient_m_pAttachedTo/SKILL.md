---
name: find-CServerSideClient_m_pAttachedTo
description: |
  Locate CServerSideClient::m_pAttachedTo in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "CServerSideClient::m_pAttachedTo" (symbol CServerSideClient_m_pAttachedTo). This is a STRUCT MEMBER OFFSET (schema netvar), not a function. Resolve the
  ...
  Trigger: CServerSideClient_m_pAttachedTo, CServerSideClient::m_pAttachedTo
disable-model-invocation: true
---

# Find CServerSideClient_m_pAttachedTo

Target: `CServerSideClient::m_pAttachedTo` (structmember) in the CS2 server module.
