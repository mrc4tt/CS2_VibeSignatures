---
name: find-INetworkSystem_EnableLoopbackBetweenSockets
description: |
  Agent fallback for INetworkSystem_EnableLoopbackBetweenSockets (auto-generated, category: vfunc). Locate
  INetworkSystem::EnableLoopbackBetweenSockets in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_EnableLoopbackBetweenSockets, INetworkSystem::EnableLoopbackBetweenSockets
disable-model-invocation: true
---

# Find INetworkSystem_EnableLoopbackBetweenSockets

Target: `INetworkSystem::EnableLoopbackBetweenSockets` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_EnableLoopbackBetweenSockets.{platform}.yaml` with EXACTLY these fields:
