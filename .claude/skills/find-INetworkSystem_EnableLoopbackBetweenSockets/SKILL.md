...
description: |
  ...
  INetworkSystem_EnableLoopbackBetweenSockets in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_EnableLoopbackBetweenSockets, INetworkSystem_EnableLoopbackBetweenSockets
disable-model-invocation: true
---

# Find INetworkSystem_EnableLoopbackBetweenSockets

Target: `INetworkSystem_EnableLoopbackBetweenSockets` (vfunc) in the module loaded in THIS session.
