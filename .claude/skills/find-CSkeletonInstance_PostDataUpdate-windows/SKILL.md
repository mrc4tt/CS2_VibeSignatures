---
name: find-CSkeletonInstance_PostDataUpdate-windows
description: |
  Agent fallback for CSkeletonInstance_PostDataUpdate-windows (auto-generated, category: vfunc). Locate
  CSkeletonInstance::PostDataUpdate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSkeletonInstance_PostDataUpdate-windows, CSkeletonInstance::PostDataUpdate
disable-model-invocation: true
---

# Find CSkeletonInstance_PostDataUpdate-windows

Target: `CSkeletonInstance::PostDataUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CSkeletonInstance_PostDataUpdate.{platform}.yaml` with EXACTLY these fields:
