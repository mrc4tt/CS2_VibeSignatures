...
description: |
  ...
  CSkeletonInstance_PostDataUpdate-windows in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSkeletonInstance_PostDataUpdate-windows, CSkeletonInstance_PostDataUpdate-windows
disable-model-invocation: true
---

# Find CSkeletonInstance_PostDataUpdate-windows

Target: `CSkeletonInstance_PostDataUpdate-windows` (vfunc) in the module loaded in THIS session.
