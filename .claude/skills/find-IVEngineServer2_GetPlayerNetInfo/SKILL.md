---
name: find-IVEngineServer2_GetPlayerNetInfo
description: |
  Agent fallback for IVEngineServer2_GetPlayerNetInfo (auto-generated, category: vfunc). Locate
  IVEngineServer2::GetPlayerNetInfo in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IVEngineServer2_GetPlayerNetInfo, IVEngineServer2::GetPlayerNetInfo
disable-model-invocation: true
---

# Find IVEngineServer2_GetPlayerNetInfo

Target: `IVEngineServer2::GetPlayerNetInfo` (vfunc) in the module loaded in THIS session.
...
Write `IVEngineServer2_GetPlayerNetInfo.{platform}.yaml` with EXACTLY these fields:
