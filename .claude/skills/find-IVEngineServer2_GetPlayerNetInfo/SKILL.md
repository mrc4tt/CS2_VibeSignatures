...
description: |
  ...
  IVEngineServer2_GetPlayerNetInfo in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IVEngineServer2_GetPlayerNetInfo, IVEngineServer2_GetPlayerNetInfo
disable-model-invocation: true
---

# Find IVEngineServer2_GetPlayerNetInfo

Target: `IVEngineServer2_GetPlayerNetInfo` (vfunc) in the module loaded in THIS session.
