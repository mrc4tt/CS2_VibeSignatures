...
description: |
  ...
  IGameSystem_OnClientAdvanceNonRenderedFrame in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientAdvanceNonRenderedFrame, IGameSystem_OnClientAdvanceNonRenderedFrame
disable-model-invocation: true
---

# Find IGameSystem_OnClientAdvanceNonRenderedFrame

Target: `IGameSystem_OnClientAdvanceNonRenderedFrame` (vfunc) in the module loaded in THIS session.
