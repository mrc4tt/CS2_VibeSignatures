...
description: |
  Agent fallback for IGameSystem_OnClientAdvanceNonRenderedFrame (auto-generated, category: vfunc). Locate
  IGameSystem::OnClientAdvanceNonRenderedFrame in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientAdvanceNonRenderedFrame, IGameSystem::OnClientAdvanceNonRenderedFrame
disable-model-invocation: true
---

# Find IGameSystem_OnClientAdvanceNonRenderedFrame

Target: `IGameSystem::OnClientAdvanceNonRenderedFrame` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientAdvanceNonRenderedFrame.{platform}.yaml` with EXACTLY these fields:
