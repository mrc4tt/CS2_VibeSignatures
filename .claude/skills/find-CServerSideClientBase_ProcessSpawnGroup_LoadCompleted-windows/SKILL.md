...
description: |
  ...
  CServerSideClientBase_ProcessSpawnGroup_LoadCompleted-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessSpawnGroup_LoadCompleted-windows, CServerSideClientBase_ProcessSpawnGroup_LoadCompleted-windows
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessSpawnGroup_LoadCompleted-windows

Target: `CServerSideClientBase_ProcessSpawnGroup_LoadCompleted-windows` (vfunc) in the module loaded in THIS session.
