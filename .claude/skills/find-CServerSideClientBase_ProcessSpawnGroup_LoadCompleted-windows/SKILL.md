...
description: |
  Agent fallback for CServerSideClientBase_ProcessSpawnGroup_LoadCompleted-windows (auto-generated, category: vfunc). Locate
  CServerSideClientBase::ProcessSpawnGroup_LoadCompleted in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessSpawnGroup_LoadCompleted-windows, CServerSideClientBase::ProcessSpawnGroup_LoadCompleted
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessSpawnGroup_LoadCompleted-windows

Target: `CServerSideClientBase::ProcessSpawnGroup_LoadCompleted` (vfunc) in the module loaded in THIS session.
...
Write `CServerSideClientBase_ProcessSpawnGroup_LoadCompleted.{platform}.yaml` with EXACTLY these fields:
