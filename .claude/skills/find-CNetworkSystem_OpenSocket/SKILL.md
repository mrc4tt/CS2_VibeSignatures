---
name: find-CNetworkSystem_OpenSocket
description: |
  Agent fallback for CNetworkSystem_OpenSocket (auto-generated, category: func). Locate
  CNetworkSystem_OpenSocket in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_OpenSocket, CNetworkSystem_OpenSocket
disable-model-invocation: true
---

# Find CNetworkSystem_OpenSocket

Target: `CNetworkSystem_OpenSocket` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_OpenSocket.{platform}.yaml` with EXACTLY these fields:
