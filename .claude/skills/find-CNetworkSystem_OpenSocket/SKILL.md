...
description: |
  Agent fallback for CNetworkSystem_OpenSocket (auto-generated, category: vfunc). Locate
...
Target: `CNetworkSystem_OpenSocket` (vfunc) in the module loaded in THIS session.
