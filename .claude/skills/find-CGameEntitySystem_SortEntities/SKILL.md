...
description: |
  Agent fallback for CGameEntitySystem_SortEntities (auto-generated, category: vfunc). Locate
  CGameEntitySystem::SortEntities in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_SortEntities, CGameEntitySystem::SortEntities
disable-model-invocation: true
---

# Find CGameEntitySystem_SortEntities

Target: `CGameEntitySystem::SortEntities` (vfunc) in the module loaded in THIS session.
...
Write `CGameEntitySystem_SortEntities.{platform}.yaml` with EXACTLY these fields:
