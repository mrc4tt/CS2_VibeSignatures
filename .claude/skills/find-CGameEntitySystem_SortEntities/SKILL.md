...
description: |
  ...
  CGameEntitySystem_SortEntities in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_SortEntities, CGameEntitySystem_SortEntities
disable-model-invocation: true
---

# Find CGameEntitySystem_SortEntities

Target: `CGameEntitySystem_SortEntities` (vfunc) in the module loaded in THIS session.
