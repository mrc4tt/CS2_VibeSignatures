---
name: find-CServerSideClientBase_GetPlayerInfo
description: |
  Agent fallback for CServerSideClientBase_GetPlayerInfo (auto-generated, category: vfunc). Locate
  CServerSideClientBase::GetPlayerInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_GetPlayerInfo, CServerSideClientBase::GetPlayerInfo
disable-model-invocation: true
---

# Find CServerSideClientBase_GetPlayerInfo

Target: `CServerSideClientBase::GetPlayerInfo` (vfunc) in the module loaded in THIS session.
...
Write `CServerSideClientBase_GetPlayerInfo.{platform}.yaml` with EXACTLY these fields:
