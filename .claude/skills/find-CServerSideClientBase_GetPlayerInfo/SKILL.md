...
description: |
  ...
  CServerSideClientBase_GetPlayerInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_GetPlayerInfo, CServerSideClientBase_GetPlayerInfo
disable-model-invocation: true
---

# Find CServerSideClientBase_GetPlayerInfo

Target: `CServerSideClientBase_GetPlayerInfo` (vfunc) in the module loaded in THIS session.
