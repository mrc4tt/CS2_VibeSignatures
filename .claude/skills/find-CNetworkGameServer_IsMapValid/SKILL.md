---
name: find-CNetworkGameServer_IsMapValid
description: |
  Agent fallback for CNetworkGameServer_IsMapValid (auto-generated, category: func). Locate
  CNetworkGameServer_IsMapValid in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_IsMapValid, CNetworkGameServer_IsMapValid
disable-model-invocation: true
---

# Find CNetworkGameServer_IsMapValid

Target: `CNetworkGameServer_IsMapValid` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServer_IsMapValid.{platform}.yaml` with EXACTLY these fields:
