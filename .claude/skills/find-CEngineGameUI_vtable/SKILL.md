...
description: |
  Agent fallback for CEngineGameUI_vtable (auto-generated, category: func). Locate
  CEngineGameUI_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineGameUI_vtable, CEngineGameUI_vtable
disable-model-invocation: true
---

# Find CEngineGameUI_vtable

Target: `CEngineGameUI_vtable` (func) in the module loaded in THIS session.
...
Write `CEngineGameUI_vtable.{platform}.yaml` with EXACTLY these fields:
