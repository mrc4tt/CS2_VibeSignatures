...
description: |
  ...
  CEngineServer_SetFakeClientConVarValue in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_SetFakeClientConVarValue, CEngineServer_SetFakeClientConVarValue
disable-model-invocation: true
---

# Find CEngineServer_SetFakeClientConVarValue

Target: `CEngineServer_SetFakeClientConVarValue` (vfunc) in the module loaded in THIS session.
