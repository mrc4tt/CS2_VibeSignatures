---
name: find-CEngineServer_SetFakeClientConVarValue
description: |
  Agent fallback for CEngineServer_SetFakeClientConVarValue (auto-generated, category: vfunc). Locate
  CEngineServer::SetFakeClientConVarValue in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_SetFakeClientConVarValue, CEngineServer::SetFakeClientConVarValue
disable-model-invocation: true
---

# Find CEngineServer_SetFakeClientConVarValue

Target: `CEngineServer::SetFakeClientConVarValue` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_SetFakeClientConVarValue.{platform}.yaml` with EXACTLY these fields:
