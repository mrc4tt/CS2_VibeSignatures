...
description: |
  Agent fallback for CCSPlayerPawn_ClientCommand (auto-generated, category: vfunc). Locate
  CCSPlayerPawn::ClientCommand in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_ClientCommand, CCSPlayerPawn::ClientCommand
disable-model-invocation: true
---

# Find CCSPlayerPawn_ClientCommand

Target: `CCSPlayerPawn::ClientCommand` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_ClientCommand.{platform}.yaml` with EXACTLY these fields:
