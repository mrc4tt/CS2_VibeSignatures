...
description: |
  ...
  CCSPlayerPawn_ClientCommand in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_ClientCommand, CCSPlayerPawn_ClientCommand
disable-model-invocation: true
---

# Find CCSPlayerPawn_ClientCommand

Target: `CCSPlayerPawn_ClientCommand` (vfunc) in the module loaded in THIS session.
