...
description: |
  Agent fallback for SetInfo_CommandHandler (auto-generated, category: func). Locate
  SetInfo_CommandHandler in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SetInfo_CommandHandler, SetInfo_CommandHandler
disable-model-invocation: true
---

# Find SetInfo_CommandHandler

Target: `SetInfo_CommandHandler` (func) in the module loaded in THIS session.
...
Write `SetInfo_CommandHandler.{platform}.yaml` with EXACTLY these fields:
