...
description: |
  ...
  CDemoPlayer_Pause-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_Pause-decompiles, CDemoPlayer_Pause-decompiles
disable-model-invocation: true
---

# Find CDemoPlayer_Pause-decompiles

Target: `CDemoPlayer_Pause-decompiles` (vfunc) in the module loaded in THIS session.
