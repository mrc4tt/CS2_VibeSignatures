---
name: find-CNetworkSystem_BufferToBufferDecompress
description: |
  Agent fallback for CNetworkSystem_BufferToBufferDecompress (auto-generated, category: func). Locate
  CNetworkSystem_BufferToBufferDecompress in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_BufferToBufferDecompress, CNetworkSystem_BufferToBufferDecompress
disable-model-invocation: true
---

# Find CNetworkSystem_BufferToBufferDecompress

Target: `CNetworkSystem_BufferToBufferDecompress` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_BufferToBufferDecompress.{platform}.yaml` with EXACTLY these fields:
