...
description: |
  Agent fallback for CNetworkSystem_BufferToBufferDecompress (auto-generated, category: vfunc). Locate
...
Target: `CNetworkSystem_BufferToBufferDecompress` (vfunc) in the module loaded in THIS session.
