...
description: |
  Agent fallback for CEngineServer_ClientCommand (auto-generated, category: vfunc). Locate
  CEngineServer::ClientCommand in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ClientCommand, CEngineServer::ClientCommand
disable-model-invocation: true
---

# Find CEngineServer_ClientCommand

Target: `CEngineServer::ClientCommand` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_ClientCommand.{platform}.yaml` with EXACTLY these fields:
