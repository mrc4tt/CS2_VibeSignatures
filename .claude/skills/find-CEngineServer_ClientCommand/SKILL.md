...
description: |
  ...
  CEngineServer_ClientCommand in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ClientCommand, CEngineServer_ClientCommand
disable-model-invocation: true
---

# Find CEngineServer_ClientCommand

Target: `CEngineServer_ClientCommand` (vfunc) in the module loaded in THIS session.
