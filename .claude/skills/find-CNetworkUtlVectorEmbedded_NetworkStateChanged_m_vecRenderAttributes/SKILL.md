...
description: |
  Agent fallback for CNetworkUtlVectorEmbedded_NetworkStateChanged_m_vecRenderAttributes (auto-generated, category: func). Locate
  CNetworkUtlVectorEmbedded<CRenderAttribute>::NetworkStateChanged_m_vecRenderAttributes in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkUtlVectorEmbedded_NetworkStateChanged_m_vecRenderAttributes, CNetworkUtlVectorEmbedded<CRenderAttribute>::NetworkStateChanged_m_vecRenderAttributes
disable-model-invocation: true
---

# Find CNetworkUtlVectorEmbedded_NetworkStateChanged_m_vecRenderAttributes

Target: `CNetworkUtlVectorEmbedded<CRenderAttribute>::NetworkStateChanged_m_vecRenderAttributes` (func) in the module loaded in THIS session.
...
Write `CNetworkUtlVectorEmbedded_NetworkStateChanged_m_vecRenderAttributes.{platform}.yaml` with EXACTLY these fields:
