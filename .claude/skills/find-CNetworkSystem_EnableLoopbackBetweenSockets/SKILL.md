...
description: |
  Agent fallback for CNetworkSystem_EnableLoopbackBetweenSockets (auto-generated, category: vfunc). Locate
...
Target: `CNetworkSystem_EnableLoopbackBetweenSockets` (vfunc) in the module loaded in THIS session.
