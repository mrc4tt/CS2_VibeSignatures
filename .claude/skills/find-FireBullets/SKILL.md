...
description: |
  Agent fallback for FireBullets (auto-generated, category: func). Locate
  FireBullets in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: FireBullets, FireBullets
disable-model-invocation: true
---

# Find FireBullets

Target: `FireBullets` (func) in the module loaded in THIS session.
...
Write `FireBullets.{platform}.yaml` with EXACTLY these fields:
