...
description: |
  Agent fallback for CNetworkClientService_SendStringCmd (auto-generated, category: vfunc). Locate
  CNetworkClientService::SendStringCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_SendStringCmd, CNetworkClientService::SendStringCmd
disable-model-invocation: true
---

# Find CNetworkClientService_SendStringCmd

Target: `CNetworkClientService::SendStringCmd` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_SendStringCmd.{platform}.yaml` with EXACTLY these fields:
