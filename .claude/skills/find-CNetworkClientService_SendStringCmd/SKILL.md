...
description: |
  ...
  CNetworkClientService_SendStringCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_SendStringCmd, CNetworkClientService_SendStringCmd
disable-model-invocation: true
---

# Find CNetworkClientService_SendStringCmd

Target: `CNetworkClientService_SendStringCmd` (vfunc) in the module loaded in THIS session.
