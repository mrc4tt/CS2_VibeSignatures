...
description: |
  ...
  CLoopTypeBase_LoopTypeInit in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_LoopTypeInit, CLoopTypeBase_LoopTypeInit
disable-model-invocation: true
---

# Find CLoopTypeBase_LoopTypeInit

Target: `CLoopTypeBase_LoopTypeInit` (vfunc) in the module loaded in THIS session.
