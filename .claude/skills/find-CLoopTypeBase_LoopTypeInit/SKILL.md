...
description: |
  Agent fallback for CLoopTypeBase_LoopTypeInit (auto-generated, category: vfunc). Locate
  CLoopTypeBase::LoopTypeInit in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_LoopTypeInit, CLoopTypeBase::LoopTypeInit
disable-model-invocation: true
---

# Find CLoopTypeBase_LoopTypeInit

Target: `CLoopTypeBase::LoopTypeInit` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeBase_LoopTypeInit.{platform}.yaml` with EXACTLY these fields:
