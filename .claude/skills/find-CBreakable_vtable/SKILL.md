---
name: find-CBreakable_vtable
description: |
  Agent fallback for CBreakable_vtable (auto-generated, category: func). Locate
  CBreakable_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBreakable_vtable, CBreakable_vtable
disable-model-invocation: true
---

# Find CBreakable_vtable

Target: `CBreakable_vtable` (func) in the module loaded in THIS session.
...
Write `CBreakable_vtable.{platform}.yaml` with EXACTLY these fields:
