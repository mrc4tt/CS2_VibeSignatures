...
description: |
  Agent fallback for CSource2Client_OnDisconnect (auto-generated, category: vfunc). Locate
  CSource2Client::OnDisconnect in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_OnDisconnect, CSource2Client::OnDisconnect
disable-model-invocation: true
---

# Find CSource2Client_OnDisconnect

Target: `CSource2Client::OnDisconnect` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Client_OnDisconnect.{platform}.yaml` with EXACTLY these fields:
