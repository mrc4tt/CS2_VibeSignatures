...
description: |
  ...
  CSource2Client_OnDisconnect in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_OnDisconnect, CSource2Client_OnDisconnect
disable-model-invocation: true
---

# Find CSource2Client_OnDisconnect

Target: `CSource2Client_OnDisconnect` (vfunc) in the module loaded in THIS session.
