...
description: |
  Agent fallback for CNetworkGameClient_vtable (auto-generated, category: func). Locate
  CNetworkGameClient_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_vtable, CNetworkGameClient_vtable
disable-model-invocation: true
---

# Find CNetworkGameClient_vtable

Target: `CNetworkGameClient_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClient_vtable.{platform}.yaml` with EXACTLY these fields:
