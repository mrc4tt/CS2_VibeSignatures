...
description: |
  ...
  CNetworkGameServerBase_BroadcastMessage in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_BroadcastMessage, CNetworkGameServerBase_BroadcastMessage
disable-model-invocation: true
---

# Find CNetworkGameServerBase_BroadcastMessage

Target: `CNetworkGameServerBase_BroadcastMessage` (vfunc) in the module loaded in THIS session.
