...
description: |
  Agent fallback for CNetworkGameServerBase_BroadcastMessage (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::BroadcastMessage in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_BroadcastMessage, CNetworkGameServerBase::BroadcastMessage
disable-model-invocation: true
---

# Find CNetworkGameServerBase_BroadcastMessage

Target: `CNetworkGameServerBase::BroadcastMessage` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_BroadcastMessage.{platform}.yaml` with EXACTLY these fields:
