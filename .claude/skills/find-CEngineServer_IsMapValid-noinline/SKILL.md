---
name: find-CEngineServer_IsMapValid-noinline
description: |
  Agent fallback for CEngineServer_IsMapValid-noinline (auto-generated, category: vfunc). Locate
  CEngineServer::IsMapValid in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_IsMapValid-noinline, CEngineServer::IsMapValid
disable-model-invocation: true
---

# Find CEngineServer_IsMapValid-noinline

Target: `CEngineServer::IsMapValid` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_IsMapValid.{platform}.yaml` with EXACTLY these fields:
