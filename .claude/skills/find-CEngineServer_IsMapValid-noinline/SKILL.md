...
description: |
  ...
  CEngineServer_IsMapValid-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_IsMapValid-noinline, CEngineServer_IsMapValid-noinline
disable-model-invocation: true
---

# Find CEngineServer_IsMapValid-noinline

Target: `CEngineServer_IsMapValid-noinline` (vfunc) in the module loaded in THIS session.
