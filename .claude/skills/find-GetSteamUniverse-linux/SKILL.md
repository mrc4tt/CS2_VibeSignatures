---
name: find-GetSteamUniverse-linux
description: |
  Agent fallback for GetSteamUniverse-linux (auto-generated, category: func). Locate
  GetSteamUniverse in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GetSteamUniverse-linux, GetSteamUniverse
disable-model-invocation: true
---

# Find GetSteamUniverse-linux

Target: `GetSteamUniverse` (func) in the module loaded in THIS session.
...
Write `GetSteamUniverse.{platform}.yaml` with EXACTLY these fields:
