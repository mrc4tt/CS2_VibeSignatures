...
description: |
  ...
  GetSteamUniverse-linux in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GetSteamUniverse-linux, GetSteamUniverse-linux
disable-model-invocation: true
---

# Find GetSteamUniverse-linux

Target: `GetSteamUniverse-linux` (func) in the module loaded in THIS session.
