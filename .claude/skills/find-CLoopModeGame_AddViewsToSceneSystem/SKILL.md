...
description: |
  Agent fallback for CLoopModeGame_AddViewsToSceneSystem (auto-generated, category: vfunc). Locate
  CLoopModeGame::AddViewsToSceneSystem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_AddViewsToSceneSystem, CLoopModeGame::AddViewsToSceneSystem
disable-model-invocation: true
---

# Find CLoopModeGame_AddViewsToSceneSystem

Target: `CLoopModeGame::AddViewsToSceneSystem` (vfunc) in the module loaded in THIS session.
...
Write `CLoopModeGame_AddViewsToSceneSystem.{platform}.yaml` with EXACTLY these fields:
