...
description: |
  ...
  CLoopModeGame_AddViewsToSceneSystem in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_AddViewsToSceneSystem, CLoopModeGame_AddViewsToSceneSystem
disable-model-invocation: true
---

# Find CLoopModeGame_AddViewsToSceneSystem

Target: `CLoopModeGame_AddViewsToSceneSystem` (vfunc) in the module loaded in THIS session.
