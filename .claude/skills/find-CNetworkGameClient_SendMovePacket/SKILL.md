...
description: |
  Agent fallback for CNetworkGameClient_SendMovePacket (auto-generated, category: func). Locate
  CNetworkGameClient::SendMovePacket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_SendMovePacket, CNetworkGameClient::SendMovePacket
disable-model-invocation: true
---

# Find CNetworkGameClient_SendMovePacket

Target: `CNetworkGameClient::SendMovePacket` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClient_SendMovePacket.{platform}.yaml` with EXACTLY these fields:
