...
description: |
  ...
  CNetworkGameClient_SendMovePacket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_SendMovePacket, CNetworkGameClient_SendMovePacket
disable-model-invocation: true
---

# Find CNetworkGameClient_SendMovePacket

Target: `CNetworkGameClient_SendMovePacket` (func) in the module loaded in THIS session.
