...
description: |
  Agent fallback for CNetworkGameServerBase_Shutdown-windows (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_Shutdown-windows, CNetworkGameServerBase::Shutdown
disable-model-invocation: true
---

# Find CNetworkGameServerBase_Shutdown-windows

Target: `CNetworkGameServerBase::Shutdown` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_Shutdown.{platform}.yaml` with EXACTLY these fields:
