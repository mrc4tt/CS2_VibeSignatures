...
description: |
  ...
  CNetworkGameServerBase_Shutdown-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_Shutdown-windows, CNetworkGameServerBase_Shutdown-windows
disable-model-invocation: true
---

# Find CNetworkGameServerBase_Shutdown-windows

Target: `CNetworkGameServerBase_Shutdown-windows` (vfunc) in the module loaded in THIS session.
