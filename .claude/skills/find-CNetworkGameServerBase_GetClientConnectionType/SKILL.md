...
description: |
  Agent fallback for CNetworkGameServerBase_GetClientConnectionType (auto-generated, category: func). Locate
  CNetworkGameServerBase_GetClientConnectionType in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetClientConnectionType, CNetworkGameServerBase_GetClientConnectionType
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetClientConnectionType

Target: `CNetworkGameServerBase_GetClientConnectionType` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_GetClientConnectionType.{platform}.yaml` with EXACTLY these fields:
