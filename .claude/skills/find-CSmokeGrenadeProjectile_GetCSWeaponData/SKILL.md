---
name: find-CSmokeGrenadeProjectile_GetCSWeaponData
description: |
  Agent fallback for CSmokeGrenadeProjectile_GetCSWeaponData (auto-generated, category: func). Locate
  CSmokeGrenadeProjectile_GetCSWeaponData in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSmokeGrenadeProjectile_GetCSWeaponData, CSmokeGrenadeProjectile_GetCSWeaponData
disable-model-invocation: true
---

# Find CSmokeGrenadeProjectile_GetCSWeaponData

Target: `CSmokeGrenadeProjectile_GetCSWeaponData` (func) in the module loaded in THIS session.
...
Write `CSmokeGrenadeProjectile_GetCSWeaponData.{platform}.yaml` with EXACTLY these fields:
