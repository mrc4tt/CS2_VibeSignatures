...
description: |
  Agent fallback for CNetworkGameServerBase_vtable (auto-generated, category: func). Locate
  CNetworkGameServerBase_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_vtable, CNetworkGameServerBase_vtable
disable-model-invocation: true
---

# Find CNetworkGameServerBase_vtable

Target: `CNetworkGameServerBase_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_vtable.{platform}.yaml` with EXACTLY these fields:
