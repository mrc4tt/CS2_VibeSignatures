...
description: |
  ...
  CCSPlayer_WeaponServices_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_WeaponServices_vtable, CCSPlayer_WeaponServices_vtable
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_vtable

Target: `CCSPlayer_WeaponServices_vtable` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_WeaponServices_vtable.{platform}.yaml` with EXACTLY these fields:
