---
name: find-CChicken_vtable
description: |
  Agent fallback for CChicken_vtable (auto-generated, category: func). Locate
  CChicken_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CChicken_vtable, CChicken_vtable
disable-model-invocation: true
---

# Find CChicken_vtable

Target: `CChicken_vtable` (func) in the module loaded in THIS session.
...
Write `CChicken_vtable.{platform}.yaml` with EXACTLY these fields:
