...
description: |
  ...
  IGameSystem_OnGamePostInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGamePostInit, IGameSystem_OnGamePostInit
disable-model-invocation: true
---

# Find IGameSystem_OnGamePostInit

Target: `IGameSystem_OnGamePostInit` (vfunc) in the module loaded in THIS session.
