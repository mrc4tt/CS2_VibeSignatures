...
description: |
  Agent fallback for IGameSystem_OnGamePostInit (auto-generated, category: vfunc). Locate
  IGameSystem::GamePostInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGamePostInit, IGameSystem::GamePostInit
disable-model-invocation: true
---

# Find IGameSystem_OnGamePostInit

Target: `IGameSystem::GamePostInit` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnGamePostInit.{platform}.yaml` with EXACTLY these fields:
