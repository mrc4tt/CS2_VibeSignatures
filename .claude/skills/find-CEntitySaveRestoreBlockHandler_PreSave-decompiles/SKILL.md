...
description: |
  ...
  CEntitySaveRestoreBlockHandler::PreSave in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_PreSave-decompiles, CEntitySaveRestoreBlockHandler::PreSave
