...
description: |
  Agent fallback for CNetworkClientService_Shutdown (auto-generated, category: vfunc). Locate
  CNetworkClientService::Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_Shutdown, CNetworkClientService::Shutdown
disable-model-invocation: true
---

# Find CNetworkClientService_Shutdown

Target: `CNetworkClientService::Shutdown` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_Shutdown.{platform}.yaml` with EXACTLY these fields:
