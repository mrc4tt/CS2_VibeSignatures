...
description: |
  ...
  CNetworkClientService_Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_Shutdown, CNetworkClientService_Shutdown
disable-model-invocation: true
---

# Find CNetworkClientService_Shutdown

Target: `CNetworkClientService_Shutdown` (vfunc) in the module loaded in THIS session.
