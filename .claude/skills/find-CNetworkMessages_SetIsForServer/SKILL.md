...
description: |
  Agent fallback for CNetworkMessages_SetIsForServer (auto-generated, category: func). Locate
  CNetworkMessages_SetIsForServer in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_SetIsForServer, CNetworkMessages_SetIsForServer
disable-model-invocation: true
---

# Find CNetworkMessages_SetIsForServer

Target: `CNetworkMessages_SetIsForServer` (func) in the module loaded in THIS session.
...
Write `CNetworkMessages_SetIsForServer.{platform}.yaml` with EXACTLY these fields:
