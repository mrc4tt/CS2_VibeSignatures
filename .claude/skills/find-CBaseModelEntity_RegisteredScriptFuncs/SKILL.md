...
description: |
  ...
  CBaseModelEntity_RegisteredScriptFuncs in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseModelEntity_RegisteredScriptFuncs, CBaseModelEntity_RegisteredScriptFuncs
disable-model-invocation: true
---

# Find CBaseModelEntity_RegisteredScriptFuncs

Target: `CBaseModelEntity_RegisteredScriptFuncs` (func) in the module loaded in THIS session.
...
Write `CBaseModelEntity_RegisteredScriptFuncs.{platform}.yaml` with EXACTLY these fields:
