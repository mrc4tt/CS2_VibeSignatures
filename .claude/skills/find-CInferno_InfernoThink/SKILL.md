...
description: |
  ...
  CInferno_InfernoThink in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInferno_InfernoThink, CInferno_InfernoThink
disable-model-invocation: true
---

# Find CInferno_InfernoThink

Target: `CInferno_InfernoThink` (func) in the module loaded in THIS session.
