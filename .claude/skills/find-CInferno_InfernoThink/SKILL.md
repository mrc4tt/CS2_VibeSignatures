...
description: |
  Agent fallback for CInferno_InfernoThink (auto-generated, category: func). Locate
  CInferno::InfernoThink in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInferno_InfernoThink, CInferno::InfernoThink
disable-model-invocation: true
---

# Find CInferno_InfernoThink

Target: `CInferno::InfernoThink` (func) in the module loaded in THIS session.
...
Write `CInferno_InfernoThink.{platform}.yaml` with EXACTLY these fields:
