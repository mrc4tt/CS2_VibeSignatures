...
description: |
  ...
  CEngineServiceMgr_Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_Shutdown, CEngineServiceMgr_Shutdown
disable-model-invocation: true
---

# Find CEngineServiceMgr_Shutdown

Target: `CEngineServiceMgr_Shutdown` (vfunc) in the module loaded in THIS session.
