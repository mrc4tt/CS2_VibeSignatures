...
description: |
  Agent fallback for CEngineServiceMgr_Shutdown (auto-generated, category: vfunc). Locate
  CEngineServiceMgr::Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_Shutdown, CEngineServiceMgr::Shutdown
disable-model-invocation: true
---

# Find CEngineServiceMgr_Shutdown

Target: `CEngineServiceMgr::Shutdown` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_Shutdown.{platform}.yaml` with EXACTLY these fields:
