...
description: |
  Agent fallback for CLoadingSpawnGroup_CreateEntityToSpawn (auto-generated, category: vfunc). Locate
  CLoadingSpawnGroup::CreateEntityToSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoadingSpawnGroup_CreateEntityToSpawn, CLoadingSpawnGroup::CreateEntityToSpawn
disable-model-invocation: true
---

# Find CLoadingSpawnGroup_CreateEntityToSpawn

Target: `CLoadingSpawnGroup::CreateEntityToSpawn` (vfunc) in the module loaded in THIS session.
...
Write `CLoadingSpawnGroup_CreateEntityToSpawn.{platform}.yaml` with EXACTLY these fields:
