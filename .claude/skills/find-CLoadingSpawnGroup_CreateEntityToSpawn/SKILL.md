...
description: |
  ...
  CLoadingSpawnGroup_CreateEntityToSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoadingSpawnGroup_CreateEntityToSpawn, CLoadingSpawnGroup_CreateEntityToSpawn
disable-model-invocation: true
---

# Find CLoadingSpawnGroup_CreateEntityToSpawn

Target: `CLoadingSpawnGroup_CreateEntityToSpawn` (vfunc) in the module loaded in THIS session.
