...
description: |
  ...
  CBaseCombatCharacter_OnKilled in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseCombatCharacter_OnKilled, CBaseCombatCharacter_OnKilled
disable-model-invocation: true
---

# Find CBaseCombatCharacter_OnKilled

Target: `CBaseCombatCharacter_OnKilled` (func) in the module loaded in THIS session.
