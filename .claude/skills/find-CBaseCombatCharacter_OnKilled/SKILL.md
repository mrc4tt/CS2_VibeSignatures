...
description: |
  ...
  CBaseCombatCharacter::OnKilled in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseCombatCharacter_OnKilled, CBaseCombatCharacter::OnKilled
disable-model-invocation: true
---

# Find CBaseCombatCharacter_OnKilled

Target: `CBaseCombatCharacter::OnKilled` (func) in the module loaded in THIS session.
...
Write `CBaseCombatCharacter_OnKilled.{platform}.yaml` with EXACTLY these fields:
