...
description: |
  ...
  CSource2Server_Init in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Init, CSource2Server_Init
disable-model-invocation: true
---

# Find CSource2Server_Init

Target: `CSource2Server_Init` (vfunc) in the module loaded in THIS session.
