...
description: |
  Agent fallback for CNetworkGameServer_Init (auto-generated, category: vfunc). Locate
  CNetworkGameServer::Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_Init, CNetworkGameServer::Init
disable-model-invocation: true
---

# Find CNetworkGameServer_Init

Target: `CNetworkGameServer::Init` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_Init.{platform}.yaml` with EXACTLY these fields:
