...
description: |
  ...
  CNetworkGameServer_Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_Init, CNetworkGameServer_Init
disable-model-invocation: true
---

# Find CNetworkGameServer_Init

Target: `CNetworkGameServer_Init` (vfunc) in the module loaded in THIS session.
