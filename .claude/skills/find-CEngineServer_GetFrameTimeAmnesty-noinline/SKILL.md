...
description: |
  ...
  CEngineServer_GetFrameTimeAmnesty-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetFrameTimeAmnesty-noinline, CEngineServer_GetFrameTimeAmnesty-noinline
disable-model-invocation: true
---

# Find CEngineServer_GetFrameTimeAmnesty-noinline

Target: `CEngineServer_GetFrameTimeAmnesty-noinline` (vfunc) in the module loaded in THIS session.
