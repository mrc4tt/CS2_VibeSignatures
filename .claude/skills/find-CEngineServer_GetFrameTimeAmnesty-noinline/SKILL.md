---
name: find-CEngineServer_GetFrameTimeAmnesty-noinline
description: |
  Agent fallback for CEngineServer_GetFrameTimeAmnesty-noinline (auto-generated, category: vfunc). Locate
  CEngineServer::GetFrameTimeAmnesty in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetFrameTimeAmnesty-noinline, CEngineServer::GetFrameTimeAmnesty
disable-model-invocation: true
---

# Find CEngineServer_GetFrameTimeAmnesty-noinline

Target: `CEngineServer::GetFrameTimeAmnesty` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_GetFrameTimeAmnesty.{platform}.yaml` with EXACTLY these fields:
