...
description: |
  Agent fallback for ClientPutInServer (auto-generated, category: func). Locate
  ClientPutInServer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ClientPutInServer, ClientPutInServer
disable-model-invocation: true
---

# Find ClientPutInServer

Target: `ClientPutInServer` (func) in the module loaded in THIS session.
...
Write `ClientPutInServer.{platform}.yaml` with EXACTLY these fields:
