...
description: |
  Agent fallback for CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded (auto-generated, category: vfunc). Locate
  CGameResourceService::PrecacheEntitiesAndConfirmResourcesAreLoaded in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded, CGameResourceService::PrecacheEntitiesAndConfirmResourcesAreLoaded
disable-model-invocation: true
---

# Find CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded

Target: `CGameResourceService::PrecacheEntitiesAndConfirmResourcesAreLoaded` (vfunc) in the module loaded in THIS session.
...
Write `CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded.{platform}.yaml` with EXACTLY these fields:
