...
description: |
  ...
  CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded, CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded
disable-model-invocation: true
---

# Find CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded

Target: `CGameResourceService_PrecacheEntitiesAndConfirmResourcesAreLoaded` (vfunc) in the module loaded in THIS session.
