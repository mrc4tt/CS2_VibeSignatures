...
description: |
  ...
  CEngineServer_ClientPrintf in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ClientPrintf, CEngineServer_ClientPrintf
disable-model-invocation: true
---

# Find CEngineServer_ClientPrintf

Target: `CEngineServer_ClientPrintf` (vfunc) in the module loaded in THIS session.
