...
description: |
  Agent fallback for CEngineServer_ClientPrintf (auto-generated, category: vfunc). Locate
  ...
  Trigger: CEngineServer_ClientPrintf, CEngineServer::ClientPrintf
disable-model-invocation: true
---

# Find CEngineServer_ClientPrintf
