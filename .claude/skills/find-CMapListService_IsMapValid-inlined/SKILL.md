...
description: |
  ...
  CMapListService_IsMapValid-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMapListService_IsMapValid-inlined, CMapListService_IsMapValid-inlined
disable-model-invocation: true
---

# Find CMapListService_IsMapValid-inlined

Target: `CMapListService_IsMapValid-inlined` (vfunc) in the module loaded in THIS session.
