...
description: |
  ...
  CCSPlayerPawn_OnSwitchWeapons in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_OnSwitchWeapons, CCSPlayerPawn_OnSwitchWeapons
disable-model-invocation: true
---

# Find CCSPlayerPawn_OnSwitchWeapons

Target: `CCSPlayerPawn_OnSwitchWeapons` (func) in the module loaded in THIS session.
