...
description: |
  ...
  CCSPlayerPawn::OnSwitchWeapons in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_OnSwitchWeapons, CCSPlayerPawn::OnSwitchWeapons
disable-model-invocation: true
---

# Find CCSPlayerPawn_OnSwitchWeapons

Target: `CCSPlayerPawn::OnSwitchWeapons` (func) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_OnSwitchWeapons.{platform}.yaml` with EXACTLY these fields:
