...
description: |
  ...
  CNetworkGameServer_PrepareForAssetLoad in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_PrepareForAssetLoad, CNetworkGameServer_PrepareForAssetLoad
disable-model-invocation: true
---

# Find CNetworkGameServer_PrepareForAssetLoad

Target: `CNetworkGameServer_PrepareForAssetLoad` (vfunc) in the module loaded in THIS session.
