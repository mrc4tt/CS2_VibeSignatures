...
description: |
  Agent fallback for CNetworkGameServer_PrepareForAssetLoad (auto-generated, category: vfunc). Locate
  CNetworkGameServer::PrepareForAssetLoad in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_PrepareForAssetLoad, CNetworkGameServer::PrepareForAssetLoad
disable-model-invocation: true
---

# Find CNetworkGameServer_PrepareForAssetLoad

Target: `CNetworkGameServer::PrepareForAssetLoad` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_PrepareForAssetLoad.{platform}.yaml` with EXACTLY these fields:
