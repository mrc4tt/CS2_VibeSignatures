...
description: |
  ...
  CLoopTypeBase_FrameUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_FrameUpdate, CLoopTypeBase_FrameUpdate
disable-model-invocation: true
---

# Find CLoopTypeBase_FrameUpdate

Target: `CLoopTypeBase_FrameUpdate` (vfunc) in the module loaded in THIS session.
