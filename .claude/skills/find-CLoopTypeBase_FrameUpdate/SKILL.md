...
description: |
  Agent fallback for CLoopTypeBase_FrameUpdate (auto-generated, category: vfunc). Locate
  CLoopTypeBase::FrameUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_FrameUpdate, CLoopTypeBase::FrameUpdate
disable-model-invocation: true
---

# Find CLoopTypeBase_FrameUpdate

Target: `CLoopTypeBase::FrameUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeBase_FrameUpdate.{platform}.yaml` with EXACTLY these fields:
