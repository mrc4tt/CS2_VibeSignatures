...
description: |
  Agent fallback for IAppSystem_Shutdown (auto-generated, category: vfunc). Locate
  IAppSystem::Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IAppSystem_Shutdown, IAppSystem::Shutdown
disable-model-invocation: true
---

# Find IAppSystem_Shutdown

Target: `IAppSystem::Shutdown` (vfunc) in the module loaded in THIS session.
...
Write `IAppSystem_Shutdown.{platform}.yaml` with EXACTLY these fields:
