...
description: |
  ...
  IAppSystem_Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IAppSystem_Shutdown, IAppSystem_Shutdown
disable-model-invocation: true
---

# Find IAppSystem_Shutdown

Target: `IAppSystem_Shutdown` (vfunc) in the module loaded in THIS session.
