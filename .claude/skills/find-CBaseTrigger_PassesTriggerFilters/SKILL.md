...
description: |
  ...
  CBaseTrigger_PassesTriggerFilters in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseTrigger_PassesTriggerFilters, CBaseTrigger_PassesTriggerFilters
disable-model-invocation: true
---

# Find CBaseTrigger_PassesTriggerFilters

Target: `CBaseTrigger_PassesTriggerFilters` (vfunc) in the module loaded in THIS session.
