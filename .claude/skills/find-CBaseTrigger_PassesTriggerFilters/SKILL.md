...
description: |
  Agent fallback for CBaseTrigger_PassesTriggerFilters (auto-generated, category: vfunc). Locate
  CBaseTrigger::PassesTriggerFilters in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseTrigger_PassesTriggerFilters, CBaseTrigger::PassesTriggerFilters
disable-model-invocation: true
---

# Find CBaseTrigger_PassesTriggerFilters

Target: `CBaseTrigger::PassesTriggerFilters` (vfunc) in the module loaded in THIS session.
...
Write `CBaseTrigger_PassesTriggerFilters.{platform}.yaml` with EXACTLY these fields:
