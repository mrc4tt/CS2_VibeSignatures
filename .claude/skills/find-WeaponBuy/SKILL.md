...
name: find-WeaponBuy
description: |
  Agent fallback for WeaponBuy (auto-generated, category: func). Locate
  WeaponBuy in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: WeaponBuy, WeaponBuy
disable-model-invocation: true
---

# Find WeaponBuy

Target: `WeaponBuy` (func) in the module loaded in THIS session.
...
Write `WeaponBuy.{platform}.yaml` with EXACTLY these fields:
