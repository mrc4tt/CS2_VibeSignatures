...
description: |
  ...
  INetworkMessages_RegisterSchemaTypeOverride in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_RegisterSchemaTypeOverride, INetworkMessages_RegisterSchemaTypeOverride
disable-model-invocation: true
---

# Find INetworkMessages_RegisterSchemaTypeOverride

Target: `INetworkMessages_RegisterSchemaTypeOverride` (vfunc) in the module loaded in THIS session.
