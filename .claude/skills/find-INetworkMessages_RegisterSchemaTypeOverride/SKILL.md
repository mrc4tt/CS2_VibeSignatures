...
description: |
  Agent fallback for INetworkMessages_RegisterSchemaTypeOverride (auto-generated, category: vfunc). Locate
  INetworkMessages::RegisterSchemaTypeOverride in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_RegisterSchemaTypeOverride, INetworkMessages::RegisterSchemaTypeOverride
disable-model-invocation: true
---

# Find INetworkMessages_RegisterSchemaTypeOverride

Target: `INetworkMessages::RegisterSchemaTypeOverride` (vfunc) in the module loaded in THIS session.
...
Write `INetworkMessages_RegisterSchemaTypeOverride.{platform}.yaml` with EXACTLY these fields:
