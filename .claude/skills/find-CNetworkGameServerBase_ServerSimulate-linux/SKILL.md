...
description: |
  ...
  CNetworkGameServerBase_ServerSimulate-linux in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerSimulate-linux, CNetworkGameServerBase_ServerSimulate-linux
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerSimulate-linux

Target: `CNetworkGameServerBase_ServerSimulate-linux` (vfunc) in the module loaded in THIS session.
