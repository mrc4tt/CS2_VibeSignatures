...
description: |
  ...
  SetGroundEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_SetGroundEntity, SetGroundEntity
disable-model-invocation: true
---

# Find CBaseEntity_SetGroundEntity

Target: `SetGroundEntity` (func) in the module loaded in THIS session.
...
Write `CBaseEntity_SetGroundEntity.{platform}.yaml` with EXACTLY these fields:
