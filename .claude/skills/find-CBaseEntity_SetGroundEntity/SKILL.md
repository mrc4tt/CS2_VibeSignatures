...
description: |
  ...
  CBaseEntity_SetGroundEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_SetGroundEntity, CBaseEntity_SetGroundEntity
disable-model-invocation: true
---

# Find CBaseEntity_SetGroundEntity

Target: `CBaseEntity_SetGroundEntity` (func) in the module loaded in THIS session.
