...
description: |
  ...
  CBaseEntity_Use in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_Use, CBaseEntity_Use
disable-model-invocation: true
---

# Find CBaseEntity_Use

Target: `CBaseEntity_Use` (vfunc) in the module loaded in THIS session.
