...
description: |
  Agent fallback for CBaseEntity_Use (auto-generated, category: vfunc). Locate
  CBaseEntity::Use in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_Use, CBaseEntity::Use
disable-model-invocation: true
---

# Find CBaseEntity_Use

Target: `CBaseEntity::Use` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_Use.{platform}.yaml` with EXACTLY these fields:
