...
description: |
  Agent fallback for CEngineServiceMgr_SwitchToLoop (auto-generated, category: vfunc). Locate
  CEngineServiceMgr::SwitchToLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_SwitchToLoop, CEngineServiceMgr::SwitchToLoop
disable-model-invocation: true
---

# Find CEngineServiceMgr_SwitchToLoop

Target: `CEngineServiceMgr::SwitchToLoop` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_SwitchToLoop.{platform}.yaml` with EXACTLY these fields:
