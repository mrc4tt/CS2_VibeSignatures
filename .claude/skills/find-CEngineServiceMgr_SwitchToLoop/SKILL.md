...
description: |
  ...
  CEngineServiceMgr_SwitchToLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_SwitchToLoop, CEngineServiceMgr_SwitchToLoop
disable-model-invocation: true
---

# Find CEngineServiceMgr_SwitchToLoop

Target: `CEngineServiceMgr_SwitchToLoop` (vfunc) in the module loaded in THIS session.
