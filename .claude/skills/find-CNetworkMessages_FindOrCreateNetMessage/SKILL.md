...
description: |
  Agent fallback for CNetworkMessages_FindOrCreateNetMessage (auto-generated, category: vfunc). Locate
  CNetworkMessages::FindOrCreateNetMessage in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_FindOrCreateNetMessage, CNetworkMessages::FindOrCreateNetMessage
disable-model-invocation: true
---

# Find CNetworkMessages_FindOrCreateNetMessage

Target: `CNetworkMessages::FindOrCreateNetMessage` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_FindOrCreateNetMessage.{platform}.yaml` with EXACTLY these fields:
