...
description: |
  ...
  CNetworkMessages_FindOrCreateNetMessage in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_FindOrCreateNetMessage, CNetworkMessages_FindOrCreateNetMessage
disable-model-invocation: true
---

# Find CNetworkMessages_FindOrCreateNetMessage

Target: `CNetworkMessages_FindOrCreateNetMessage` (vfunc) in the module loaded in THIS session.
