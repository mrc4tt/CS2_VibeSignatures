...
description: |
  Agent fallback for CL_NET_PrintSummary_CommandHandler (auto-generated, category: func). Locate
  CL_NET_PrintSummary_CommandHandler in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CL_NET_PrintSummary_CommandHandler, CL_NET_PrintSummary_CommandHandler
disable-model-invocation: true
---

# Find CL_NET_PrintSummary_CommandHandler

Target: `CL_NET_PrintSummary_CommandHandler` (func) in the module loaded in THIS session.
...
Write `CL_NET_PrintSummary_CommandHandler.{platform}.yaml` with EXACTLY these fields:
