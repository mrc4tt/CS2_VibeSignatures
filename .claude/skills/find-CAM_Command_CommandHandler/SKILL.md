...
description: |
  ...
  CAM_Command_CommandHandler in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CAM_Command_CommandHandler, CAM_Command_CommandHandler
disable-model-invocation: true
---

# Find CAM_Command_CommandHandler

Target: `CAM_Command_CommandHandler` (func) in the module loaded in THIS session.
...
Write `CAM_Command_CommandHandler.{platform}.yaml` with EXACTLY these fields:
