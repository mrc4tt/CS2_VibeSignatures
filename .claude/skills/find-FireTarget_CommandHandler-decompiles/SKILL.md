...
description: |
  ...
  FireTarget_CommandHandler-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: FireTarget_CommandHandler-decompiles, FireTarget_CommandHandler-decompiles
disable-model-invocation: true
---

# Find FireTarget_CommandHandler-decompiles

Target: `FireTarget_CommandHandler-decompiles` (func) in the module loaded in THIS session.
