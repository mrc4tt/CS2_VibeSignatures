---
name: find-FireTarget_CommandHandler-decompiles
description: |
  Agent fallback for FireTarget_CommandHandler-decompiles (auto-generated, category: func). Locate
  FireTarget_CommandHandler in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: FireTarget_CommandHandler-decompiles, FireTarget_CommandHandler
disable-model-invocation: true
---

# Find FireTarget_CommandHandler-decompiles

Target: `FireTarget_CommandHandler` (func) in the module loaded in THIS session.
...
Write `FireTarget_CommandHandler.{platform}.yaml` with EXACTLY these fields:
