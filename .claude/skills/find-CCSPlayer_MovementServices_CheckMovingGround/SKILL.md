...
description: |
  ...
  CCSPlayer_MovementServices_CheckMovingGround in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_MovementServices_CheckMovingGround, CCSPlayer_MovementServices_CheckMovingGround
disable-model-invocation: true
---

# Find CCSPlayer_MovementServices_CheckMovingGround

Target: `CCSPlayer_MovementServices_CheckMovingGround` (vfunc) in the module loaded in THIS session.
