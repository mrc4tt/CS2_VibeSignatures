...
description: |
  Agent fallback for CDemoPlayer_SetIgnorePacketsForResourceLoading (auto-generated, category: vfunc). Locate
  CDemoPlayer::SetIgnorePacketsForResourceLoading in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_SetIgnorePacketsForResourceLoading, CDemoPlayer::SetIgnorePacketsForResourceLoading
disable-model-invocation: true
---

# Find CDemoPlayer_SetIgnorePacketsForResourceLoading

Target: `CDemoPlayer::SetIgnorePacketsForResourceLoading` (vfunc) in the module loaded in THIS session.
...
Write `CDemoPlayer_SetIgnorePacketsForResourceLoading.{platform}.yaml` with EXACTLY these fields:
