...
description: |
  ...
  CDemoPlayer_SetIgnorePacketsForResourceLoading in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_SetIgnorePacketsForResourceLoading, CDemoPlayer_SetIgnorePacketsForResourceLoading
disable-model-invocation: true
---

# Find CDemoPlayer_SetIgnorePacketsForResourceLoading

Target: `CDemoPlayer_SetIgnorePacketsForResourceLoading` (vfunc) in the module loaded in THIS session.
