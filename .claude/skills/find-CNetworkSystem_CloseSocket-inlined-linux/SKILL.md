...
description: |
  ...
  CNetworkSystem_CloseSocket-inlined-linux in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_CloseSocket-inlined-linux, CNetworkSystem_CloseSocket-inlined-linux
disable-model-invocation: true
---

# Find CNetworkSystem_CloseSocket-inlined-linux

Target: `CNetworkSystem_CloseSocket-inlined-linux` (func) in the module loaded in THIS session.
