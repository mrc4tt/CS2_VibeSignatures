...
description: |
  ...
  CEntityInstance_OnRestore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_OnRestore, CEntityInstance_OnRestore
disable-model-invocation: true
---

# Find CEntityInstance_OnRestore

Target: `CEntityInstance_OnRestore` (vfunc) in the module loaded in THIS session.
