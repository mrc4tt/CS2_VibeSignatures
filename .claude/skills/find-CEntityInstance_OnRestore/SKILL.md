...
description: |
  Agent fallback for CEntityInstance_OnRestore (auto-generated, category: vfunc). Locate
  CEntityInstance::OnRestore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_OnRestore, CEntityInstance::OnRestore
disable-model-invocation: true
---

# Find CEntityInstance_OnRestore

Target: `CEntityInstance::OnRestore` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_OnRestore.{platform}.yaml` with EXACTLY these fields:
