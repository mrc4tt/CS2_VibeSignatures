...
description: |
  ...
  ISource2Server_PreWorldUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ISource2Server_PreWorldUpdate, ISource2Server_PreWorldUpdate
disable-model-invocation: true
---

# Find ISource2Server_PreWorldUpdate

Target: `ISource2Server_PreWorldUpdate` (vfunc) in the module loaded in THIS session.
