...
description: |
  Agent fallback for ISource2Server_PreWorldUpdate (auto-generated, category: vfunc). Locate
  ISource2Server::PreWorldUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ISource2Server_PreWorldUpdate, ISource2Server::PreWorldUpdate
disable-model-invocation: true
---

# Find ISource2Server_PreWorldUpdate

Target: `ISource2Server::PreWorldUpdate` (vfunc) in the module loaded in THIS session.
...
Write `ISource2Server_PreWorldUpdate.{platform}.yaml` with EXACTLY these fields:
