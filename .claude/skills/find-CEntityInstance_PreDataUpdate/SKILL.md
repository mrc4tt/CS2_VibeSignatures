...
description: |
  Agent fallback for CEntityInstance_PreDataUpdate (auto-generated, category: vfunc). Locate
  CEntityInstance::PreDataUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_PreDataUpdate, CEntityInstance::PreDataUpdate
disable-model-invocation: true
---

# Find CEntityInstance_PreDataUpdate

Target: `CEntityInstance::PreDataUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_PreDataUpdate.{platform}.yaml` with EXACTLY these fields:
