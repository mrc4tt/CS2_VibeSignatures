...
description: |
  Agent fallback for CEntityInstance_PreDataUpdate (auto-generated, category: func). Locate
  CEntityInstance_PreDataUpdate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_PreDataUpdate, CEntityInstance_PreDataUpdate
disable-model-invocation: true
---

# Find CEntityInstance_PreDataUpdate

Target: `CEntityInstance_PreDataUpdate` (func) in the module loaded in THIS session.
