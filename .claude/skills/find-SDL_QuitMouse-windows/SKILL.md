...
description: |
  ...
  SDL_QuitMouse-windows in the CS2 SDL3 module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SDL_QuitMouse-windows, SDL_QuitMouse-windows
disable-model-invocation: true
---

# Find SDL_QuitMouse-windows

Target: `SDL_QuitMouse-windows` (func) in the module loaded in THIS session.
