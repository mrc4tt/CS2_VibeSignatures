---
name: find-SDL_QuitMouse-windows
description: |
  Agent fallback for SDL_QuitMouse-windows (auto-generated, category: func). Locate
  SDL_QuitMouse in the CS2 SDL3 module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SDL_QuitMouse-windows, SDL_QuitMouse
disable-model-invocation: true
---

# Find SDL_QuitMouse-windows

Target: `SDL_QuitMouse` (func) in the module loaded in THIS session.
...
Write `SDL_QuitMouse.{platform}.yaml` with EXACTLY these fields:
