...
description: |
  ...
  CEntityInstance_Connect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Connect, CEntityInstance_Connect
disable-model-invocation: true
---

# Find CEntityInstance_Connect

Target: `CEntityInstance_Connect` (vfunc) in the module loaded in THIS session.
