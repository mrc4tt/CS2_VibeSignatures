...
description: |
  Agent fallback for CEntityInstance_Connect (auto-generated, category: vfunc). Locate
  CEntityInstance::Connect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Connect, CEntityInstance::Connect
disable-model-invocation: true
---

# Find CEntityInstance_Connect

Target: `CEntityInstance::Connect` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_Connect.{platform}.yaml` with EXACTLY these fields:
