...
description: |
  Agent fallback for CServerSideClientBase_ProcessClientInfo (auto-generated, category: vfunc). Locate
  CServerSideClientBase::ProcessClientInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessClientInfo, CServerSideClientBase::ProcessClientInfo
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessClientInfo

Target: `CServerSideClientBase::ProcessClientInfo` (vfunc) in the module loaded in THIS session.
...
Write `CServerSideClientBase_ProcessClientInfo.{platform}.yaml` with EXACTLY these fields:
