...
description: |
  ...
  CServerSideClientBase_ProcessClientInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessClientInfo, CServerSideClientBase_ProcessClientInfo
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessClientInfo

Target: `CServerSideClientBase_ProcessClientInfo` (vfunc) in the module loaded in THIS session.
