---
name: find-CServerSideClient_m_Name
description: |
  Locate CServerSideClient::m_Name in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "CServerSideClient::m_Name" (symbol CServerSideClient_m_Name). This is a STRUCT MEMBER OFFSET (schema netvar), not a function. Resolve the
  ...
  Trigger: CServerSideClient_m_Name, CServerSideClient::m_Name
disable-model-invocation: true
---

# Find CServerSideClient_m_Name

Target: `CServerSideClient::m_Name` (structmember) in the CS2 server module.
