---
name: find-SendViolationReport-decompiles
description: |
  Agent fallback for SendViolationReport-decompiles (auto-generated, category: func). Locate
  SendViolationReport in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SendViolationReport-decompiles, SendViolationReport
disable-model-invocation: true
---

# Find SendViolationReport-decompiles

Target: `SendViolationReport` (func) in the module loaded in THIS session.
...
Write `SendViolationReport.{platform}.yaml` with EXACTLY these fields:
