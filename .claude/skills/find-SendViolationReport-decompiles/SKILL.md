...
description: |
  ...
  SendViolationReport-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SendViolationReport-decompiles, SendViolationReport-decompiles
disable-model-invocation: true
---

# Find SendViolationReport-decompiles

Target: `SendViolationReport-decompiles` (func) in the module loaded in THIS session.
