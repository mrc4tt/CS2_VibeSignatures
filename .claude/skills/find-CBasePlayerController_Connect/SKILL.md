...
description: |
  Agent fallback for CBasePlayerController_Connect (auto-generated, category: vfunc). Locate
  CBasePlayerController::Connect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_Connect, CBasePlayerController::Connect
disable-model-invocation: true
---

# Find CBasePlayerController_Connect

Target: `CBasePlayerController::Connect` (vfunc) in the module loaded in THIS session.
...
Write `CBasePlayerController_Connect.{platform}.yaml` with EXACTLY these fields:
