...
description: |
  ...
  CBasePlayerController_Connect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_Connect, CBasePlayerController_Connect
disable-model-invocation: true
---

# Find CBasePlayerController_Connect

Target: `CBasePlayerController_Connect` (vfunc) in the module loaded in THIS session.
