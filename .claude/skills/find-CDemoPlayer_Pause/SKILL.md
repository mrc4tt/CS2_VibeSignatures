...
description: |
  ...
  CDemoPlayer_Pause in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_Pause, CDemoPlayer_Pause
disable-model-invocation: true
---

# Find CDemoPlayer_Pause

Target: `CDemoPlayer_Pause` (vfunc) in the module loaded in THIS session.
