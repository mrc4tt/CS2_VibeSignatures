...
description: |
  ...
  CServerSideClientBase_ProcessTick in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessTick, CServerSideClientBase_ProcessTick
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessTick

Target: `CServerSideClientBase_ProcessTick` (vfunc) in the module loaded in THIS session.
