...
description: |
  Agent fallback for CServerSideClientBase_ProcessTick (auto-generated, category: vfunc). Locate
  CServerSideClientBase::ProcessTick in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessTick, CServerSideClientBase::ProcessTick
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessTick

Target: `CServerSideClientBase::ProcessTick` (vfunc) in the module loaded in THIS session.
...
Write `CServerSideClientBase_ProcessTick.{platform}.yaml` with EXACTLY these fields:
