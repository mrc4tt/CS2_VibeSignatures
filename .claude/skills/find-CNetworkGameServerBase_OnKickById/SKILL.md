...
description: |
  Agent fallback for CNetworkGameServerBase_OnKickById (auto-generated, category: func). Locate
  CNetworkGameServerBase::OnKickById in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_OnKickById, CNetworkGameServerBase::OnKickById
disable-model-invocation: true
---

# Find CNetworkGameServerBase_OnKickById

Target: `CNetworkGameServerBase::OnKickById` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_OnKickById.{platform}.yaml` with EXACTLY these fields:
