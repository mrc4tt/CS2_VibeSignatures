...
description: |
  ...
  CNetworkGameServerBase_OnKickById in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_OnKickById, CNetworkGameServerBase_OnKickById
disable-model-invocation: true
---

# Find CNetworkGameServerBase_OnKickById

Target: `CNetworkGameServerBase_OnKickById` (func) in the module loaded in THIS session.
