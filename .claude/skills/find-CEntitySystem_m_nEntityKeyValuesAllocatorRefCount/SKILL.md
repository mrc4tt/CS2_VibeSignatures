...
description: |
  Agent fallback for CEntitySystem_m_nEntityKeyValuesAllocatorRefCount (auto-generated, category: structmember). Locate
  CEntitySystem::m_nEntityKeyValuesAllocatorRefCount in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_nEntityKeyValuesAllocatorRefCount, CEntitySystem::m_nEntityKeyValuesAllocatorRefCount
disable-model-invocation: true
---

# Find CEntitySystem_m_nEntityKeyValuesAllocatorRefCount

Target: `CEntitySystem::m_nEntityKeyValuesAllocatorRefCount` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_nEntityKeyValuesAllocatorRefCount.{platform}.yaml` with EXACTLY these fields:
