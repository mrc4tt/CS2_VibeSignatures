---
name: find-INetworkGameServer_GetSpawnGroupLoadingStatus
description: |
  Agent fallback for INetworkGameServer_GetSpawnGroupLoadingStatus (auto-generated, category: vfunc). Locate
  INetworkGameServer::GetSpawnGroupLoadingStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetSpawnGroupLoadingStatus, INetworkGameServer::GetSpawnGroupLoadingStatus
disable-model-invocation: true
---

# Find INetworkGameServer_GetSpawnGroupLoadingStatus

Target: `INetworkGameServer::GetSpawnGroupLoadingStatus` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_GetSpawnGroupLoadingStatus.{platform}.yaml` with EXACTLY these fields:
