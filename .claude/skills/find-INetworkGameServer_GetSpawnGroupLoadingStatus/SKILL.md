...
description: |
  ...
  INetworkGameServer_GetSpawnGroupLoadingStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetSpawnGroupLoadingStatus, INetworkGameServer_GetSpawnGroupLoadingStatus
disable-model-invocation: true
---

# Find INetworkGameServer_GetSpawnGroupLoadingStatus

Target: `INetworkGameServer_GetSpawnGroupLoadingStatus` (vfunc) in the module loaded in THIS session.
