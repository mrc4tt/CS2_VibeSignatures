...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_SpawnGroupInit (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::SpawnGroupInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupInit, CSpawnGroupMgrGameSystem::SpawnGroupInit
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupInit

Target: `CSpawnGroupMgrGameSystem::SpawnGroupInit` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_SpawnGroupInit.{platform}.yaml` with EXACTLY these fields:
