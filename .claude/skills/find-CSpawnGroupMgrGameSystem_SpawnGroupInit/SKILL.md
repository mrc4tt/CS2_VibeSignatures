...
description: |
  ...
  CSpawnGroupMgrGameSystem_SpawnGroupInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupInit, CSpawnGroupMgrGameSystem_SpawnGroupInit
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupInit

Target: `CSpawnGroupMgrGameSystem_SpawnGroupInit` (vfunc) in the module loaded in THIS session.
