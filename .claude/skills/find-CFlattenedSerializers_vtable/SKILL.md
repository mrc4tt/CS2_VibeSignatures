...
description: |
  Agent fallback for CFlattenedSerializers_vtable (auto-generated, category: func). Locate
  CFlattenedSerializers_vtable in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlattenedSerializers_vtable, CFlattenedSerializers_vtable
disable-model-invocation: true
---

# Find CFlattenedSerializers_vtable

Target: `CFlattenedSerializers_vtable` (func) in the module loaded in THIS session.
...
Write `CFlattenedSerializers_vtable.{platform}.yaml` with EXACTLY these fields:
