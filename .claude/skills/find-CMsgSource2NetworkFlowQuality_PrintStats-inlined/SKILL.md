...
description: |
  ...
  CMsgSource2NetworkFlowQuality_PrintStats-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMsgSource2NetworkFlowQuality_PrintStats-inlined, CMsgSource2NetworkFlowQuality_PrintStats-inlined
disable-model-invocation: true
---

# Find CMsgSource2NetworkFlowQuality_PrintStats-inlined

Target: `CMsgSource2NetworkFlowQuality_PrintStats-inlined` (func) in the module loaded in THIS session.
