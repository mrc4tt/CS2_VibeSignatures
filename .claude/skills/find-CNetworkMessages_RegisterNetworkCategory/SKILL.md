...
description: |
  Agent fallback for CNetworkMessages_RegisterNetworkCategory (auto-generated, category: vfunc). Locate
  CNetworkMessages::RegisterNetworkCategory in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_RegisterNetworkCategory, CNetworkMessages::RegisterNetworkCategory
disable-model-invocation: true
---

# Find CNetworkMessages_RegisterNetworkCategory

Target: `CNetworkMessages::RegisterNetworkCategory` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_RegisterNetworkCategory.{platform}.yaml` with EXACTLY these fields:
