...
description: |
  ...
  CNetworkMessages_RegisterNetworkCategory in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_RegisterNetworkCategory, CNetworkMessages_RegisterNetworkCategory
disable-model-invocation: true
---

# Find CNetworkMessages_RegisterNetworkCategory

Target: `CNetworkMessages_RegisterNetworkCategory` (vfunc) in the module loaded in THIS session.
