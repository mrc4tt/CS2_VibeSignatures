...
description: |
  Agent fallback for CNetworkServerSpawnGroupCreatePrerequisites_Init (auto-generated, category: func). Locate
  CNetworkServerSpawnGroupCreatePrerequisites::Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerSpawnGroupCreatePrerequisites_Init, CNetworkServerSpawnGroupCreatePrerequisites::Init
disable-model-invocation: true
---

# Find CNetworkServerSpawnGroupCreatePrerequisites_Init

Target: `CNetworkServerSpawnGroupCreatePrerequisites::Init` (func) in the module loaded in THIS session.
...
Write `CNetworkServerSpawnGroupCreatePrerequisites_Init.{platform}.yaml` with EXACTLY these fields:
