...
description: |
  ...
  CNetworkServerSpawnGroupCreatePrerequisites_Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerSpawnGroupCreatePrerequisites_Init, CNetworkServerSpawnGroupCreatePrerequisites_Init
disable-model-invocation: true
---

# Find CNetworkServerSpawnGroupCreatePrerequisites_Init

Target: `CNetworkServerSpawnGroupCreatePrerequisites_Init` (func) in the module loaded in THIS session.
