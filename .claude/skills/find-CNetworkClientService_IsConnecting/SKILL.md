---
name: find-CNetworkClientService_IsConnecting
description: |
  Agent fallback for CNetworkClientService_IsConnecting (auto-generated, category: func). Locate
  CNetworkClientService_IsConnecting in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_IsConnecting, CNetworkClientService_IsConnecting
disable-model-invocation: true
---

# Find CNetworkClientService_IsConnecting

Target: `CNetworkClientService_IsConnecting` (func) in the module loaded in THIS session.
