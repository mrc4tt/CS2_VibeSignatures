---
name: find-CCSPlayer_WeaponServices_PickupItem-decompiles
description: |
  Agent fallback for CCSPlayer_WeaponServices_PickupItem-decompiles (auto-generated, category: vfunc). Locate
  CCSPlayer_WeaponServices::PickupItem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_WeaponServices_PickupItem-decompiles, CCSPlayer_WeaponServices::PickupItem
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_PickupItem-decompiles

Target: `CCSPlayer_WeaponServices::PickupItem` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayer_WeaponServices_PickupItem.{platform}.yaml` with EXACTLY these fields:
