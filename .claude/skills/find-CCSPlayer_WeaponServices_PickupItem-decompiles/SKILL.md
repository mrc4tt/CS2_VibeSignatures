...
description: |
  ...
  CCSPlayer_WeaponServices_PickupItem-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_WeaponServices_PickupItem-decompiles, CCSPlayer_WeaponServices_PickupItem-decompiles
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_PickupItem-decompiles

Target: `CCSPlayer_WeaponServices_PickupItem-decompiles` (vfunc) in the module loaded in THIS session.
