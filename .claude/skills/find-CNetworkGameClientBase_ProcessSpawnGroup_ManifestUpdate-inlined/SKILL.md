...
description: |
  ...
  CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-inlined, CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-inlined
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-inlined

Target: `CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-inlined` (vfunc) in the module loaded in THIS session.
