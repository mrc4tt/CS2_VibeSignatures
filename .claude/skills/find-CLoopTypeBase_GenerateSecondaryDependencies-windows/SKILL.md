---
name: find-CLoopTypeBase_GenerateSecondaryDependencies-windows
description: |
  Agent fallback for CLoopTypeBase_GenerateSecondaryDependencies-windows (auto-generated, category: func). Locate
  CLoopTypeBase::GenerateSecondaryDependencies in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_GenerateSecondaryDependencies-windows, CLoopTypeBase::GenerateSecondaryDependencies
disable-model-invocation: true
---

# Find CLoopTypeBase_GenerateSecondaryDependencies-windows

Target: `CLoopTypeBase::GenerateSecondaryDependencies` (func) in the module loaded in THIS session.
...
Write `CLoopTypeBase_GenerateSecondaryDependencies.{platform}.yaml` with EXACTLY these fields:
