...
description: |
  ...
  CLoopTypeBase_GenerateSecondaryDependencies-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_GenerateSecondaryDependencies-windows, CLoopTypeBase_GenerateSecondaryDependencies-windows
disable-model-invocation: true
---

# Find CLoopTypeBase_GenerateSecondaryDependencies-windows

Target: `CLoopTypeBase_GenerateSecondaryDependencies-windows` (func) in the module loaded in THIS session.
