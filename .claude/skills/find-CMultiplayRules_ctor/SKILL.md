...
description: |
  ...
  CMultiplayRules_ctor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMultiplayRules_ctor, CMultiplayRules_ctor
disable-model-invocation: true
---

# Find CMultiplayRules_ctor

Target: `CMultiplayRules_ctor` (func) in the module loaded in THIS session.
