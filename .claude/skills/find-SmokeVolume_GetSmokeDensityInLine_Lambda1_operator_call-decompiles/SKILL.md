---
name: find-SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles
description: |
  Agent fallback for SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles (auto-generated, category: func). Locate
  SmokeVolume::GetSmokeDensityInLine::<lambda_1>::operator() in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles, SmokeVolume::GetSmokeDensityInLine::<lambda_1>::operator()
disable-model-invocation: true
---

# Find SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles

Target: `SmokeVolume::GetSmokeDensityInLine::<lambda_1>::operator()` (func) in the module loaded in THIS session.
...
Write `SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call.{platform}.yaml` with EXACTLY these fields:
