...
description: |
  ...
  SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles, SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles
disable-model-invocation: true
---

# Find SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles

Target: `SmokeVolume_GetSmokeDensityInLine_Lambda1_operator_call-decompiles` (func) in the module loaded in THIS session.
