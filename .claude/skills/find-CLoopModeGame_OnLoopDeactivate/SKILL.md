...
description: |
  ...
  CLoopModeGame_OnLoopDeactivate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnLoopDeactivate, CLoopModeGame_OnLoopDeactivate
disable-model-invocation: true
---

# Find CLoopModeGame_OnLoopDeactivate

Target: `CLoopModeGame_OnLoopDeactivate` (vfunc) in the module loaded in THIS session.
