...
description: |
  Agent fallback for CLoopModeGame_OnLoopDeactivate (auto-generated, category: vfunc). Locate
  CLoopModeGame::OnLoopDeactivate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnLoopDeactivate, CLoopModeGame::OnLoopDeactivate
disable-model-invocation: true
---

# Find CLoopModeGame_OnLoopDeactivate

Target: `CLoopModeGame::OnLoopDeactivate` (vfunc) in the module loaded in THIS session.
...
Write `CLoopModeGame_OnLoopDeactivate.{platform}.yaml` with EXACTLY these fields:
