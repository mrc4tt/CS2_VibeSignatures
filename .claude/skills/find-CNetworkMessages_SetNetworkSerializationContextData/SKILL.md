...
description: |
  Agent fallback for CNetworkMessages_SetNetworkSerializationContextData (auto-generated, category: func). Locate
  CNetworkMessages_SetNetworkSerializationContextData in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_SetNetworkSerializationContextData, CNetworkMessages_SetNetworkSerializationContextData
disable-model-invocation: true
---

# Find CNetworkMessages_SetNetworkSerializationContextData

Target: `CNetworkMessages_SetNetworkSerializationContextData` (func) in the module loaded in THIS session.
...
Write `CNetworkMessages_SetNetworkSerializationContextData.{platform}.yaml` with EXACTLY these fields:
