...
description: |
  Agent fallback for CEntityKeyValuesAllocator_GetTempBuffer (auto-generated, category: func). Locate
  CEntityKeyValuesAllocator::GetTempBuffer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityKeyValuesAllocator_GetTempBuffer, CEntityKeyValuesAllocator::GetTempBuffer
disable-model-invocation: true
---

# Find CEntityKeyValuesAllocator_GetTempBuffer

Target: `CEntityKeyValuesAllocator::GetTempBuffer` (func) in the module loaded in THIS session.
...
Write `CEntityKeyValuesAllocator_GetTempBuffer.{platform}.yaml` with EXACTLY these fields:
