...
description: |
  ...
  CEntityKeyValuesAllocator_GetTempBuffer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityKeyValuesAllocator_GetTempBuffer, CEntityKeyValuesAllocator_GetTempBuffer
disable-model-invocation: true
---

# Find CEntityKeyValuesAllocator_GetTempBuffer

Target: `CEntityKeyValuesAllocator_GetTempBuffer` (func) in the module loaded in THIS session.
