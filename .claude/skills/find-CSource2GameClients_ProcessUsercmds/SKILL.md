...
description: |
  ...
  CSource2GameClients_ProcessUsercmds in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ProcessUsercmds, CSource2GameClients_ProcessUsercmds
disable-model-invocation: true
---

# Find CSource2GameClients_ProcessUsercmds

Target: `CSource2GameClients_ProcessUsercmds` (vfunc) in the module loaded in THIS session.
