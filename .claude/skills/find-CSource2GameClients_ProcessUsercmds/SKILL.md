...
description: |
  Agent fallback for CSource2GameClients_ProcessUsercmds (auto-generated, category: vfunc). Locate
  CSource2GameClients::ProcessUsercmds in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ProcessUsercmds, CSource2GameClients::ProcessUsercmds
disable-model-invocation: true
---

# Find CSource2GameClients_ProcessUsercmds

Target: `CSource2GameClients::ProcessUsercmds` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ProcessUsercmds.{platform}.yaml` with EXACTLY these fields:
