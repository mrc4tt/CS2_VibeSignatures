...
description: |
  ...
  ISource2Server_GetAllServerClasses in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ISource2Server_GetAllServerClasses, ISource2Server_GetAllServerClasses
disable-model-invocation: true
---

# Find ISource2Server_GetAllServerClasses

Target: `ISource2Server_GetAllServerClasses` (vfunc) in the module loaded in THIS session.
