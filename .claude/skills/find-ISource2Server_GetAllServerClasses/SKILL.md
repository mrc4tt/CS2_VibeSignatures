...
description: |
  Agent fallback for ISource2Server_GetAllServerClasses (auto-generated, category: vfunc). Locate
  ISource2Server::GetAllServerClasses in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ISource2Server_GetAllServerClasses, ISource2Server::GetAllServerClasses
disable-model-invocation: true
---

# Find ISource2Server_GetAllServerClasses

Target: `ISource2Server::GetAllServerClasses` (vfunc) in the module loaded in THIS session.
...
Write `ISource2Server_GetAllServerClasses.{platform}.yaml` with EXACTLY these fields:
