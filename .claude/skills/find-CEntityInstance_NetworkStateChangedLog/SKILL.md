...
description: |
  ...
  CEntityInstance_NetworkStateChangedLog in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_NetworkStateChangedLog, CEntityInstance_NetworkStateChangedLog
disable-model-invocation: true
---

# Find CEntityInstance_NetworkStateChangedLog

Target: `CEntityInstance_NetworkStateChangedLog` (vfunc) in the module loaded in THIS session.
