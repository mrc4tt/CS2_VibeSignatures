...
description: |
  Agent fallback for CEntityInstance_NetworkStateChangedLog (auto-generated, category: vfunc). Locate
  CEntityInstance::NetworkStateChangedLog in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_NetworkStateChangedLog, CEntityInstance::NetworkStateChangedLog
disable-model-invocation: true
---

# Find CEntityInstance_NetworkStateChangedLog

Target: `CEntityInstance::NetworkStateChangedLog` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_NetworkStateChangedLog.{platform}.yaml` with EXACTLY these fields:
