---
name: find-CGameResourceService_RegisterEventMap-noinline
description: |
  Agent fallback for CGameResourceService_RegisterEventMap-noinline (auto-generated, category: vfunc). Locate
  CGameResourceService::RegisterEventMap in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_RegisterEventMap-noinline, CGameResourceService::RegisterEventMap
disable-model-invocation: true
---

# Find CGameResourceService_RegisterEventMap-noinline

Target: `CGameResourceService::RegisterEventMap` (vfunc) in the module loaded in THIS session.
...
Write `CGameResourceService_RegisterEventMap.{platform}.yaml` with EXACTLY these fields:
