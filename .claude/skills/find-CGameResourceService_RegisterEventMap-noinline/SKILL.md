...
description: |
  ...
  CGameResourceService_RegisterEventMap-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_RegisterEventMap-noinline, CGameResourceService_RegisterEventMap-noinline
disable-model-invocation: true
---

# Find CGameResourceService_RegisterEventMap-noinline

Target: `CGameResourceService_RegisterEventMap-noinline` (vfunc) in the module loaded in THIS session.
