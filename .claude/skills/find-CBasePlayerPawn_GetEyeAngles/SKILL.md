...
description: |
  ...
  CBasePlayerPawn_GetEyeAngles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_GetEyeAngles, CBasePlayerPawn_GetEyeAngles
disable-model-invocation: true
---

# Find CBasePlayerPawn_GetEyeAngles

Target: `CBasePlayerPawn_GetEyeAngles` (vfunc) in the module loaded in THIS session.
