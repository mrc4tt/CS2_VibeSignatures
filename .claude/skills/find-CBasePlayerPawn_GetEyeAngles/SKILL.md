...
description: |
  Agent fallback for CBasePlayerPawn_GetEyeAngles (auto-generated, category: vfunc). Locate
  CBasePlayerPawn::GetEyeAngles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_GetEyeAngles, CBasePlayerPawn::GetEyeAngles
disable-model-invocation: true
---

# Find CBasePlayerPawn_GetEyeAngles

Target: `CBasePlayerPawn::GetEyeAngles` (vfunc) in the module loaded in THIS session.
...
Write `CBasePlayerPawn_GetEyeAngles.{platform}.yaml` with EXACTLY these fields:
