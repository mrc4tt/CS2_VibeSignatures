...
description: |
  Agent fallback for CNetworkGameServer_ActivateServer (auto-generated, category: vfunc). Locate
  CNetworkGameServer::ActivateServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_ActivateServer, CNetworkGameServer::ActivateServer
disable-model-invocation: true
---

# Find CNetworkGameServer_ActivateServer

Target: `CNetworkGameServer::ActivateServer` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_ActivateServer.{platform}.yaml` with EXACTLY these fields:
