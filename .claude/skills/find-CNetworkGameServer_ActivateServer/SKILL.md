...
description: |
  ...
  CNetworkGameServer_ActivateServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_ActivateServer, CNetworkGameServer_ActivateServer
disable-model-invocation: true
---

# Find CNetworkGameServer_ActivateServer

Target: `CNetworkGameServer_ActivateServer` (vfunc) in the module loaded in THIS session.
