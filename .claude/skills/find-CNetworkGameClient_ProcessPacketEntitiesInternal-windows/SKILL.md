...
description: |
  Agent fallback for CNetworkGameClient_ProcessPacketEntitiesInternal-windows (auto-generated, category: func). Locate
  CNetworkGameClient::ProcessPacketEntitiesInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessPacketEntitiesInternal-windows, CNetworkGameClient::ProcessPacketEntitiesInternal
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessPacketEntitiesInternal-windows

Target: `CNetworkGameClient::ProcessPacketEntitiesInternal` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClient_ProcessPacketEntitiesInternal.{platform}.yaml` with EXACTLY these fields:
