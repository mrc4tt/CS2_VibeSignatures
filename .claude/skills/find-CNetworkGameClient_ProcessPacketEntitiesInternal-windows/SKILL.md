...
description: |
  ...
  CNetworkGameClient_ProcessPacketEntitiesInternal-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessPacketEntitiesInternal-windows, CNetworkGameClient_ProcessPacketEntitiesInternal-windows
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessPacketEntitiesInternal-windows

Target: `CNetworkGameClient_ProcessPacketEntitiesInternal-windows` (func) in the module loaded in THIS session.
