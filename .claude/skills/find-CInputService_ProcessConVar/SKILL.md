---
name: find-CInputService_ProcessConVar
description: |
  Agent fallback for CInputService_ProcessConVar (auto-generated, category: func). Locate
  CInputService::ProcessConVar in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_ProcessConVar, CInputService::ProcessConVar
disable-model-invocation: true
---

# Find CInputService_ProcessConVar

Target: `CInputService::ProcessConVar` (func) in the module loaded in THIS session.
