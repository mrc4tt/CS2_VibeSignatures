...
description: |
  Agent fallback for CEntitySystem_m_nExecuteQueuedDeletionDepth (auto-generated, category: structmember). Locate
  CEntitySystem::m_nExecuteQueuedDeletionDepth in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_nExecuteQueuedDeletionDepth, CEntitySystem::m_nExecuteQueuedDeletionDepth
disable-model-invocation: true
---

# Find CEntitySystem_m_nExecuteQueuedDeletionDepth

Target: `CEntitySystem::m_nExecuteQueuedDeletionDepth` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_nExecuteQueuedDeletionDepth.{platform}.yaml` with EXACTLY these fields:
