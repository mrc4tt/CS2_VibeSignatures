...
description: |
  ...
  CEngineServer_GetSteamUniverse-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetSteamUniverse-windows, CEngineServer_GetSteamUniverse-windows
disable-model-invocation: true
---

# Find CEngineServer_GetSteamUniverse-windows

Target: `CEngineServer_GetSteamUniverse-windows` (vfunc) in the module loaded in THIS session.
