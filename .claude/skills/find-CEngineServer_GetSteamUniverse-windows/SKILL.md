...
description: |
  Agent fallback for CEngineServer_GetSteamUniverse-windows (auto-generated, category: vfunc). Locate
  CEngineServer::GetSteamUniverse in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetSteamUniverse-windows, CEngineServer::GetSteamUniverse
disable-model-invocation: true
---

# Find CEngineServer_GetSteamUniverse-windows

Target: `CEngineServer::GetSteamUniverse` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_GetSteamUniverse.{platform}.yaml` with EXACTLY these fields:
