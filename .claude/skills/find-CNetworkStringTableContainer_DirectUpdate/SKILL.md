---
name: find-CNetworkStringTableContainer_DirectUpdate
description: |
  Agent fallback for CNetworkStringTableContainer_DirectUpdate (auto-generated, category: func). Locate
  CNetworkStringTableContainer_DirectUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkStringTableContainer_DirectUpdate, CNetworkStringTableContainer_DirectUpdate
disable-model-invocation: true
---

# Find CNetworkStringTableContainer_DirectUpdate

Target: `CNetworkStringTableContainer_DirectUpdate` (func) in the module loaded in THIS session.
...
Write `CNetworkStringTableContainer_DirectUpdate.{platform}.yaml` with EXACTLY these fields:
