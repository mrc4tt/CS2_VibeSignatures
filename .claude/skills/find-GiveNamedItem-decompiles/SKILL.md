---
name: find-GiveNamedItem-decompiles
description: |
  Agent fallback for GiveNamedItem-decompiles (auto-generated, category: func). Locate
  GiveNamedItem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GiveNamedItem-decompiles, GiveNamedItem
disable-model-invocation: true
---

# Find GiveNamedItem-decompiles

Target: `GiveNamedItem` (func) in the module loaded in THIS session.
...
Write `GiveNamedItem.{platform}.yaml` with EXACTLY these fields:
