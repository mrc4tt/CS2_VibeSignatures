...
description: |
  ...
  GiveNamedItem-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GiveNamedItem-decompiles, GiveNamedItem-decompiles
disable-model-invocation: true
---

# Find GiveNamedItem-decompiles

Target: `GiveNamedItem-decompiles` (func) in the module loaded in THIS session.
