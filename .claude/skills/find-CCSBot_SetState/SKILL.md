...
description: |
  ...
  CCSBot::SetState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBot_SetState, CCSBot::SetState
disable-model-invocation: true
---

# Find CCSBot_SetState

Target: `CCSBot::SetState` (func) in the module loaded in THIS session.
...
Write `CCSBot_SetState.{platform}.yaml` with EXACTLY these fields:
