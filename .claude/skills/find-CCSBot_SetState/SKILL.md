...
description: |
  ...
  CCSBot_SetState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBot_SetState, CCSBot_SetState
disable-model-invocation: true
---

# Find CCSBot_SetState

Target: `CCSBot_SetState` (func) in the module loaded in THIS session.
