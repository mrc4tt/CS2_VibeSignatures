...
description: |
  Agent fallback for CPlayer_MovementServices_ForceButtonState (auto-generated, category: func). Locate
  CPlayer_MovementServices::ForceButtonState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayer_MovementServices_ForceButtonState, CPlayer_MovementServices::ForceButtonState
disable-model-invocation: true
---

# Find CPlayer_MovementServices_ForceButtonState

Target: `CPlayer_MovementServices::ForceButtonState` (func) in the module loaded in THIS session.
...
Write `CPlayer_MovementServices_ForceButtonState.{platform}.yaml` with EXACTLY these fields:
