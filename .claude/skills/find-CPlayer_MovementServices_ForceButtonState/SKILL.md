...
description: |
  ...
  CPlayer_MovementServices_ForceButtonState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayer_MovementServices_ForceButtonState, CPlayer_MovementServices_ForceButtonState
disable-model-invocation: true
---

# Find CPlayer_MovementServices_ForceButtonState

Target: `CPlayer_MovementServices_ForceButtonState` (func) in the module loaded in THIS session.
