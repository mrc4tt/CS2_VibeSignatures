...
description: |
  Agent fallback for CPhysBox_vtable (auto-generated, category: func). Locate
  CPhysBox_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysBox_vtable, CPhysBox_vtable
disable-model-invocation: true
---

# Find CPhysBox_vtable

Target: `CPhysBox_vtable` (func) in the module loaded in THIS session.
...
Write `CPhysBox_vtable.{platform}.yaml` with EXACTLY these fields:
