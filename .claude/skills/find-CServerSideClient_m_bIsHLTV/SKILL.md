---
name: find-CServerSideClient_m_bIsHLTV
description: |
  Locate CServerSideClient::m_bIsHLTV in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "CServerSideClient::m_bIsHLTV" (symbol CServerSideClient_m_bIsHLTV). This is a STRUCT MEMBER OFFSET (schema netvar), not a function. Resolve the
  ...
  Trigger: CServerSideClient_m_bIsHLTV, CServerSideClient::m_bIsHLTV
disable-model-invocation: true
---

# Find CServerSideClient_m_bIsHLTV

Target: `CServerSideClient::m_bIsHLTV` (structmember) in the CS2 server module.
