---
name: find-IGameSystem_SetGameSystemGlobalPtrs
description: |
  Agent fallback for IGameSystem_SetGameSystemGlobalPtrs (auto-generated, category: vfunc). Locate
  IGameSystem::SetGameSystemGlobalPtrs in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_SetGameSystemGlobalPtrs, IGameSystem::SetGameSystemGlobalPtrs
disable-model-invocation: true
---

# Find IGameSystem_SetGameSystemGlobalPtrs

Target: `IGameSystem::SetGameSystemGlobalPtrs` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_SetGameSystemGlobalPtrs.{platform}.yaml` with EXACTLY these fields:
