...
description: |
  Agent fallback for g_pCSGOInput (auto-generated, category: func). Locate
  g_pCSGOInput in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: g_pCSGOInput, g_pCSGOInput
disable-model-invocation: true
---

# Find g_pCSGOInput

Target: `g_pCSGOInput` (func) in the module loaded in THIS session.
...
Write `g_pCSGOInput.{platform}.yaml` with EXACTLY these fields:
