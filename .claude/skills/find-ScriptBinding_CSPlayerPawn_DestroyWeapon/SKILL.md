...
description: |
  ...
  ScriptBinding_CSPlayerPawn_DestroyWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ScriptBinding_CSPlayerPawn_DestroyWeapon, ScriptBinding_CSPlayerPawn_DestroyWeapon
disable-model-invocation: true
---

# Find ScriptBinding_CSPlayerPawn_DestroyWeapon

Target: `ScriptBinding_CSPlayerPawn_DestroyWeapon` (func) in the module loaded in THIS session.
