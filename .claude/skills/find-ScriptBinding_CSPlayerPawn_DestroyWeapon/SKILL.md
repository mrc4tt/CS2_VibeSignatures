...
description: |
  Agent fallback for ScriptBinding_CSPlayerPawn_DestroyWeapon (auto-generated, category: func). Locate
  CSPlayerPawn::DestroyWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ScriptBinding_CSPlayerPawn_DestroyWeapon, CSPlayerPawn::DestroyWeapon
disable-model-invocation: true
---

# Find ScriptBinding_CSPlayerPawn_DestroyWeapon

Target: `CSPlayerPawn::DestroyWeapon` (func) in the module loaded in THIS session.
...
Write `ScriptBinding_CSPlayerPawn_DestroyWeapon.{platform}.yaml` with EXACTLY these fields:
