---
name: find-CEngineServer_GetClientSteamID
description: |
  Agent fallback for CEngineServer_GetClientSteamID (auto-generated, category: func). Locate
  CEngineServer_GetClientSteamID in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetClientSteamID, CEngineServer_GetClientSteamID
disable-model-invocation: true
---

# Find CEngineServer_GetClientSteamID

Target: `CEngineServer_GetClientSteamID` (func) in the module loaded in THIS session.
...
Write `CEngineServer_GetClientSteamID.{platform}.yaml` with EXACTLY these fields:
