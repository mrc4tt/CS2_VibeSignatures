...
description: |
  ...
  CNetworkGameClient_CopyExistingEntity in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_CopyExistingEntity, CNetworkGameClient_CopyExistingEntity
disable-model-invocation: true
---

# Find CNetworkGameClient_CopyExistingEntity

Target: `CNetworkGameClient_CopyExistingEntity` (vfunc) in the module loaded in THIS session.
