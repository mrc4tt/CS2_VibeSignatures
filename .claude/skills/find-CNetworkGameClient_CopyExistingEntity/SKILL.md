...
description: |
  Agent fallback for CNetworkGameClient_CopyExistingEntity (auto-generated, category: vfunc). Locate
  CNetworkGameClient::CopyExistingEntity in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_CopyExistingEntity, CNetworkGameClient::CopyExistingEntity
disable-model-invocation: true
---

# Find CNetworkGameClient_CopyExistingEntity

Target: `CNetworkGameClient::CopyExistingEntity` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_CopyExistingEntity.{platform}.yaml` with EXACTLY these fields:
