...
description: |
  ...
  INetworkMessages_FindNetworkMessageById in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_FindNetworkMessageById, INetworkMessages_FindNetworkMessageById
disable-model-invocation: true
---

# Find INetworkMessages_FindNetworkMessageById

Target: `INetworkMessages_FindNetworkMessageById` (vfunc) in the module loaded in THIS session.
