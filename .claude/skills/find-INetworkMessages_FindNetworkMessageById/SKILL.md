...
description: |
  Agent fallback for INetworkMessages_FindNetworkMessageById (auto-generated, category: vfunc). Locate
  INetworkMessages::FindNetworkMessageById in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_FindNetworkMessageById, INetworkMessages::FindNetworkMessageById
disable-model-invocation: true
---

# Find INetworkMessages_FindNetworkMessageById

Target: `INetworkMessages::FindNetworkMessageById` (vfunc) in the module loaded in THIS session.
...
Write `INetworkMessages_FindNetworkMessageById.{platform}.yaml` with EXACTLY these fields:
