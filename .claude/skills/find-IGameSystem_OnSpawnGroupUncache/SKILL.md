...
description: |
  ...
  IGameSystem_OnSpawnGroupUncache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnSpawnGroupUncache, IGameSystem_OnSpawnGroupUncache
disable-model-invocation: true
---

# Find IGameSystem_OnSpawnGroupUncache

Target: `IGameSystem_OnSpawnGroupUncache` (vfunc) in the module loaded in THIS session.
