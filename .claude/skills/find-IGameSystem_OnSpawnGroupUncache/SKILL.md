...
description: |
  Agent fallback for IGameSystem_OnSpawnGroupUncache (auto-generated, category: vfunc). Locate
  IGameSystem::OnSpawnGroupUncache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnSpawnGroupUncache, IGameSystem::OnSpawnGroupUncache
disable-model-invocation: true
---

# Find IGameSystem_OnSpawnGroupUncache

Target: `IGameSystem::OnSpawnGroupUncache` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnSpawnGroupUncache.{platform}.yaml` with EXACTLY these fields:
