...
description: |
  Agent fallback for CEntitySystem_AddRefKeyValues (auto-generated, category: vfunc). Locate
  CEntitySystem::AddRefKeyValues in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_AddRefKeyValues, CEntitySystem::AddRefKeyValues
disable-model-invocation: true
---

# Find CEntitySystem_AddRefKeyValues

Target: `CEntitySystem::AddRefKeyValues` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_AddRefKeyValues.{platform}.yaml` with EXACTLY these fields:
