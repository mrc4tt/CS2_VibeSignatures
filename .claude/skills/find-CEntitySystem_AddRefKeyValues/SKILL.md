...
description: |
  ...
  CEntitySystem_AddRefKeyValues in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_AddRefKeyValues, CEntitySystem_AddRefKeyValues
disable-model-invocation: true
---

# Find CEntitySystem_AddRefKeyValues

Target: `CEntitySystem_AddRefKeyValues` (vfunc) in the module loaded in THIS session.
