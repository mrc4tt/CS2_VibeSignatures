---
name: find-CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdateImpl
description: |
  Agent fallback for CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdateImpl (auto-generated, category: func). Locate
  CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdateImpl in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdateImpl, CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdateImpl
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdateImpl

Target: `CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdateImpl` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdateImpl.{platform}.yaml` with EXACTLY these fields:
