...
description: |
  ...
  CEngineServer_GetFrameTimeAmnesty-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetFrameTimeAmnesty-inlined, CEngineServer_GetFrameTimeAmnesty-inlined
disable-model-invocation: true
---

# Find CEngineServer_GetFrameTimeAmnesty-inlined

Target: `CEngineServer_GetFrameTimeAmnesty-inlined` (vfunc) in the module loaded in THIS session.
