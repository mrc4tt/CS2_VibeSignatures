...
description: |
  ...
  CSource2Server_Init-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Init-decompiles, CSource2Server_Init-decompiles
disable-model-invocation: true
---

# Find CSource2Server_Init-decompiles

Target: `CSource2Server_Init-decompiles` (vfunc) in the module loaded in THIS session.
