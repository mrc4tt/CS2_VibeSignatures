...
description: |
  Agent fallback for CSource2Server_Init-decompiles (auto-generated, category: vfunc). Locate
  CSource2Server::Init in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Init-decompiles, CSource2Server::Init
disable-model-invocation: true
---

# Find CSource2Server_Init-decompiles

Target: `CSource2Server::Init` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_Init.{platform}.yaml` with EXACTLY these fields:
