...
description: |
  ...
  CEntityInstance_DrawDebugTextOverlays in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_DrawDebugTextOverlays, CEntityInstance_DrawDebugTextOverlays
disable-model-invocation: true
---

# Find CEntityInstance_DrawDebugTextOverlays

Target: `CEntityInstance_DrawDebugTextOverlays` (vfunc) in the module loaded in THIS session.
