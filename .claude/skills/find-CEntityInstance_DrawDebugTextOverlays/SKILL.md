...
description: |
  Agent fallback for CEntityInstance_DrawDebugTextOverlays (auto-generated, category: vfunc). Locate
  CEntityInstance::DrawDebugTextOverlays in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_DrawDebugTextOverlays, CEntityInstance::DrawDebugTextOverlays
disable-model-invocation: true
---

# Find CEntityInstance_DrawDebugTextOverlays

Target: `CEntityInstance::DrawDebugTextOverlays` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_DrawDebugTextOverlays.{platform}.yaml` with EXACTLY these fields:
