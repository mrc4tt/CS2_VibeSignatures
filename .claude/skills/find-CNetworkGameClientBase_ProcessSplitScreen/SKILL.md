...
description: |
  ...
  CNetworkGameClientBase_ProcessSplitScreen in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessSplitScreen, CNetworkGameClientBase_ProcessSplitScreen
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessSplitScreen

Target: `CNetworkGameClientBase_ProcessSplitScreen` (vfunc) in the module loaded in THIS session.
