---
name: find-CNetworkGameClientBase_ProcessSplitScreen
description: |
  Agent fallback for CNetworkGameClientBase_ProcessSplitScreen (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::ProcessSplitScreen in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessSplitScreen, CNetworkGameClientBase::ProcessSplitScreen
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessSplitScreen

Target: `CNetworkGameClientBase::ProcessSplitScreen` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ProcessSplitScreen.{platform}.yaml` with EXACTLY these fields:
