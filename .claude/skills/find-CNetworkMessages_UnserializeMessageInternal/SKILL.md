...
description: |
  ...
  CNetworkMessages_UnserializeMessageInternal in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_UnserializeMessageInternal, CNetworkMessages_UnserializeMessageInternal
disable-model-invocation: true
---

# Find CNetworkMessages_UnserializeMessageInternal

Target: `CNetworkMessages_UnserializeMessageInternal` (vfunc) in the module loaded in THIS session.
