...
description: |
  Agent fallback for CNetworkMessages_UnserializeMessageInternal (auto-generated, category: vfunc). Locate
  CNetworkMessages::UnserializeMessageInternal in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_UnserializeMessageInternal, CNetworkMessages::UnserializeMessageInternal
disable-model-invocation: true
---

# Find CNetworkMessages_UnserializeMessageInternal

Target: `CNetworkMessages::UnserializeMessageInternal` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_UnserializeMessageInternal.{platform}.yaml` with EXACTLY these fields:
