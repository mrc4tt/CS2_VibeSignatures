...
description: |
  ...
  CEntitySystem_Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_Spawn, CEntitySystem_Spawn
disable-model-invocation: true
---

# Find CEntitySystem_Spawn

Target: `CEntitySystem_Spawn` (vfunc) in the module loaded in THIS session.
