...
description: |
  Agent fallback for CEntitySystem_Spawn (auto-generated, category: vfunc). Locate
  CEntitySystem::Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_Spawn, CEntitySystem::Spawn
disable-model-invocation: true
---

# Find CEntitySystem_Spawn

Target: `CEntitySystem::Spawn` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_Spawn.{platform}.yaml` with EXACTLY these fields:
