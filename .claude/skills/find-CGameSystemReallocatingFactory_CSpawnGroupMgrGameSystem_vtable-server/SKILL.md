---
name: find-CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_vtable-server
description: |
  Agent fallback for CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_vtable-server (auto-generated, category: func). Locate
  CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_vtable-server, CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_vtable
disable-model-invocation: true
---

# Find CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_vtable-server

Target: `CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_vtable` (func) in the module loaded in THIS session.
...
Write `CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_vtable.{platform}.yaml` with EXACTLY these fields:
