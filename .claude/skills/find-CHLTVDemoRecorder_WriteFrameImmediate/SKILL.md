...
description: |
  ...
  CHLTVDemoRecorder_WriteFrameImmediate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHLTVDemoRecorder_WriteFrameImmediate, CHLTVDemoRecorder_WriteFrameImmediate
disable-model-invocation: true
---

# Find CHLTVDemoRecorder_WriteFrameImmediate

Target: `CHLTVDemoRecorder_WriteFrameImmediate` (func) in the module loaded in THIS session.
