...
description: |
  Agent fallback for CHLTVDemoRecorder_WriteFrameImmediate (auto-generated, category: func). Locate
  CHLTVDemoRecorder::WriteFrameImmediate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHLTVDemoRecorder_WriteFrameImmediate, CHLTVDemoRecorder::WriteFrameImmediate
disable-model-invocation: true
---

# Find CHLTVDemoRecorder_WriteFrameImmediate

Target: `CHLTVDemoRecorder::WriteFrameImmediate` (func) in the module loaded in THIS session.
...
Write `CHLTVDemoRecorder_WriteFrameImmediate.{platform}.yaml` with EXACTLY these fields:
