---
name: find-CNetworkGameServerBase_SetGameSpawnGroupMgr
description: |
  Agent fallback for CNetworkGameServerBase_SetGameSpawnGroupMgr (auto-generated, category: func). Locate
  CNetworkGameServerBase_SetGameSpawnGroupMgr in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SetGameSpawnGroupMgr, CNetworkGameServerBase_SetGameSpawnGroupMgr
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SetGameSpawnGroupMgr

Target: `CNetworkGameServerBase_SetGameSpawnGroupMgr` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_SetGameSpawnGroupMgr.{platform}.yaml` with EXACTLY these fields:
