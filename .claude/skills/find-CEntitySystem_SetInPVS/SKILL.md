...
description: |
  ...
  CEntitySystem_SetInPVS in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_SetInPVS, CEntitySystem_SetInPVS
disable-model-invocation: true
---

# Find CEntitySystem_SetInPVS

Target: `CEntitySystem_SetInPVS` (func) in the module loaded in THIS session.
