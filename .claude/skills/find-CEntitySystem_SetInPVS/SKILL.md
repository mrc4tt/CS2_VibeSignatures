...
description: |
  Agent fallback for CEntitySystem_SetInPVS (auto-generated, category: func). Locate
  CEntitySystem::SetInPVS in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_SetInPVS, CEntitySystem::SetInPVS
disable-model-invocation: true
---

# Find CEntitySystem_SetInPVS

Target: `CEntitySystem::SetInPVS` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_SetInPVS.{platform}.yaml` with EXACTLY these fields:
