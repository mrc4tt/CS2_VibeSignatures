...
description: |
  Agent fallback for CCSPlayer_UseServices_OnUse (auto-generated, category: vfunc). Locate
  CCSPlayer_UseServices::OnUse in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_UseServices_OnUse, CCSPlayer_UseServices::OnUse
disable-model-invocation: true
---

# Find CCSPlayer_UseServices_OnUse

Target: `CCSPlayer_UseServices::OnUse` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayer_UseServices_OnUse.{platform}.yaml` with EXACTLY these fields:
