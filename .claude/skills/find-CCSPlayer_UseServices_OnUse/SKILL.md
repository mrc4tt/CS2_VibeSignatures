...
description: |
  ...
  CCSPlayer_UseServices_OnUse in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_UseServices_OnUse, CCSPlayer_UseServices_OnUse
disable-model-invocation: true
---

# Find CCSPlayer_UseServices_OnUse

Target: `CCSPlayer_UseServices_OnUse` (vfunc) in the module loaded in THIS session.
