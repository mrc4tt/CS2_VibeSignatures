...
description: |
  ...
  CBaseEntity_FullEdictChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_FullEdictChanged, CBaseEntity_FullEdictChanged
disable-model-invocation: true
---

# Find CBaseEntity_FullEdictChanged

Target: `CBaseEntity_FullEdictChanged` (vfunc) in the module loaded in THIS session.
