...
description: |
  Agent fallback for CBaseEntity_FullEdictChanged (auto-generated, category: vfunc). Locate
  CBaseEntity::FullEdictChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_FullEdictChanged, CBaseEntity::FullEdictChanged
disable-model-invocation: true
---

# Find CBaseEntity_FullEdictChanged

Target: `CBaseEntity::FullEdictChanged` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_FullEdictChanged.{platform}.yaml` with EXACTLY these fields:
