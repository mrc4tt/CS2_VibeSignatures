...
description: |
  Agent fallback for CSource2Client_SetGlobals-decompiles (auto-generated, category: vfunc). Locate
  CSource2Client::SetGlobals in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_SetGlobals-decompiles, CSource2Client::SetGlobals
disable-model-invocation: true
---

# Find CSource2Client_SetGlobals-decompiles

Target: `CSource2Client::SetGlobals` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Client_SetGlobals.{platform}.yaml` with EXACTLY these fields:
