...
description: |
  ...
  CSource2Client_SetGlobals-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_SetGlobals-decompiles, CSource2Client_SetGlobals-decompiles
disable-model-invocation: true
---

# Find CSource2Client_SetGlobals-decompiles

Target: `CSource2Client_SetGlobals-decompiles` (vfunc) in the module loaded in THIS session.
