...
description: |
  Agent fallback for CLoopTypeClientServer_ActivateLoop (auto-generated, category: vfunc). Locate
  CLoopTypeClientServer::ActivateLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_ActivateLoop, CLoopTypeClientServer::ActivateLoop
disable-model-invocation: true
---

# Find CLoopTypeClientServer_ActivateLoop

Target: `CLoopTypeClientServer::ActivateLoop` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_ActivateLoop.{platform}.yaml` with EXACTLY these fields:
