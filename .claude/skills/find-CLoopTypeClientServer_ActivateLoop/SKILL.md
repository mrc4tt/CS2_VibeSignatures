...
description: |
  ...
  CLoopTypeClientServer_ActivateLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_ActivateLoop, CLoopTypeClientServer_ActivateLoop
disable-model-invocation: true
---

# Find CLoopTypeClientServer_ActivateLoop

Target: `CLoopTypeClientServer_ActivateLoop` (vfunc) in the module loaded in THIS session.
