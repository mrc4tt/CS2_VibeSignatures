...
description: |
  Agent fallback for ClientModeCSNormal_Update (auto-generated, category: vfunc). Locate
  ClientModeCSNormal::Update in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ClientModeCSNormal_Update, ClientModeCSNormal::Update
disable-model-invocation: true
---

# Find ClientModeCSNormal_Update

Target: `ClientModeCSNormal::Update` (vfunc) in the module loaded in THIS session.
...
Write `ClientModeCSNormal_Update.{platform}.yaml` with EXACTLY these fields:
