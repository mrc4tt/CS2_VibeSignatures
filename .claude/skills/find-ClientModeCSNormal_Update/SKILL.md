...
description: |
  ...
  ClientModeCSNormal_Update in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ClientModeCSNormal_Update, ClientModeCSNormal_Update
disable-model-invocation: true
---

# Find ClientModeCSNormal_Update

Target: `ClientModeCSNormal_Update` (vfunc) in the module loaded in THIS session.
