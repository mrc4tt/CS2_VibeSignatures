...
description: |
  ...
  CDemoRecorder_ParseMessage in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoRecorder_ParseMessage, CDemoRecorder_ParseMessage
disable-model-invocation: true
---

# Find CDemoRecorder_ParseMessage

Target: `CDemoRecorder_ParseMessage` (vfunc) in the module loaded in THIS session.
