...
description: |
  ...
  CLog_Print in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLog_Print, CLog_Print
disable-model-invocation: true
---

# Find CLog_Print

Target: `CLog_Print` (func) in the module loaded in THIS session.
