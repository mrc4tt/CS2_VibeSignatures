...
description: |
  Agent fallback for CLog_Print (auto-generated, category: func). Locate
  CLog::Print in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLog_Print, CLog::Print
disable-model-invocation: true
---

# Find CLog_Print

Target: `CLog::Print` (func) in the module loaded in THIS session.
...
Write `CLog_Print.{platform}.yaml` with EXACTLY these fields:
