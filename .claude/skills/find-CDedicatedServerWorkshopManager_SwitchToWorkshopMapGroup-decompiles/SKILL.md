---
name: find-CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup-decompiles
description: |
  ...
  CDedicatedServerWorkshopManager::SwitchToWorkshopMapGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup-decompiles, CDedicatedServerWorkshopManager::SwitchToWorkshopMapGroup
disable-model-invocation: true
---

# Find CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup-decompiles

Target: `CDedicatedServerWorkshopManager::SwitchToWorkshopMapGroup` (func) in the module loaded in THIS session.
...
Write `CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup.{platform}.yaml` with EXACTLY these fields:
