...
description: |
  ...
  CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup-decompiles, CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup-decompiles
disable-model-invocation: true
---

# Find CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup-decompiles

Target: `CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup-decompiles` (func) in the module loaded in THIS session.
