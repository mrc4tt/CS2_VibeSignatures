---
name: find-INetworkSystem_PollSocket-linux
description: |
  Agent fallback for INetworkSystem_PollSocket-linux (auto-generated, category: vfunc). Locate
  INetworkSystem::PollSocket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_PollSocket-linux, INetworkSystem::PollSocket
disable-model-invocation: true
---

# Find INetworkSystem_PollSocket-linux

Target: `INetworkSystem::PollSocket` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_PollSocket.{platform}.yaml` with EXACTLY these fields:
