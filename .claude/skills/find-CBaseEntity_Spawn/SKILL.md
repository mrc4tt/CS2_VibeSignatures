...
description: |
  Agent fallback for CBaseEntity_Spawn (auto-generated, category: vfunc). Locate
  CBaseEntity::Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_Spawn, CBaseEntity::Spawn
disable-model-invocation: true
---

# Find CBaseEntity_Spawn

Target: `CBaseEntity::Spawn` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_Spawn.{platform}.yaml` with EXACTLY these fields:
