...
description: |
  ...
  CBaseEntity_Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_Spawn, CBaseEntity_Spawn
disable-model-invocation: true
---

# Find CBaseEntity_Spawn

Target: `CBaseEntity_Spawn` (vfunc) in the module loaded in THIS session.
