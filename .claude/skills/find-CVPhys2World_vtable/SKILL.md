...
description: |
  Agent fallback for CVPhys2World_vtable (auto-generated, category: func). Locate
  CVPhys2World_vtable in the CS2 vphysics2 module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CVPhys2World_vtable, CVPhys2World_vtable
disable-model-invocation: true
---

# Find CVPhys2World_vtable

Target: `CVPhys2World_vtable` (func) in the module loaded in THIS session.
...
Write `CVPhys2World_vtable.{platform}.yaml` with EXACTLY these fields:
