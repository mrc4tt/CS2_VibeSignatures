...
description: |
  ...
  CEngineServiceMgr_RegisterEngineService in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_RegisterEngineService, CEngineServiceMgr_RegisterEngineService
disable-model-invocation: true
---

# Find CEngineServiceMgr_RegisterEngineService

Target: `CEngineServiceMgr_RegisterEngineService` (vfunc) in the module loaded in THIS session.
