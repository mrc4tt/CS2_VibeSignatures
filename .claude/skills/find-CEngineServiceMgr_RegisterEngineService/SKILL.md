...
description: |
  Agent fallback for CEngineServiceMgr_RegisterEngineService (auto-generated, category: vfunc). Locate
  CEngineServiceMgr::RegisterEngineService in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_RegisterEngineService, CEngineServiceMgr::RegisterEngineService
disable-model-invocation: true
---

# Find CEngineServiceMgr_RegisterEngineService

Target: `CEngineServiceMgr::RegisterEngineService` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_RegisterEngineService.{platform}.yaml` with EXACTLY these fields:
