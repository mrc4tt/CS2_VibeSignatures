...
description: |
  ...
  CRenderService_OnClientOutput in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRenderService_OnClientOutput, CRenderService_OnClientOutput
disable-model-invocation: true
---

# Find CRenderService_OnClientOutput

Target: `CRenderService_OnClientOutput` (func) in the module loaded in THIS session.
