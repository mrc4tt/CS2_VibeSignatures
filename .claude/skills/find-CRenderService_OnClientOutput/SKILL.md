---
name: find-CRenderService_OnClientOutput
description: |
  Agent fallback for CRenderService_OnClientOutput (auto-generated, category: func). Locate
  CRenderService::OnClientOutput in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CRenderService_OnClientOutput, CRenderService::OnClientOutput
disable-model-invocation: true
---

# Find CRenderService_OnClientOutput

Target: `CRenderService::OnClientOutput` (func) in the module loaded in THIS session.
...
Write `CRenderService_OnClientOutput.{platform}.yaml` with EXACTLY these fields:
