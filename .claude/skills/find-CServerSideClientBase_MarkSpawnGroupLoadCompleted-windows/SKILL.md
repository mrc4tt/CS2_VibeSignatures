...
description: |
  ...
  CServerSideClientBase_MarkSpawnGroupLoadCompleted-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_MarkSpawnGroupLoadCompleted-windows, CServerSideClientBase_MarkSpawnGroupLoadCompleted-windows
disable-model-invocation: true
---

# Find CServerSideClientBase_MarkSpawnGroupLoadCompleted-windows

Target: `CServerSideClientBase_MarkSpawnGroupLoadCompleted-windows` (func) in the module loaded in THIS session.
