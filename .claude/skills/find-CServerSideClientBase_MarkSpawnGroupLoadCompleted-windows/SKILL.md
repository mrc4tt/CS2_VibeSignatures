...
description: |
  Agent fallback for CServerSideClientBase_MarkSpawnGroupLoadCompleted-windows (auto-generated, category: func). Locate
  CServerSideClientBase::MarkSpawnGroupLoadCompleted in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_MarkSpawnGroupLoadCompleted-windows, CServerSideClientBase::MarkSpawnGroupLoadCompleted
disable-model-invocation: true
---

# Find CServerSideClientBase_MarkSpawnGroupLoadCompleted-windows

Target: `CServerSideClientBase::MarkSpawnGroupLoadCompleted` (func) in the module loaded in THIS session.
...
Write `CServerSideClientBase_MarkSpawnGroupLoadCompleted.{platform}.yaml` with EXACTLY these fields:
