...
description: |
  Agent fallback for CSource2Server_GetActiveWorldName (auto-generated, category: vfunc). Locate
  CSource2Server::GetActiveWorldName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetActiveWorldName, CSource2Server::GetActiveWorldName
disable-model-invocation: true
---

# Find CSource2Server_GetActiveWorldName

Target: `CSource2Server::GetActiveWorldName` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GetActiveWorldName.{platform}.yaml` with EXACTLY these fields:
