...
description: |
  ...
  CSource2Server_GetActiveWorldName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetActiveWorldName, CSource2Server_GetActiveWorldName
disable-model-invocation: true
---

# Find CSource2Server_GetActiveWorldName

Target: `CSource2Server_GetActiveWorldName` (vfunc) in the module loaded in THIS session.
