...
description: |
  ...
  CNetworkGameServerBase_GetMaxClients in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetMaxClients, CNetworkGameServerBase_GetMaxClients
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetMaxClients

Target: `CNetworkGameServerBase_GetMaxClients` (vfunc) in the module loaded in THIS session.
