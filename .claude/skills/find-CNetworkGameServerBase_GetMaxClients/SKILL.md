...
description: |
  Agent fallback for CNetworkGameServerBase_GetMaxClients (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::GetMaxClients in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetMaxClients, CNetworkGameServerBase::GetMaxClients
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetMaxClients

Target: `CNetworkGameServerBase::GetMaxClients` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_GetMaxClients.{platform}.yaml` with EXACTLY these fields:
