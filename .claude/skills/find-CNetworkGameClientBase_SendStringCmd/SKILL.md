...
description: |
  ...
  CNetworkGameClientBase_SendStringCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_SendStringCmd, CNetworkGameClientBase_SendStringCmd
disable-model-invocation: true
---

# Find CNetworkGameClientBase_SendStringCmd

Target: `CNetworkGameClientBase_SendStringCmd` (vfunc) in the module loaded in THIS session.
