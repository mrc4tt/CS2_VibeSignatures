...
description: |
  Agent fallback for CNetworkGameClientBase_SendStringCmd (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::SendStringCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_SendStringCmd, CNetworkGameClientBase::SendStringCmd
disable-model-invocation: true
---

# Find CNetworkGameClientBase_SendStringCmd

Target: `CNetworkGameClientBase::SendStringCmd` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_SendStringCmd.{platform}.yaml` with EXACTLY these fields:
