...
description: |
  Agent fallback for CNetworkGameServerBase_ReserveServerForQueuedGame (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::ReserveServerForQueuedGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ReserveServerForQueuedGame, CNetworkGameServerBase::ReserveServerForQueuedGame
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ReserveServerForQueuedGame

Target: `CNetworkGameServerBase::ReserveServerForQueuedGame` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_ReserveServerForQueuedGame.{platform}.yaml` with EXACTLY these fields:
