...
description: |
  ...
  CNetworkGameServerBase_ReserveServerForQueuedGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ReserveServerForQueuedGame, CNetworkGameServerBase_ReserveServerForQueuedGame
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ReserveServerForQueuedGame

Target: `CNetworkGameServerBase_ReserveServerForQueuedGame` (vfunc) in the module loaded in THIS session.
