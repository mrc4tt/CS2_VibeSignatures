...
description: |
  ...
  CBaseAnimGraph_GetAnimationController in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseAnimGraph_GetAnimationController, CBaseAnimGraph_GetAnimationController
disable-model-invocation: true
---

# Find CBaseAnimGraph_GetAnimationController

Target: `CBaseAnimGraph_GetAnimationController` (func) in the module loaded in THIS session.
