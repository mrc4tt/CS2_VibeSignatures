...
description: |
  ...
  CEntityInstance_FullEdictChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_FullEdictChanged, CEntityInstance_FullEdictChanged
disable-model-invocation: true
---

# Find CEntityInstance_FullEdictChanged

Target: `CEntityInstance_FullEdictChanged` (vfunc) in the module loaded in THIS session.
