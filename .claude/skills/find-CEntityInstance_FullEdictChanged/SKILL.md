...
description: |
  Agent fallback for CEntityInstance_FullEdictChanged (auto-generated, category: vfunc). Locate
  CEntityInstance::FullEdictChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_FullEdictChanged, CEntityInstance::FullEdictChanged
disable-model-invocation: true
---

# Find CEntityInstance_FullEdictChanged

Target: `CEntityInstance::FullEdictChanged` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_FullEdictChanged.{platform}.yaml` with EXACTLY these fields:
