...
description: |
  ...
  CNetworkGameServer_IsPausable-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_IsPausable-noinline, CNetworkGameServer_IsPausable-noinline
disable-model-invocation: true
---

# Find CNetworkGameServer_IsPausable-noinline

Target: `CNetworkGameServer_IsPausable-noinline` (vfunc) in the module loaded in THIS session.
