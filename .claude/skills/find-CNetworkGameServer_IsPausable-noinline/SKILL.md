...
description: |
  Agent fallback for CNetworkGameServer_IsPausable-noinline (auto-generated, category: vfunc). Locate
  ...
  Trigger: CNetworkGameServer_IsPausable-noinline, CNetworkGameServer::IsPausable
