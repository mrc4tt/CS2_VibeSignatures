---
name: find-CNetworkClientSpawnGroupCreatePrerequisites_vtable
description: |
  Agent fallback for CNetworkClientSpawnGroupCreatePrerequisites_vtable (auto-generated, category: func). Locate
  CNetworkClientSpawnGroupCreatePrerequisites_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientSpawnGroupCreatePrerequisites_vtable, CNetworkClientSpawnGroupCreatePrerequisites_vtable
disable-model-invocation: true
---

# Find CNetworkClientSpawnGroupCreatePrerequisites_vtable

Target: `CNetworkClientSpawnGroupCreatePrerequisites_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkClientSpawnGroupCreatePrerequisites_vtable.{platform}.yaml` with EXACTLY these fields:
