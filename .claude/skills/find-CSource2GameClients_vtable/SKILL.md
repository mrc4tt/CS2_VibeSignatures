...
description: |
  Agent fallback for CSource2GameClients_vtable (auto-generated, category: func). Locate
  CSource2GameClients_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_vtable, CSource2GameClients_vtable
disable-model-invocation: true
---

# Find CSource2GameClients_vtable

Target: `CSource2GameClients_vtable` (func) in the module loaded in THIS session.
...
Write `CSource2GameClients_vtable.{platform}.yaml` with EXACTLY these fields:
