---
name: find-CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem-decompiles
description: |
  Agent fallback for CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem-decompiles (auto-generated, category: func). Locate
  CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem-decompiles, CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem
disable-model-invocation: true
---

# Find CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem-decompiles

Target: `CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem` (func) in the module loaded in THIS session.
...
Write `CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem.{platform}.yaml` with EXACTLY these fields:
