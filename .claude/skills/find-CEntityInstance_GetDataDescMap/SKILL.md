...
description: |
  ...
  CEntityInstance_GetDataDescMap in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_GetDataDescMap, CEntityInstance_GetDataDescMap
disable-model-invocation: true
---

# Find CEntityInstance_GetDataDescMap

Target: `CEntityInstance_GetDataDescMap` (vfunc) in the module loaded in THIS session.
