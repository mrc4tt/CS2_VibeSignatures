...
description: |
  Agent fallback for CEntityInstance_GetDataDescMap (auto-generated, category: vfunc). Locate
  CEntityInstance::GetDataDescMap in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_GetDataDescMap, CEntityInstance::GetDataDescMap
disable-model-invocation: true
---

# Find CEntityInstance_GetDataDescMap

Target: `CEntityInstance::GetDataDescMap` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_GetDataDescMap.{platform}.yaml` with EXACTLY these fields:
