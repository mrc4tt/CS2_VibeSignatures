...
description: |
  Agent fallback for CNetworkGameServerBase_IsBackgroundMap (auto-generated, category: func). Locate
  CNetworkGameServerBase_IsBackgroundMap in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_IsBackgroundMap, CNetworkGameServerBase_IsBackgroundMap
disable-model-invocation: true
---

# Find CNetworkGameServerBase_IsBackgroundMap

Target: `CNetworkGameServerBase_IsBackgroundMap` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_IsBackgroundMap.{platform}.yaml` with EXACTLY these fields:
