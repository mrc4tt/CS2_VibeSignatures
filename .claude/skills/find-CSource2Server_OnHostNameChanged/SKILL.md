...
description: |
  Agent fallback for CSource2Server_OnHostNameChanged (auto-generated, category: vfunc). Locate
  CSource2Server::OnHostNameChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_OnHostNameChanged, CSource2Server::OnHostNameChanged
disable-model-invocation: true
---

# Find CSource2Server_OnHostNameChanged

Target: `CSource2Server::OnHostNameChanged` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_OnHostNameChanged.{platform}.yaml` with EXACTLY these fields:
