...
description: |
  ...
  CSource2Server_OnHostNameChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_OnHostNameChanged, CSource2Server_OnHostNameChanged
disable-model-invocation: true
---

# Find CSource2Server_OnHostNameChanged

Target: `CSource2Server_OnHostNameChanged` (vfunc) in the module loaded in THIS session.
