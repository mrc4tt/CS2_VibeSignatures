...
description: |
  ...
  CSource2GameClients_GetBugReportInfo in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_GetBugReportInfo, CSource2GameClients_GetBugReportInfo
disable-model-invocation: true
---

# Find CSource2GameClients_GetBugReportInfo

Target: `CSource2GameClients_GetBugReportInfo` (vfunc) in the module loaded in THIS session.
