...
description: |
  Agent fallback for CSource2GameClients_GetBugReportInfo (auto-generated, category: vfunc). Locate
  CSource2GameClients::GetBugReportInfo in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_GetBugReportInfo, CSource2GameClients::GetBugReportInfo
disable-model-invocation: true
---

# Find CSource2GameClients_GetBugReportInfo

Target: `CSource2GameClients::GetBugReportInfo` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_GetBugReportInfo.{platform}.yaml` with EXACTLY these fields:
