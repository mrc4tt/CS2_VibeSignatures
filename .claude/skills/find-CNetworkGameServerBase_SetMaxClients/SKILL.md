...
description: |
  Agent fallback for CNetworkGameServerBase_SetMaxClients (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::SetMaxClients in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SetMaxClients, CNetworkGameServerBase::SetMaxClients
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SetMaxClients

Target: `CNetworkGameServerBase::SetMaxClients` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_SetMaxClients.{platform}.yaml` with EXACTLY these fields:
