...
description: |
  ...
  CNetworkGameServerBase_SetMaxClients in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SetMaxClients, CNetworkGameServerBase_SetMaxClients
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SetMaxClients

Target: `CNetworkGameServerBase_SetMaxClients` (vfunc) in the module loaded in THIS session.
