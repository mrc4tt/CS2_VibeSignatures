...
description: |
  ...
  sub_1402310 in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SmokeVolume_BuildSmokeSimulation_Initialize-linux, sub_1402310
disable-model-invocation: true
---

# Find SmokeVolume_BuildSmokeSimulation_Initialize-linux

Target: `sub_1402310` (func) in the module loaded in THIS session.
...
Write `SmokeVolume_BuildSmokeSimulation_Initialize.{platform}.yaml` with EXACTLY these fields:
