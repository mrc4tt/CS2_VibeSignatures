---
name: find-SmokeVolume_BuildSmokeSimulation_Initialize-linux
description: |
  Agent fallback for SmokeVolume_BuildSmokeSimulation_Initialize-linux (auto-generated, category: func). Locate
  SmokeVolume_BuildSmokeSimulation_Initialize-linux in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SmokeVolume_BuildSmokeSimulation_Initialize-linux, SmokeVolume_BuildSmokeSimulation_Initialize-linux
disable-model-invocation: true
---

# Find SmokeVolume_BuildSmokeSimulation_Initialize-linux

Target: `SmokeVolume_BuildSmokeSimulation_Initialize-linux` (func) in the module loaded in THIS session.
