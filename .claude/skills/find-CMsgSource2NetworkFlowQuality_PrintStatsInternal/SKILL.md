---
name: find-CMsgSource2NetworkFlowQuality_PrintStatsInternal
description: |
  Agent fallback for CMsgSource2NetworkFlowQuality_PrintStatsInternal (auto-generated, category: func). Locate
  CMsgSource2NetworkFlowQuality_PrintStatsInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMsgSource2NetworkFlowQuality_PrintStatsInternal, CMsgSource2NetworkFlowQuality_PrintStatsInternal
disable-model-invocation: true
---

# Find CMsgSource2NetworkFlowQuality_PrintStatsInternal

Target: `CMsgSource2NetworkFlowQuality_PrintStatsInternal` (func) in the module loaded in THIS session.
...
Write `CMsgSource2NetworkFlowQuality_PrintStatsInternal.{platform}.yaml` with EXACTLY these fields:
