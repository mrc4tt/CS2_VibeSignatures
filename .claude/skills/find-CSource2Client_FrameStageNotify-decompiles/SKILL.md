...
description: |
  ...
  CSource2Client_FrameStageNotify-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_FrameStageNotify-decompiles, CSource2Client_FrameStageNotify-decompiles
disable-model-invocation: true
---

# Find CSource2Client_FrameStageNotify-decompiles

Target: `CSource2Client_FrameStageNotify-decompiles` (vfunc) in the module loaded in THIS session.
