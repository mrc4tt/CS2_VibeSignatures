...
description: |
  Agent fallback for CSource2Client_FrameStageNotify-decompiles (auto-generated, category: vfunc). Locate
  CSource2Client::FrameStageNotify in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_FrameStageNotify-decompiles, CSource2Client::FrameStageNotify
disable-model-invocation: true
---

# Find CSource2Client_FrameStageNotify-decompiles

Target: `CSource2Client::FrameStageNotify` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Client_FrameStageNotify.{platform}.yaml` with EXACTLY these fields:
