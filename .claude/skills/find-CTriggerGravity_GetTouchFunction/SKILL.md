...
description: |
  ...
  CTriggerGravity_GetTouchFunction in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTriggerGravity_GetTouchFunction, CTriggerGravity_GetTouchFunction
disable-model-invocation: true
---

# Find CTriggerGravity_GetTouchFunction

Target: `CTriggerGravity_GetTouchFunction` (func) in the module loaded in THIS session.
