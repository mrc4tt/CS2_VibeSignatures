...
description: |
  Agent fallback for CTriggerGravity_GetTouchFunction (auto-generated, category: func). Locate
  CTriggerGravity::GetTouchFunction in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTriggerGravity_GetTouchFunction, CTriggerGravity::GetTouchFunction
disable-model-invocation: true
---

# Find CTriggerGravity_GetTouchFunction

Target: `CTriggerGravity::GetTouchFunction` (func) in the module loaded in THIS session.
...
Write `CTriggerGravity_GetTouchFunction.{platform}.yaml` with EXACTLY these fields:
