...
description: |
  ...
  CEngineServiceMgr__MainLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr__MainLoop, CEngineServiceMgr__MainLoop
disable-model-invocation: true
---

# Find CEngineServiceMgr__MainLoop

Target: `CEngineServiceMgr__MainLoop` (func) in the module loaded in THIS session.
