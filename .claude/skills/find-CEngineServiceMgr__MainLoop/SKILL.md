...
description: |
  Agent fallback for CEngineServiceMgr__MainLoop (auto-generated, category: func). Locate
  CEngineServiceMgr::_MainLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr__MainLoop, CEngineServiceMgr::_MainLoop
disable-model-invocation: true
---

# Find CEngineServiceMgr__MainLoop

Target: `CEngineServiceMgr::_MainLoop` (func) in the module loaded in THIS session.
...
Write `CEngineServiceMgr__MainLoop.{platform}.yaml` with EXACTLY these fields:
