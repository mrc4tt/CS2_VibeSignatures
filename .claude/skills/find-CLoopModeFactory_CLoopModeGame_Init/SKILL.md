...
description: |
  ...
  CLoopModeFactory_CLoopModeGame_Init in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeFactory_CLoopModeGame_Init, CLoopModeFactory_CLoopModeGame_Init
disable-model-invocation: true
---

# Find CLoopModeFactory_CLoopModeGame_Init

Target: `CLoopModeFactory_CLoopModeGame_Init` (vfunc) in the module loaded in THIS session.
