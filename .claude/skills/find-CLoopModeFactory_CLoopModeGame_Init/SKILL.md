...
description: |
  Agent fallback for CLoopModeFactory_CLoopModeGame_Init (auto-generated, category: vfunc). Locate
  CLoopModeFactory<CLoopModeGame>::Init in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeFactory_CLoopModeGame_Init, CLoopModeFactory<CLoopModeGame>::Init
disable-model-invocation: true
---

# Find CLoopModeFactory_CLoopModeGame_Init

Target: `CLoopModeFactory<CLoopModeGame>::Init` (vfunc) in the module loaded in THIS session.
...
Write `CLoopModeFactory_CLoopModeGame_Init.{platform}.yaml` with EXACTLY these fields:
