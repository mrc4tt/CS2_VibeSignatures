...
description: |
  Agent fallback for CEngineServer_GetClientConVarValue (auto-generated, category: vfunc). Locate
  CEngineServer::GetClientConVarValue in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetClientConVarValue, CEngineServer::GetClientConVarValue
disable-model-invocation: true
---

# Find CEngineServer_GetClientConVarValue

Target: `CEngineServer::GetClientConVarValue` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_GetClientConVarValue.{platform}.yaml` with EXACTLY these fields:
