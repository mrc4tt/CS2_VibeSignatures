...
description: |
  ...
  CEngineServer_GetClientConVarValue in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetClientConVarValue, CEngineServer_GetClientConVarValue
disable-model-invocation: true
---

# Find CEngineServer_GetClientConVarValue

Target: `CEngineServer_GetClientConVarValue` (vfunc) in the module loaded in THIS session.
