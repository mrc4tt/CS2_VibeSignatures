...
description: |
  ...
  CCSPlayerPawnBase_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawnBase_vtable, CCSPlayerPawnBase_vtable
disable-model-invocation: true
---

# Find CCSPlayerPawnBase_vtable

Target: `CCSPlayerPawnBase_vtable` (func) in the module loaded in THIS session.
...
Write `CCSPlayerPawnBase_vtable.{platform}.yaml` with EXACTLY these fields:
