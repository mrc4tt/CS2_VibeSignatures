...
description: |
  ...
  CLoopTypeClientServer_WritePerfStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_WritePerfStats, CLoopTypeClientServer_WritePerfStats
disable-model-invocation: true
---

# Find CLoopTypeClientServer_WritePerfStats

Target: `CLoopTypeClientServer_WritePerfStats` (func) in the module loaded in THIS session.
