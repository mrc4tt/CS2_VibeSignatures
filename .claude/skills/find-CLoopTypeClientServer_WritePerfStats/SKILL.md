...
description: |
  Agent fallback for CLoopTypeClientServer_WritePerfStats (auto-generated, category: func). Locate
  CLoopTypeClientServer::WritePerfStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_WritePerfStats, CLoopTypeClientServer::WritePerfStats
disable-model-invocation: true
---

# Find CLoopTypeClientServer_WritePerfStats

Target: `CLoopTypeClientServer::WritePerfStats` (func) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_WritePerfStats.{platform}.yaml` with EXACTLY these fields:
