---
name: find-CCSPlayer_MovementServices_FullWalkMove
description: |
  Agent fallback for CCSPlayer_MovementServices_FullWalkMove (auto-generated, category: func). Locate
  CCSPlayer_MovementServices::FullWalkMove in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_MovementServices_FullWalkMove, CCSPlayer_MovementServices::FullWalkMove
disable-model-invocation: true
---

# Find CCSPlayer_MovementServices_FullWalkMove

Target: `CCSPlayer_MovementServices::FullWalkMove` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_MovementServices_FullWalkMove.{platform}.yaml` with EXACTLY these fields:
