...
description: |
  ...
  IEngineServiceMgr_OnFrameRenderingFinished in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_OnFrameRenderingFinished, IEngineServiceMgr_OnFrameRenderingFinished
disable-model-invocation: true
---

# Find IEngineServiceMgr_OnFrameRenderingFinished

Target: `IEngineServiceMgr_OnFrameRenderingFinished` (vfunc) in the module loaded in THIS session.
