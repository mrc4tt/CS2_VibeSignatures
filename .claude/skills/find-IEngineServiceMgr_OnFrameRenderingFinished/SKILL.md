---
name: find-IEngineServiceMgr_OnFrameRenderingFinished
description: |
  Agent fallback for IEngineServiceMgr_OnFrameRenderingFinished (auto-generated, category: vfunc). Locate
  IEngineServiceMgr::OnFrameRenderingFinished in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_OnFrameRenderingFinished, IEngineServiceMgr::OnFrameRenderingFinished
disable-model-invocation: true
---

# Find IEngineServiceMgr_OnFrameRenderingFinished

Target: `IEngineServiceMgr::OnFrameRenderingFinished` (vfunc) in the module loaded in THIS session.
...
Write `IEngineServiceMgr_OnFrameRenderingFinished.{platform}.yaml` with EXACTLY these fields:
