...
description: |
  ...
  CSource2GameClients_ClientActive in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientActive, CSource2GameClients_ClientActive
disable-model-invocation: true
---

# Find CSource2GameClients_ClientActive

Target: `CSource2GameClients_ClientActive` (vfunc) in the module loaded in THIS session.
