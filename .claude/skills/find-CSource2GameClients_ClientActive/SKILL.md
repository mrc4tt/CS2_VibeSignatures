...
description: |
  Agent fallback for CSource2GameClients_ClientActive (auto-generated, category: vfunc). Locate
  CSource2GameClients::ClientActive in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientActive, CSource2GameClients::ClientActive
disable-model-invocation: true
---

# Find CSource2GameClients_ClientActive

Target: `CSource2GameClients::ClientActive` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientActive.{platform}.yaml` with EXACTLY these fields:
