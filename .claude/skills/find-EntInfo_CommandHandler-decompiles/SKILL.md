...
description: |
  ...
  EntInfo_CommandHandler-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: EntInfo_CommandHandler-decompiles, EntInfo_CommandHandler-decompiles
disable-model-invocation: true
---

# Find EntInfo_CommandHandler-decompiles

Target: `EntInfo_CommandHandler-decompiles` (func) in the module loaded in THIS session.
