---
name: find-EntInfo_CommandHandler-decompiles
description: |
  Agent fallback for EntInfo_CommandHandler-decompiles (auto-generated, category: func). Locate
  CC_Ent_Info in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: EntInfo_CommandHandler-decompiles, CC_Ent_Info
disable-model-invocation: true
---

# Find EntInfo_CommandHandler-decompiles

Target: `CC_Ent_Info` (func) in the module loaded in THIS session.
...
Write `EntInfo_CommandHandler.{platform}.yaml` with EXACTLY these fields:
