...
description: |
  ...
  CEntityInstance_PostDataUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_PostDataUpdate, CEntityInstance_PostDataUpdate
disable-model-invocation: true
---

# Find CEntityInstance_PostDataUpdate

Target: `CEntityInstance_PostDataUpdate` (vfunc) in the module loaded in THIS session.
