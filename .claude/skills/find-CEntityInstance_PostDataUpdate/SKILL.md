...
description: |
  Agent fallback for CEntityInstance_PostDataUpdate (auto-generated, category: vfunc). Locate
  CEntityInstance::PostDataUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_PostDataUpdate, CEntityInstance::PostDataUpdate
disable-model-invocation: true
---

# Find CEntityInstance_PostDataUpdate

Target: `CEntityInstance::PostDataUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_PostDataUpdate.{platform}.yaml` with EXACTLY these fields:
