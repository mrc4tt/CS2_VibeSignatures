---
name: find-CEntitySaveRestoreBlockHandler_SaveInternal-decompiles
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_SaveInternal-decompiles (auto-generated, category: func). Locate
  CEntitySaveRestoreBlockHandler::SaveInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_SaveInternal-decompiles, CEntitySaveRestoreBlockHandler::SaveInternal
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_SaveInternal-decompiles

Target: `CEntitySaveRestoreBlockHandler::SaveInternal` (func) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_SaveInternal.{platform}.yaml` with EXACTLY these fields:
