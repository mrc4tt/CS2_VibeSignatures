...
description: |
  ...
  CEntitySaveRestoreBlockHandler_SaveInternal-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_SaveInternal-decompiles, CEntitySaveRestoreBlockHandler_SaveInternal-decompiles
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_SaveInternal-decompiles

Target: `CEntitySaveRestoreBlockHandler_SaveInternal-decompiles` (func) in the module loaded in THIS session.
