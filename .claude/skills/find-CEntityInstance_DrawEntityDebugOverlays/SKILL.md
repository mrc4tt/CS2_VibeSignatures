...
description: |
  Agent fallback for CEntityInstance_DrawEntityDebugOverlays (auto-generated, category: vfunc). Locate
  CEntityInstance::DrawEntityDebugOverlays in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_DrawEntityDebugOverlays, CEntityInstance::DrawEntityDebugOverlays
disable-model-invocation: true
---

# Find CEntityInstance_DrawEntityDebugOverlays

Target: `CEntityInstance::DrawEntityDebugOverlays` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_DrawEntityDebugOverlays.{platform}.yaml` with EXACTLY these fields:
