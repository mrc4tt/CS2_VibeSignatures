...
description: |
  ...
  CEntityInstance_DrawEntityDebugOverlays in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_DrawEntityDebugOverlays, CEntityInstance_DrawEntityDebugOverlays
disable-model-invocation: true
---

# Find CEntityInstance_DrawEntityDebugOverlays

Target: `CEntityInstance_DrawEntityDebugOverlays` (vfunc) in the module loaded in THIS session.
