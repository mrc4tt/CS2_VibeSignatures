---
name: find-CLoopModeGame_OnServerEndAsyncPostTickWork-decompiles
description: |
  Agent fallback for CLoopModeGame_OnServerEndAsyncPostTickWork-decompiles (auto-generated, category: func). Locate
  CLoopModeGame::OnServerEndAsyncPostTickWork in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnServerEndAsyncPostTickWork-decompiles, CLoopModeGame::OnServerEndAsyncPostTickWork
disable-model-invocation: true
---

# Find CLoopModeGame_OnServerEndAsyncPostTickWork-decompiles

Target: `CLoopModeGame::OnServerEndAsyncPostTickWork` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_OnServerEndAsyncPostTickWork.{platform}.yaml` with EXACTLY these fields:
