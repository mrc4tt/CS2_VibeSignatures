...
description: |
  ...
  CLoopTypeSimpleService_OnLoopActivate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeSimpleService_OnLoopActivate, CLoopTypeSimpleService_OnLoopActivate
disable-model-invocation: true
---

# Find CLoopTypeSimpleService_OnLoopActivate

Target: `CLoopTypeSimpleService_OnLoopActivate` (vfunc) in the module loaded in THIS session.
