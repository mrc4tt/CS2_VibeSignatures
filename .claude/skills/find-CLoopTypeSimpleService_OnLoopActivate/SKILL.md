---
name: find-CLoopTypeSimpleService_OnLoopActivate
description: |
  Agent fallback for CLoopTypeSimpleService_OnLoopActivate (auto-generated, category: vfunc). Locate
  CLoopTypeSimpleService::OnLoopActivate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeSimpleService_OnLoopActivate, CLoopTypeSimpleService::OnLoopActivate
disable-model-invocation: true
---

# Find CLoopTypeSimpleService_OnLoopActivate

Target: `CLoopTypeSimpleService::OnLoopActivate` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeSimpleService_OnLoopActivate.{platform}.yaml` with EXACTLY these fields:
