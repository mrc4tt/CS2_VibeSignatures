...
description: |
  ...
  IGameSystem_OnServerPostAdvanceTick in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerPostAdvanceTick, IGameSystem_OnServerPostAdvanceTick
disable-model-invocation: true
---

# Find IGameSystem_OnServerPostAdvanceTick

Target: `IGameSystem_OnServerPostAdvanceTick` (vfunc) in the module loaded in THIS session.
