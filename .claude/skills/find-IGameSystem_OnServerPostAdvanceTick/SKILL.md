...
description: |
  Agent fallback for IGameSystem_OnServerPostAdvanceTick (auto-generated, category: vfunc). Locate
  IGameSystem::ServerPostAdvanceTick in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerPostAdvanceTick, IGameSystem::ServerPostAdvanceTick
disable-model-invocation: true
---

# Find IGameSystem_OnServerPostAdvanceTick

Target: `IGameSystem::ServerPostAdvanceTick` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnServerPostAdvanceTick.{platform}.yaml` with EXACTLY these fields:
