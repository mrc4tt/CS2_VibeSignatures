---
name: find-CNetworkGameServer_ChangeLevel
description: |
  Agent fallback for CNetworkGameServer_ChangeLevel (auto-generated, category: func). Locate
  CNetworkGameServer_ChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_ChangeLevel, CNetworkGameServer_ChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameServer_ChangeLevel

Target: `CNetworkGameServer_ChangeLevel` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServer_ChangeLevel.{platform}.yaml` with EXACTLY these fields:
