...
description: |
  ...
  CNetworkGameClient_OnPreserveEntity in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_OnPreserveEntity, CNetworkGameClient_OnPreserveEntity
disable-model-invocation: true
---

# Find CNetworkGameClient_OnPreserveEntity

Target: `CNetworkGameClient_OnPreserveEntity` (vfunc) in the module loaded in THIS session.
