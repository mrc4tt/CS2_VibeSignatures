...
description: |
  Agent fallback for CNetworkGameClient_OnPreserveEntity (auto-generated, category: vfunc). Locate
  ...
  Trigger: CNetworkGameClient_OnPreserveEntity, CNetworkGameClient::OnPreserveEntity
disable-model-invocation: true
---

# Find CNetworkGameClient_OnPreserveEntity
