...
description: |
  Agent fallback for CNetworkTransmitComponent_vtable (auto-generated, category: func). Locate
  CNetworkTransmitComponent_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkTransmitComponent_vtable, CNetworkTransmitComponent_vtable
disable-model-invocation: true
---

# Find CNetworkTransmitComponent_vtable

Target: `CNetworkTransmitComponent_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkTransmitComponent_vtable.{platform}.yaml` with EXACTLY these fields:
