...
description: |
  Agent fallback for CNetworkClientService_GetDisconnectReason (auto-generated, category: vfunc). Locate
  CNetworkClientService::GetDisconnectReason in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_GetDisconnectReason, CNetworkClientService::GetDisconnectReason
disable-model-invocation: true
---

# Find CNetworkClientService_GetDisconnectReason

Target: `CNetworkClientService::GetDisconnectReason` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_GetDisconnectReason.{platform}.yaml` with EXACTLY these fields:
