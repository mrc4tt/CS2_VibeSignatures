...
description: |
  ...
  CNetworkClientService_GetDisconnectReason in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_GetDisconnectReason, CNetworkClientService_GetDisconnectReason
disable-model-invocation: true
---

# Find CNetworkClientService_GetDisconnectReason

Target: `CNetworkClientService_GetDisconnectReason` (vfunc) in the module loaded in THIS session.
