...
description: |
  ...
  CSpawnGroupMgrGameSystem_AllocateSpawnGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_AllocateSpawnGroup, CSpawnGroupMgrGameSystem_AllocateSpawnGroup
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_AllocateSpawnGroup

Target: `CSpawnGroupMgrGameSystem_AllocateSpawnGroup` (vfunc) in the module loaded in THIS session.
