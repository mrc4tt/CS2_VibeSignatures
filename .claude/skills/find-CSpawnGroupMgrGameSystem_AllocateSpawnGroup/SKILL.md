...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_AllocateSpawnGroup (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::AllocateSpawnGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_AllocateSpawnGroup, CSpawnGroupMgrGameSystem::AllocateSpawnGroup
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_AllocateSpawnGroup

Target: `CSpawnGroupMgrGameSystem::AllocateSpawnGroup` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_AllocateSpawnGroup.{platform}.yaml` with EXACTLY these fields:
