...
description: |
  ...
  CNetworkGameServerBase_SendPeerList in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SendPeerList, CNetworkGameServerBase_SendPeerList
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SendPeerList

Target: `CNetworkGameServerBase_SendPeerList` (func) in the module loaded in THIS session.
