...
description: |
  Agent fallback for CNetworkGameServerBase_SendPeerList (auto-generated, category: func). Locate
  CNetworkGameServerBase::SendPeerList in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SendPeerList, CNetworkGameServerBase::SendPeerList
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SendPeerList

Target: `CNetworkGameServerBase::SendPeerList` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_SendPeerList.{platform}.yaml` with EXACTLY these fields:
