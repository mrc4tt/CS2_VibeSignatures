...
description: |
  Agent fallback for CBasePlayerPawn_GetEyePosition (auto-generated, category: vfunc). Locate
  CBasePlayerPawn::GetEyePosition in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_GetEyePosition, CBasePlayerPawn::GetEyePosition
disable-model-invocation: true
---

# Find CBasePlayerPawn_GetEyePosition

Target: `CBasePlayerPawn::GetEyePosition` (vfunc) in the module loaded in THIS session.
...
Write `CBasePlayerPawn_GetEyePosition.{platform}.yaml` with EXACTLY these fields:
