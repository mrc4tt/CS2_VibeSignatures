...
description: |
  ...
  CBasePlayerPawn_GetEyePosition in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_GetEyePosition, CBasePlayerPawn_GetEyePosition
disable-model-invocation: true
---

# Find CBasePlayerPawn_GetEyePosition

Target: `CBasePlayerPawn_GetEyePosition` (vfunc) in the module loaded in THIS session.
