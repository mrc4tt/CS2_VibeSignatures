...
description: |
  ...
  CEntitySystem_PrecacheEntity-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_PrecacheEntity-decompiles, CEntitySystem_PrecacheEntity-decompiles
disable-model-invocation: true
---

# Find CEntitySystem_PrecacheEntity-decompiles

Target: `CEntitySystem_PrecacheEntity-decompiles` (func) in the module loaded in THIS session.
