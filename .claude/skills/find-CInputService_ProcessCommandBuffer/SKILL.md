---
name: find-CInputService_ProcessCommandBuffer
description: |
  Agent fallback for CInputService_ProcessCommandBuffer (auto-generated, category: func). Locate
  CInputService_ProcessCommandBuffer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_ProcessCommandBuffer, CInputService_ProcessCommandBuffer
disable-model-invocation: true
---

# Find CInputService_ProcessCommandBuffer

Target: `CInputService_ProcessCommandBuffer` (func) in the module loaded in THIS session.
...
Write `CInputService_ProcessCommandBuffer.{platform}.yaml` with EXACTLY these fields:
