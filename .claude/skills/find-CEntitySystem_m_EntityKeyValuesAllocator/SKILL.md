...
description: |
  Agent fallback for CEntitySystem_m_EntityKeyValuesAllocator (auto-generated, category: structmember). Locate
  CEntitySystem::m_EntityKeyValuesAllocator in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_EntityKeyValuesAllocator, CEntitySystem::m_EntityKeyValuesAllocator
disable-model-invocation: true
---

# Find CEntitySystem_m_EntityKeyValuesAllocator

Target: `CEntitySystem::m_EntityKeyValuesAllocator` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_EntityKeyValuesAllocator.{platform}.yaml` with EXACTLY these fields:
