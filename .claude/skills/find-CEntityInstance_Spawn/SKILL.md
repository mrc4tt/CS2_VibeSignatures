...
description: |
  Agent fallback for CEntityInstance_Spawn (auto-generated, category: vfunc). Locate
  CEntityInstance::Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Spawn, CEntityInstance::Spawn
disable-model-invocation: true
---

# Find CEntityInstance_Spawn

Target: `CEntityInstance::Spawn` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_Spawn.{platform}.yaml` with EXACTLY these fields:
