...
description: |
  ...
  CEntityInstance_Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Spawn, CEntityInstance_Spawn
disable-model-invocation: true
---

# Find CEntityInstance_Spawn

Target: `CEntityInstance_Spawn` (vfunc) in the module loaded in THIS session.
