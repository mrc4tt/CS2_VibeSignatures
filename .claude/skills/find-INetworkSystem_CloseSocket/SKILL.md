...
description: |
  ...
  INetworkSystem_CloseSocket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_CloseSocket, INetworkSystem_CloseSocket
disable-model-invocation: true
---

# Find INetworkSystem_CloseSocket

Target: `INetworkSystem_CloseSocket` (vfunc) in the module loaded in THIS session.
