...
description: |
  ...
  CCSGameRules::BeginRound in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_BeginRound, CCSGameRules::BeginRound
disable-model-invocation: true
---

# Find CCSGameRules_BeginRound

Target: `CCSGameRules::BeginRound` (func) in the module loaded in THIS session.
...
Write `CCSGameRules_BeginRound.{platform}.yaml` with EXACTLY these fields:
