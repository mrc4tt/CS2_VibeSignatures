...
description: |
  ...
  CCSGameRules_BeginRound in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_BeginRound, CCSGameRules_BeginRound
disable-model-invocation: true
---

# Find CCSGameRules_BeginRound

Target: `CCSGameRules_BeginRound` (func) in the module loaded in THIS session.
