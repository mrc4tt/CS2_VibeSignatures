---
name: find-CServerSideClientBase_dtor
description: |
  Agent fallback for CServerSideClientBase_dtor (auto-generated, category: func). Locate
  CServerSideClientBase::~CServerSideClientBase in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_dtor, CServerSideClientBase::~CServerSideClientBase
disable-model-invocation: true
---

# Find CServerSideClientBase_dtor

Target: `CServerSideClientBase::~CServerSideClientBase` (func) in the module loaded in THIS session.
...
Write `CServerSideClientBase_dtor.{platform}.yaml` with EXACTLY these fields:
