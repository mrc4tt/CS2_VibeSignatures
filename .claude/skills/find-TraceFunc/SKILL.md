...
name: find-TraceFunc
description: |
  Agent fallback for TraceFunc (auto-generated, category: func). Locate
  TraceFunc in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: TraceFunc, TraceFunc
disable-model-invocation: true
---

# Find TraceFunc

Target: `TraceFunc` (func) in the module loaded in THIS session.
...
Write `TraceFunc.{platform}.yaml` with EXACTLY these fields:
