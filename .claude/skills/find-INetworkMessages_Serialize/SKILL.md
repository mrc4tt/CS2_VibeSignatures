...
description: |
  Agent fallback for INetworkMessages_Serialize (auto-generated, category: vfunc). Locate
  INetworkMessages::Serialize in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_Serialize, INetworkMessages::Serialize
disable-model-invocation: true
---

# Find INetworkMessages_Serialize

Target: `INetworkMessages::Serialize` (vfunc) in the module loaded in THIS session.
...
Write `INetworkMessages_Serialize.{platform}.yaml` with EXACTLY these fields:
