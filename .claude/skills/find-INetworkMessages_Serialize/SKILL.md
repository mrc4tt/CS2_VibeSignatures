...
description: |
  ...
  INetworkMessages_Serialize in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_Serialize, INetworkMessages_Serialize
disable-model-invocation: true
---

# Find INetworkMessages_Serialize

Target: `INetworkMessages_Serialize` (vfunc) in the module loaded in THIS session.
