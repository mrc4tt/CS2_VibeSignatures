...
description: |
  ...
  IGameSystem_OnSpawnGroupPrecache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnSpawnGroupPrecache, IGameSystem_OnSpawnGroupPrecache
disable-model-invocation: true
---

# Find IGameSystem_OnSpawnGroupPrecache

Target: `IGameSystem_OnSpawnGroupPrecache` (vfunc) in the module loaded in THIS session.
