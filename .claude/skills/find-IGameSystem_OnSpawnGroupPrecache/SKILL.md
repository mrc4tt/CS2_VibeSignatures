...
description: |
  Agent fallback for IGameSystem_OnSpawnGroupPrecache (auto-generated, category: vfunc). Locate
  IGameSystem::OnSpawnGroupPrecache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnSpawnGroupPrecache, IGameSystem::OnSpawnGroupPrecache
disable-model-invocation: true
---

# Find IGameSystem_OnSpawnGroupPrecache

Target: `IGameSystem::OnSpawnGroupPrecache` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnSpawnGroupPrecache.{platform}.yaml` with EXACTLY these fields:
