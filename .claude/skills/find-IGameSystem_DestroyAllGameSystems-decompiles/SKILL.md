...
description: |
  ...
  IGameSystem_DestroyAllGameSystems-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_DestroyAllGameSystems-decompiles, IGameSystem_DestroyAllGameSystems-decompiles
disable-model-invocation: true
---

# Find IGameSystem_DestroyAllGameSystems-decompiles

Target: `IGameSystem_DestroyAllGameSystems-decompiles` (func) in the module loaded in THIS session.
