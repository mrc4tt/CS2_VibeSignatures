---
name: find-IGameSystem_DestroyAllGameSystems-decompiles
description: |
  Agent fallback for IGameSystem_DestroyAllGameSystems-decompiles (auto-generated, category: func). Locate
  IGameSystem::DestroyAllGameSystems in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_DestroyAllGameSystems-decompiles, IGameSystem::DestroyAllGameSystems
disable-model-invocation: true
---

# Find IGameSystem_DestroyAllGameSystems-decompiles

Target: `IGameSystem::DestroyAllGameSystems` (func) in the module loaded in THIS session.
...
Write `IGameSystem_DestroyAllGameSystems.{platform}.yaml` with EXACTLY these fields:
