---
name: find-INetworkSystem_InitNetworkSystem
description: |
  Agent fallback for INetworkSystem_InitNetworkSystem (auto-generated, category: vfunc). Locate
  INetworkSystem::InitNetworkSystem in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_InitNetworkSystem, INetworkSystem::InitNetworkSystem
disable-model-invocation: true
---

# Find INetworkSystem_InitNetworkSystem

Target: `INetworkSystem::InitNetworkSystem` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_InitNetworkSystem.{platform}.yaml` with EXACTLY these fields:
