...
description: |
  ...
  INetworkSystem_InitNetworkSystem in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_InitNetworkSystem, INetworkSystem_InitNetworkSystem
disable-model-invocation: true
---

# Find INetworkSystem_InitNetworkSystem

Target: `INetworkSystem_InitNetworkSystem` (vfunc) in the module loaded in THIS session.
