...
description: |
  ...
  INetworkMessages_FindNetworkGroup in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_FindNetworkGroup, INetworkMessages_FindNetworkGroup
disable-model-invocation: true
---

# Find INetworkMessages_FindNetworkGroup

Target: `INetworkMessages_FindNetworkGroup` (vfunc) in the module loaded in THIS session.
