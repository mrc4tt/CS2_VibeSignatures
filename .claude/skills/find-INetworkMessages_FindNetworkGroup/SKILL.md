...
description: |
  Agent fallback for INetworkMessages_FindNetworkGroup (auto-generated, category: vfunc). Locate
  INetworkMessages::FindNetworkGroup in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_FindNetworkGroup, INetworkMessages::FindNetworkGroup
disable-model-invocation: true
---

# Find INetworkMessages_FindNetworkGroup

Target: `INetworkMessages::FindNetworkGroup` (vfunc) in the module loaded in THIS session.
...
Write `INetworkMessages_FindNetworkGroup.{platform}.yaml` with EXACTLY these fields:
