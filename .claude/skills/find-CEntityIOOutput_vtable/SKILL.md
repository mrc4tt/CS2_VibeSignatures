...
description: |
  Agent fallback for CEntityIOOutput_vtable (auto-generated, category: func). Locate
  CEntityIOOutput_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityIOOutput_vtable, CEntityIOOutput_vtable
disable-model-invocation: true
---

# Find CEntityIOOutput_vtable

Target: `CEntityIOOutput_vtable` (func) in the module loaded in THIS session.
...
Write `CEntityIOOutput_vtable.{platform}.yaml` with EXACTLY these fields:
