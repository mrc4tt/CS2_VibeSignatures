...
description: |
  ...
  CServerSideClientBase_ProcessSplitPlayerConnectInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessSplitPlayerConnectInternal, CServerSideClientBase_ProcessSplitPlayerConnectInternal
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessSplitPlayerConnectInternal

Target: `CServerSideClientBase_ProcessSplitPlayerConnectInternal` (func) in the module loaded in THIS session.
