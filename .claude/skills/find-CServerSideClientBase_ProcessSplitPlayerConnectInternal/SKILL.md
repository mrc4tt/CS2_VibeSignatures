...
description: |
  Agent fallback for CServerSideClientBase_ProcessSplitPlayerConnectInternal (auto-generated, category: func). Locate
  CServerSideClientBase::ProcessSplitPlayerConnectInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessSplitPlayerConnectInternal, CServerSideClientBase::ProcessSplitPlayerConnectInternal
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessSplitPlayerConnectInternal

Target: `CServerSideClientBase::ProcessSplitPlayerConnectInternal` (func) in the module loaded in THIS session.
...
Write `CServerSideClientBase_ProcessSplitPlayerConnectInternal.{platform}.yaml` with EXACTLY these fields:
