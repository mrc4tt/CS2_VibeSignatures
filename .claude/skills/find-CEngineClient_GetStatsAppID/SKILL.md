...
description: |
  ...
  CEngineClient_GetStatsAppID in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_GetStatsAppID, CEngineClient_GetStatsAppID
disable-model-invocation: true
---

# Find CEngineClient_GetStatsAppID

Target: `CEngineClient_GetStatsAppID` (vfunc) in the module loaded in THIS session.
