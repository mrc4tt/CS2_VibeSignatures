...
description: |
  Agent fallback for CTriggerPush_Touch (auto-generated, category: vfunc). Locate
  CTriggerPush::Touch in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTriggerPush_Touch, CTriggerPush::Touch
disable-model-invocation: true
---

# Find CTriggerPush_Touch

Target: `CTriggerPush::Touch` (vfunc) in the module loaded in THIS session.
...
Write `CTriggerPush_Touch.{platform}.yaml` with EXACTLY these fields:
