...
description: |
  ...
  CTriggerPush_Touch in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTriggerPush_Touch, CTriggerPush_Touch
disable-model-invocation: true
---

# Find CTriggerPush_Touch

Target: `CTriggerPush_Touch` (vfunc) in the module loaded in THIS session.
