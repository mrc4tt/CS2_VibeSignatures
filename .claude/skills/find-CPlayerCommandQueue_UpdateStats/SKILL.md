---
name: find-CPlayerCommandQueue_UpdateStats
description: |
  Agent fallback for CPlayerCommandQueue_UpdateStats (auto-generated, category: func). Locate
  CPlayerCommandQueue::UpdateStats in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayerCommandQueue_UpdateStats, CPlayerCommandQueue::UpdateStats
disable-model-invocation: true
---

# Find CPlayerCommandQueue_UpdateStats

Target: `CPlayerCommandQueue::UpdateStats` (func) in the module loaded in THIS session.
...
Write `CPlayerCommandQueue_UpdateStats.{platform}.yaml` with EXACTLY these fields:
