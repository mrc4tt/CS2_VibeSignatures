...
description: |
  ...
  CPlayerCommandQueue_UpdateStats in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayerCommandQueue_UpdateStats, CPlayerCommandQueue_UpdateStats
disable-model-invocation: true
---

# Find CPlayerCommandQueue_UpdateStats

Target: `CPlayerCommandQueue_UpdateStats` (func) in the module loaded in THIS session.
