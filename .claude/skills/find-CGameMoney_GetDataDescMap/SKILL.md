...
description: |
  Agent fallback for CGameMoney_GetDataDescMap (auto-generated, category: vfunc). Locate
  CGameMoney::GetDataDescMap in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameMoney_GetDataDescMap, CGameMoney::GetDataDescMap
disable-model-invocation: true
---

# Find CGameMoney_GetDataDescMap

Target: `CGameMoney::GetDataDescMap` (vfunc) in the module loaded in THIS session.
...
Write `CGameMoney_GetDataDescMap.{platform}.yaml` with EXACTLY these fields:
