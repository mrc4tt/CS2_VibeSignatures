...
description: |
  ...
  CGameMoney_GetDataDescMap in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameMoney_GetDataDescMap, CGameMoney_GetDataDescMap
disable-model-invocation: true
---

# Find CGameMoney_GetDataDescMap

Target: `CGameMoney_GetDataDescMap` (vfunc) in the module loaded in THIS session.
