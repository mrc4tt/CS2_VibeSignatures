...
description: |
  Agent fallback for CNetworkGameClient_CopyNewEntity (auto-generated, category: vfunc). Locate
  CNetworkGameClient::CopyNewEntity in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_CopyNewEntity, CNetworkGameClient::CopyNewEntity
disable-model-invocation: true
---

# Find CNetworkGameClient_CopyNewEntity

Target: `CNetworkGameClient::CopyNewEntity` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_CopyNewEntity.{platform}.yaml` with EXACTLY these fields:
