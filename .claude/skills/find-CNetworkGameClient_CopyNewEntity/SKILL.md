...
description: |
  ...
  CNetworkGameClient_CopyNewEntity in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_CopyNewEntity, CNetworkGameClient_CopyNewEntity
disable-model-invocation: true
---

# Find CNetworkGameClient_CopyNewEntity

Target: `CNetworkGameClient_CopyNewEntity` (vfunc) in the module loaded in THIS session.
