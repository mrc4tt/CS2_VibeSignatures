...
description: |
  Agent fallback for INetworkGameServer_IsChangelevelPending (auto-generated, category: vfunc). Locate
  INetworkGameServer::IsChangelevelPending in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_IsChangelevelPending, INetworkGameServer::IsChangelevelPending
disable-model-invocation: true
---

# Find INetworkGameServer_IsChangelevelPending

Target: `INetworkGameServer::IsChangelevelPending` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_IsChangelevelPending.{platform}.yaml` with EXACTLY these fields:
