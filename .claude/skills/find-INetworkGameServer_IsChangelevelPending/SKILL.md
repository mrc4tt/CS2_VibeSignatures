...
description: |
  ...
  INetworkGameServer_IsChangelevelPending in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_IsChangelevelPending, INetworkGameServer_IsChangelevelPending
disable-model-invocation: true
---

# Find INetworkGameServer_IsChangelevelPending

Target: `INetworkGameServer_IsChangelevelPending` (vfunc) in the module loaded in THIS session.
