...
description: |
  ...
  IGameSystem_OnGamePreShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGamePreShutdown, IGameSystem_OnGamePreShutdown
disable-model-invocation: true
---

# Find IGameSystem_OnGamePreShutdown

Target: `IGameSystem_OnGamePreShutdown` (vfunc) in the module loaded in THIS session.
