...
description: |
  Agent fallback for IGameSystem_OnGamePreShutdown (auto-generated, category: vfunc). Locate
  IGameSystem::GamePreShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGamePreShutdown, IGameSystem::GamePreShutdown
disable-model-invocation: true
---

# Find IGameSystem_OnGamePreShutdown

Target: `IGameSystem::GamePreShutdown` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnGamePreShutdown.{platform}.yaml` with EXACTLY these fields:
