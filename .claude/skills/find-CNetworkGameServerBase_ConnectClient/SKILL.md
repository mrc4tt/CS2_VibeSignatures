...
description: |
  ...
  CNetworkGameServerBase_ConnectClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ConnectClient, CNetworkGameServerBase_ConnectClient
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ConnectClient

Target: `CNetworkGameServerBase_ConnectClient` (func) in the module loaded in THIS session.
