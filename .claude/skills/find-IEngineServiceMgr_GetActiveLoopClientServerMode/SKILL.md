...
description: |
  Agent fallback for IEngineServiceMgr_GetActiveLoopClientServerMode (auto-generated, category: vfunc). Locate
  IEngineServiceMgr::GetActiveLoopClientServerMode in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_GetActiveLoopClientServerMode, IEngineServiceMgr::GetActiveLoopClientServerMode
disable-model-invocation: true
---

# Find IEngineServiceMgr_GetActiveLoopClientServerMode

Target: `IEngineServiceMgr::GetActiveLoopClientServerMode` (vfunc) in the module loaded in THIS session.
...
Write `IEngineServiceMgr_GetActiveLoopClientServerMode.{platform}.yaml` with EXACTLY these fields:
