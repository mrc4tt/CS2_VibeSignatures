...
description: |
  ...
  IEngineServiceMgr_GetActiveLoopClientServerMode in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_GetActiveLoopClientServerMode, IEngineServiceMgr_GetActiveLoopClientServerMode
disable-model-invocation: true
---

# Find IEngineServiceMgr_GetActiveLoopClientServerMode

Target: `IEngineServiceMgr_GetActiveLoopClientServerMode` (vfunc) in the module loaded in THIS session.
