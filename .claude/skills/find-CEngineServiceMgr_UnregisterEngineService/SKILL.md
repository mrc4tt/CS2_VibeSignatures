...
description: |
  Agent fallback for CEngineServiceMgr_UnregisterEngineService (auto-generated, category: func). Locate
  CEngineServiceMgr_UnregisterEngineService in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_UnregisterEngineService, CEngineServiceMgr_UnregisterEngineService
disable-model-invocation: true
---

# Find CEngineServiceMgr_UnregisterEngineService

Target: `CEngineServiceMgr_UnregisterEngineService` (func) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_UnregisterEngineService.{platform}.yaml` with EXACTLY these fields:
