...
description: |
  Agent fallback for CNetworkGameServerBase_BroadcastPrintf (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::BroadcastPrintf in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_BroadcastPrintf, CNetworkGameServerBase::BroadcastPrintf
disable-model-invocation: true
---

# Find CNetworkGameServerBase_BroadcastPrintf

Target: `CNetworkGameServerBase::BroadcastPrintf` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_BroadcastPrintf.{platform}.yaml` with EXACTLY these fields:
