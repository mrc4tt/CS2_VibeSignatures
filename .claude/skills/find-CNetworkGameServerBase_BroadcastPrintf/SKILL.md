...
description: |
  ...
  CNetworkGameServerBase_BroadcastPrintf in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_BroadcastPrintf, CNetworkGameServerBase_BroadcastPrintf
disable-model-invocation: true
---

# Find CNetworkGameServerBase_BroadcastPrintf

Target: `CNetworkGameServerBase_BroadcastPrintf` (vfunc) in the module loaded in THIS session.
