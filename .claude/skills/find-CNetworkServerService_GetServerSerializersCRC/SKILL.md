---
name: find-CNetworkServerService_GetServerSerializersCRC
description: |
  Agent fallback for CNetworkServerService_GetServerSerializersCRC (auto-generated, category: func). Locate
  CNetworkServerService_GetServerSerializersCRC in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_GetServerSerializersCRC, CNetworkServerService_GetServerSerializersCRC
disable-model-invocation: true
---

# Find CNetworkServerService_GetServerSerializersCRC

Target: `CNetworkServerService_GetServerSerializersCRC` (func) in the module loaded in THIS session.
...
Write `CNetworkServerService_GetServerSerializersCRC.{platform}.yaml` with EXACTLY these fields:
