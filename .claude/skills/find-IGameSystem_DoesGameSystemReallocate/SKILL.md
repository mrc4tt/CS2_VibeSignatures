...
description: |
  Agent fallback for IGameSystem_DoesGameSystemReallocate (auto-generated, category: func). Locate
  IGameSystem_DoesGameSystemReallocate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_DoesGameSystemReallocate, IGameSystem_DoesGameSystemReallocate
disable-model-invocation: true
---

# Find IGameSystem_DoesGameSystemReallocate

Target: `IGameSystem_DoesGameSystemReallocate` (func) in the module loaded in THIS session.
...
Write `IGameSystem_DoesGameSystemReallocate.{platform}.yaml` with EXACTLY these fields:
