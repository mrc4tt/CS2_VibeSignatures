...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_SpawnGroupShutdown (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::SpawnGroupShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupShutdown, CSpawnGroupMgrGameSystem::SpawnGroupShutdown
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupShutdown

Target: `CSpawnGroupMgrGameSystem::SpawnGroupShutdown` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_SpawnGroupShutdown.{platform}.yaml` with EXACTLY these fields:
