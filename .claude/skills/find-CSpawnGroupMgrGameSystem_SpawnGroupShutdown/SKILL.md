...
description: |
  ...
  CSpawnGroupMgrGameSystem_SpawnGroupShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupShutdown, CSpawnGroupMgrGameSystem_SpawnGroupShutdown
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupShutdown

Target: `CSpawnGroupMgrGameSystem_SpawnGroupShutdown` (vfunc) in the module loaded in THIS session.
