...
description: |
  Agent fallback for GiveCommand (auto-generated, category: func). Locate
  GiveCommand in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GiveCommand, GiveCommand
disable-model-invocation: true
---

# Find GiveCommand

Target: `GiveCommand` (func) in the module loaded in THIS session.
...
Write `GiveCommand.{platform}.yaml` with EXACTLY these fields:
