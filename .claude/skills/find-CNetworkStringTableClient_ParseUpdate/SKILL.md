...
description: |
  ...
  CNetworkStringTableClient_ParseUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkStringTableClient_ParseUpdate, CNetworkStringTableClient_ParseUpdate
disable-model-invocation: true
---

# Find CNetworkStringTableClient_ParseUpdate

Target: `CNetworkStringTableClient_ParseUpdate` (func) in the module loaded in THIS session.
