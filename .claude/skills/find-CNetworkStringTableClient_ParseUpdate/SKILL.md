---
name: find-CNetworkStringTableClient_ParseUpdate
description: |
  Agent fallback for CNetworkStringTableClient_ParseUpdate (auto-generated, category: func). Locate
  CNetworkStringTableClient::ParseUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkStringTableClient_ParseUpdate, CNetworkStringTableClient::ParseUpdate
disable-model-invocation: true
---

# Find CNetworkStringTableClient_ParseUpdate

Target: `CNetworkStringTableClient::ParseUpdate` (func) in the module loaded in THIS session.
...
Write `CNetworkStringTableClient_ParseUpdate.{platform}.yaml` with EXACTLY these fields:
