...
description: |
  Agent fallback for CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats (auto-generated, category: func). Locate
  CNetworkUtlVectorEmbedded<CSPerRoundStats_t>::NetworkStateChanged_m_perRoundStats in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats, CNetworkUtlVectorEmbedded<CSPerRoundStats_t>::NetworkStateChanged_m_perRoundStats
disable-model-invocation: true
---

# Find CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats

Target: `CNetworkUtlVectorEmbedded<CSPerRoundStats_t>::NetworkStateChanged_m_perRoundStats` (func) in the module loaded in THIS session.
...
Write `CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats.{platform}.yaml` with EXACTLY these fields:
