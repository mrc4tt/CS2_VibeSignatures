...
description: |
  ...
  CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats, CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats
disable-model-invocation: true
---

# Find CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats

Target: `CNetworkUtlVectorEmbedded_NetworkStateChanged_m_perRoundStats` (func) in the module loaded in THIS session.
