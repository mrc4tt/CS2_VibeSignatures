...
description: |
  Agent fallback for CEntitySystem_CreateEntity (auto-generated, category: func). Locate
  CEntitySystem::CreateEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_CreateEntity, CEntitySystem::CreateEntity
disable-model-invocation: true
---

# Find CEntitySystem_CreateEntity

Target: `CEntitySystem::CreateEntity` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_CreateEntity.{platform}.yaml` with EXACTLY these fields:
