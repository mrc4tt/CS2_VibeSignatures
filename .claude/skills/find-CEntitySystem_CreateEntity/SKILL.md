...
description: |
  ...
  CEntitySystem_CreateEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_CreateEntity, CEntitySystem_CreateEntity
disable-model-invocation: true
---

# Find CEntitySystem_CreateEntity

Target: `CEntitySystem_CreateEntity` (func) in the module loaded in THIS session.
