...
description: |
  Agent fallback for CSource2Server_GameFrame (auto-generated, category: vfunc). Locate
  ...
  Trigger: CSource2Server_GameFrame, CSource2Server::GameFrame
disable-model-invocation: true
---

# Find CSource2Server_GameFrame
