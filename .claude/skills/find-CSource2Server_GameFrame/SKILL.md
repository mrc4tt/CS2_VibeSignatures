...
description: |
  ...
  CSource2Server_GameFrame in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameFrame, CSource2Server_GameFrame
disable-model-invocation: true
---

# Find CSource2Server_GameFrame

Target: `CSource2Server_GameFrame` (vfunc) in the module loaded in THIS session.
