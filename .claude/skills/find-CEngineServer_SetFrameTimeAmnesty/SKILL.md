...
description: |
  Agent fallback for CEngineServer_SetFrameTimeAmnesty (auto-generated, category: vfunc). Locate
  CEngineServer::SetFrameTimeAmnesty in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_SetFrameTimeAmnesty, CEngineServer::SetFrameTimeAmnesty
disable-model-invocation: true
---

# Find CEngineServer_SetFrameTimeAmnesty

Target: `CEngineServer::SetFrameTimeAmnesty` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_SetFrameTimeAmnesty.{platform}.yaml` with EXACTLY these fields:
