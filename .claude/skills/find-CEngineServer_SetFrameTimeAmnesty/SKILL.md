...
description: |
  ...
  CEngineServer_SetFrameTimeAmnesty in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_SetFrameTimeAmnesty, CEngineServer_SetFrameTimeAmnesty
disable-model-invocation: true
---

# Find CEngineServer_SetFrameTimeAmnesty

Target: `CEngineServer_SetFrameTimeAmnesty` (vfunc) in the module loaded in THIS session.
