...
description: |
  ...
  CEntitySaveRestoreBlockHandler_Save in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_Save, CEntitySaveRestoreBlockHandler_Save
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_Save

Target: `CEntitySaveRestoreBlockHandler_Save` (vfunc) in the module loaded in THIS session.
