...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_Save (auto-generated, category: vfunc). Locate
  CEntitySaveRestoreBlockHandler::Save in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_Save, CEntitySaveRestoreBlockHandler::Save
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_Save

Target: `CEntitySaveRestoreBlockHandler::Save` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_Save.{platform}.yaml` with EXACTLY these fields:
