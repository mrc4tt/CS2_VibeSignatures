...
description: |
  ...
  CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline, CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline

Target: `CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline` (vfunc) in the module loaded in THIS session.
