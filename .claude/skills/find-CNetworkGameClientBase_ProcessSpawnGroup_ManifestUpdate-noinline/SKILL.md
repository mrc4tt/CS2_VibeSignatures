---
name: find-CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline
description: |
  Agent fallback for CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::ProcessSpawnGroup_ManifestUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline, CNetworkGameClientBase::ProcessSpawnGroup_ManifestUpdate
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate-noinline

Target: `CNetworkGameClientBase::ProcessSpawnGroup_ManifestUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ProcessSpawnGroup_ManifestUpdate.{platform}.yaml` with EXACTLY these fields:
