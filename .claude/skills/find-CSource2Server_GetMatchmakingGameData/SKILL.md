...
description: |
  Agent fallback for CSource2Server_GetMatchmakingGameData (auto-generated, category: vfunc). Locate
  CSource2Server::GetMatchmakingGameData in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetMatchmakingGameData, CSource2Server::GetMatchmakingGameData
disable-model-invocation: true
---

# Find CSource2Server_GetMatchmakingGameData

Target: `CSource2Server::GetMatchmakingGameData` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GetMatchmakingGameData.{platform}.yaml` with EXACTLY these fields:
