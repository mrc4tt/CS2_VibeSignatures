...
description: |
  ...
  CSource2Server_GetMatchmakingGameData in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetMatchmakingGameData, CSource2Server_GetMatchmakingGameData
disable-model-invocation: true
---

# Find CSource2Server_GetMatchmakingGameData

Target: `CSource2Server_GetMatchmakingGameData` (vfunc) in the module loaded in THIS session.
