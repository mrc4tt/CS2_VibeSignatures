...
description: |
  Agent fallback for GameTypes_vtable (auto-generated, category: func). Locate
  GameTypes_vtable in the CS2 matchmaking module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GameTypes_vtable, GameTypes_vtable
disable-model-invocation: true
---

# Find GameTypes_vtable

Target: `GameTypes_vtable` (func) in the module loaded in THIS session.
...
Write `GameTypes_vtable.{platform}.yaml` with EXACTLY these fields:
