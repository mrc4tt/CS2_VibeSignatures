...
description: |
  ...
  CEntityInstance_ScriptAcceptInput in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ScriptAcceptInput, CEntityInstance_ScriptAcceptInput
disable-model-invocation: true
---

# Find CEntityInstance_ScriptAcceptInput

Target: `CEntityInstance_ScriptAcceptInput` (vfunc) in the module loaded in THIS session.
