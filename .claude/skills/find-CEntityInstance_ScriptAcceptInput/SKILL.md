---
name: find-CEntityInstance_ScriptAcceptInput
description: |
  Agent fallback for CEntityInstance_ScriptAcceptInput (auto-generated, category: vfunc). Locate
  CEntityInstance::ScriptAcceptInput in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ScriptAcceptInput, CEntityInstance::ScriptAcceptInput
disable-model-invocation: true
---

# Find CEntityInstance_ScriptAcceptInput

Target: `CEntityInstance::ScriptAcceptInput` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_ScriptAcceptInput.{platform}.yaml` with EXACTLY these fields:
