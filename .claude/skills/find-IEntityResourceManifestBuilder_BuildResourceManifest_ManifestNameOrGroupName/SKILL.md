...
description: |
  Agent fallback for IEntityResourceManifestBuilder_BuildResourceManifest_ManifestNameOrGroupName (auto-generated, category: func). Locate
  IEntityResourceManifestBuilder_BuildResourceManifest_ManifestNameOrGroupName in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEntityResourceManifestBuilder_BuildResourceManifest_ManifestNameOrGroupName, IEntityResourceManifestBuilder_BuildResourceManifest_ManifestNameOrGroupName
disable-model-invocation: true
---

# Find IEntityResourceManifestBuilder_BuildResourceManifest_ManifestNameOrGroupName

Target: `IEntityResourceManifestBuilder_BuildResourceManifest_ManifestNameOrGroupName` (func) in the module loaded in THIS session.
...
Write `IEntityResourceManifestBuilder_BuildResourceManifest_ManifestNameOrGroupName.{platform}.yaml` with EXACTLY these fields:
