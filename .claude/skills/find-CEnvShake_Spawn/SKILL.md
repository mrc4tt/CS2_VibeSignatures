...
description: |
  ...
  CEnvShake_Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEnvShake_Spawn, CEnvShake_Spawn
disable-model-invocation: true
---

# Find CEnvShake_Spawn

Target: `CEnvShake_Spawn` (vfunc) in the module loaded in THIS session.
