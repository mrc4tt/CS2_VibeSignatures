...
description: |
  Agent fallback for CEnvShake_Spawn (auto-generated, category: vfunc). Locate
  CEnvShake::Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEnvShake_Spawn, CEnvShake::Spawn
disable-model-invocation: true
---

# Find CEnvShake_Spawn

Target: `CEnvShake::Spawn` (vfunc) in the module loaded in THIS session.
...
Write `CEnvShake_Spawn.{platform}.yaml` with EXACTLY these fields:
