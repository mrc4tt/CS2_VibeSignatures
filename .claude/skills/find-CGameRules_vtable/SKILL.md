...
description: |
  Agent fallback for CGameRules_vtable (auto-generated, category: func). Locate
  CGameRules_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_vtable, CGameRules_vtable
disable-model-invocation: true
---

# Find CGameRules_vtable

Target: `CGameRules_vtable` (func) in the module loaded in THIS session.
...
Write `CGameRules_vtable.{platform}.yaml` with EXACTLY these fields:
