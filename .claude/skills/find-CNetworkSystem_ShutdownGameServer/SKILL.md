---
name: find-CNetworkSystem_ShutdownGameServer
description: |
  Agent fallback for CNetworkSystem_ShutdownGameServer (auto-generated, category: func). Locate
  CNetworkSystem_ShutdownGameServer in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_ShutdownGameServer, CNetworkSystem_ShutdownGameServer
disable-model-invocation: true
---

# Find CNetworkSystem_ShutdownGameServer

Target: `CNetworkSystem_ShutdownGameServer` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_ShutdownGameServer.{platform}.yaml` with EXACTLY these fields:
