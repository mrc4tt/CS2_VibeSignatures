...
description: |
  Agent fallback for CNetworkSystem_ShutdownGameServer (auto-generated, category: vfunc). Locate
...
Target: `CNetworkSystem_ShutdownGameServer` (vfunc) in the module loaded in THIS session.
