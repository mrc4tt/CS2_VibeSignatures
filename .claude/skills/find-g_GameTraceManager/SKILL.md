...
description: |
  Agent fallback for g_GameTraceManager (auto-generated, category: func). Locate
  g_GameTraceManager in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: g_GameTraceManager, g_GameTraceManager
disable-model-invocation: true
---

# Find g_GameTraceManager

Target: `g_GameTraceManager` (func) in the module loaded in THIS session.
...
Write `g_GameTraceManager.{platform}.yaml` with EXACTLY these fields:
