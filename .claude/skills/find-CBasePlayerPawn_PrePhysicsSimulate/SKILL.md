...
description: |
  ...
  CBasePlayerPawn_PrePhysicsSimulate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_PrePhysicsSimulate, CBasePlayerPawn_PrePhysicsSimulate
disable-model-invocation: true
---

# Find CBasePlayerPawn_PrePhysicsSimulate

Target: `CBasePlayerPawn_PrePhysicsSimulate` (vfunc) in the module loaded in THIS session.
