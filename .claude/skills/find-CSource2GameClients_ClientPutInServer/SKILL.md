...
description: |
  Agent fallback for CSource2GameClients_ClientPutInServer (auto-generated, category: vfunc). Locate
  CSource2GameClients::ClientPutInServer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientPutInServer, CSource2GameClients::ClientPutInServer
disable-model-invocation: true
---

# Find CSource2GameClients_ClientPutInServer

Target: `CSource2GameClients::ClientPutInServer` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientPutInServer.{platform}.yaml` with EXACTLY these fields:
