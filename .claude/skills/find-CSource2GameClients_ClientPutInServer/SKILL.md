...
description: |
  ...
  CSource2GameClients_ClientPutInServer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientPutInServer, CSource2GameClients_ClientPutInServer
disable-model-invocation: true
---

# Find CSource2GameClients_ClientPutInServer

Target: `CSource2GameClients_ClientPutInServer` (vfunc) in the module loaded in THIS session.
