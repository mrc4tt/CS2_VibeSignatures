---
name: find-CEngineServer_ServerCommand
description: |
  Agent fallback for CEngineServer_ServerCommand (auto-generated, category: func). Locate
  CEngineServer_ServerCommand in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ServerCommand, CEngineServer_ServerCommand
disable-model-invocation: true
---

# Find CEngineServer_ServerCommand

Target: `CEngineServer_ServerCommand` (func) in the module loaded in THIS session.
...
Write `CEngineServer_ServerCommand.{platform}.yaml` with EXACTLY these fields:
