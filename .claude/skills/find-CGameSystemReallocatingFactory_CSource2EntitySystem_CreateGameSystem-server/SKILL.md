---
name: find-CGameSystemReallocatingFactory_CSource2EntitySystem_CreateGameSystem-server
description: |
  Agent fallback for CGameSystemReallocatingFactory_CSource2EntitySystem_CreateGameSystem-server (auto-generated, category: vfunc). Locate
  CGameSystemReallocatingFactory<CSource2EntitySystem>::CreateGameSystem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSystemReallocatingFactory_CSource2EntitySystem_CreateGameSystem-server, CGameSystemReallocatingFactory<CSource2EntitySystem>::CreateGameSystem
