...
description: |
  ...
  CNetworkMessages_FindNetworkMessage in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_FindNetworkMessage, CNetworkMessages_FindNetworkMessage
disable-model-invocation: true
---

# Find CNetworkMessages_FindNetworkMessage

Target: `CNetworkMessages_FindNetworkMessage` (vfunc) in the module loaded in THIS session.
