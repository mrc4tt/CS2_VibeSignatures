...
description: |
  Agent fallback for CNetworkMessages_FindNetworkMessage (auto-generated, category: vfunc). Locate
  CNetworkMessages::FindNetworkMessage in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_FindNetworkMessage, CNetworkMessages::FindNetworkMessage
disable-model-invocation: true
---

# Find CNetworkMessages_FindNetworkMessage

Target: `CNetworkMessages::FindNetworkMessage` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_FindNetworkMessage.{platform}.yaml` with EXACTLY these fields:
