...
description: |
  Agent fallback for CGameSceneNode_vtable (auto-generated, category: func). Locate
  CGameSceneNode_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_vtable, CGameSceneNode_vtable
disable-model-invocation: true
---

# Find CGameSceneNode_vtable

Target: `CGameSceneNode_vtable` (func) in the module loaded in THIS session.
...
Write `CGameSceneNode_vtable.{platform}.yaml` with EXACTLY these fields:
