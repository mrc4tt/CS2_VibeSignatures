...
description: |
  ...
  CGameEntitySystem_FindEntityProcedural in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_FindEntityProcedural, CGameEntitySystem_FindEntityProcedural
disable-model-invocation: true
---

# Find CGameEntitySystem_FindEntityProcedural

Target: `CGameEntitySystem_FindEntityProcedural` (vfunc) in the module loaded in THIS session.
