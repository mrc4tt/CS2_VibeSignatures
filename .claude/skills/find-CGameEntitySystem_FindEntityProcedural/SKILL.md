...
description: |
  Agent fallback for CGameEntitySystem_FindEntityProcedural (auto-generated, category: vfunc). Locate
  CGameEntitySystem::FindEntityProcedural in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_FindEntityProcedural, CGameEntitySystem::FindEntityProcedural
disable-model-invocation: true
---

# Find CGameEntitySystem_FindEntityProcedural

Target: `CGameEntitySystem::FindEntityProcedural` (vfunc) in the module loaded in THIS session.
...
Write `CGameEntitySystem_FindEntityProcedural.{platform}.yaml` with EXACTLY these fields:
