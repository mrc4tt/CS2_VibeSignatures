...
description: |
  ...
  CGameEntitySystem_Spawn-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_Spawn-decompiles, CGameEntitySystem_Spawn-decompiles
disable-model-invocation: true
---

# Find CGameEntitySystem_Spawn-decompiles

Target: `CGameEntitySystem_Spawn-decompiles` (vfunc) in the module loaded in THIS session.
