---
name: find-CGameEntitySystem_Spawn-decompiles
description: |
  Agent fallback for CGameEntitySystem_Spawn-decompiles (auto-generated, category: vfunc). Locate
  CGameEntitySystem::Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_Spawn-decompiles, CGameEntitySystem::Spawn
disable-model-invocation: true
---

# Find CGameEntitySystem_Spawn-decompiles

Target: `CGameEntitySystem::Spawn` (vfunc) in the module loaded in THIS session.
...
Write `CGameEntitySystem_Spawn.{platform}.yaml` with EXACTLY these fields:
