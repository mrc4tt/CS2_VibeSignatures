...
description: |
  Agent fallback for CEntityIdentity_AcceptInputInternal (auto-generated, category: func). Locate
  CEntityIdentity::AcceptInputInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityIdentity_AcceptInputInternal, CEntityIdentity::AcceptInputInternal
disable-model-invocation: true
---

# Find CEntityIdentity_AcceptInputInternal

Target: `CEntityIdentity::AcceptInputInternal` (func) in the module loaded in THIS session.
...
Write `CEntityIdentity_AcceptInputInternal.{platform}.yaml` with EXACTLY these fields:
