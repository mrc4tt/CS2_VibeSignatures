...
description: |
  ...
  CEntityIdentity_AcceptInputInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityIdentity_AcceptInputInternal, CEntityIdentity_AcceptInputInternal
disable-model-invocation: true
---

# Find CEntityIdentity_AcceptInputInternal

Target: `CEntityIdentity_AcceptInputInternal` (func) in the module loaded in THIS session.
