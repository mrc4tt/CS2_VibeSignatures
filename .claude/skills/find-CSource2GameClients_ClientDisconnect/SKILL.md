...
description: |
  ...
  CSource2GameClients_ClientDisconnect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientDisconnect, CSource2GameClients_ClientDisconnect
disable-model-invocation: true
---

# Find CSource2GameClients_ClientDisconnect

Target: `CSource2GameClients_ClientDisconnect` (vfunc) in the module loaded in THIS session.
