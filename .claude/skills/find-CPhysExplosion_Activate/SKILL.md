...
description: |
  ...
  CPhysExplosion_Activate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysExplosion_Activate, CPhysExplosion_Activate
disable-model-invocation: true
---

# Find CPhysExplosion_Activate

Target: `CPhysExplosion_Activate` (vfunc) in the module loaded in THIS session.
