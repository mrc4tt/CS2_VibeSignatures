...
description: |
  Agent fallback for CPhysExplosion_Activate (auto-generated, category: vfunc). Locate
  ...
  Trigger: CPhysExplosion_Activate, CPhysExplosion::Activate
disable-model-invocation: true
---

# Find CPhysExplosion_Activate
