...
description: |
  ...
  CClientInput_CreateMove-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CClientInput_CreateMove-decompiles, CClientInput_CreateMove-decompiles
disable-model-invocation: true
---

# Find CClientInput_CreateMove-decompiles

Target: `CClientInput_CreateMove-decompiles` (vfunc) in the module loaded in THIS session.
