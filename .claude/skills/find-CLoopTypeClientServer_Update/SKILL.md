...
description: |
  ...
  CLoopTypeClientServer_Update in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_Update, CLoopTypeClientServer_Update
disable-model-invocation: true
---

# Find CLoopTypeClientServer_Update

Target: `CLoopTypeClientServer_Update` (vfunc) in the module loaded in THIS session.
