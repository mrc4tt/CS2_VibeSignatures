...
description: |
  Agent fallback for CLoopTypeClientServer_Update (auto-generated, category: vfunc). Locate
  CLoopTypeClientServer::Update in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_Update, CLoopTypeClientServer::Update
disable-model-invocation: true
---

# Find CLoopTypeClientServer_Update

Target: `CLoopTypeClientServer::Update` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_Update.{platform}.yaml` with EXACTLY these fields:
