...
description: |
  Agent fallback for IGameSystem_OnPostSpawnGroupLoad (auto-generated, category: vfunc). Locate
  IGameSystem::OnPostSpawnGroupLoad in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnPostSpawnGroupLoad, IGameSystem::OnPostSpawnGroupLoad
disable-model-invocation: true
---

# Find IGameSystem_OnPostSpawnGroupLoad

Target: `IGameSystem::OnPostSpawnGroupLoad` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnPostSpawnGroupLoad.{platform}.yaml` with EXACTLY these fields:
