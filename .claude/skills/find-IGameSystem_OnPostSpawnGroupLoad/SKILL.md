...
description: |
  ...
  IGameSystem_OnPostSpawnGroupLoad in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnPostSpawnGroupLoad, IGameSystem_OnPostSpawnGroupLoad
disable-model-invocation: true
---

# Find IGameSystem_OnPostSpawnGroupLoad

Target: `IGameSystem_OnPostSpawnGroupLoad` (vfunc) in the module loaded in THIS session.
