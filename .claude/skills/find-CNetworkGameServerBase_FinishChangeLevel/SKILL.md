...
description: |
  Agent fallback for CNetworkGameServerBase_FinishChangeLevel (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::FinishChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_FinishChangeLevel, CNetworkGameServerBase::FinishChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameServerBase_FinishChangeLevel

Target: `CNetworkGameServerBase::FinishChangeLevel` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_FinishChangeLevel.{platform}.yaml` with EXACTLY these fields:
