...
description: |
  ...
  CNetworkGameServerBase_FinishChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_FinishChangeLevel, CNetworkGameServerBase_FinishChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameServerBase_FinishChangeLevel

Target: `CNetworkGameServerBase_FinishChangeLevel` (vfunc) in the module loaded in THIS session.
