...
description: |
  Agent fallback for CSource2Server_Shutdown (auto-generated, category: vfunc). Locate
  ...
  Trigger: CSource2Server_Shutdown, CSource2Server::Shutdown
disable-model-invocation: true
---

# Find CSource2Server_Shutdown
