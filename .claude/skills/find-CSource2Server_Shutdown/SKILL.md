...
description: |
  ...
  CSource2Server_Shutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Shutdown, CSource2Server_Shutdown
disable-model-invocation: true
---

# Find CSource2Server_Shutdown

Target: `CSource2Server_Shutdown` (vfunc) in the module loaded in THIS session.
