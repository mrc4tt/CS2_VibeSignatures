...
description: |
  Agent fallback for CCSPlayerPawn_PostThink (auto-generated, category: vfunc). Locate
  CCSPlayerPawnBase::PostThink in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_PostThink, CCSPlayerPawnBase::PostThink
disable-model-invocation: true
---

# Find CCSPlayerPawn_PostThink

Target: `CCSPlayerPawnBase::PostThink` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_PostThink.{platform}.yaml` with EXACTLY these fields:
