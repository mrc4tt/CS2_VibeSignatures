...
description: |
  ...
  CCSPlayerPawn_PostThink in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_PostThink, CCSPlayerPawn_PostThink
disable-model-invocation: true
---

# Find CCSPlayerPawn_PostThink

Target: `CCSPlayerPawn_PostThink` (vfunc) in the module loaded in THIS session.
