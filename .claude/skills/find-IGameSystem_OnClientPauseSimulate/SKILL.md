...
description: |
  Agent fallback for IGameSystem_OnClientPauseSimulate (auto-generated, category: vfunc). Locate
  IGameSystem::OnClientPauseSimulate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPauseSimulate, IGameSystem::OnClientPauseSimulate
disable-model-invocation: true
---

# Find IGameSystem_OnClientPauseSimulate

Target: `IGameSystem::OnClientPauseSimulate` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientPauseSimulate.{platform}.yaml` with EXACTLY these fields:
