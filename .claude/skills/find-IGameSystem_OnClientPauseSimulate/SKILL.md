...
description: |
  ...
  IGameSystem_OnClientPauseSimulate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPauseSimulate, IGameSystem_OnClientPauseSimulate
disable-model-invocation: true
---

# Find IGameSystem_OnClientPauseSimulate

Target: `IGameSystem_OnClientPauseSimulate` (vfunc) in the module loaded in THIS session.
