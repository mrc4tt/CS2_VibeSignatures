...
description: |
  Agent fallback for CNetworkClientService_SendNetMessage (auto-generated, category: func). Locate
  CNetworkClientService_SendNetMessage in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_SendNetMessage, CNetworkClientService_SendNetMessage
disable-model-invocation: true
---

# Find CNetworkClientService_SendNetMessage

Target: `CNetworkClientService_SendNetMessage` (func) in the module loaded in THIS session.
...
Write `CNetworkClientService_SendNetMessage.{platform}.yaml` with EXACTLY these fields:
