...
description: |
  Agent fallback for CGameSceneNode_UpdateEntityForHierarchyChange (auto-generated, category: func). Locate
  CGameSceneNode::UpdateEntityForHierarchyChange in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_UpdateEntityForHierarchyChange, CGameSceneNode::UpdateEntityForHierarchyChange
disable-model-invocation: true
---

# Find CGameSceneNode_UpdateEntityForHierarchyChange

Target: `CGameSceneNode::UpdateEntityForHierarchyChange` (func) in the module loaded in THIS session.
...
Write `CGameSceneNode_UpdateEntityForHierarchyChange.{platform}.yaml` with EXACTLY these fields:
