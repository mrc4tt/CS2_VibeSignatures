...
description: |
  ...
  CGameSceneNode_UpdateEntityForHierarchyChange in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_UpdateEntityForHierarchyChange, CGameSceneNode_UpdateEntityForHierarchyChange
disable-model-invocation: true
---

# Find CGameSceneNode_UpdateEntityForHierarchyChange

Target: `CGameSceneNode_UpdateEntityForHierarchyChange` (func) in the module loaded in THIS session.
