...
description: |
  ...
  IGameSystem_OnServerGamePostSimulate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerGamePostSimulate, IGameSystem_OnServerGamePostSimulate
disable-model-invocation: true
---

# Find IGameSystem_OnServerGamePostSimulate

Target: `IGameSystem_OnServerGamePostSimulate` (vfunc) in the module loaded in THIS session.
