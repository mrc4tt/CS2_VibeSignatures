...
description: |
  Agent fallback for IGameSystem_OnServerGamePostSimulate (auto-generated, category: vfunc). Locate
  IGameSystem::ServerGamePostSimulate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerGamePostSimulate, IGameSystem::ServerGamePostSimulate
disable-model-invocation: true
---

# Find IGameSystem_OnServerGamePostSimulate

Target: `IGameSystem::ServerGamePostSimulate` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnServerGamePostSimulate.{platform}.yaml` with EXACTLY these fields:
