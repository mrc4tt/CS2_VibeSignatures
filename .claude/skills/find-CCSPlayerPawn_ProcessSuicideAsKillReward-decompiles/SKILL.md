---
name: find-CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles
description: |
  Agent fallback for CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles (auto-generated, category: func). Locate
  CCSPlayerPawn::ProcessSuicideAsKillReward in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles, CCSPlayerPawn::ProcessSuicideAsKillReward
disable-model-invocation: true
---

# Find CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles

Target: `CCSPlayerPawn::ProcessSuicideAsKillReward` (func) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_ProcessSuicideAsKillReward.{platform}.yaml` with EXACTLY these fields:
