...
description: |
  ...
  CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles, CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles
disable-model-invocation: true
---

# Find CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles

Target: `CCSPlayerPawn_ProcessSuicideAsKillReward-decompiles` (func) in the module loaded in THIS session.
