...
description: |
  Agent fallback for GetCSceneEntityScriptDesc (auto-generated, category: func). Locate
  GetCSceneEntityScriptDesc in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GetCSceneEntityScriptDesc, GetCSceneEntityScriptDesc
disable-model-invocation: true
---

# Find GetCSceneEntityScriptDesc

Target: `GetCSceneEntityScriptDesc` (func) in the module loaded in THIS session.
...
Write `GetCSceneEntityScriptDesc.{platform}.yaml` with EXACTLY these fields:
