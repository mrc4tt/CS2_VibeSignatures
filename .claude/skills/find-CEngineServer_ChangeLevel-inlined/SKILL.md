...
description: |
  ...
  CEngineServer_ChangeLevel-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ChangeLevel-inlined, CEngineServer_ChangeLevel-inlined
disable-model-invocation: true
---

# Find CEngineServer_ChangeLevel-inlined

Target: `CEngineServer_ChangeLevel-inlined` (vfunc) in the module loaded in THIS session.
