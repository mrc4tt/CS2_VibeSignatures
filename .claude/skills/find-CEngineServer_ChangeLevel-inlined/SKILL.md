...
description: |
  Agent fallback for CEngineServer_ChangeLevel-inlined (auto-generated, category: vfunc). Locate
  CEngineServer::ChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ChangeLevel-inlined, CEngineServer::ChangeLevel
disable-model-invocation: true
---

# Find CEngineServer_ChangeLevel-inlined

Target: `CEngineServer::ChangeLevel` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_ChangeLevel.{platform}.yaml` with EXACTLY these fields:
