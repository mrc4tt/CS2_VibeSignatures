...
description: |
  Agent fallback for CSource2Client_vtable (auto-generated, category: func). Locate
  CSource2Client_vtable in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_vtable, CSource2Client_vtable
disable-model-invocation: true
---

# Find CSource2Client_vtable

Target: `CSource2Client_vtable` (func) in the module loaded in THIS session.
...
Write `CSource2Client_vtable.{platform}.yaml` with EXACTLY these fields:
