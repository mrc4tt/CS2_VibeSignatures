...
description: |
  Agent fallback for CPlayer_MovementServices_ForceButtons (auto-generated, category: func). Locate
  CPlayer_MovementServices::ForceButtons in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayer_MovementServices_ForceButtons, CPlayer_MovementServices::ForceButtons
disable-model-invocation: true
---

# Find CPlayer_MovementServices_ForceButtons

Target: `CPlayer_MovementServices::ForceButtons` (func) in the module loaded in THIS session.
...
Write `CPlayer_MovementServices_ForceButtons.{platform}.yaml` with EXACTLY these fields:
