...
description: |
  ...
  CPlayer_MovementServices_ForceButtons in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayer_MovementServices_ForceButtons, CPlayer_MovementServices_ForceButtons
disable-model-invocation: true
---

# Find CPlayer_MovementServices_ForceButtons

Target: `CPlayer_MovementServices_ForceButtons` (func) in the module loaded in THIS session.
