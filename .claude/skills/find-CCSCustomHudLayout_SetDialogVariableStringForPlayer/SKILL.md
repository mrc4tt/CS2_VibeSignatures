---
name: find-CCSCustomHudLayout_SetDialogVariableStringForPlayer
description: |
...
# Find CCSCustomHudLayout_SetDialogVariableStringForPlayer

Target: `CCSCustomHudLayout_SetDialogVariableStringForPlayer` (func) in the CS2 server module.
