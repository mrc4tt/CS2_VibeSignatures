---
name: find-CEntitySystem_AddEntityToEntityDataBase-decompiles
description: |
  Agent fallback for CEntitySystem_AddEntityToEntityDataBase-decompiles (auto-generated, category: func). Locate
  CEntitySystem::AddEntityToEntityDataBase in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_AddEntityToEntityDataBase-decompiles, CEntitySystem::AddEntityToEntityDataBase
disable-model-invocation: true
---

# Find CEntitySystem_AddEntityToEntityDataBase-decompiles

Target: `CEntitySystem::AddEntityToEntityDataBase` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_AddEntityToEntityDataBase.{platform}.yaml` with EXACTLY these fields:
