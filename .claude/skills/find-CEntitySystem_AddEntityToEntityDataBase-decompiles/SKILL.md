...
description: |
  ...
  CEntitySystem_AddEntityToEntityDataBase-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_AddEntityToEntityDataBase-decompiles, CEntitySystem_AddEntityToEntityDataBase-decompiles
disable-model-invocation: true
---

# Find CEntitySystem_AddEntityToEntityDataBase-decompiles

Target: `CEntitySystem_AddEntityToEntityDataBase-decompiles` (func) in the module loaded in THIS session.
