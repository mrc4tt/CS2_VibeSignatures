...
description: |
  ...
  CLoopTypeBase_LoadDependentServices-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_LoadDependentServices-inlined, CLoopTypeBase_LoadDependentServices-inlined
disable-model-invocation: true
---

# Find CLoopTypeBase_LoadDependentServices-inlined

Target: `CLoopTypeBase_LoadDependentServices-inlined` (func) in the module loaded in THIS session.
