---
name: find-CNetworkGameClientBase_ProcessSpawnGroup_Load
description: |
  Agent fallback for CNetworkGameClientBase_ProcessSpawnGroup_Load (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::ProcessSpawnGroup_Load in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessSpawnGroup_Load, CNetworkGameClientBase::ProcessSpawnGroup_Load
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessSpawnGroup_Load

Target: `CNetworkGameClientBase::ProcessSpawnGroup_Load` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ProcessSpawnGroup_Load.{platform}.yaml` with EXACTLY these fields:
