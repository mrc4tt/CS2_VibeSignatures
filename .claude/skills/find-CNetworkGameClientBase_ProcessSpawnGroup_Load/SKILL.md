...
description: |
  ...
  CNetworkGameClientBase_ProcessSpawnGroup_Load in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessSpawnGroup_Load, CNetworkGameClientBase_ProcessSpawnGroup_Load
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessSpawnGroup_Load

Target: `CNetworkGameClientBase_ProcessSpawnGroup_Load` (vfunc) in the module loaded in THIS session.
