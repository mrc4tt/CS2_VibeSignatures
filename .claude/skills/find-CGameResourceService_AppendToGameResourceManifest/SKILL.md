...
description: |
  Agent fallback for CGameResourceService_AppendToGameResourceManifest (auto-generated, category: vfunc). Locate
  CGameResourceService::AppendToGameResourceManifest in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_AppendToGameResourceManifest, CGameResourceService::AppendToGameResourceManifest
disable-model-invocation: true
---

# Find CGameResourceService_AppendToGameResourceManifest

Target: `CGameResourceService::AppendToGameResourceManifest` (vfunc) in the module loaded in THIS session.
...
Write `CGameResourceService_AppendToGameResourceManifest.{platform}.yaml` with EXACTLY these fields:
