...
description: |
  ...
  CGameResourceService_AppendToGameResourceManifest in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_AppendToGameResourceManifest, CGameResourceService_AppendToGameResourceManifest
disable-model-invocation: true
---

# Find CGameResourceService_AppendToGameResourceManifest

Target: `CGameResourceService_AppendToGameResourceManifest` (vfunc) in the module loaded in THIS session.
