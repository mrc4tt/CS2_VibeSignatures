...
description: |
  Agent fallback for CSimulationState_SetupJointState-windows (auto-generated, category: func). Locate
  CSimulationState::SetupJointState in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSimulationState_SetupJointState-windows, CSimulationState::SetupJointState
disable-model-invocation: true
---

# Find CSimulationState_SetupJointState-windows

Target: `CSimulationState::SetupJointState` (func) in the module loaded in THIS session.
...
Write `CSimulationState_SetupJointState.{platform}.yaml` with EXACTLY these fields:
