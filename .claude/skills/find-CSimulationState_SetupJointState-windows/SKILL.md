...
description: |
  ...
  CSimulationState_SetupJointState-windows in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSimulationState_SetupJointState-windows, CSimulationState_SetupJointState-windows
disable-model-invocation: true
---

# Find CSimulationState_SetupJointState-windows

Target: `CSimulationState_SetupJointState-windows` (func) in the module loaded in THIS session.
