...
description: |
  ...
  CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles, CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles
disable-model-invocation: true
---

# Find CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles

Target: `CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles` (func) in the module loaded in THIS session.
