---
name: find-CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles
description: |
  Agent fallback for CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles (auto-generated, category: func). Locate
  CFlattenedSerializers_CreateFieldChangedEventQueue in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles, CFlattenedSerializers_CreateFieldChangedEventQueue
disable-model-invocation: true
---

# Find CFlattenedSerializers_CreateFieldChangedEventQueue-decompiles

Target: `CFlattenedSerializers_CreateFieldChangedEventQueue` (func) in the module loaded in THIS session.
...
Write `CFlattenedSerializers_CreateFieldChangedEventQueue.{platform}.yaml` with EXACTLY these fields:
