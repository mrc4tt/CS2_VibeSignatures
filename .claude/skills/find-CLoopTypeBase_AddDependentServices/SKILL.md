...
description: |
  ...
  CLoopTypeBase_AddDependentServices in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_AddDependentServices, CLoopTypeBase_AddDependentServices
disable-model-invocation: true
---

# Find CLoopTypeBase_AddDependentServices

Target: `CLoopTypeBase_AddDependentServices` (func) in the module loaded in THIS session.
