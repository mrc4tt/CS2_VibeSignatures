...
description: |
  Agent fallback for CEntitySystem_m_pCurrentManifest (auto-generated, category: structmember). Locate
  CEntitySystem::m_pCurrentManifest in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_pCurrentManifest, CEntitySystem::m_pCurrentManifest
disable-model-invocation: true
---

# Find CEntitySystem_m_pCurrentManifest

Target: `CEntitySystem::m_pCurrentManifest` (structmember) in the module loaded in THIS session.
