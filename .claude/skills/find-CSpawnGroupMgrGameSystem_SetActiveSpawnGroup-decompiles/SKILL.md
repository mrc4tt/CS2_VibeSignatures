...
description: |
  ...
  CSpawnGroupMgrGameSystem_SetActiveSpawnGroup-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SetActiveSpawnGroup-decompiles, CSpawnGroupMgrGameSystem_SetActiveSpawnGroup-decompiles
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SetActiveSpawnGroup-decompiles

Target: `CSpawnGroupMgrGameSystem_SetActiveSpawnGroup-decompiles` (vfunc) in the module loaded in THIS session.
