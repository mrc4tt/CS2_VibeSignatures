...
description: |
  Agent fallback for CGameSceneNode_PreInstanceSpawn (auto-generated, category: vfunc). Locate
  CGameSceneNode::PreInstanceSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_PreInstanceSpawn, CGameSceneNode::PreInstanceSpawn
disable-model-invocation: true
---

# Find CGameSceneNode_PreInstanceSpawn

Target: `CGameSceneNode::PreInstanceSpawn` (vfunc) in the module loaded in THIS session.
...
Write `CGameSceneNode_PreInstanceSpawn.{platform}.yaml` with EXACTLY these fields:
