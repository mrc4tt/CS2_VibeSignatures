...
description: |
  ...
  CGameSceneNode_PreInstanceSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_PreInstanceSpawn, CGameSceneNode_PreInstanceSpawn
disable-model-invocation: true
---

# Find CGameSceneNode_PreInstanceSpawn

Target: `CGameSceneNode_PreInstanceSpawn` (vfunc) in the module loaded in THIS session.
