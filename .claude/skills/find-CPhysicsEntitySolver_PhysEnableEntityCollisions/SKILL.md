...
description: |
  Agent fallback for CPhysicsEntitySolver_PhysEnableEntityCollisions (auto-generated, category: vfunc). Locate
  CPhysicsEntitySolver::PhysEnableEntityCollisions in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysicsEntitySolver_PhysEnableEntityCollisions, CPhysicsEntitySolver::PhysEnableEntityCollisions
disable-model-invocation: true
---

# Find CPhysicsEntitySolver_PhysEnableEntityCollisions

Target: `CPhysicsEntitySolver::PhysEnableEntityCollisions` (vfunc) in the module loaded in THIS session.
...
Write `CPhysicsEntitySolver_PhysEnableEntityCollisions.{platform}.yaml` with EXACTLY these fields:
