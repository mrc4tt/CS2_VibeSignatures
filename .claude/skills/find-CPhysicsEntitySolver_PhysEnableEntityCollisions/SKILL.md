...
description: |
  ...
  CPhysicsEntitySolver_PhysEnableEntityCollisions in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysicsEntitySolver_PhysEnableEntityCollisions, CPhysicsEntitySolver_PhysEnableEntityCollisions
disable-model-invocation: true
---

# Find CPhysicsEntitySolver_PhysEnableEntityCollisions

Target: `CPhysicsEntitySolver_PhysEnableEntityCollisions` (vfunc) in the module loaded in THIS session.
