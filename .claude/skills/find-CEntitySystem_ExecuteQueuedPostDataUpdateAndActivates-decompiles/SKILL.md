---
name: find-CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles
description: |
  Agent fallback for CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles (auto-generated, category: func). Locate
  CEntitySystem::ExecuteQueuedPostDataUpdateAndActivates in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles, CEntitySystem::ExecuteQueuedPostDataUpdateAndActivates
disable-model-invocation: true
---

# Find CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles

Target: `CEntitySystem::ExecuteQueuedPostDataUpdateAndActivates` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates.{platform}.yaml` with EXACTLY these fields:
