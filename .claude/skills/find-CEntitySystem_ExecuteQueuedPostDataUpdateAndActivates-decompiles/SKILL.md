...
description: |
  ...
  CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles, CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles
disable-model-invocation: true
---

# Find CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles

Target: `CEntitySystem_ExecuteQueuedPostDataUpdateAndActivates-decompiles` (func) in the module loaded in THIS session.
