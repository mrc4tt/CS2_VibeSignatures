...
description: |
  ...
  HideState_OnUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: HideState_OnUpdate, HideState_OnUpdate
disable-model-invocation: true
---

# Find HideState_OnUpdate

Target: `HideState_OnUpdate` (vfunc) in the module loaded in THIS session.
