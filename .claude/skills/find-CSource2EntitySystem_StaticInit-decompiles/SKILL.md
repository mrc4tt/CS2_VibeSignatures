...
description: |
  Agent fallback for CSource2EntitySystem_StaticInit-decompiles (auto-generated, category: func). Locate
  CSource2EntitySystem_StaticInit-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2EntitySystem_StaticInit-decompiles, CSource2EntitySystem_StaticInit-decompiles
disable-model-invocation: true
---

# Find CSource2EntitySystem_StaticInit-decompiles

Target: `CSource2EntitySystem_StaticInit-decompiles` (func) in the module loaded in THIS session.
