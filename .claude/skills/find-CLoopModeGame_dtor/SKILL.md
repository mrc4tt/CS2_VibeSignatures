---
name: find-CLoopModeGame_dtor
description: |
  Agent fallback for CLoopModeGame_dtor (auto-generated, category: func). Locate
  CLoopModeGame::~CLoopModeGame in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_dtor, CLoopModeGame::~CLoopModeGame
disable-model-invocation: true
---

# Find CLoopModeGame_dtor

Target: `CLoopModeGame::~CLoopModeGame` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_dtor.{platform}.yaml` with EXACTLY these fields:
