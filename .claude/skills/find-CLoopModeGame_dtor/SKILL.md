...
description: |
  ...
  CLoopModeGame_dtor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_dtor, CLoopModeGame_dtor
disable-model-invocation: true
---

# Find CLoopModeGame_dtor

Target: `CLoopModeGame_dtor` (func) in the module loaded in THIS session.
