...
description: |
  Agent fallback for CBasePlayerController_IsFakeClient (auto-generated, category: func). Locate
  CBasePlayerController::IsFakeClient in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_IsFakeClient, CBasePlayerController::IsFakeClient
disable-model-invocation: true
---

# Find CBasePlayerController_IsFakeClient

Target: `CBasePlayerController::IsFakeClient` (func) in the module loaded in THIS session.
...
Write `CBasePlayerController_IsFakeClient.{platform}.yaml` with EXACTLY these fields:
