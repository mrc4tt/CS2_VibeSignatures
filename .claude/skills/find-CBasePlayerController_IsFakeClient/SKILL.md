...
description: |
  ...
  CBasePlayerController_IsFakeClient in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_IsFakeClient, CBasePlayerController_IsFakeClient
disable-model-invocation: true
---

# Find CBasePlayerController_IsFakeClient

Target: `CBasePlayerController_IsFakeClient` (func) in the module loaded in THIS session.
