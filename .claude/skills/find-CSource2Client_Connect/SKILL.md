...
description: |
  ...
  CSource2Client_Connect in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_Connect, CSource2Client_Connect
disable-model-invocation: true
---

# Find CSource2Client_Connect

Target: `CSource2Client_Connect` (vfunc) in the module loaded in THIS session.
