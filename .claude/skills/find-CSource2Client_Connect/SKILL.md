...
description: |
  Agent fallback for CSource2Client_Connect (auto-generated, category: vfunc). Locate
  ...
  Trigger: CSource2Client_Connect, CSource2Client::Connect
disable-model-invocation: true
---

# Find CSource2Client_Connect
