...
description: |
  ...
  CEngineServer_ClientPrintf-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ClientPrintf-decompiles, CEngineServer_ClientPrintf-decompiles
disable-model-invocation: true
---

# Find CEngineServer_ClientPrintf-decompiles

Target: `CEngineServer_ClientPrintf-decompiles` (vfunc) in the module loaded in THIS session.
