---
name: find-CEngineServer_ClientPrintf-decompiles
description: |
  Agent fallback for CEngineServer_ClientPrintf-decompiles (auto-generated, category: vfunc). Locate
  CEngineServer::ClientPrintf in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ClientPrintf-decompiles, CEngineServer::ClientPrintf
disable-model-invocation: true
---

# Find CEngineServer_ClientPrintf-decompiles

Target: `CEngineServer::ClientPrintf` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_ClientPrintf.{platform}.yaml` with EXACTLY these fields:
