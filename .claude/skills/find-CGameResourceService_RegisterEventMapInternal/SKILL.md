---
name: find-CGameResourceService_RegisterEventMapInternal
description: |
  Agent fallback for CGameResourceService_RegisterEventMapInternal (auto-generated, category: func). Locate
  CGameResourceService_RegisterEventMapInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_RegisterEventMapInternal, CGameResourceService_RegisterEventMapInternal
disable-model-invocation: true
---

# Find CGameResourceService_RegisterEventMapInternal

Target: `CGameResourceService_RegisterEventMapInternal` (func) in the module loaded in THIS session.
...
Write `CGameResourceService_RegisterEventMapInternal.{platform}.yaml` with EXACTLY these fields:
