...
description: |
  Agent fallback for IGameSystem_vtable (auto-generated, category: func). Locate
  IGameSystem_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_vtable, IGameSystem_vtable
disable-model-invocation: true
---

# Find IGameSystem_vtable

Target: `IGameSystem_vtable` (func) in the module loaded in THIS session.
...
Write `IGameSystem_vtable.{platform}.yaml` with EXACTLY these fields:
