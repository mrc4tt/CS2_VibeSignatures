...
description: |
  Agent fallback for CGameResourceService_vtable (auto-generated, category: func). Locate
  CGameResourceService_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_vtable, CGameResourceService_vtable
disable-model-invocation: true
---

# Find CGameResourceService_vtable

Target: `CGameResourceService_vtable` (func) in the module loaded in THIS session.
...
Write `CGameResourceService_vtable.{platform}.yaml` with EXACTLY these fields:
