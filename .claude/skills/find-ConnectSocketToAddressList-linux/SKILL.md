---
name: find-ConnectSocketToAddressList-linux
description: |
  Agent fallback for ConnectSocketToAddressList-linux (auto-generated, category: func). Locate
  ConnectSocketToAddressList in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ConnectSocketToAddressList-linux, ConnectSocketToAddressList
disable-model-invocation: true
---

# Find ConnectSocketToAddressList-linux

Target: `ConnectSocketToAddressList` (func) in the module loaded in THIS session.
...
Write `ConnectSocketToAddressList.{platform}.yaml` with EXACTLY these fields:
