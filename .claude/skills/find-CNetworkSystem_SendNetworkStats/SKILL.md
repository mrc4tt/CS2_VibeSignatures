...
description: |
  ...
  CNetworkSystem_SendNetworkStats in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_SendNetworkStats, CNetworkSystem_SendNetworkStats
disable-model-invocation: true
---

# Find CNetworkSystem_SendNetworkStats

Target: `CNetworkSystem_SendNetworkStats` (func) in the module loaded in THIS session.
