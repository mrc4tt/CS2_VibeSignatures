---
name: find-IGameSystem_LoopDestroyAllSystems-decompiles
description: |
  Agent fallback for IGameSystem_LoopDestroyAllSystems-decompiles (auto-generated, category: func). Locate
  IGameSystem::LoopDestroyAllSystems in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_LoopDestroyAllSystems-decompiles, IGameSystem::LoopDestroyAllSystems
disable-model-invocation: true
---

# Find IGameSystem_LoopDestroyAllSystems-decompiles

Target: `IGameSystem::LoopDestroyAllSystems` (func) in the module loaded in THIS session.
...
Write `IGameSystem_LoopDestroyAllSystems.{platform}.yaml` with EXACTLY these fields:
