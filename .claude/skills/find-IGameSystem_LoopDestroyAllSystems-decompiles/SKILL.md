...
description: |
  ...
  IGameSystem_LoopDestroyAllSystems-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_LoopDestroyAllSystems-decompiles, IGameSystem_LoopDestroyAllSystems-decompiles
disable-model-invocation: true
---

# Find IGameSystem_LoopDestroyAllSystems-decompiles

Target: `IGameSystem_LoopDestroyAllSystems-decompiles` (func) in the module loaded in THIS session.
