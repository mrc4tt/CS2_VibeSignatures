...
description: |
  Agent fallback for CLoopTypeClientServerService_vtable (auto-generated, category: func). Locate
  CLoopTypeClientServerService_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServerService_vtable, CLoopTypeClientServerService_vtable
disable-model-invocation: true
---

# Find CLoopTypeClientServerService_vtable

Target: `CLoopTypeClientServerService_vtable` (func) in the module loaded in THIS session.
...
Write `CLoopTypeClientServerService_vtable.{platform}.yaml` with EXACTLY these fields:
