...
description: |
  Agent fallback for CPointTeleport_vtable (auto-generated, category: func). Locate
  CPointTeleport_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPointTeleport_vtable, CPointTeleport_vtable
disable-model-invocation: true
---

# Find CPointTeleport_vtable

Target: `CPointTeleport_vtable` (func) in the module loaded in THIS session.
...
Write `CPointTeleport_vtable.{platform}.yaml` with EXACTLY these fields:
