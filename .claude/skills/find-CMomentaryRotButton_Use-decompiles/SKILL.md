...
description: |
  ...
  CMomentaryRotButton_Use-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMomentaryRotButton_Use-decompiles, CMomentaryRotButton_Use-decompiles
disable-model-invocation: true
---

# Find CMomentaryRotButton_Use-decompiles

Target: `CMomentaryRotButton_Use-decompiles` (vfunc) in the module loaded in THIS session.
