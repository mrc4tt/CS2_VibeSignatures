---
name: find-CMomentaryRotButton_Use-decompiles
description: |
  Agent fallback for CMomentaryRotButton_Use-decompiles (auto-generated, category: vfunc). Locate
  CMomentaryRotButton::Use in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMomentaryRotButton_Use-decompiles, CMomentaryRotButton::Use
disable-model-invocation: true
---

# Find CMomentaryRotButton_Use-decompiles

Target: `CMomentaryRotButton::Use` (vfunc) in the module loaded in THIS session.
...
Write `CMomentaryRotButton_Use.{platform}.yaml` with EXACTLY these fields:
