...
description: |
  ...
  CCSBotManager::BotAddCommand in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: BotAdd_CommandHandler, CCSBotManager::BotAddCommand
disable-model-invocation: true
---

# Find BotAdd_CommandHandler

Target: `CCSBotManager::BotAddCommand` (func) in the module loaded in THIS session.
...
Write `BotAdd_CommandHandler.{platform}.yaml` with EXACTLY these fields:
