...
description: |
  ...
  BotAdd_CommandHandler in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: BotAdd_CommandHandler, BotAdd_CommandHandler
disable-model-invocation: true
---

# Find BotAdd_CommandHandler

Target: `BotAdd_CommandHandler` (func) in the module loaded in THIS session.
