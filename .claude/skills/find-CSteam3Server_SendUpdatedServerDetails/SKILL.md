...
description: |
  ...
  CSteam3Server_SendUpdatedServerDetails in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSteam3Server_SendUpdatedServerDetails, CSteam3Server_SendUpdatedServerDetails
disable-model-invocation: true
---

# Find CSteam3Server_SendUpdatedServerDetails

Target: `CSteam3Server_SendUpdatedServerDetails` (func) in the module loaded in THIS session.
