...
description: |
  Agent fallback for CTakeDamageInfo_HitGroupInfo (auto-generated, category: structmember). Locate
  CTakeDamageInfo::HitGroupInfo in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTakeDamageInfo_HitGroupInfo, CTakeDamageInfo::HitGroupInfo
disable-model-invocation: true
---

# Find CTakeDamageInfo_HitGroupInfo

Target: `CTakeDamageInfo::HitGroupInfo` (structmember) in the module loaded in THIS session.
...
Write `CTakeDamageInfo_HitGroupInfo.{platform}.yaml` with EXACTLY these fields:
