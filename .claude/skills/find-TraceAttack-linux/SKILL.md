...
description: |
  ...
  TraceAttack-linux in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: TraceAttack-linux, TraceAttack-linux
disable-model-invocation: true
---

# Find TraceAttack-linux

Target: `TraceAttack-linux` (func) in the module loaded in THIS session.
