...
description: |
  ...
  CCSBotManager::BotPlace in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBotManager_BotPlaceCommand, CCSBotManager::BotPlace
disable-model-invocation: true
---

# Find CCSBotManager_BotPlaceCommand

Target: `CCSBotManager::BotPlace` (func) in the module loaded in THIS session.
...
Write `CCSBotManager_BotPlaceCommand.{platform}.yaml` with EXACTLY these fields:
