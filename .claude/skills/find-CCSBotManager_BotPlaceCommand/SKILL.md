...
description: |
  ...
  CCSBotManager_BotPlaceCommand in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBotManager_BotPlaceCommand, CCSBotManager_BotPlaceCommand
disable-model-invocation: true
---

# Find CCSBotManager_BotPlaceCommand

Target: `CCSBotManager_BotPlaceCommand` (func) in the module loaded in THIS session.
