---
name: find-Callback_GenericChanged
description: |
  Agent fallback for Callback_GenericChanged (auto-generated, category: func). Locate
  Callback_GenericChanged in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: Callback_GenericChanged, Callback_GenericChanged
disable-model-invocation: true
---

# Find Callback_GenericChanged

Target: `Callback_GenericChanged` (func) in the module loaded in THIS session.
...
Write `Callback_GenericChanged.{platform}.yaml` with EXACTLY these fields:
