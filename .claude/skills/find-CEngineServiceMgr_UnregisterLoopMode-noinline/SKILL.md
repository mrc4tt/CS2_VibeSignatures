---
name: find-CEngineServiceMgr_UnregisterLoopMode-noinline
description: |
  Agent fallback for CEngineServiceMgr_UnregisterLoopMode-noinline (auto-generated, category: func). Locate
  CEngineServiceMgr_UnregisterLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_UnregisterLoopMode-noinline, CEngineServiceMgr_UnregisterLoopMode
disable-model-invocation: true
---

# Find CEngineServiceMgr_UnregisterLoopMode-noinline

Target: `CEngineServiceMgr_UnregisterLoopMode` (func) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_UnregisterLoopMode.{platform}.yaml` with EXACTLY these fields:
