...
description: |
  Agent fallback for CGamePlayerEquip_InputTriggerForActivatedPlayer (auto-generated, category: func). Locate
  CGamePlayerEquip::InputTriggerForActivatedPlayer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGamePlayerEquip_InputTriggerForActivatedPlayer, CGamePlayerEquip::InputTriggerForActivatedPlayer
disable-model-invocation: true
---

# Find CGamePlayerEquip_InputTriggerForActivatedPlayer

Target: `CGamePlayerEquip::InputTriggerForActivatedPlayer` (func) in the module loaded in THIS session.
...
Write `CGamePlayerEquip_InputTriggerForActivatedPlayer.{platform}.yaml` with EXACTLY these fields:
