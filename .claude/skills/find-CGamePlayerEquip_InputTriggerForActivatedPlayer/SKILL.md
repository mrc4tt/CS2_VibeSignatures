...
description: |
  ...
  CGamePlayerEquip_InputTriggerForActivatedPlayer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGamePlayerEquip_InputTriggerForActivatedPlayer, CGamePlayerEquip_InputTriggerForActivatedPlayer
disable-model-invocation: true
---

# Find CGamePlayerEquip_InputTriggerForActivatedPlayer

Target: `CGamePlayerEquip_InputTriggerForActivatedPlayer` (func) in the module loaded in THIS session.
