...
description: |
  ...
  CEntitySystem_DestroyEntity-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_DestroyEntity-decompiles, CEntitySystem_DestroyEntity-decompiles
disable-model-invocation: true
---

# Find CEntitySystem_DestroyEntity-decompiles

Target: `CEntitySystem_DestroyEntity-decompiles` (func) in the module loaded in THIS session.
