---
name: find-CEntitySystem_DestroyEntity-decompiles
description: |
  Agent fallback for CEntitySystem_DestroyEntity-decompiles (auto-generated, category: func). Locate
  CEntitySystem::DestroyEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_DestroyEntity-decompiles, CEntitySystem::DestroyEntity
disable-model-invocation: true
---

# Find CEntitySystem_DestroyEntity-decompiles

Target: `CEntitySystem::DestroyEntity` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_DestroyEntity.{platform}.yaml` with EXACTLY these fields:
