...
description: |
  ...
  CCSPlayerController_GetThinkFunction in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_GetThinkFunction, CCSPlayerController_GetThinkFunction
disable-model-invocation: true
---

# Find CCSPlayerController_GetThinkFunction

Target: `CCSPlayerController_GetThinkFunction` (func) in the module loaded in THIS session.
