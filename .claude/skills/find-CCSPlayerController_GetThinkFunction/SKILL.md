...
description: |
  ...
  Trigger: CCSPlayerController_GetThinkFunction, CCSPlayerController::GetThinkFunction
disable-model-invocation: true
---

# Find CCSPlayerController_GetThinkFunction
