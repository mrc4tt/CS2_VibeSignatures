...
description: |
  ...
  CBaseEntity_OnRestore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_OnRestore, CBaseEntity_OnRestore
disable-model-invocation: true
---

# Find CBaseEntity_OnRestore

Target: `CBaseEntity_OnRestore` (vfunc) in the module loaded in THIS session.
