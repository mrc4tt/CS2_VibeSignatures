...
description: |
  Agent fallback for CBaseEntity_OnRestore (auto-generated, category: vfunc). Locate
  CBaseEntity::OnRestore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_OnRestore, CBaseEntity::OnRestore
disable-model-invocation: true
---

# Find CBaseEntity_OnRestore

Target: `CBaseEntity::OnRestore` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_OnRestore.{platform}.yaml` with EXACTLY these fields:
