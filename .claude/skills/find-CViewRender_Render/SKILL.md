...
description: |
  ...
  CViewRender_Render in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CViewRender_Render, CViewRender_Render
disable-model-invocation: true
---

# Find CViewRender_Render

Target: `CViewRender_Render` (vfunc) in the module loaded in THIS session.
