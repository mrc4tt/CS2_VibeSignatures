...
description: |
  Agent fallback for CViewRender_Render (auto-generated, category: vfunc). Locate
  CViewRender::Render in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CViewRender_Render, CViewRender::Render
disable-model-invocation: true
---

# Find CViewRender_Render

Target: `CViewRender::Render` (vfunc) in the module loaded in THIS session.
...
Write `CViewRender_Render.{platform}.yaml` with EXACTLY these fields:
