...
description: |
  ...
  CCSPlayer_UseServices_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_UseServices_vtable, CCSPlayer_UseServices_vtable
disable-model-invocation: true
---

# Find CCSPlayer_UseServices_vtable

Target: `CCSPlayer_UseServices_vtable` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_UseServices_vtable.{platform}.yaml` with EXACTLY these fields:
