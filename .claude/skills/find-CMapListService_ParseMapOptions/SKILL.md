---
name: find-CMapListService_ParseMapOptions
description: |
  Agent fallback for CMapListService_ParseMapOptions (auto-generated, category: vfunc). Locate
  CMapListService::ParseMapOptions in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMapListService_ParseMapOptions, CMapListService::ParseMapOptions
disable-model-invocation: true
---

# Find CMapListService_ParseMapOptions

Target: `CMapListService::ParseMapOptions` (vfunc) in the module loaded in THIS session.
...
Write `CMapListService_ParseMapOptions.{platform}.yaml` with EXACTLY these fields:
