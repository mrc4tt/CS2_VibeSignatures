...
description: |
  ...
  CMapListService_ParseMapOptions in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMapListService_ParseMapOptions, CMapListService_ParseMapOptions
disable-model-invocation: true
---

# Find CMapListService_ParseMapOptions

Target: `CMapListService_ParseMapOptions` (vfunc) in the module loaded in THIS session.
