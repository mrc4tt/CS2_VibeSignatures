...
description: |
  ...
  CCSPlayer_UseServices::BumpWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_UseServices_BumpWeapon, CCSPlayer_UseServices::BumpWeapon
disable-model-invocation: true
---

# Find CCSPlayer_UseServices_BumpWeapon

Target: `CCSPlayer_UseServices::BumpWeapon` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_UseServices_BumpWeapon.{platform}.yaml` with EXACTLY these fields:
