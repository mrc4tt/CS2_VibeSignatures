...
description: |
  ...
  CCSPlayer_UseServices_BumpWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_UseServices_BumpWeapon, CCSPlayer_UseServices_BumpWeapon
disable-model-invocation: true
---

# Find CCSPlayer_UseServices_BumpWeapon

Target: `CCSPlayer_UseServices_BumpWeapon` (func) in the module loaded in THIS session.
