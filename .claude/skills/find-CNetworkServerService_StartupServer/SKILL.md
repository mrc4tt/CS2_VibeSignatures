...
description: |
  ...
  CNetworkServerService_StartupServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_StartupServer, CNetworkServerService_StartupServer
disable-model-invocation: true
---

# Find CNetworkServerService_StartupServer

Target: `CNetworkServerService_StartupServer` (vfunc) in the module loaded in THIS session.
