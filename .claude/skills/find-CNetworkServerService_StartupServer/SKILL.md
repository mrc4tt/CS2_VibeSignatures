...
description: |
  Agent fallback for CNetworkServerService_StartupServer (auto-generated, category: vfunc). Locate
  CNetworkServerService::StartupServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_StartupServer, CNetworkServerService::StartupServer
disable-model-invocation: true
---

# Find CNetworkServerService_StartupServer

Target: `CNetworkServerService::StartupServer` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkServerService_StartupServer.{platform}.yaml` with EXACTLY these fields:
