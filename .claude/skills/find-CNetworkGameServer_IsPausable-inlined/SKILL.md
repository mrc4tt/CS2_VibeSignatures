...
description: |
  ...
  CNetworkGameServer_IsPausable-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_IsPausable-inlined, CNetworkGameServer_IsPausable-inlined
disable-model-invocation: true
---

# Find CNetworkGameServer_IsPausable-inlined

Target: `CNetworkGameServer_IsPausable-inlined` (vfunc) in the module loaded in THIS session.
