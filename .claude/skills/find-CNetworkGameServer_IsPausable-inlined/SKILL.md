...
description: |
  Agent fallback for CNetworkGameServer_IsPausable-inlined (auto-generated, category: vfunc). Locate
  CNetworkGameServer::IsPausable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_IsPausable-inlined, CNetworkGameServer::IsPausable
disable-model-invocation: true
---

# Find CNetworkGameServer_IsPausable-inlined

Target: `CNetworkGameServer::IsPausable` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_IsPausable.{platform}.yaml` with EXACTLY these fields:
