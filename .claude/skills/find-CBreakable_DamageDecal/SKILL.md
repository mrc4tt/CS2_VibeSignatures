---
name: find-CBreakable_DamageDecal
description: |
  Agent fallback for CBreakable_DamageDecal (auto-generated, category: vfunc). Locate
  CBreakable::DamageDecal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBreakable_DamageDecal, CBreakable::DamageDecal
disable-model-invocation: true
---

# Find CBreakable_DamageDecal

Target: `CBreakable::DamageDecal` (vfunc) in the module loaded in THIS session.
...
Write `CBreakable_DamageDecal.{platform}.yaml` with EXACTLY these fields:
