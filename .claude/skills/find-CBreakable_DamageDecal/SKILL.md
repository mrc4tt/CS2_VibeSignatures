...
description: |
  ...
  CBreakable_DamageDecal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBreakable_DamageDecal, CBreakable_DamageDecal
disable-model-invocation: true
---

# Find CBreakable_DamageDecal

Target: `CBreakable_DamageDecal` (vfunc) in the module loaded in THIS session.
