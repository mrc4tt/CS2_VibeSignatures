---
name: find-ParseNetadrList
description: |
  Agent fallback for ParseNetadrList (auto-generated, category: func). Locate
  ParseNetadrList in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ParseNetadrList, ParseNetadrList
disable-model-invocation: true
---

# Find ParseNetadrList

Target: `ParseNetadrList` (func) in the module loaded in THIS session.
...
Write `ParseNetadrList.{platform}.yaml` with EXACTLY these fields:
