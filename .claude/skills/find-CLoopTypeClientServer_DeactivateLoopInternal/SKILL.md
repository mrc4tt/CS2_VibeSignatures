---
name: find-CLoopTypeClientServer_DeactivateLoopInternal
description: |
  Agent fallback for CLoopTypeClientServer_DeactivateLoopInternal (auto-generated, category: func). Locate
  CLoopTypeClientServer_DeactivateLoopInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_DeactivateLoopInternal, CLoopTypeClientServer_DeactivateLoopInternal
disable-model-invocation: true
---

# Find CLoopTypeClientServer_DeactivateLoopInternal

Target: `CLoopTypeClientServer_DeactivateLoopInternal` (func) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_DeactivateLoopInternal.{platform}.yaml` with EXACTLY these fields:
