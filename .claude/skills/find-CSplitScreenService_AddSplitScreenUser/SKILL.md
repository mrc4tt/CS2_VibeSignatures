...
description: |
  Agent fallback for CSplitScreenService_AddSplitScreenUser (auto-generated, category: vfunc). Locate
  CSplitScreenService::AddSplitScreenUser in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSplitScreenService_AddSplitScreenUser, CSplitScreenService::AddSplitScreenUser
disable-model-invocation: true
---

# Find CSplitScreenService_AddSplitScreenUser

Target: `CSplitScreenService::AddSplitScreenUser` (vfunc) in the module loaded in THIS session.
...
Write `CSplitScreenService_AddSplitScreenUser.{platform}.yaml` with EXACTLY these fields:
