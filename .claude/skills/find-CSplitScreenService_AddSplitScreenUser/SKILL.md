...
description: |
  ...
  CSplitScreenService_AddSplitScreenUser in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSplitScreenService_AddSplitScreenUser, CSplitScreenService_AddSplitScreenUser
disable-model-invocation: true
---

# Find CSplitScreenService_AddSplitScreenUser

Target: `CSplitScreenService_AddSplitScreenUser` (vfunc) in the module loaded in THIS session.
