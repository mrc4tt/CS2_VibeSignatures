...
description: |
  ...
  CNetworkGameServerBase_ServerAdvanceTick in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerAdvanceTick, CNetworkGameServerBase_ServerAdvanceTick
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerAdvanceTick

Target: `CNetworkGameServerBase_ServerAdvanceTick` (vfunc) in the module loaded in THIS session.
