...
description: |
  Agent fallback for CNetworkGameServerBase_ServerAdvanceTick (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::ServerAdvanceTick in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerAdvanceTick, CNetworkGameServerBase::ServerAdvanceTick
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerAdvanceTick

Target: `CNetworkGameServerBase::ServerAdvanceTick` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_ServerAdvanceTick.{platform}.yaml` with EXACTLY these fields:
