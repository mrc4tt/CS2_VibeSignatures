...
description: |
  Agent fallback for CSource2Server_vtable (auto-generated, category: func). Locate
  CSource2Server_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_vtable, CSource2Server_vtable
disable-model-invocation: true
---

# Find CSource2Server_vtable

Target: `CSource2Server_vtable` (func) in the module loaded in THIS session.
...
Write `CSource2Server_vtable.{platform}.yaml` with EXACTLY these fields:
