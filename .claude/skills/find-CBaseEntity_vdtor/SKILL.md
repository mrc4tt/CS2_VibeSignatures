...
description: |
  ...
  CBaseEntity_vdtor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_vdtor, CBaseEntity_vdtor
disable-model-invocation: true
---

# Find CBaseEntity_vdtor

Target: `CBaseEntity_vdtor` (vfunc) in the module loaded in THIS session.
