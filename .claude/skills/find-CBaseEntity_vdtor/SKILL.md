...
description: |
  Agent fallback for CBaseEntity_vdtor (auto-generated, category: vfunc). Locate
  CBaseEntity::~CBaseEntity (virtual) in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_vdtor, CBaseEntity::~CBaseEntity (virtual)
disable-model-invocation: true
---

# Find CBaseEntity_vdtor

Target: `CBaseEntity::~CBaseEntity (virtual)` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_vdtor.{platform}.yaml` with EXACTLY these fields:
