...
description: |
  ...
  IGameSystem_OnClientPollNetworking in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPollNetworking, IGameSystem_OnClientPollNetworking
disable-model-invocation: true
---

# Find IGameSystem_OnClientPollNetworking

Target: `IGameSystem_OnClientPollNetworking` (vfunc) in the module loaded in THIS session.
