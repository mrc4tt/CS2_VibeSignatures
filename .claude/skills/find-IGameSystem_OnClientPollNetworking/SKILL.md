...
description: |
  Agent fallback for IGameSystem_OnClientPollNetworking (auto-generated, category: vfunc). Locate
  IGameSystem::OnClientPollNetworking in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPollNetworking, IGameSystem::OnClientPollNetworking
disable-model-invocation: true
---

# Find IGameSystem_OnClientPollNetworking

Target: `IGameSystem::OnClientPollNetworking` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientPollNetworking.{platform}.yaml` with EXACTLY these fields:
