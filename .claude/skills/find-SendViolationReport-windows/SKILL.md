...
description: |
  Agent fallback for SendViolationReport-windows (auto-generated, category: func). Locate
  ...
  Trigger: SendViolationReport-windows, SendViolationReport
disable-model-invocation: true
---

# Find SendViolationReport-windows
