...
description: |
  ...
  SendViolationReport-windows in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SendViolationReport-windows, SendViolationReport-windows
disable-model-invocation: true
---

# Find SendViolationReport-windows

Target: `SendViolationReport-windows` (func) in the module loaded in THIS session.
