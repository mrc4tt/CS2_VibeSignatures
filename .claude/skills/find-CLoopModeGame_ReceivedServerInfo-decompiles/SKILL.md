---
name: find-CLoopModeGame_ReceivedServerInfo-decompiles
description: |
  Agent fallback for CLoopModeGame_ReceivedServerInfo-decompiles (auto-generated, category: func). Locate
  CLoopModeGame::ReceivedServerInfo in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_ReceivedServerInfo-decompiles, CLoopModeGame::ReceivedServerInfo
disable-model-invocation: true
---

# Find CLoopModeGame_ReceivedServerInfo-decompiles

Target: `CLoopModeGame::ReceivedServerInfo` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_ReceivedServerInfo.{platform}.yaml` with EXACTLY these fields:
