...
description: |
  ...
  CLoopModeGame_ReceivedServerInfo-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_ReceivedServerInfo-decompiles, CLoopModeGame_ReceivedServerInfo-decompiles
disable-model-invocation: true
---

# Find CLoopModeGame_ReceivedServerInfo-decompiles

Target: `CLoopModeGame_ReceivedServerInfo-decompiles` (func) in the module loaded in THIS session.
