...
description: |
  ...
  CNetworkMessages_SerializeInternal in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_SerializeInternal, CNetworkMessages_SerializeInternal
disable-model-invocation: true
---

# Find CNetworkMessages_SerializeInternal

Target: `CNetworkMessages_SerializeInternal` (func) in the module loaded in THIS session.
