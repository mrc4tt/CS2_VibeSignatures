...
description: |
  Agent fallback for CNetworkMessages_SerializeInternal (auto-generated, category: func). Locate
  CNetworkMessages::SerializeInternal in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_SerializeInternal, CNetworkMessages::SerializeInternal
disable-model-invocation: true
---

# Find CNetworkMessages_SerializeInternal

Target: `CNetworkMessages::SerializeInternal` (func) in the module loaded in THIS session.
...
Write `CNetworkMessages_SerializeInternal.{platform}.yaml` with EXACTLY these fields:
