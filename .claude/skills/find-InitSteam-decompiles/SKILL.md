...
description: |
  Agent fallback for InitSteam-decompiles (auto-generated, category: func). Locate
  InitSteam in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: InitSteam-decompiles, InitSteam
disable-model-invocation: true
---

# Find InitSteam-decompiles

Target: `InitSteam` (func) in the module loaded in THIS session.
...
Write `InitSteam.{platform}.yaml` with EXACTLY these fields:
