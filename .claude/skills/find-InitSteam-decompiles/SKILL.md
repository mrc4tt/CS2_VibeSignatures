...
description: |
  ...
  InitSteam-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: InitSteam-decompiles, InitSteam-decompiles
disable-model-invocation: true
---

# Find InitSteam-decompiles

Target: `InitSteam-decompiles` (func) in the module loaded in THIS session.
