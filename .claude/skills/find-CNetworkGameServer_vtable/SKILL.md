...
description: |
  Agent fallback for CNetworkGameServer_vtable (auto-generated, category: func). Locate
  CNetworkGameServer_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_vtable, CNetworkGameServer_vtable
disable-model-invocation: true
---

# Find CNetworkGameServer_vtable

Target: `CNetworkGameServer_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServer_vtable.{platform}.yaml` with EXACTLY these fields:
