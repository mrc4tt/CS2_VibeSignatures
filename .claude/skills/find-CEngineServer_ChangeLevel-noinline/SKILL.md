...
description: |
  ...
  CEngineServer_ChangeLevel-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ChangeLevel-noinline, CEngineServer_ChangeLevel-noinline
disable-model-invocation: true
---

# Find CEngineServer_ChangeLevel-noinline

Target: `CEngineServer_ChangeLevel-noinline` (vfunc) in the module loaded in THIS session.
