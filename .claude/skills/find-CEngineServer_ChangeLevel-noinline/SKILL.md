...
description: |
  Agent fallback for CEngineServer_ChangeLevel-noinline (auto-generated, category: vfunc). Locate
  ...
  Trigger: CEngineServer_ChangeLevel-noinline, CEngineServer::ChangeLevel
