...
description: |
  ...
  INetworkSystem_BufferToBufferDecompress in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_BufferToBufferDecompress, INetworkSystem_BufferToBufferDecompress
disable-model-invocation: true
---

# Find INetworkSystem_BufferToBufferDecompress

Target: `INetworkSystem_BufferToBufferDecompress` (vfunc) in the module loaded in THIS session.
