---
name: find-INetworkSystem_BufferToBufferDecompress
description: |
  Agent fallback for INetworkSystem_BufferToBufferDecompress (auto-generated, category: vfunc). Locate
  INetworkSystem::BufferToBufferDecompress in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_BufferToBufferDecompress, INetworkSystem::BufferToBufferDecompress
disable-model-invocation: true
---

# Find INetworkSystem_BufferToBufferDecompress

Target: `INetworkSystem::BufferToBufferDecompress` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_BufferToBufferDecompress.{platform}.yaml` with EXACTLY these fields:
