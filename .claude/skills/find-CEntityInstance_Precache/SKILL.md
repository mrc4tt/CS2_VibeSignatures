...
description: |
  Agent fallback for CEntityInstance_Precache (auto-generated, category: vfunc). Locate
  CEntityInstance::Precache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Precache, CEntityInstance::Precache
disable-model-invocation: true
---

# Find CEntityInstance_Precache

Target: `CEntityInstance::Precache` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_Precache.{platform}.yaml` with EXACTLY these fields:
