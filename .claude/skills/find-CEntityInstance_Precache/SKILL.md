...
description: |
  ...
  CEntityInstance_Precache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Precache, CEntityInstance_Precache
disable-model-invocation: true
---

# Find CEntityInstance_Precache

Target: `CEntityInstance_Precache` (vfunc) in the module loaded in THIS session.
