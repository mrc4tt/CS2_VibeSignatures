...
description: |
  ...
  CBaseEntity_DispatchSpawn-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_DispatchSpawn-decompiles, CBaseEntity_DispatchSpawn-decompiles
disable-model-invocation: true
---

# Find CBaseEntity_DispatchSpawn-decompiles

Target: `CBaseEntity_DispatchSpawn-decompiles` (func) in the module loaded in THIS session.
