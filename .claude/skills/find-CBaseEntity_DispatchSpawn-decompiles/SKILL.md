---
name: find-CBaseEntity_DispatchSpawn-decompiles
description: |
  Agent fallback for CBaseEntity_DispatchSpawn-decompiles (auto-generated, category: func). Locate
  CBaseEntity::DispatchSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_DispatchSpawn-decompiles, CBaseEntity::DispatchSpawn
disable-model-invocation: true
---

# Find CBaseEntity_DispatchSpawn-decompiles

Target: `CBaseEntity::DispatchSpawn` (func) in the module loaded in THIS session.
...
Write `CBaseEntity_DispatchSpawn.{platform}.yaml` with EXACTLY these fields:
