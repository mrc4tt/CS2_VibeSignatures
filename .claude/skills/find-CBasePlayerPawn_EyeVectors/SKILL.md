...
description: |
  ...
  CBasePlayerPawn::EyeVectors in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_EyeVectors, CBasePlayerPawn::EyeVectors
disable-model-invocation: true
---

# Find CBasePlayerPawn_EyeVectors

Target: `CBasePlayerPawn::EyeVectors` (func) in the module loaded in THIS session.
...
Write `CBasePlayerPawn_EyeVectors.{platform}.yaml` with EXACTLY these fields:
