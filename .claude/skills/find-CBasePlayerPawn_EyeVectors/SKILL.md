...
description: |
  ...
  CBasePlayerPawn_EyeVectors in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_EyeVectors, CBasePlayerPawn_EyeVectors
disable-model-invocation: true
---

# Find CBasePlayerPawn_EyeVectors

Target: `CBasePlayerPawn_EyeVectors` (func) in the module loaded in THIS session.
