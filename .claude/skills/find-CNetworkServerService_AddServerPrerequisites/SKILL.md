...
description: |
  Agent fallback for CNetworkServerService_AddServerPrerequisites (auto-generated, category: func). Locate
  CNetworkServerService_AddServerPrerequisites in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_AddServerPrerequisites, CNetworkServerService_AddServerPrerequisites
disable-model-invocation: true
---

# Find CNetworkServerService_AddServerPrerequisites

Target: `CNetworkServerService_AddServerPrerequisites` (func) in the module loaded in THIS session.
...
Write `CNetworkServerService_AddServerPrerequisites.{platform}.yaml` with EXACTLY these fields:
