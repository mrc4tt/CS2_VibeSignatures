...
description: |
  Agent fallback for CSource2Server_GetAllServerClasses (auto-generated, category: vfunc). Locate
  CSource2Server::GetAllServerClasses in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetAllServerClasses, CSource2Server::GetAllServerClasses
disable-model-invocation: true
---

# Find CSource2Server_GetAllServerClasses

Target: `CSource2Server::GetAllServerClasses` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GetAllServerClasses.{platform}.yaml` with EXACTLY these fields:
