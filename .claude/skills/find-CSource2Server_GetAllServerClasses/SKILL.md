...
description: |
  ...
  CSource2Server_GetAllServerClasses in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetAllServerClasses, CSource2Server_GetAllServerClasses
disable-model-invocation: true
---

# Find CSource2Server_GetAllServerClasses

Target: `CSource2Server_GetAllServerClasses` (vfunc) in the module loaded in THIS session.
