...
description: |
  ...
  CCSPlayerPawn_HandleDropWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_HandleDropWeapon, CCSPlayerPawn_HandleDropWeapon
disable-model-invocation: true
---

# Find CCSPlayerPawn_HandleDropWeapon

Target: `CCSPlayerPawn_HandleDropWeapon` (func) in the module loaded in THIS session.
