...
description: |
  ...
  CCSPlayerPawn::HandleDropWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_HandleDropWeapon, CCSPlayerPawn::HandleDropWeapon
disable-model-invocation: true
---

# Find CCSPlayerPawn_HandleDropWeapon

Target: `CCSPlayerPawn::HandleDropWeapon` (func) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_HandleDropWeapon.{platform}.yaml` with EXACTLY these fields:
