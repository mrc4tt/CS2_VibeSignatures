...
description: |
  Agent fallback for CSaveRestoreBlockSet_vtable (auto-generated, category: func). Locate
  CSaveRestoreBlockSet_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSaveRestoreBlockSet_vtable, CSaveRestoreBlockSet_vtable
disable-model-invocation: true
---

# Find CSaveRestoreBlockSet_vtable

Target: `CSaveRestoreBlockSet_vtable` (func) in the module loaded in THIS session.
...
Write `CSaveRestoreBlockSet_vtable.{platform}.yaml` with EXACTLY these fields:
