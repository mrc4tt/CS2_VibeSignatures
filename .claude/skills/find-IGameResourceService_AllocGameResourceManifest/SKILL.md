---
name: find-IGameResourceService_AllocGameResourceManifest
description: |
  Agent fallback for IGameResourceService_AllocGameResourceManifest (auto-generated, category: func). Locate
  IGameResourceService_AllocGameResourceManifest in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameResourceService_AllocGameResourceManifest, IGameResourceService_AllocGameResourceManifest
disable-model-invocation: true
---

# Find IGameResourceService_AllocGameResourceManifest

Target: `IGameResourceService_AllocGameResourceManifest` (func) in the module loaded in THIS session.
...
Write `IGameResourceService_AllocGameResourceManifest.{platform}.yaml` with EXACTLY these fields:
