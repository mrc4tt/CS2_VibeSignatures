...
description: |
  Agent fallback for CNetworkGameServerBase_RegisterLoadingSpawnGroups (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::RegisterLoadingSpawnGroups in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_RegisterLoadingSpawnGroups, CNetworkGameServerBase::RegisterLoadingSpawnGroups
disable-model-invocation: true
---

# Find CNetworkGameServerBase_RegisterLoadingSpawnGroups

Target: `CNetworkGameServerBase::RegisterLoadingSpawnGroups` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_RegisterLoadingSpawnGroups.{platform}.yaml` with EXACTLY these fields:
