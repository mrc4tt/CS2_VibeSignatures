...
description: |
  ...
  CNetworkGameServerBase_RegisterLoadingSpawnGroups in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_RegisterLoadingSpawnGroups, CNetworkGameServerBase_RegisterLoadingSpawnGroups
disable-model-invocation: true
---

# Find CNetworkGameServerBase_RegisterLoadingSpawnGroups

Target: `CNetworkGameServerBase_RegisterLoadingSpawnGroups` (vfunc) in the module loaded in THIS session.
