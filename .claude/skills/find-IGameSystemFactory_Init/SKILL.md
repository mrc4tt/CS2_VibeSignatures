...
description: |
  Agent fallback for IGameSystemFactory_Init (auto-generated, category: vfunc). Locate
  IGameSystemFactory::Init in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystemFactory_Init, IGameSystemFactory::Init
disable-model-invocation: true
---

# Find IGameSystemFactory_Init

Target: `IGameSystemFactory::Init` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystemFactory_Init.{platform}.yaml` with EXACTLY these fields:
