...
description: |
  ...
  IGameSystemFactory_Init in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystemFactory_Init, IGameSystemFactory_Init
disable-model-invocation: true
---

# Find IGameSystemFactory_Init

Target: `IGameSystemFactory_Init` (vfunc) in the module loaded in THIS session.
