...
description: |
  ...
  CCSPlayerController_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_vtable, CCSPlayerController_vtable
disable-model-invocation: true
---

# Find CCSPlayerController_vtable

Target: `CCSPlayerController_vtable` (func) in the module loaded in THIS session.
...
Write `CCSPlayerController_vtable.{platform}.yaml` with EXACTLY these fields:
