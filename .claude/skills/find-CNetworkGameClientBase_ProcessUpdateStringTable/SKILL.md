...
description: |
  ...
  CNetworkGameClientBase_ProcessUpdateStringTable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessUpdateStringTable, CNetworkGameClientBase_ProcessUpdateStringTable
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessUpdateStringTable

Target: `CNetworkGameClientBase_ProcessUpdateStringTable` (vfunc) in the module loaded in THIS session.
