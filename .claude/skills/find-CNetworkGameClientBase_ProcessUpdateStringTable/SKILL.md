---
name: find-CNetworkGameClientBase_ProcessUpdateStringTable
description: |
  Agent fallback for CNetworkGameClientBase_ProcessUpdateStringTable (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::ProcessUpdateStringTable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessUpdateStringTable, CNetworkGameClientBase::ProcessUpdateStringTable
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessUpdateStringTable

Target: `CNetworkGameClientBase::ProcessUpdateStringTable` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ProcessUpdateStringTable.{platform}.yaml` with EXACTLY these fields:
