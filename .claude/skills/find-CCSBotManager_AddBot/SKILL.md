...
description: |
  ...
  CCSBotManager_AddBot in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBotManager_AddBot, CCSBotManager_AddBot
disable-model-invocation: true
---

# Find CCSBotManager_AddBot

Target: `CCSBotManager_AddBot` (func) in the module loaded in THIS session.
