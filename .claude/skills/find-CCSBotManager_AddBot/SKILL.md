...
description: |
  ...
  CCSBotManager::AddBot in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBotManager_AddBot, CCSBotManager::AddBot
disable-model-invocation: true
---

# Find CCSBotManager_AddBot

Target: `CCSBotManager::AddBot` (func) in the module loaded in THIS session.
...
Write `CCSBotManager_AddBot.{platform}.yaml` with EXACTLY these fields:
