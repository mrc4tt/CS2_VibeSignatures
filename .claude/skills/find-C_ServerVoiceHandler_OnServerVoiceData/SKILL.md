...
description: |
  ...
  C_ServerVoiceHandler_OnServerVoiceData in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_ServerVoiceHandler_OnServerVoiceData, C_ServerVoiceHandler_OnServerVoiceData
disable-model-invocation: true
---

# Find C_ServerVoiceHandler_OnServerVoiceData

Target: `C_ServerVoiceHandler_OnServerVoiceData` (func) in the module loaded in THIS session.
