---
name: find-CGameRules_GetSaveGameComment
description: |
  Agent fallback for CGameRules_GetSaveGameComment (auto-generated, category: vfunc). Locate
  CGameRules::GetSaveGameComment in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_GetSaveGameComment, CGameRules::GetSaveGameComment
disable-model-invocation: true
---

# Find CGameRules_GetSaveGameComment

Target: `CGameRules::GetSaveGameComment` (vfunc) in the module loaded in THIS session.
...
Write `CGameRules_GetSaveGameComment.{platform}.yaml` with EXACTLY these fields:
