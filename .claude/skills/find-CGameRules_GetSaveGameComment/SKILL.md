...
description: |
  ...
  CGameRules_GetSaveGameComment in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_GetSaveGameComment, CGameRules_GetSaveGameComment
disable-model-invocation: true
---

# Find CGameRules_GetSaveGameComment

Target: `CGameRules_GetSaveGameComment` (vfunc) in the module loaded in THIS session.
