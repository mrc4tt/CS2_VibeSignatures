...
description: |
  ...
  CPlayerCommandQueue_ctor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayerCommandQueue_ctor, CPlayerCommandQueue_ctor
disable-model-invocation: true
---

# Find CPlayerCommandQueue_ctor

Target: `CPlayerCommandQueue_ctor` (func) in the module loaded in THIS session.
