...
description: |
  Agent fallback for CPlayerCommandQueue_ctor (auto-generated, category: func). Locate
  CPlayerCommandQueue::CPlayerCommandQueue in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayerCommandQueue_ctor, CPlayerCommandQueue::CPlayerCommandQueue
disable-model-invocation: true
---

# Find CPlayerCommandQueue_ctor

Target: `CPlayerCommandQueue::CPlayerCommandQueue` (func) in the module loaded in THIS session.
...
Write `CPlayerCommandQueue_ctor.{platform}.yaml` with EXACTLY these fields:
