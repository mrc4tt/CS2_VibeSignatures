...
description: |
  Agent fallback for CNetworkClientService_AddClientPrerequisites (auto-generated, category: vfunc). Locate
  CNetworkClientService::AddClientPrerequisites in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_AddClientPrerequisites, CNetworkClientService::AddClientPrerequisites
disable-model-invocation: true
---

# Find CNetworkClientService_AddClientPrerequisites

Target: `CNetworkClientService::AddClientPrerequisites` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_AddClientPrerequisites.{platform}.yaml` with EXACTLY these fields:
