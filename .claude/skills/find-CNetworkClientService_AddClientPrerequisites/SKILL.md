...
description: |
  ...
  CNetworkClientService_AddClientPrerequisites in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_AddClientPrerequisites, CNetworkClientService_AddClientPrerequisites
disable-model-invocation: true
---

# Find CNetworkClientService_AddClientPrerequisites

Target: `CNetworkClientService_AddClientPrerequisites` (vfunc) in the module loaded in THIS session.
