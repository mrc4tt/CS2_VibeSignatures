---
name: find-CNetworkClientService_IsPutInServer
description: |
  Agent fallback for CNetworkClientService_IsPutInServer (auto-generated, category: func). Locate
  CNetworkClientService_IsPutInServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_IsPutInServer, CNetworkClientService_IsPutInServer
disable-model-invocation: true
---

# Find CNetworkClientService_IsPutInServer

Target: `CNetworkClientService_IsPutInServer` (func) in the module loaded in THIS session.
...
Write `CNetworkClientService_IsPutInServer.{platform}.yaml` with EXACTLY these fields:
