...
description: |
  Agent fallback for CEntityInstance_NetworkUpdateState (auto-generated, category: vfunc). Locate
  CEntityInstance::NetworkUpdateState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_NetworkUpdateState, CEntityInstance::NetworkUpdateState
disable-model-invocation: true
---

# Find CEntityInstance_NetworkUpdateState

Target: `CEntityInstance::NetworkUpdateState` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_NetworkUpdateState.{platform}.yaml` with EXACTLY these fields:
