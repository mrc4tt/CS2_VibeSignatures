...
description: |
  ...
  CEntityInstance_NetworkUpdateState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_NetworkUpdateState, CEntityInstance_NetworkUpdateState
disable-model-invocation: true
---

# Find CEntityInstance_NetworkUpdateState

Target: `CEntityInstance_NetworkUpdateState` (vfunc) in the module loaded in THIS session.
