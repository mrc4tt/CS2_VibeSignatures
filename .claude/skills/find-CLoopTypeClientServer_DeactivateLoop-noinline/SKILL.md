...
description: |
  ...
  CLoopTypeClientServer_DeactivateLoop-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_DeactivateLoop-noinline, CLoopTypeClientServer_DeactivateLoop-noinline
disable-model-invocation: true
---

# Find CLoopTypeClientServer_DeactivateLoop-noinline

Target: `CLoopTypeClientServer_DeactivateLoop-noinline` (vfunc) in the module loaded in THIS session.
