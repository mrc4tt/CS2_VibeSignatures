---
name: find-CLoopTypeClientServer_DeactivateLoop-noinline
description: |
  Agent fallback for CLoopTypeClientServer_DeactivateLoop-noinline (auto-generated, category: vfunc). Locate
  CLoopTypeClientServer::DeactivateLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_DeactivateLoop-noinline, CLoopTypeClientServer::DeactivateLoop
disable-model-invocation: true
---

# Find CLoopTypeClientServer_DeactivateLoop-noinline

Target: `CLoopTypeClientServer::DeactivateLoop` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_DeactivateLoop.{platform}.yaml` with EXACTLY these fields:
