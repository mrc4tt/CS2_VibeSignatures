...
description: |
  ...
  CEntitySystem_AddEntityIOEventBuildStruct-linux in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_AddEntityIOEventBuildStruct-linux, CEntitySystem_AddEntityIOEventBuildStruct-linux
disable-model-invocation: true
---

# Find CEntitySystem_AddEntityIOEventBuildStruct-linux

Target: `CEntitySystem_AddEntityIOEventBuildStruct-linux` (func) in the module loaded in THIS session.
