...
description: |
  Agent fallback for CEntitySystem_AddEntityIOEventBuildStruct-linux (auto-generated, category: func). Locate
  CEntitySystem::AddEntityIOEventBuildStruct in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_AddEntityIOEventBuildStruct-linux, CEntitySystem::AddEntityIOEventBuildStruct
disable-model-invocation: true
---

# Find CEntitySystem_AddEntityIOEventBuildStruct-linux

Target: `CEntitySystem::AddEntityIOEventBuildStruct` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_AddEntityIOEventBuildStruct.{platform}.yaml` with EXACTLY these fields:
