...
description: |
  Agent fallback for CLoadingSpawnGroup_vtable (auto-generated, category: func). Locate
  CLoadingSpawnGroup_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoadingSpawnGroup_vtable, CLoadingSpawnGroup_vtable
disable-model-invocation: true
---

# Find CLoadingSpawnGroup_vtable

Target: `CLoadingSpawnGroup_vtable` (func) in the module loaded in THIS session.
...
Write `CLoadingSpawnGroup_vtable.{platform}.yaml` with EXACTLY these fields:
