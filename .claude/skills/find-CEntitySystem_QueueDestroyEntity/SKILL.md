...
description: |
  ...
  CEntitySystem_QueueDestroyEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_QueueDestroyEntity, CEntitySystem_QueueDestroyEntity
disable-model-invocation: true
---

# Find CEntitySystem_QueueDestroyEntity

Target: `CEntitySystem_QueueDestroyEntity` (func) in the module loaded in THIS session.
