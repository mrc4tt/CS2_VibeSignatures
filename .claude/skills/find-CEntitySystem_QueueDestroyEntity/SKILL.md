...
description: |
  Agent fallback for CEntitySystem_QueueDestroyEntity (auto-generated, category: func). Locate
  CEntitySystem::QueueDestroyEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_QueueDestroyEntity, CEntitySystem::QueueDestroyEntity
disable-model-invocation: true
---

# Find CEntitySystem_QueueDestroyEntity

Target: `CEntitySystem::QueueDestroyEntity` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_QueueDestroyEntity.{platform}.yaml` with EXACTLY these fields:
