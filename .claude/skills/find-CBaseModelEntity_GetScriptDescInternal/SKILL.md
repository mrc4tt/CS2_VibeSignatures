...
description: |
  ...
  CBaseModelEntity_GetScriptDescInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseModelEntity_GetScriptDescInternal, CBaseModelEntity_GetScriptDescInternal
disable-model-invocation: true
---

# Find CBaseModelEntity_GetScriptDescInternal

Target: `CBaseModelEntity_GetScriptDescInternal` (func) in the module loaded in THIS session.
