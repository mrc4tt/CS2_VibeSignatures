...
description: |
  Agent fallback for CBaseModelEntity_GetScriptDescInternal (auto-generated, category: func). Locate
  CBaseModelEntity::GetScriptDescInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseModelEntity_GetScriptDescInternal, CBaseModelEntity::GetScriptDescInternal
disable-model-invocation: true
---

# Find CBaseModelEntity_GetScriptDescInternal

Target: `CBaseModelEntity::GetScriptDescInternal` (func) in the module loaded in THIS session.
...
Write `CBaseModelEntity_GetScriptDescInternal.{platform}.yaml` with EXACTLY these fields:
