---
name: find-CNetworkGameServerBase_ConnectClient-decompiles
description: |
  Agent fallback for CNetworkGameServerBase_ConnectClient-decompiles (auto-generated, category: func). Locate
  CNetworkGameServerBase::ConnectClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ConnectClient-decompiles, CNetworkGameServerBase::ConnectClient
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ConnectClient-decompiles

Target: `CNetworkGameServerBase::ConnectClient` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_ConnectClient.{platform}.yaml` with EXACTLY these fields:
