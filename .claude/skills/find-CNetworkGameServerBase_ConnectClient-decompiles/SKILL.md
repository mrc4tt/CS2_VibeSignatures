...
description: |
  ...
  CNetworkGameServerBase_ConnectClient-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ConnectClient-decompiles, CNetworkGameServerBase_ConnectClient-decompiles
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ConnectClient-decompiles

Target: `CNetworkGameServerBase_ConnectClient-decompiles` (func) in the module loaded in THIS session.
