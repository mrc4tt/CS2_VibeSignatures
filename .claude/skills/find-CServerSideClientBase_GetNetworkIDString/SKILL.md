...
description: |
  Agent fallback for CServerSideClientBase_GetNetworkIDString (auto-generated, category: func). Locate
  CServerSideClientBase::GetNetworkIDString in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_GetNetworkIDString, CServerSideClientBase::GetNetworkIDString
disable-model-invocation: true
---

# Find CServerSideClientBase_GetNetworkIDString

Target: `CServerSideClientBase::GetNetworkIDString` (func) in the module loaded in THIS session.
...
Write `CServerSideClientBase_GetNetworkIDString.{platform}.yaml` with EXACTLY these fields:
