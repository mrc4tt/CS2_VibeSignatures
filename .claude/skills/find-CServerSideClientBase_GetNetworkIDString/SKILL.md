...
description: |
  ...
  CServerSideClientBase_GetNetworkIDString in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_GetNetworkIDString, CServerSideClientBase_GetNetworkIDString
disable-model-invocation: true
---

# Find CServerSideClientBase_GetNetworkIDString

Target: `CServerSideClientBase_GetNetworkIDString` (func) in the module loaded in THIS session.
