...
description: |
  ...
  IsMapValid-linux in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IsMapValid-linux, IsMapValid-linux
disable-model-invocation: true
---

# Find IsMapValid-linux

Target: `IsMapValid-linux` (func) in the module loaded in THIS session.
