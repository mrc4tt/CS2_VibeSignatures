---
name: find-IsMapValid-linux
description: |
  Agent fallback for IsMapValid-linux (auto-generated, category: func). Locate
  IsMapValid in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IsMapValid-linux, IsMapValid
disable-model-invocation: true
---

# Find IsMapValid-linux

Target: `IsMapValid` (func) in the module loaded in THIS session.
...
Write `IsMapValid.{platform}.yaml` with EXACTLY these fields:
