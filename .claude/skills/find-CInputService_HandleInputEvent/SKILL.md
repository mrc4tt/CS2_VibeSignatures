---
name: find-CInputService_HandleInputEvent
description: |
  Agent fallback for CInputService_HandleInputEvent (auto-generated, category: func). Locate
  CInputService_HandleInputEvent in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_HandleInputEvent, CInputService_HandleInputEvent
disable-model-invocation: true
---

# Find CInputService_HandleInputEvent

Target: `CInputService_HandleInputEvent` (func) in the module loaded in THIS session.
...
Write `CInputService_HandleInputEvent.{platform}.yaml` with EXACTLY these fields:
