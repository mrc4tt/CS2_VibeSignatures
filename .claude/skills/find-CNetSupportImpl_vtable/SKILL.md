...
description: |
  Agent fallback for CNetSupportImpl_vtable (auto-generated, category: func). Locate
  CNetSupportImpl_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetSupportImpl_vtable, CNetSupportImpl_vtable
disable-model-invocation: true
---

# Find CNetSupportImpl_vtable

Target: `CNetSupportImpl_vtable` (func) in the module loaded in THIS session.
...
Write `CNetSupportImpl_vtable.{platform}.yaml` with EXACTLY these fields:
