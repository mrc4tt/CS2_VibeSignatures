...
description: |
  Agent fallback for CEntityComponentHelperT_CBodyComponent_vtable (auto-generated, category: func). Locate
  CEntityComponentHelperT_CBodyComponent_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityComponentHelperT_CBodyComponent_vtable, CEntityComponentHelperT_CBodyComponent_vtable
disable-model-invocation: true
---

# Find CEntityComponentHelperT_CBodyComponent_vtable

Target: `CEntityComponentHelperT_CBodyComponent_vtable` (func) in the module loaded in THIS session.
...
Write `CEntityComponentHelperT_CBodyComponent_vtable.{platform}.yaml` with EXACTLY these fields:
