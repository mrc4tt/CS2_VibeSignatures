---
name: find-SetBeamOrigin
description: |
  Locate SetBeamOrigin in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "SetBeamOrigin" (symbol SetBeamOrigin). The gamedata consumer stores a BYTE SIGNATURE for this entry - ALWAYS emit the func
  ...
  Trigger: SetBeamOrigin, SetBeamOrigin
disable-model-invocation: true
---

# Find SetBeamOrigin

Target: `SetBeamOrigin` (func) in the CS2 server module.
