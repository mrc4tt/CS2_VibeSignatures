...
description: |
  Agent fallback for IGameSystem_OnBuildGameSessionManifest (auto-generated, category: vfunc). Locate
  IGameSystem::BuildGameSessionManifest in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnBuildGameSessionManifest, IGameSystem::BuildGameSessionManifest
disable-model-invocation: true
---

# Find IGameSystem_OnBuildGameSessionManifest

Target: `IGameSystem::BuildGameSessionManifest` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnBuildGameSessionManifest.{platform}.yaml` with EXACTLY these fields:
