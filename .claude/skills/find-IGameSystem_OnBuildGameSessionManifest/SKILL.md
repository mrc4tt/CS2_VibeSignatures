...
description: |
  ...
  IGameSystem_OnBuildGameSessionManifest in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnBuildGameSessionManifest, IGameSystem_OnBuildGameSessionManifest
disable-model-invocation: true
---

# Find IGameSystem_OnBuildGameSessionManifest

Target: `IGameSystem_OnBuildGameSessionManifest` (vfunc) in the module loaded in THIS session.
