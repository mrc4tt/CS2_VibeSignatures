...
description: |
  ...
  C_BaseEntity_SetInterpolationPhase in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_BaseEntity_SetInterpolationPhase, C_BaseEntity_SetInterpolationPhase
disable-model-invocation: true
---

# Find C_BaseEntity_SetInterpolationPhase

Target: `C_BaseEntity_SetInterpolationPhase` (func) in the module loaded in THIS session.
