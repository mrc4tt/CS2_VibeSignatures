...
description: |
  Agent fallback for C_BaseEntity_SetInterpolationPhase (auto-generated, category: func). Locate
  C_BaseEntity::SetInterpolationPhase in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_BaseEntity_SetInterpolationPhase, C_BaseEntity::SetInterpolationPhase
disable-model-invocation: true
---

# Find C_BaseEntity_SetInterpolationPhase

Target: `C_BaseEntity::SetInterpolationPhase` (func) in the module loaded in THIS session.
...
Write `C_BaseEntity_SetInterpolationPhase.{platform}.yaml` with EXACTLY these fields:
