...
description: |
  ...
  IGameSystem_OnServerBeginAsyncPostTickWork in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerBeginAsyncPostTickWork, IGameSystem_OnServerBeginAsyncPostTickWork
disable-model-invocation: true
---

# Find IGameSystem_OnServerBeginAsyncPostTickWork

Target: `IGameSystem_OnServerBeginAsyncPostTickWork` (vfunc) in the module loaded in THIS session.
