...
description: |
  Agent fallback for IGameSystem_OnServerBeginAsyncPostTickWork (auto-generated, category: vfunc). Locate
  IGameSystem::OnServerBeginAsyncPostTickWork in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerBeginAsyncPostTickWork, IGameSystem::OnServerBeginAsyncPostTickWork
disable-model-invocation: true
---

# Find IGameSystem_OnServerBeginAsyncPostTickWork

Target: `IGameSystem::OnServerBeginAsyncPostTickWork` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnServerBeginAsyncPostTickWork.{platform}.yaml` with EXACTLY these fields:
