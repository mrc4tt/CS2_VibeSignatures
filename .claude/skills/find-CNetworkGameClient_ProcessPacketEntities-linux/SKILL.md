...
description: |
  ...
  CNetworkGameClient_ProcessPacketEntities-linux in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessPacketEntities-linux, CNetworkGameClient_ProcessPacketEntities-linux
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessPacketEntities-linux

Target: `CNetworkGameClient_ProcessPacketEntities-linux` (func) in the module loaded in THIS session.
