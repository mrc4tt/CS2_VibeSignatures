---
name: find-SDL_SetRelativeMouseMode-decompiles
description: |
  Agent fallback for SDL_SetRelativeMouseMode-decompiles (auto-generated, category: func). Locate
  SDL_SetRelativeMouseMode in the CS2 SDL3 module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SDL_SetRelativeMouseMode-decompiles, SDL_SetRelativeMouseMode
disable-model-invocation: true
---

# Find SDL_SetRelativeMouseMode-decompiles

Target: `SDL_SetRelativeMouseMode` (func) in the module loaded in THIS session.
...
Write `SDL_SetRelativeMouseMode.{platform}.yaml` with EXACTLY these fields:
