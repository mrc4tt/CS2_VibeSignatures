...
description: |
  ...
  SDL_SetRelativeMouseMode-decompiles in the CS2 SDL3 module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SDL_SetRelativeMouseMode-decompiles, SDL_SetRelativeMouseMode-decompiles
disable-model-invocation: true
---

# Find SDL_SetRelativeMouseMode-decompiles

Target: `SDL_SetRelativeMouseMode-decompiles` (func) in the module loaded in THIS session.
