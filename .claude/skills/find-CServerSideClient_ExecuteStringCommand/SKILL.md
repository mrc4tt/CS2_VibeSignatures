---
name: find-CServerSideClient_ExecuteStringCommand
description: |
  Agent fallback for CServerSideClient_ExecuteStringCommand (auto-generated, category: vfunc). Locate
  CServerSideClient::ExecuteStringCommand in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClient_ExecuteStringCommand, CServerSideClient::ExecuteStringCommand
disable-model-invocation: true
---

# Find CServerSideClient_ExecuteStringCommand

Target: `CServerSideClient::ExecuteStringCommand` (vfunc) in the module loaded in THIS session.
...
Write `CServerSideClient_ExecuteStringCommand.{platform}.yaml` with EXACTLY these fields:
