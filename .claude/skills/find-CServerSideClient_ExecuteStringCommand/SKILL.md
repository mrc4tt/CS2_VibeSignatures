...
description: |
  ...
  CServerSideClient_ExecuteStringCommand in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClient_ExecuteStringCommand, CServerSideClient_ExecuteStringCommand
disable-model-invocation: true
---

# Find CServerSideClient_ExecuteStringCommand

Target: `CServerSideClient_ExecuteStringCommand` (vfunc) in the module loaded in THIS session.
