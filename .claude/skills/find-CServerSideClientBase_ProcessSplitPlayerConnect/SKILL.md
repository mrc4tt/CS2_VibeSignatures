...
description: |
  ...
  CServerSideClientBase_ProcessSplitPlayerConnect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessSplitPlayerConnect, CServerSideClientBase_ProcessSplitPlayerConnect
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessSplitPlayerConnect

Target: `CServerSideClientBase_ProcessSplitPlayerConnect` (vfunc) in the module loaded in THIS session.
