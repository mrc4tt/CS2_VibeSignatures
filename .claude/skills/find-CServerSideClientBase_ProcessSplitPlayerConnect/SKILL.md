...
description: |
  Agent fallback for CServerSideClientBase_ProcessSplitPlayerConnect (auto-generated, category: vfunc). Locate
  CServerSideClientBase::ProcessSplitPlayerConnect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_ProcessSplitPlayerConnect, CServerSideClientBase::ProcessSplitPlayerConnect
disable-model-invocation: true
---

# Find CServerSideClientBase_ProcessSplitPlayerConnect

Target: `CServerSideClientBase::ProcessSplitPlayerConnect` (vfunc) in the module loaded in THIS session.
...
Write `CServerSideClientBase_ProcessSplitPlayerConnect.{platform}.yaml` with EXACTLY these fields:
