---
name: find-GameStateAPI_RegisterAPIs
description: |
  Agent fallback for GameStateAPI_RegisterAPIs (auto-generated, category: func). Locate
  GameStateAPI::RegisterAPIs in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GameStateAPI_RegisterAPIs, GameStateAPI::RegisterAPIs
disable-model-invocation: true
---

# Find GameStateAPI_RegisterAPIs

Target: `GameStateAPI::RegisterAPIs` (func) in the module loaded in THIS session.
...
Write `GameStateAPI_RegisterAPIs.{platform}.yaml` with EXACTLY these fields:
