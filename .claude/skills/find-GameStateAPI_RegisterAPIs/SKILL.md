...
description: |
  ...
  GameStateAPI_RegisterAPIs in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GameStateAPI_RegisterAPIs, GameStateAPI_RegisterAPIs
disable-model-invocation: true
---

# Find GameStateAPI_RegisterAPIs

Target: `GameStateAPI_RegisterAPIs` (func) in the module loaded in THIS session.
