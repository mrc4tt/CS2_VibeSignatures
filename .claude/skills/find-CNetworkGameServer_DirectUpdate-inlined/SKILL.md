...
description: |
  ...
  CNetworkGameServer_DirectUpdate-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_DirectUpdate-inlined, CNetworkGameServer_DirectUpdate-inlined
disable-model-invocation: true
---

# Find CNetworkGameServer_DirectUpdate-inlined

Target: `CNetworkGameServer_DirectUpdate-inlined` (vfunc) in the module loaded in THIS session.
