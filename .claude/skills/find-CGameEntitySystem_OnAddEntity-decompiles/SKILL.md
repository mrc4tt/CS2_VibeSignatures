...
description: |
  ...
  CGameEntitySystem_OnAddEntity-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_OnAddEntity-decompiles, CGameEntitySystem_OnAddEntity-decompiles
disable-model-invocation: true
---

# Find CGameEntitySystem_OnAddEntity-decompiles

Target: `CGameEntitySystem_OnAddEntity-decompiles` (vfunc) in the module loaded in THIS session.
