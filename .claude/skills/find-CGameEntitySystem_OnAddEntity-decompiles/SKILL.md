---
name: find-CGameEntitySystem_OnAddEntity-decompiles
description: |
  Agent fallback for CGameEntitySystem_OnAddEntity-decompiles (auto-generated, category: vfunc). Locate
  CGameEntitySystem::OnAddEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_OnAddEntity-decompiles, CGameEntitySystem::OnAddEntity
disable-model-invocation: true
---

# Find CGameEntitySystem_OnAddEntity-decompiles

Target: `CGameEntitySystem::OnAddEntity` (vfunc) in the module loaded in THIS session.
...
Write `CGameEntitySystem_OnAddEntity.{platform}.yaml` with EXACTLY these fields:
