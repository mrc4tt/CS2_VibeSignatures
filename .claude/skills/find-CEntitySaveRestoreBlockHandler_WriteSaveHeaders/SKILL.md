...
description: |
  ...
  CEntitySaveRestoreBlockHandler_WriteSaveHeaders in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_WriteSaveHeaders, CEntitySaveRestoreBlockHandler_WriteSaveHeaders
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_WriteSaveHeaders

Target: `CEntitySaveRestoreBlockHandler_WriteSaveHeaders` (vfunc) in the module loaded in THIS session.
