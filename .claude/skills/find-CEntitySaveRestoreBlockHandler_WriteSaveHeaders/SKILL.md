...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_WriteSaveHeaders (auto-generated, category: vfunc). Locate
  CEntitySaveRestoreBlockHandler::WriteSaveHeaders in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_WriteSaveHeaders, CEntitySaveRestoreBlockHandler::WriteSaveHeaders
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_WriteSaveHeaders

Target: `CEntitySaveRestoreBlockHandler::WriteSaveHeaders` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_WriteSaveHeaders.{platform}.yaml` with EXACTLY these fields:
