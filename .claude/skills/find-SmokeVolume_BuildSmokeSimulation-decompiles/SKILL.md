---
name: find-SmokeVolume_BuildSmokeSimulation-decompiles
description: |
  Agent fallback for SmokeVolume_BuildSmokeSimulation-decompiles (auto-generated, category: func). Locate
  SmokeVolume::BuildSmokeSimulation in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SmokeVolume_BuildSmokeSimulation-decompiles, SmokeVolume::BuildSmokeSimulation
disable-model-invocation: true
---

# Find SmokeVolume_BuildSmokeSimulation-decompiles

Target: `SmokeVolume::BuildSmokeSimulation` (func) in the module loaded in THIS session.
...
Write `SmokeVolume_BuildSmokeSimulation.{platform}.yaml` with EXACTLY these fields:
