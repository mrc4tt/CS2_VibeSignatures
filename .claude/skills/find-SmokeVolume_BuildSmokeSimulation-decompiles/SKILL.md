...
description: |
  ...
  SmokeVolume_BuildSmokeSimulation-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SmokeVolume_BuildSmokeSimulation-decompiles, SmokeVolume_BuildSmokeSimulation-decompiles
disable-model-invocation: true
---

# Find SmokeVolume_BuildSmokeSimulation-decompiles

Target: `SmokeVolume_BuildSmokeSimulation-decompiles` (func) in the module loaded in THIS session.
