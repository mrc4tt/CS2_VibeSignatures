...
description: |
  Agent fallback for CNetworkTransmitComponent_m_nStateFlags (auto-generated, category: structmember). Locate
  CNetworkTransmitComponent::m_nStateFlags in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkTransmitComponent_m_nStateFlags, CNetworkTransmitComponent::m_nStateFlags
disable-model-invocation: true
---

# Find CNetworkTransmitComponent_m_nStateFlags

Target: `CNetworkTransmitComponent::m_nStateFlags` (structmember) in the module loaded in THIS session.
...
Write `CNetworkTransmitComponent_m_nStateFlags.{platform}.yaml` with EXACTLY these fields:
