...
description: |
  Agent fallback for CEntitySystem_DestroyEntityImmediate-decompiles (auto-generated, category: func). Locate
  CEntitySystem::DestroyEntityImmediate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_DestroyEntityImmediate-decompiles, CEntitySystem::DestroyEntityImmediate
disable-model-invocation: true
---

# Find CEntitySystem_DestroyEntityImmediate-decompiles

Target: `CEntitySystem::DestroyEntityImmediate` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_DestroyEntityImmediate.{platform}.yaml` with EXACTLY these fields:
