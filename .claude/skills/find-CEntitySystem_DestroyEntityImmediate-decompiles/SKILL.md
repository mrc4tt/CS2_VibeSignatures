...
description: |
  ...
  CEntitySystem_DestroyEntityImmediate-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_DestroyEntityImmediate-decompiles, CEntitySystem_DestroyEntityImmediate-decompiles
disable-model-invocation: true
---

# Find CEntitySystem_DestroyEntityImmediate-decompiles

Target: `CEntitySystem_DestroyEntityImmediate-decompiles` (func) in the module loaded in THIS session.
