...
description: |
  ...
  CDelayedCall2_CServerSideClientBase_ProcessBaselineAckCall_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDelayedCall2_CServerSideClientBase_ProcessBaselineAckCall_vtable, CDelayedCall2_CServerSideClientBase_ProcessBaselineAckCall_vtable
disable-model-invocation: true
---

# Find CDelayedCall2_CServerSideClientBase_ProcessBaselineAckCall_vtable

Target: `CDelayedCall2_CServerSideClientBase_ProcessBaselineAckCall_vtable` (func) in the module loaded in THIS session.
...
Write `CDelayedCall2_CServerSideClientBase_ProcessBaselineAckCall_vtable.{platform}.yaml` with EXACTLY these fields:
