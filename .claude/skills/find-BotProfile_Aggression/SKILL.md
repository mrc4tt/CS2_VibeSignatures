---
name: find-BotProfile_Aggression
description: |
...
# Find BotProfile_Aggression

Target: `BotProfile::Aggression` (vfunc) in the CS2 server module.
...
This is a VIRTUAL function - resolve the BotProfile::Aggression vtable via RTTI and identify the
slot, then emit the slot. Verify by xrefs from expected call sites. vtable slots
commonly differ between platforms - never assume identical indices.
