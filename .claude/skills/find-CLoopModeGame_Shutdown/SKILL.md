---
name: find-CLoopModeGame_Shutdown
description: |
  Agent fallback for CLoopModeGame_Shutdown (auto-generated, category: func). Locate
  CLoopModeGame_Shutdown in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_Shutdown, CLoopModeGame_Shutdown
disable-model-invocation: true
---

# Find CLoopModeGame_Shutdown

Target: `CLoopModeGame_Shutdown` (func) in the module loaded in THIS session.
