---
name: find-CPanoramaEngineHandler_OnClientPreOutput
description: |
  Agent fallback for CPanoramaEngineHandler_OnClientPreOutput (auto-generated, category: func). Locate
  CPanoramaEngineHandler_OnClientPreOutput in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPanoramaEngineHandler_OnClientPreOutput, CPanoramaEngineHandler_OnClientPreOutput
disable-model-invocation: true
---

# Find CPanoramaEngineHandler_OnClientPreOutput

Target: `CPanoramaEngineHandler_OnClientPreOutput` (func) in the module loaded in THIS session.
...
Write `CPanoramaEngineHandler_OnClientPreOutput.{platform}.yaml` with EXACTLY these fields:
