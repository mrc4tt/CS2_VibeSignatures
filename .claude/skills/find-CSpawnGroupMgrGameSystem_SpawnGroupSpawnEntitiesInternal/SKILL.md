...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal (auto-generated, category: func). Locate
  CSpawnGroupMgrGameSystem::SpawnGroupSpawnEntitiesInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal, CSpawnGroupMgrGameSystem::SpawnGroupSpawnEntitiesInternal
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal

Target: `CSpawnGroupMgrGameSystem::SpawnGroupSpawnEntitiesInternal` (func) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal.{platform}.yaml` with EXACTLY these fields:
