...
description: |
  ...
  CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal, CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal

Target: `CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntitiesInternal` (func) in the module loaded in THIS session.
