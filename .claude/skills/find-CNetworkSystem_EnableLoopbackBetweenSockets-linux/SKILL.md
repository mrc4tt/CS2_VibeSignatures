...
description: |
  ...
  CNetworkSystem_EnableLoopbackBetweenSockets-linux in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_EnableLoopbackBetweenSockets-linux, CNetworkSystem_EnableLoopbackBetweenSockets-linux
disable-model-invocation: true
---

# Find CNetworkSystem_EnableLoopbackBetweenSockets-linux

Target: `CNetworkSystem_EnableLoopbackBetweenSockets-linux` (func) in the module loaded in THIS session.
