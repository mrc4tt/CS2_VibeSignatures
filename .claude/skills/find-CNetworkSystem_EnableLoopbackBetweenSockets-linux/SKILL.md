---
name: find-CNetworkSystem_EnableLoopbackBetweenSockets-linux
description: |
  Agent fallback for CNetworkSystem_EnableLoopbackBetweenSockets-linux (auto-generated, category: func). Locate
  CNetworkSystem_EnableLoopbackBetweenSockets in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_EnableLoopbackBetweenSockets-linux, CNetworkSystem_EnableLoopbackBetweenSockets
disable-model-invocation: true
---

# Find CNetworkSystem_EnableLoopbackBetweenSockets-linux

Target: `CNetworkSystem_EnableLoopbackBetweenSockets` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_EnableLoopbackBetweenSockets.{platform}.yaml` with EXACTLY these fields:
