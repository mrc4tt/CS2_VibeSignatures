...
description: |
  Agent fallback for CLoopTypeClientServerService_vtable2 (auto-generated, category: func). Locate
  CLoopTypeClientServerService_vtable2 in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServerService_vtable2, CLoopTypeClientServerService_vtable2
disable-model-invocation: true
---

# Find CLoopTypeClientServerService_vtable2

Target: `CLoopTypeClientServerService_vtable2` (func) in the module loaded in THIS session.
...
Write `CLoopTypeClientServerService_vtable2.{platform}.yaml` with EXACTLY these fields:
