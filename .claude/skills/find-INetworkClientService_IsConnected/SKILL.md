...
description: |
  Agent fallback for INetworkClientService_IsConnected (auto-generated, category: vfunc). Locate
  INetworkClientService::IsConnected in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkClientService_IsConnected, INetworkClientService::IsConnected
disable-model-invocation: true
---

# Find INetworkClientService_IsConnected

Target: `INetworkClientService::IsConnected` (vfunc) in the module loaded in THIS session.
...
Write `INetworkClientService_IsConnected.{platform}.yaml` with EXACTLY these fields:
