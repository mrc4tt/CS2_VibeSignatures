...
description: |
  ...
  INetworkClientService_IsConnected in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkClientService_IsConnected, INetworkClientService_IsConnected
disable-model-invocation: true
---

# Find INetworkClientService_IsConnected

Target: `INetworkClientService_IsConnected` (vfunc) in the module loaded in THIS session.
