...
description: |
  Agent fallback for CNetworkGameClient_OnPreserveEntity-decompiles (auto-generated, category: vfunc). Locate
  CNetworkGameClient::OnPreserveEntity in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_OnPreserveEntity-decompiles, CNetworkGameClient::OnPreserveEntity
disable-model-invocation: true
---

# Find CNetworkGameClient_OnPreserveEntity-decompiles

Target: `CNetworkGameClient::OnPreserveEntity` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_OnPreserveEntity.{platform}.yaml` with EXACTLY these fields:
