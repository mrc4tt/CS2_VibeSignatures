...
description: |
  ...
  CNetworkGameClient_OnPreserveEntity-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_OnPreserveEntity-decompiles, CNetworkGameClient_OnPreserveEntity-decompiles
disable-model-invocation: true
---

# Find CNetworkGameClient_OnPreserveEntity-decompiles

Target: `CNetworkGameClient_OnPreserveEntity-decompiles` (vfunc) in the module loaded in THIS session.
