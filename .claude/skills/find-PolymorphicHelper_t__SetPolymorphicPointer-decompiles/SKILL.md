...
description: |
  ...
  PolymorphicHelper_t__SetPolymorphicPointer-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: PolymorphicHelper_t__SetPolymorphicPointer-decompiles, PolymorphicHelper_t__SetPolymorphicPointer-decompiles
disable-model-invocation: true
---

# Find PolymorphicHelper_t__SetPolymorphicPointer-decompiles

Target: `PolymorphicHelper_t__SetPolymorphicPointer-decompiles` (func) in the module loaded in THIS session.
