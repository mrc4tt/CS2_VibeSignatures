...
description: |
  Agent fallback for PolymorphicHelper_t__SetPolymorphicPointer-decompiles (auto-generated, category: func). Locate
  PolymorphicHelper_t::SetPolymorphicPointer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: PolymorphicHelper_t__SetPolymorphicPointer-decompiles, PolymorphicHelper_t::SetPolymorphicPointer
disable-model-invocation: true
---

# Find PolymorphicHelper_t__SetPolymorphicPointer-decompiles

Target: `PolymorphicHelper_t::SetPolymorphicPointer` (func) in the module loaded in THIS session.
...
Write `PolymorphicHelper_t__SetPolymorphicPointer.{platform}.yaml` with EXACTLY these fields:
