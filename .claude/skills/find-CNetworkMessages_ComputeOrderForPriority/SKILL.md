...
description: |
  ...
  CNetworkMessages_ComputeOrderForPriority in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_ComputeOrderForPriority, CNetworkMessages_ComputeOrderForPriority
disable-model-invocation: true
---

# Find CNetworkMessages_ComputeOrderForPriority

Target: `CNetworkMessages_ComputeOrderForPriority` (vfunc) in the module loaded in THIS session.
