...
description: |
  Agent fallback for CNetworkMessages_ComputeOrderForPriority (auto-generated, category: vfunc). Locate
  CNetworkMessages::ComputeOrderForPriority in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_ComputeOrderForPriority, CNetworkMessages::ComputeOrderForPriority
disable-model-invocation: true
---

# Find CNetworkMessages_ComputeOrderForPriority

Target: `CNetworkMessages::ComputeOrderForPriority` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_ComputeOrderForPriority.{platform}.yaml` with EXACTLY these fields:
