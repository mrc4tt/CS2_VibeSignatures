...
description: |
  ...
  CGameRulesGameSystem_OnGameInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRulesGameSystem_OnGameInit, CGameRulesGameSystem_OnGameInit
disable-model-invocation: true
---

# Find CGameRulesGameSystem_OnGameInit

Target: `CGameRulesGameSystem_OnGameInit` (vfunc) in the module loaded in THIS session.
