...
description: |
  Agent fallback for CGameRulesGameSystem_OnGameInit (auto-generated, category: vfunc). Locate
  CGameRulesGameSystem::GameInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRulesGameSystem_OnGameInit, CGameRulesGameSystem::GameInit
disable-model-invocation: true
---

# Find CGameRulesGameSystem_OnGameInit

Target: `CGameRulesGameSystem::GameInit` (vfunc) in the module loaded in THIS session.
...
Write `CGameRulesGameSystem_OnGameInit.{platform}.yaml` with EXACTLY these fields:
