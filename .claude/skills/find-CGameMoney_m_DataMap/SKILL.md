...
description: |
  Agent fallback for CGameMoney_m_DataMap (auto-generated, category: func). Locate
  CGameMoney::m_DataMap in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameMoney_m_DataMap, CGameMoney::m_DataMap
disable-model-invocation: true
---

# Find CGameMoney_m_DataMap

Target: `CGameMoney::m_DataMap` (func) in the module loaded in THIS session.
...
Write `CGameMoney_m_DataMap.{platform}.yaml` with EXACTLY these fields:
