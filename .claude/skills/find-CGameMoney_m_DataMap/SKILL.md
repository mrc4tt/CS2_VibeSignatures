...
description: |
  ...
  CGameMoney_m_DataMap in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameMoney_m_DataMap, CGameMoney_m_DataMap
disable-model-invocation: true
---

# Find CGameMoney_m_DataMap

Target: `CGameMoney_m_DataMap` (func) in the module loaded in THIS session.
