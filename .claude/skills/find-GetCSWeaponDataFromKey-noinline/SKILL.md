...
description: |
  ...
  GetCSWeaponDataFromKey-noinline in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GetCSWeaponDataFromKey-noinline, GetCSWeaponDataFromKey-noinline
disable-model-invocation: true
---

# Find GetCSWeaponDataFromKey-noinline

Target: `GetCSWeaponDataFromKey-noinline` (func) in the module loaded in THIS session.
