---
name: find-GetCSWeaponDataFromKey-noinline
description: |
  Agent fallback for GetCSWeaponDataFromKey-noinline (auto-generated, category: func). Locate
  GetCSWeaponDataFromKey in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GetCSWeaponDataFromKey-noinline, GetCSWeaponDataFromKey
disable-model-invocation: true
---

# Find GetCSWeaponDataFromKey-noinline

Target: `GetCSWeaponDataFromKey` (func) in the module loaded in THIS session.
...
Write `GetCSWeaponDataFromKey.{platform}.yaml` with EXACTLY these fields:
