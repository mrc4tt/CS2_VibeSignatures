...
description: |
  ...
  CNetworkGameServerBase_BroadcastEntityVoice in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_BroadcastEntityVoice, CNetworkGameServerBase_BroadcastEntityVoice
disable-model-invocation: true
---

# Find CNetworkGameServerBase_BroadcastEntityVoice

Target: `CNetworkGameServerBase_BroadcastEntityVoice` (vfunc) in the module loaded in THIS session.
