---
name: find-CNetworkGameServerBase_BroadcastEntityVoice
description: |
  Agent fallback for CNetworkGameServerBase_BroadcastEntityVoice (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::BroadcastEntityVoice in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_BroadcastEntityVoice, CNetworkGameServerBase::BroadcastEntityVoice
disable-model-invocation: true
---

# Find CNetworkGameServerBase_BroadcastEntityVoice

Target: `CNetworkGameServerBase::BroadcastEntityVoice` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_BroadcastEntityVoice.{platform}.yaml` with EXACTLY these fields:
