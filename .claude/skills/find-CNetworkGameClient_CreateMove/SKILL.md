...
description: |
  ...
  CNetworkGameClient_CreateMove in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_CreateMove, CNetworkGameClient_CreateMove
disable-model-invocation: true
---

# Find CNetworkGameClient_CreateMove

Target: `CNetworkGameClient_CreateMove` (vfunc) in the module loaded in THIS session.
