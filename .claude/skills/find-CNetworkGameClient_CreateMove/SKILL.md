---
name: find-CNetworkGameClient_CreateMove
description: |
  Agent fallback for CNetworkGameClient_CreateMove (auto-generated, category: vfunc). Locate
  CNetworkGameClient::CreateMove in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_CreateMove, CNetworkGameClient::CreateMove
disable-model-invocation: true
---

# Find CNetworkGameClient_CreateMove

Target: `CNetworkGameClient::CreateMove` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_CreateMove.{platform}.yaml` with EXACTLY these fields:
