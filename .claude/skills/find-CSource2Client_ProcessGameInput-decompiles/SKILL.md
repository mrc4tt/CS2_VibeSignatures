...
description: |
  Agent fallback for CSource2Client_ProcessGameInput-decompiles (auto-generated, category: vfunc). Locate
  CSource2Client::ProcessGameInput in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_ProcessGameInput-decompiles, CSource2Client::ProcessGameInput
disable-model-invocation: true
---

# Find CSource2Client_ProcessGameInput-decompiles

Target: `CSource2Client::ProcessGameInput` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Client_ProcessGameInput.{platform}.yaml` with EXACTLY these fields:
