...
description: |
  ...
  CSource2Client_ProcessGameInput-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_ProcessGameInput-decompiles, CSource2Client_ProcessGameInput-decompiles
disable-model-invocation: true
---

# Find CSource2Client_ProcessGameInput-decompiles

Target: `CSource2Client_ProcessGameInput-decompiles` (vfunc) in the module loaded in THIS session.
