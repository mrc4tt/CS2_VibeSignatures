---
name: find-CServerSideClientBase_Connect
description: |
  Agent fallback for CServerSideClientBase_Connect (auto-generated, category: vfunc). Locate
  CServerSideClientBase::Connect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_Connect, CServerSideClientBase::Connect
disable-model-invocation: true
---

# Find CServerSideClientBase_Connect

Target: `CServerSideClientBase::Connect` (vfunc) in the module loaded in THIS session.
...
Write `CServerSideClientBase_Connect.{platform}.yaml` with EXACTLY these fields:
