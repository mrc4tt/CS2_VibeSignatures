...
description: |
  ...
  CServerSideClientBase_Connect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_Connect, CServerSideClientBase_Connect
disable-model-invocation: true
---

# Find CServerSideClientBase_Connect

Target: `CServerSideClientBase_Connect` (vfunc) in the module loaded in THIS session.
