...
description: |
  Agent fallback for CNetworkClientService_vtable (auto-generated, category: func). Locate
  CNetworkClientService_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_vtable, CNetworkClientService_vtable
disable-model-invocation: true
---

# Find CNetworkClientService_vtable

Target: `CNetworkClientService_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkClientService_vtable.{platform}.yaml` with EXACTLY these fields:
