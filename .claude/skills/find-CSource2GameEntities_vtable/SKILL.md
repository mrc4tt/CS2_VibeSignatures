...
description: |
  Agent fallback for CSource2GameEntities_vtable (auto-generated, category: func). Locate
  CSource2GameEntities_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameEntities_vtable, CSource2GameEntities_vtable
disable-model-invocation: true
---

# Find CSource2GameEntities_vtable

Target: `CSource2GameEntities_vtable` (func) in the module loaded in THIS session.
...
Write `CSource2GameEntities_vtable.{platform}.yaml` with EXACTLY these fields:
