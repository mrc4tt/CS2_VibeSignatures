---
name: find-CEntityResourceManifest_AddResource-windows
description: |
  Agent fallback for CEntityResourceManifest_AddResource-windows (auto-generated, category: func). Locate
  CEntityResourceManifest_AddResource in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityResourceManifest_AddResource-windows, CEntityResourceManifest_AddResource
disable-model-invocation: true
---

# Find CEntityResourceManifest_AddResource-windows

Target: `CEntityResourceManifest_AddResource` (func) in the module loaded in THIS session.
...
Write `CEntityResourceManifest_AddResource.{platform}.yaml` with EXACTLY these fields:
