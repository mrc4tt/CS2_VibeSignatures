...
description: |
  ...
  CCSPlayerStateDeathAnim_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerStateDeathAnim_vtable, CCSPlayerStateDeathAnim_vtable
disable-model-invocation: true
---

# Find CCSPlayerStateDeathAnim_vtable

Target: `CCSPlayerStateDeathAnim_vtable` (func) in the module loaded in THIS session.
...
Write `CCSPlayerStateDeathAnim_vtable.{platform}.yaml` with EXACTLY these fields:
