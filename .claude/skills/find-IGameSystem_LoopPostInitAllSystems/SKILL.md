...
description: |
  ...
  IGameSystem_LoopPostInitAllSystems in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_LoopPostInitAllSystems, IGameSystem_LoopPostInitAllSystems
disable-model-invocation: true
---

# Find IGameSystem_LoopPostInitAllSystems

Target: `IGameSystem_LoopPostInitAllSystems` (func) in the module loaded in THIS session.
