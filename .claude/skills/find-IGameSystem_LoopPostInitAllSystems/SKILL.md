...
description: |
  Agent fallback for IGameSystem_LoopPostInitAllSystems (auto-generated, category: func). Locate
  IGameSystem::LoopPostInitAllSystems in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_LoopPostInitAllSystems, IGameSystem::LoopPostInitAllSystems
disable-model-invocation: true
---

# Find IGameSystem_LoopPostInitAllSystems

Target: `IGameSystem::LoopPostInitAllSystems` (func) in the module loaded in THIS session.
...
Write `IGameSystem_LoopPostInitAllSystems.{platform}.yaml` with EXACTLY these fields:
