...
description: |
  ...
  CMsgSource2NetworkFlowQuality_PrintStats-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMsgSource2NetworkFlowQuality_PrintStats-noinline, CMsgSource2NetworkFlowQuality_PrintStats-noinline
disable-model-invocation: true
---

# Find CMsgSource2NetworkFlowQuality_PrintStats-noinline

Target: `CMsgSource2NetworkFlowQuality_PrintStats-noinline` (func) in the module loaded in THIS session.
