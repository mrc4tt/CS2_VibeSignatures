---
name: find-CMsgSource2NetworkFlowQuality_PrintStats-noinline
description: |
  Agent fallback for CMsgSource2NetworkFlowQuality_PrintStats-noinline (auto-generated, category: func). Locate
  CMsgSource2NetworkFlowQuality::PrintStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMsgSource2NetworkFlowQuality_PrintStats-noinline, CMsgSource2NetworkFlowQuality::PrintStats
disable-model-invocation: true
---

# Find CMsgSource2NetworkFlowQuality_PrintStats-noinline

Target: `CMsgSource2NetworkFlowQuality::PrintStats` (func) in the module loaded in THIS session.
...
Write `CMsgSource2NetworkFlowQuality_PrintStats.{platform}.yaml` with EXACTLY these fields:
