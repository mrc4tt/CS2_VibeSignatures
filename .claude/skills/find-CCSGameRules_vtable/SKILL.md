...
description: |
  ...
  CCSGameRules_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_vtable, CCSGameRules_vtable
disable-model-invocation: true
---

# Find CCSGameRules_vtable

Target: `CCSGameRules_vtable` (func) in the module loaded in THIS session.
...
Write `CCSGameRules_vtable.{platform}.yaml` with EXACTLY these fields:
