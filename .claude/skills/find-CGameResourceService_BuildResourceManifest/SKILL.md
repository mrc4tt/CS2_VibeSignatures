...
description: |
  Agent fallback for CGameResourceService_BuildResourceManifest (auto-generated, category: func). Locate
  CGameResourceService::BuildResourceManifest in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_BuildResourceManifest, CGameResourceService::BuildResourceManifest
disable-model-invocation: true
---

# Find CGameResourceService_BuildResourceManifest

Target: `CGameResourceService::BuildResourceManifest` (func) in the module loaded in THIS session.
...
Write `CGameResourceService_BuildResourceManifest.{platform}.yaml` with EXACTLY these fields:
