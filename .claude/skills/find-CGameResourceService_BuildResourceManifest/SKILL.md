...
description: |
  ...
  CGameResourceService_BuildResourceManifest in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_BuildResourceManifest, CGameResourceService_BuildResourceManifest
disable-model-invocation: true
---

# Find CGameResourceService_BuildResourceManifest

Target: `CGameResourceService_BuildResourceManifest` (func) in the module loaded in THIS session.
