...
description: |
  Agent fallback for CLoopModeGame_vtable (auto-generated, category: func). Locate
  CLoopModeGame_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_vtable, CLoopModeGame_vtable
disable-model-invocation: true
---

# Find CLoopModeGame_vtable

Target: `CLoopModeGame_vtable` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_vtable.{platform}.yaml` with EXACTLY these fields:
