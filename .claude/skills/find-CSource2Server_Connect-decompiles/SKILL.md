---
name: find-CSource2Server_Connect-decompiles
description: |
  Agent fallback for CSource2Server_Connect-decompiles (auto-generated, category: vfunc). Locate
  CSource2Server::Connect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Connect-decompiles, CSource2Server::Connect
disable-model-invocation: true
---

# Find CSource2Server_Connect-decompiles

Target: `CSource2Server::Connect` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_Connect.{platform}.yaml` with EXACTLY these fields:
