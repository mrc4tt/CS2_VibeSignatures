...
description: |
  ...
  CSource2Server_Connect-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Connect-decompiles, CSource2Server_Connect-decompiles
disable-model-invocation: true
---

# Find CSource2Server_Connect-decompiles

Target: `CSource2Server_Connect-decompiles` (vfunc) in the module loaded in THIS session.
