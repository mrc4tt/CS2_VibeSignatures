...
description: |
  ...
  CBasePlayerPawn_Event_Killed in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_Event_Killed, CBasePlayerPawn_Event_Killed
disable-model-invocation: true
---

# Find CBasePlayerPawn_Event_Killed

Target: `CBasePlayerPawn_Event_Killed` (vfunc) in the module loaded in THIS session.
