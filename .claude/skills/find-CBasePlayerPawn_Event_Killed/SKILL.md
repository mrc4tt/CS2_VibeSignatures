---
name: find-CBasePlayerPawn_Event_Killed
description: |
  Agent fallback for CBasePlayerPawn_Event_Killed (auto-generated, category: vfunc). Locate
  CBasePlayerPawn::Event_Killed in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_Event_Killed, CBasePlayerPawn::Event_Killed
disable-model-invocation: true
---

# Find CBasePlayerPawn_Event_Killed

Target: `CBasePlayerPawn::Event_Killed` (vfunc) in the module loaded in THIS session.
...
Write `CBasePlayerPawn_Event_Killed.{platform}.yaml` with EXACTLY these fields:
