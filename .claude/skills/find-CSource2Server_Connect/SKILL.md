...
description: |
  Agent fallback for CSource2Server_Connect (auto-generated, category: vfunc). Locate
  ...
  Trigger: CSource2Server_Connect, CSource2Server::Connect
disable-model-invocation: true
---

# Find CSource2Server_Connect
