...
description: |
  ...
  CSource2Server_Connect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Connect, CSource2Server_Connect
disable-model-invocation: true
---

# Find CSource2Server_Connect

Target: `CSource2Server_Connect` (vfunc) in the module loaded in THIS session.
