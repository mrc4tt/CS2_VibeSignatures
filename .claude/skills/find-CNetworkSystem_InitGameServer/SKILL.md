---
name: find-CNetworkSystem_InitGameServer
description: |
  Agent fallback for CNetworkSystem_InitGameServer (auto-generated, category: vfunc). Locate
  CNetworkSystem::InitGameServer in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_InitGameServer, CNetworkSystem::InitGameServer
disable-model-invocation: true
---

# Find CNetworkSystem_InitGameServer

Target: `CNetworkSystem::InitGameServer` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkSystem_InitGameServer.{platform}.yaml` with EXACTLY these fields:
