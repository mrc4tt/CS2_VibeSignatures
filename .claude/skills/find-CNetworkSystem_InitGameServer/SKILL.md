...
description: |
  ...
  CNetworkSystem_InitGameServer in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_InitGameServer, CNetworkSystem_InitGameServer
disable-model-invocation: true
---

# Find CNetworkSystem_InitGameServer

Target: `CNetworkSystem_InitGameServer` (vfunc) in the module loaded in THIS session.
