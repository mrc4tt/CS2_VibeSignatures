...
description: |
  Agent fallback for CNetworkClientService_FinishChangeLevel (auto-generated, category: vfunc). Locate
  CNetworkClientService::FinishChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_FinishChangeLevel, CNetworkClientService::FinishChangeLevel
disable-model-invocation: true
---

# Find CNetworkClientService_FinishChangeLevel

Target: `CNetworkClientService::FinishChangeLevel` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_FinishChangeLevel.{platform}.yaml` with EXACTLY these fields:
