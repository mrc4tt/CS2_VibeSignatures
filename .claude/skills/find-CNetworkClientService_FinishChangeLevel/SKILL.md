...
description: |
  ...
  CNetworkClientService_FinishChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_FinishChangeLevel, CNetworkClientService_FinishChangeLevel
disable-model-invocation: true
---

# Find CNetworkClientService_FinishChangeLevel

Target: `CNetworkClientService_FinishChangeLevel` (vfunc) in the module loaded in THIS session.
