...
description: |
  ...
  CEntitySystem_PostCreateEntitySystem in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_PostCreateEntitySystem, CEntitySystem_PostCreateEntitySystem
disable-model-invocation: true
---

# Find CEntitySystem_PostCreateEntitySystem

Target: `CEntitySystem_PostCreateEntitySystem` (func) in the module loaded in THIS session.
