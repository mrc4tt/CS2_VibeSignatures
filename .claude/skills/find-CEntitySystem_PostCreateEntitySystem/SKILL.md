...
description: |
  Agent fallback for CEntitySystem_PostCreateEntitySystem (auto-generated, category: func). Locate
  CEntitySystem::PostCreateEntitySystem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_PostCreateEntitySystem, CEntitySystem::PostCreateEntitySystem
disable-model-invocation: true
---

# Find CEntitySystem_PostCreateEntitySystem

Target: `CEntitySystem::PostCreateEntitySystem` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_PostCreateEntitySystem.{platform}.yaml` with EXACTLY these fields:
