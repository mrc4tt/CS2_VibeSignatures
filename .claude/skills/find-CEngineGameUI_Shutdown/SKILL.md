...
description: |
  ...
  CEngineGameUI_Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineGameUI_Shutdown, CEngineGameUI_Shutdown
disable-model-invocation: true
---

# Find CEngineGameUI_Shutdown

Target: `CEngineGameUI_Shutdown` (vfunc) in the module loaded in THIS session.
