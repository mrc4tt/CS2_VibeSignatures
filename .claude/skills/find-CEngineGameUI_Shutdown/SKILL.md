...
description: |
  Agent fallback for CEngineGameUI_Shutdown (auto-generated, category: vfunc). Locate
  CEngineGameUI::Shutdown in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineGameUI_Shutdown, CEngineGameUI::Shutdown
disable-model-invocation: true
---

# Find CEngineGameUI_Shutdown

Target: `CEngineGameUI::Shutdown` (vfunc) in the module loaded in THIS session.
...
Write `CEngineGameUI_Shutdown.{platform}.yaml` with EXACTLY these fields:
