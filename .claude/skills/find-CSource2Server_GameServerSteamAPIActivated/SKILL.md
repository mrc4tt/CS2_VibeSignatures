...
description: |
  Agent fallback for CSource2Server_GameServerSteamAPIActivated (auto-generated, category: vfunc). Locate
  CSource2Server::GameServerSteamAPIActivated in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameServerSteamAPIActivated, CSource2Server::GameServerSteamAPIActivated
disable-model-invocation: true
---

# Find CSource2Server_GameServerSteamAPIActivated

Target: `CSource2Server::GameServerSteamAPIActivated` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GameServerSteamAPIActivated.{platform}.yaml` with EXACTLY these fields:
