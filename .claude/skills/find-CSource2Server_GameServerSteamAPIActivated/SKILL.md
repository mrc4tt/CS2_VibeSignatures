...
description: |
  ...
  CSource2Server_GameServerSteamAPIActivated in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameServerSteamAPIActivated, CSource2Server_GameServerSteamAPIActivated
disable-model-invocation: true
---

# Find CSource2Server_GameServerSteamAPIActivated

Target: `CSource2Server_GameServerSteamAPIActivated` (vfunc) in the module loaded in THIS session.
