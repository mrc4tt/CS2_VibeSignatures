...
description: |
  Agent fallback for CScriptedSequence_SynchronizeSequence (auto-generated, category: func). Locate
  CScriptedSequence::SynchronizeSequence in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CScriptedSequence_SynchronizeSequence, CScriptedSequence::SynchronizeSequence
disable-model-invocation: true
---

# Find CScriptedSequence_SynchronizeSequence

Target: `CScriptedSequence::SynchronizeSequence` (func) in the module loaded in THIS session.
...
Write `CScriptedSequence_SynchronizeSequence.{platform}.yaml` with EXACTLY these fields:
