...
description: |
  ...
  CScriptedSequence_SynchronizeSequence in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CScriptedSequence_SynchronizeSequence, CScriptedSequence_SynchronizeSequence
disable-model-invocation: true
---

# Find CScriptedSequence_SynchronizeSequence

Target: `CScriptedSequence_SynchronizeSequence` (func) in the module loaded in THIS session.
