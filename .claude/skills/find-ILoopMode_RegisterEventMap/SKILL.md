...
description: |
  ...
  ILoopMode_RegisterEventMap in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_RegisterEventMap, ILoopMode_RegisterEventMap
disable-model-invocation: true
---

# Find ILoopMode_RegisterEventMap

Target: `ILoopMode_RegisterEventMap` (vfunc) in the module loaded in THIS session.
