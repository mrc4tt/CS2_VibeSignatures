...
description: |
  Agent fallback for ILoopMode_RegisterEventMap (auto-generated, category: vfunc). Locate
  ILoopMode::RegisterEventMap in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_RegisterEventMap, ILoopMode::RegisterEventMap
disable-model-invocation: true
---

# Find ILoopMode_RegisterEventMap

Target: `ILoopMode::RegisterEventMap` (vfunc) in the module loaded in THIS session.
...
Write `ILoopMode_RegisterEventMap.{platform}.yaml` with EXACTLY these fields:
