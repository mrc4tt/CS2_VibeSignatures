...
description: |
  ...
  IsBackgroundMap-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IsBackgroundMap-decompiles, IsBackgroundMap-decompiles
disable-model-invocation: true
---

# Find IsBackgroundMap-decompiles

Target: `IsBackgroundMap-decompiles` (func) in the module loaded in THIS session.
