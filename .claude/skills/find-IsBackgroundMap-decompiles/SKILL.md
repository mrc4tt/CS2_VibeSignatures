...
description: |
  Agent fallback for IsBackgroundMap-decompiles (auto-generated, category: func). Locate
  IsBackgroundMap in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IsBackgroundMap-decompiles, IsBackgroundMap
disable-model-invocation: true
---

# Find IsBackgroundMap-decompiles

Target: `IsBackgroundMap` (func) in the module loaded in THIS session.
...
Write `IsBackgroundMap.{platform}.yaml` with EXACTLY these fields:
