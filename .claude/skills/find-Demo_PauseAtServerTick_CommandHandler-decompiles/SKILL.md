...
description: |
  Agent fallback for Demo_PauseAtServerTick_CommandHandler-decompiles (auto-generated, category: func). Locate
  Demo_PauseAtServerTick_CommandHandler in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: Demo_PauseAtServerTick_CommandHandler-decompiles, Demo_PauseAtServerTick_CommandHandler
disable-model-invocation: true
---

# Find Demo_PauseAtServerTick_CommandHandler-decompiles

Target: `Demo_PauseAtServerTick_CommandHandler` (func) in the module loaded in THIS session.
...
Write `Demo_PauseAtServerTick_CommandHandler.{platform}.yaml` with EXACTLY these fields:
