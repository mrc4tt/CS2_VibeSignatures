...
description: |
  ...
  Demo_PauseAtServerTick_CommandHandler-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: Demo_PauseAtServerTick_CommandHandler-decompiles, Demo_PauseAtServerTick_CommandHandler-decompiles
disable-model-invocation: true
---

# Find Demo_PauseAtServerTick_CommandHandler-decompiles

Target: `Demo_PauseAtServerTick_CommandHandler-decompiles` (func) in the module loaded in THIS session.
