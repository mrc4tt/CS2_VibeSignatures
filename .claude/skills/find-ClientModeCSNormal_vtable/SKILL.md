...
description: |
  Agent fallback for ClientModeCSNormal_vtable (auto-generated, category: func). Locate
  ClientModeCSNormal_vtable in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ClientModeCSNormal_vtable, ClientModeCSNormal_vtable
disable-model-invocation: true
---

# Find ClientModeCSNormal_vtable

Target: `ClientModeCSNormal_vtable` (func) in the module loaded in THIS session.
...
Write `ClientModeCSNormal_vtable.{platform}.yaml` with EXACTLY these fields:
