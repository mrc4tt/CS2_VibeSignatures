...
description: |
  Agent fallback for UTIL_ClientPrintAll (auto-generated, category: func). Locate
  UTIL_ClientPrintAll in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: UTIL_ClientPrintAll, UTIL_ClientPrintAll
disable-model-invocation: true
---

# Find UTIL_ClientPrintAll

Target: `UTIL_ClientPrintAll` (func) in the module loaded in THIS session.
...
Write `UTIL_ClientPrintAll.{platform}.yaml` with EXACTLY these fields:
