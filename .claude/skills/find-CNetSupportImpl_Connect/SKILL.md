...
description: |
  Agent fallback for CNetSupportImpl_Connect (auto-generated, category: func). Locate
  CNetSupportImpl_Connect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetSupportImpl_Connect, CNetSupportImpl_Connect
disable-model-invocation: true
---

# Find CNetSupportImpl_Connect

Target: `CNetSupportImpl_Connect` (func) in the module loaded in THIS session.
...
Write `CNetSupportImpl_Connect.{platform}.yaml` with EXACTLY these fields:
