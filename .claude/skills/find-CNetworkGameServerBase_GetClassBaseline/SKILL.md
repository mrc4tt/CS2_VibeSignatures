...
description: |
  ...
  CNetworkGameServerBase_GetClassBaseline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetClassBaseline, CNetworkGameServerBase_GetClassBaseline
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetClassBaseline

Target: `CNetworkGameServerBase_GetClassBaseline` (vfunc) in the module loaded in THIS session.
