...
description: |
  Agent fallback for CNetworkGameServerBase_GetClassBaseline (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::GetClassBaseline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetClassBaseline, CNetworkGameServerBase::GetClassBaseline
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetClassBaseline

Target: `CNetworkGameServerBase::GetClassBaseline` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_GetClassBaseline.{platform}.yaml` with EXACTLY these fields:
