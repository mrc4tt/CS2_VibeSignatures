...
description: |
  ...
  CBaseEntity_EmitSoundFilter in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_EmitSoundFilter, CBaseEntity_EmitSoundFilter
disable-model-invocation: true
---

# Find CBaseEntity_EmitSoundFilter

Target: `CBaseEntity_EmitSoundFilter` (func) in the module loaded in THIS session.
