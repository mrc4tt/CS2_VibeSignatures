...
description: |
  Agent fallback for CSource2Server_GameServerSteamAPIDeactivated (auto-generated, category: vfunc). Locate
  CSource2Server::GameServerSteamAPIDeactivated in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameServerSteamAPIDeactivated, CSource2Server::GameServerSteamAPIDeactivated
disable-model-invocation: true
---

# Find CSource2Server_GameServerSteamAPIDeactivated

Target: `CSource2Server::GameServerSteamAPIDeactivated` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GameServerSteamAPIDeactivated.{platform}.yaml` with EXACTLY these fields:
