...
description: |
  ...
  CSource2Server_GameServerSteamAPIDeactivated in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GameServerSteamAPIDeactivated, CSource2Server_GameServerSteamAPIDeactivated
disable-model-invocation: true
---

# Find CSource2Server_GameServerSteamAPIDeactivated

Target: `CSource2Server_GameServerSteamAPIDeactivated` (vfunc) in the module loaded in THIS session.
