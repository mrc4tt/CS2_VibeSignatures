...
description: |
  ...
  CBaseEntity_NetworkStateChanged-inlined in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_NetworkStateChanged-inlined, CBaseEntity_NetworkStateChanged-inlined
disable-model-invocation: true
---

# Find CBaseEntity_NetworkStateChanged-inlined

Target: `CBaseEntity_NetworkStateChanged-inlined` (vfunc) in the module loaded in THIS session.
