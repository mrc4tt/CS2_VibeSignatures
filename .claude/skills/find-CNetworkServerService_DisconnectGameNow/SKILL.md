...
description: |
  Agent fallback for CNetworkServerService_DisconnectGameNow (auto-generated, category: vfunc). Locate
  CNetworkServerService::DisconnectGameNow in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_DisconnectGameNow, CNetworkServerService::DisconnectGameNow
disable-model-invocation: true
---

# Find CNetworkServerService_DisconnectGameNow

Target: `CNetworkServerService::DisconnectGameNow` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkServerService_DisconnectGameNow.{platform}.yaml` with EXACTLY these fields:
