...
description: |
  ...
  CNetworkServerService_DisconnectGameNow in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_DisconnectGameNow, CNetworkServerService_DisconnectGameNow
disable-model-invocation: true
---

# Find CNetworkServerService_DisconnectGameNow

Target: `CNetworkServerService_DisconnectGameNow` (vfunc) in the module loaded in THIS session.
