...
description: |
  Agent fallback for CBaseEntity_Teleport (auto-generated, category: vfunc). Locate
  CBaseEntity::Teleport in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_Teleport, CBaseEntity::Teleport
disable-model-invocation: true
---

# Find CBaseEntity_Teleport

Target: `CBaseEntity::Teleport` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_Teleport.{platform}.yaml` with EXACTLY these fields:
