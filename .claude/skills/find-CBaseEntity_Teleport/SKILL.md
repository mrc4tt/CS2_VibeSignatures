...
description: |
  ...
  CBaseEntity_Teleport in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_Teleport, CBaseEntity_Teleport
disable-model-invocation: true
---

# Find CBaseEntity_Teleport

Target: `CBaseEntity_Teleport` (vfunc) in the module loaded in THIS session.
