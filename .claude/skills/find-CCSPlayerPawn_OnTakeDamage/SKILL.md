...
description: |
  ...
  CCSPlayerPawn_OnTakeDamage in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_OnTakeDamage, CCSPlayerPawn_OnTakeDamage
disable-model-invocation: true
---

# Find CCSPlayerPawn_OnTakeDamage

Target: `CCSPlayerPawn_OnTakeDamage` (func) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_OnTakeDamage.{platform}.yaml` with EXACTLY these fields:
