...
description: |
  Agent fallback for CEntitySystem_SortEntities (auto-generated, category: vfunc). Locate
  CEntitySystem::SortEntities in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_SortEntities, CEntitySystem::SortEntities
disable-model-invocation: true
---

# Find CEntitySystem_SortEntities

Target: `CEntitySystem::SortEntities` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_SortEntities.{platform}.yaml` with EXACTLY these fields:
