...
description: |
  ...
  CEntitySystem_SortEntities in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_SortEntities, CEntitySystem_SortEntities
disable-model-invocation: true
---

# Find CEntitySystem_SortEntities

Target: `CEntitySystem_SortEntities` (vfunc) in the module loaded in THIS session.
