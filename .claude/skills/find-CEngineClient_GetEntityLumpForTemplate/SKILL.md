...
description: |
  Agent fallback for CEngineClient_GetEntityLumpForTemplate (auto-generated, category: vfunc). Locate
  CEngineClient::GetEntityLumpForTemplate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_GetEntityLumpForTemplate, CEngineClient::GetEntityLumpForTemplate
disable-model-invocation: true
---

# Find CEngineClient_GetEntityLumpForTemplate

Target: `CEngineClient::GetEntityLumpForTemplate` (vfunc) in the module loaded in THIS session.
...
Write `CEngineClient_GetEntityLumpForTemplate.{platform}.yaml` with EXACTLY these fields:
