...
description: |
  ...
  CEngineClient_GetEntityLumpForTemplate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_GetEntityLumpForTemplate, CEngineClient_GetEntityLumpForTemplate
disable-model-invocation: true
---

# Find CEngineClient_GetEntityLumpForTemplate

Target: `CEngineClient_GetEntityLumpForTemplate` (vfunc) in the module loaded in THIS session.
