...
description: |
  ...
  IEngineServiceMgr_UnregisterEngineService in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_UnregisterEngineService, IEngineServiceMgr_UnregisterEngineService
disable-model-invocation: true
---

# Find IEngineServiceMgr_UnregisterEngineService

Target: `IEngineServiceMgr_UnregisterEngineService` (vfunc) in the module loaded in THIS session.
