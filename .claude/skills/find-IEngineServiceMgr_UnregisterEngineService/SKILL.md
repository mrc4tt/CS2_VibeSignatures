...
description: |
  Agent fallback for IEngineServiceMgr_UnregisterEngineService (auto-generated, category: vfunc). Locate
  IEngineServiceMgr::UnregisterEngineService in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_UnregisterEngineService, IEngineServiceMgr::UnregisterEngineService
disable-model-invocation: true
---

# Find IEngineServiceMgr_UnregisterEngineService

Target: `IEngineServiceMgr::UnregisterEngineService` (vfunc) in the module loaded in THIS session.
...
Write `IEngineServiceMgr_UnregisterEngineService.{platform}.yaml` with EXACTLY these fields:
