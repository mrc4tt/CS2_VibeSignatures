...
description: |
  Agent fallback for CCSGameRules_FindPickerEntity (auto-generated, category: vfunc). Locate
  CCSGameRules::FindPickerEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_FindPickerEntity, CCSGameRules::FindPickerEntity
disable-model-invocation: true
---

# Find CCSGameRules_FindPickerEntity

Target: `CCSGameRules::FindPickerEntity` (vfunc) in the module loaded in THIS session.
...
Write `CCSGameRules_FindPickerEntity.{platform}.yaml` with EXACTLY these fields:
