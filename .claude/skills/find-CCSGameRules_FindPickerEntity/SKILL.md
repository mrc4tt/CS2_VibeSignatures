...
description: |
  ...
  CCSGameRules_FindPickerEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_FindPickerEntity, CCSGameRules_FindPickerEntity
disable-model-invocation: true
---

# Find CCSGameRules_FindPickerEntity

Target: `CCSGameRules_FindPickerEntity` (vfunc) in the module loaded in THIS session.
