...
description: |
  Agent fallback for TraceShape (auto-generated, category: func). Locate
  TraceShape in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: TraceShape, TraceShape
disable-model-invocation: true
---

# Find TraceShape

Target: `TraceShape` (func) in the module loaded in THIS session.
...
Write `TraceShape.{platform}.yaml` with EXACTLY these fields:
