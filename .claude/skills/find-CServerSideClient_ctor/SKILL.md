...
description: |
  Agent fallback for CServerSideClient_ctor (auto-generated, category: func). Locate
  CServerSideClient::CServerSideClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClient_ctor, CServerSideClient::CServerSideClient
disable-model-invocation: true
---

# Find CServerSideClient_ctor

Target: `CServerSideClient::CServerSideClient` (func) in the module loaded in THIS session.
...
Write `CServerSideClient_ctor.{platform}.yaml` with EXACTLY these fields:
