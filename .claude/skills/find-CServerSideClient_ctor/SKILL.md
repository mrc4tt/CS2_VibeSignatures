...
description: |
  ...
  CServerSideClient_ctor in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClient_ctor, CServerSideClient_ctor
disable-model-invocation: true
---

# Find CServerSideClient_ctor

Target: `CServerSideClient_ctor` (func) in the module loaded in THIS session.
