...
description: |
  Agent fallback for CNetworkGameServerBase_ServerPollNetworking (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::ServerPollNetworking in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerPollNetworking, CNetworkGameServerBase::ServerPollNetworking
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerPollNetworking

Target: `CNetworkGameServerBase::ServerPollNetworking` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_ServerPollNetworking.{platform}.yaml` with EXACTLY these fields:
