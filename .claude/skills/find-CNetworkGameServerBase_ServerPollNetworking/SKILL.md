...
description: |
  ...
  CNetworkGameServerBase_ServerPollNetworking in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerPollNetworking, CNetworkGameServerBase_ServerPollNetworking
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerPollNetworking

Target: `CNetworkGameServerBase_ServerPollNetworking` (vfunc) in the module loaded in THIS session.
