---
name: find-ClientAntiTamperTest-windows
description: |
  Agent fallback for ClientAntiTamperTest-windows (auto-generated, category: func). Locate
  ClientAntiTamperTest in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ClientAntiTamperTest-windows, ClientAntiTamperTest
disable-model-invocation: true
---

# Find ClientAntiTamperTest-windows

Target: `ClientAntiTamperTest` (func) in the module loaded in THIS session.
...
Write `ClientAntiTamperTest.{platform}.yaml` with EXACTLY these fields:
