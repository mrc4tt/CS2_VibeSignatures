...
description: |
  ...
  ClientAntiTamperTest-windows in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ClientAntiTamperTest-windows, ClientAntiTamperTest-windows
disable-model-invocation: true
---

# Find ClientAntiTamperTest-windows

Target: `ClientAntiTamperTest-windows` (func) in the module loaded in THIS session.
