...
description: |
  Agent fallback for ILoopMode_OnLoopDeactivate (auto-generated, category: vfunc). Locate
  ILoopMode::OnLoopDeactivate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_OnLoopDeactivate, ILoopMode::OnLoopDeactivate
disable-model-invocation: true
---

# Find ILoopMode_OnLoopDeactivate

Target: `ILoopMode::OnLoopDeactivate` (vfunc) in the module loaded in THIS session.
...
Write `ILoopMode_OnLoopDeactivate.{platform}.yaml` with EXACTLY these fields:
