...
description: |
  ...
  ILoopMode_OnLoopDeactivate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_OnLoopDeactivate, ILoopMode_OnLoopDeactivate
disable-model-invocation: true
---

# Find ILoopMode_OnLoopDeactivate

Target: `ILoopMode_OnLoopDeactivate` (vfunc) in the module loaded in THIS session.
