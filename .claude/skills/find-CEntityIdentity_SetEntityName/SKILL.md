...
description: |
  ...
  CEntityIdentity_SetEntityName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityIdentity_SetEntityName, CEntityIdentity_SetEntityName
disable-model-invocation: true
---

# Find CEntityIdentity_SetEntityName

Target: `CEntityIdentity_SetEntityName` (func) in the module loaded in THIS session.
