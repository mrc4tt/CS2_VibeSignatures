...
description: |
  Agent fallback for CEntityIdentity_SetEntityName (auto-generated, category: func). Locate
  ...
  Trigger: CEntityIdentity_SetEntityName, CEntityIdentity::SetEntityName
