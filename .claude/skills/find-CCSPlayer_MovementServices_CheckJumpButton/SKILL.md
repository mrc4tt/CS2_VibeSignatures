...
description: |
  Agent fallback for CCSPlayer_MovementServices_CheckJumpButton (auto-generated, category: func). Locate
  CCSPlayer_MovementServices::CheckJumpButton in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_MovementServices_CheckJumpButton, CCSPlayer_MovementServices::CheckJumpButton
disable-model-invocation: true
---

# Find CCSPlayer_MovementServices_CheckJumpButton

Target: `CCSPlayer_MovementServices::CheckJumpButton` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_MovementServices_CheckJumpButton.{platform}.yaml` with EXACTLY these fields:
