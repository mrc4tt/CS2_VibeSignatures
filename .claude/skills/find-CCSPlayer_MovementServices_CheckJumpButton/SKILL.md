...
description: |
  ...
  CCSPlayer_MovementServices_CheckJumpButton in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_MovementServices_CheckJumpButton, CCSPlayer_MovementServices_CheckJumpButton
disable-model-invocation: true
---

# Find CCSPlayer_MovementServices_CheckJumpButton

Target: `CCSPlayer_MovementServices_CheckJumpButton` (func) in the module loaded in THIS session.
