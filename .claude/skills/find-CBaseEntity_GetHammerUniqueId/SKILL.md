...
description: |
  ...
  CBaseEntity_GetHammerUniqueId in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_GetHammerUniqueId, CBaseEntity_GetHammerUniqueId
disable-model-invocation: true
---

# Find CBaseEntity_GetHammerUniqueId

Target: `CBaseEntity_GetHammerUniqueId` (vfunc) in the module loaded in THIS session.
