...
description: |
  Agent fallback for CBaseEntity_GetHammerUniqueId (auto-generated, category: vfunc). Locate
  CBaseEntity::GetHammerUniqueId in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_GetHammerUniqueId, CBaseEntity::GetHammerUniqueId
disable-model-invocation: true
---

# Find CBaseEntity_GetHammerUniqueId

Target: `CBaseEntity::GetHammerUniqueId` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_GetHammerUniqueId.{platform}.yaml` with EXACTLY these fields:
