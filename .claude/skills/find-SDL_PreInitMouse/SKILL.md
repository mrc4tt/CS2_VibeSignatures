---
name: find-SDL_PreInitMouse
description: |
  Agent fallback for SDL_PreInitMouse (auto-generated, category: func). Locate
  ...
  Trigger: SDL_PreInitMouse, SDL_PreInitMouse
disable-model-invocation: true
---

# Find SDL_PreInitMouse
