...
description: |
  ...
  CNetworkGameServer_SpawnServer-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_SpawnServer-decompiles, CNetworkGameServer_SpawnServer-decompiles
disable-model-invocation: true
---

# Find CNetworkGameServer_SpawnServer-decompiles

Target: `CNetworkGameServer_SpawnServer-decompiles` (vfunc) in the module loaded in THIS session.
