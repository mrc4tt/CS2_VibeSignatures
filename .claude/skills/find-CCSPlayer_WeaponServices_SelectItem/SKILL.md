...
description: |
  ...
  CCSPlayer_WeaponServices_SelectItem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_WeaponServices_SelectItem, CCSPlayer_WeaponServices_SelectItem
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_SelectItem

Target: `CCSPlayer_WeaponServices_SelectItem` (vfunc) in the module loaded in THIS session.
