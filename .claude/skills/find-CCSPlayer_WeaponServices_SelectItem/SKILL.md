...
description: |
  Agent fallback for CCSPlayer_WeaponServices_SelectItem (auto-generated, category: vfunc). Locate
  CCSPlayer_WeaponServices::SelectItem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_WeaponServices_SelectItem, CCSPlayer_WeaponServices::SelectItem
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_SelectItem

Target: `CCSPlayer_WeaponServices::SelectItem` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayer_WeaponServices_SelectItem.{platform}.yaml` with EXACTLY these fields:
