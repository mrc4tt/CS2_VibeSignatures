...
description: |
  ...
  BotKill_CommandHandler in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: BotKill_CommandHandler, BotKill_CommandHandler
disable-model-invocation: true
---

# Find BotKill_CommandHandler

Target: `BotKill_CommandHandler` (func) in the module loaded in THIS session.
