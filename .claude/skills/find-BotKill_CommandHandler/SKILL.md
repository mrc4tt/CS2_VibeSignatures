...
description: |
  ...
  CCSBotManager::BotKillCommand in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: BotKill_CommandHandler, CCSBotManager::BotKillCommand
disable-model-invocation: true
---

# Find BotKill_CommandHandler

Target: `CCSBotManager::BotKillCommand` (func) in the module loaded in THIS session.
...
Write `BotKill_CommandHandler.{platform}.yaml` with EXACTLY these fields:
