---
name: find-CBaseModelEntity_DamageDecal
description: |
  Agent fallback for CBaseModelEntity_DamageDecal (auto-generated, category: vfunc). Locate
  CBaseModelEntity::DamageDecal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseModelEntity_DamageDecal, CBaseModelEntity::DamageDecal
disable-model-invocation: true
---

# Find CBaseModelEntity_DamageDecal

Target: `CBaseModelEntity::DamageDecal` (vfunc) in the module loaded in THIS session.
...
Write `CBaseModelEntity_DamageDecal.{platform}.yaml` with EXACTLY these fields:
