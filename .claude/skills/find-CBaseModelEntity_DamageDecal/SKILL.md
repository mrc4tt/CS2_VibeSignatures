...
description: |
  ...
  CBaseModelEntity_DamageDecal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseModelEntity_DamageDecal, CBaseModelEntity_DamageDecal
disable-model-invocation: true
---

# Find CBaseModelEntity_DamageDecal

Target: `CBaseModelEntity_DamageDecal` (vfunc) in the module loaded in THIS session.
