...
description: |
  ...
  SDL_PerformWarpMouseInWindow-decompiles in the CS2 SDL3 module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SDL_PerformWarpMouseInWindow-decompiles, SDL_PerformWarpMouseInWindow-decompiles
disable-model-invocation: true
---

# Find SDL_PerformWarpMouseInWindow-decompiles

Target: `SDL_PerformWarpMouseInWindow-decompiles` (func) in the module loaded in THIS session.
