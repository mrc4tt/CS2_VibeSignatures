---
name: find-SDL_PerformWarpMouseInWindow-decompiles
description: |
  Agent fallback for SDL_PerformWarpMouseInWindow-decompiles (auto-generated, category: func). Locate
  SDL_PerformWarpMouseInWindow in the CS2 SDL3 module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SDL_PerformWarpMouseInWindow-decompiles, SDL_PerformWarpMouseInWindow
disable-model-invocation: true
---

# Find SDL_PerformWarpMouseInWindow-decompiles

Target: `SDL_PerformWarpMouseInWindow` (func) in the module loaded in THIS session.
...
Write `SDL_PerformWarpMouseInWindow.{platform}.yaml` with EXACTLY these fields:
