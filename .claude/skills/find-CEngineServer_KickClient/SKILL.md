...
description: |
  Agent fallback for CEngineServer_KickClient (auto-generated, category: vfunc). Locate
  CEngineServer::KickClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_KickClient, CEngineServer::KickClient
disable-model-invocation: true
---

# Find CEngineServer_KickClient

Target: `CEngineServer::KickClient` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_KickClient.{platform}.yaml` with EXACTLY these fields:
