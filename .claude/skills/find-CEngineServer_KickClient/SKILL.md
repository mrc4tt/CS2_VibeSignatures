...
description: |
  ...
  CEngineServer_KickClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_KickClient, CEngineServer_KickClient
disable-model-invocation: true
---

# Find CEngineServer_KickClient

Target: `CEngineServer_KickClient` (vfunc) in the module loaded in THIS session.
