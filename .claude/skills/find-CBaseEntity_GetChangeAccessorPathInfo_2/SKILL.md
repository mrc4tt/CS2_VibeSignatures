...
description: |
  ...
  CBaseEntity_GetChangeAccessorPathInfo_2 in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_GetChangeAccessorPathInfo_2, CBaseEntity_GetChangeAccessorPathInfo_2
disable-model-invocation: true
---

# Find CBaseEntity_GetChangeAccessorPathInfo_2

Target: `CBaseEntity_GetChangeAccessorPathInfo_2` (vfunc) in the module loaded in THIS session.
