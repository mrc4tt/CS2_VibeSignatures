...
description: |
  ...
  CSource2Client_CreateMove in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_CreateMove, CSource2Client_CreateMove
disable-model-invocation: true
---

# Find CSource2Client_CreateMove

Target: `CSource2Client_CreateMove` (vfunc) in the module loaded in THIS session.
