---
name: find-CNetworkGameServer_GetPlayerNetworkIDString
description: |
  Agent fallback for CNetworkGameServer_GetPlayerNetworkIDString (auto-generated, category: func). Locate
  CNetworkGameServer_GetPlayerNetworkIDString in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_GetPlayerNetworkIDString, CNetworkGameServer_GetPlayerNetworkIDString
disable-model-invocation: true
---

# Find CNetworkGameServer_GetPlayerNetworkIDString

Target: `CNetworkGameServer_GetPlayerNetworkIDString` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServer_GetPlayerNetworkIDString.{platform}.yaml` with EXACTLY these fields:
