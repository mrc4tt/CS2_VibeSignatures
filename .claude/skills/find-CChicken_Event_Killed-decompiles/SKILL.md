---
name: find-CChicken_Event_Killed-decompiles
description: |
  Agent fallback for CChicken_Event_Killed-decompiles (auto-generated, category: vfunc). Locate
  CChicken::Event_Killed in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CChicken_Event_Killed-decompiles, CChicken::Event_Killed
disable-model-invocation: true
---

# Find CChicken_Event_Killed-decompiles

Target: `CChicken::Event_Killed` (vfunc) in the module loaded in THIS session.
...
Write `CChicken_Event_Killed.{platform}.yaml` with EXACTLY these fields:
