...
description: |
  ...
  CChicken_Event_Killed-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CChicken_Event_Killed-decompiles, CChicken_Event_Killed-decompiles
disable-model-invocation: true
---

# Find CChicken_Event_Killed-decompiles

Target: `CChicken_Event_Killed-decompiles` (vfunc) in the module loaded in THIS session.
