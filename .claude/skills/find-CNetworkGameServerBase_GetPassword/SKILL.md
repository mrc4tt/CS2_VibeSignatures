...
description: |
  ...
  CNetworkGameServerBase_GetPassword in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetPassword, CNetworkGameServerBase_GetPassword
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetPassword

Target: `CNetworkGameServerBase_GetPassword` (vfunc) in the module loaded in THIS session.
