...
description: |
  Agent fallback for CNetworkGameServerBase_GetPassword (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::GetPassword in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetPassword, CNetworkGameServerBase::GetPassword
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetPassword

Target: `CNetworkGameServerBase::GetPassword` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_GetPassword.{platform}.yaml` with EXACTLY these fields:
