...
description: |
  ...
  ILoopMode_HandleInputEvent in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_HandleInputEvent, ILoopMode_HandleInputEvent
disable-model-invocation: true
---

# Find ILoopMode_HandleInputEvent

Target: `ILoopMode_HandleInputEvent` (vfunc) in the module loaded in THIS session.
