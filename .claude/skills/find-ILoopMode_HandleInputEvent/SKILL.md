...
description: |
  Agent fallback for ILoopMode_HandleInputEvent (auto-generated, category: vfunc). Locate
  ILoopMode::HandleInputEvent in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_HandleInputEvent, ILoopMode::HandleInputEvent
disable-model-invocation: true
---

# Find ILoopMode_HandleInputEvent

Target: `ILoopMode::HandleInputEvent` (vfunc) in the module loaded in THIS session.
...
Write `ILoopMode_HandleInputEvent.{platform}.yaml` with EXACTLY these fields:
