...
description: |
  ...
  CSource2GameClients_ClientSetupVisibility in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientSetupVisibility, CSource2GameClients_ClientSetupVisibility
disable-model-invocation: true
---

# Find CSource2GameClients_ClientSetupVisibility

Target: `CSource2GameClients_ClientSetupVisibility` (vfunc) in the module loaded in THIS session.
