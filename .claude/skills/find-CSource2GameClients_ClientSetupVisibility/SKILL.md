...
description: |
  Agent fallback for CSource2GameClients_ClientSetupVisibility (auto-generated, category: vfunc). Locate
  CSource2GameClients::ClientSetupVisibility in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientSetupVisibility, CSource2GameClients::ClientSetupVisibility
disable-model-invocation: true
---

# Find CSource2GameClients_ClientSetupVisibility

Target: `CSource2GameClients::ClientSetupVisibility` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientSetupVisibility.{platform}.yaml` with EXACTLY these fields:
