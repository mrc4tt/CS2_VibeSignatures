...
description: |
  Agent fallback for CEntitySystem_HelperExecuteQueuedSpawn (auto-generated, category: func). Locate
  CEntitySystem::HelperExecuteQueuedSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_HelperExecuteQueuedSpawn, CEntitySystem::HelperExecuteQueuedSpawn
disable-model-invocation: true
---

# Find CEntitySystem_HelperExecuteQueuedSpawn

Target: `CEntitySystem::HelperExecuteQueuedSpawn` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_HelperExecuteQueuedSpawn.{platform}.yaml` with EXACTLY these fields:
