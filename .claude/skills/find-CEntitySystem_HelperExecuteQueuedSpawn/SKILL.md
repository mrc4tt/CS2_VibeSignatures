...
description: |
  ...
  CEntitySystem_HelperExecuteQueuedSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_HelperExecuteQueuedSpawn, CEntitySystem_HelperExecuteQueuedSpawn
disable-model-invocation: true
---

# Find CEntitySystem_HelperExecuteQueuedSpawn

Target: `CEntitySystem_HelperExecuteQueuedSpawn` (func) in the module loaded in THIS session.
