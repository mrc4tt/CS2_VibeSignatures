...
description: |
  ...
  CBasePlayerController_CheckForLocalPlayer in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_CheckForLocalPlayer, CBasePlayerController_CheckForLocalPlayer
disable-model-invocation: true
---

# Find CBasePlayerController_CheckForLocalPlayer

Target: `CBasePlayerController_CheckForLocalPlayer` (func) in the module loaded in THIS session.
