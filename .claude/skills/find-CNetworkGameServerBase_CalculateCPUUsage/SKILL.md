---
name: find-CNetworkGameServerBase_CalculateCPUUsage
description: |
  Agent fallback for CNetworkGameServerBase_CalculateCPUUsage (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::CalculateCPUUsage in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_CalculateCPUUsage, CNetworkGameServerBase::CalculateCPUUsage
disable-model-invocation: true
---

# Find CNetworkGameServerBase_CalculateCPUUsage

Target: `CNetworkGameServerBase::CalculateCPUUsage` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_CalculateCPUUsage.{platform}.yaml` with EXACTLY these fields:
