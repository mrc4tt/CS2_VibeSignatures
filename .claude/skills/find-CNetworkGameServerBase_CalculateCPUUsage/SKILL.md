...
description: |
  ...
  CNetworkGameServerBase_CalculateCPUUsage in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_CalculateCPUUsage, CNetworkGameServerBase_CalculateCPUUsage
disable-model-invocation: true
---

# Find CNetworkGameServerBase_CalculateCPUUsage

Target: `CNetworkGameServerBase_CalculateCPUUsage` (vfunc) in the module loaded in THIS session.
