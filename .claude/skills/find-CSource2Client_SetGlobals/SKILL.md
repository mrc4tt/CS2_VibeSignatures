...
description: |
  ...
  CSource2Client_SetGlobals in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_SetGlobals, CSource2Client_SetGlobals
disable-model-invocation: true
---

# Find CSource2Client_SetGlobals

Target: `CSource2Client_SetGlobals` (vfunc) in the module loaded in THIS session.
