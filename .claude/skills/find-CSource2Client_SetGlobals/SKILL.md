...
description: |
  Agent fallback for CSource2Client_SetGlobals (auto-generated, category: vfunc). Locate
  ...
  Trigger: CSource2Client_SetGlobals, CSource2Client::SetGlobals
disable-model-invocation: true
---

# Find CSource2Client_SetGlobals
