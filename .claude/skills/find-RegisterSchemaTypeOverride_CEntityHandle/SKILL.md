...
description: |
  Agent fallback for RegisterSchemaTypeOverride_CEntityHandle (auto-generated, category: func). Locate
  RegisterSchemaTypeOverride_CEntityHandle in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: RegisterSchemaTypeOverride_CEntityHandle, RegisterSchemaTypeOverride_CEntityHandle
disable-model-invocation: true
---

# Find RegisterSchemaTypeOverride_CEntityHandle

Target: `RegisterSchemaTypeOverride_CEntityHandle` (func) in the module loaded in THIS session.
...
Write `RegisterSchemaTypeOverride_CEntityHandle.{platform}.yaml` with EXACTLY these fields:
