...
description: |
  Agent fallback for CGameEntitySystem_m_spawnGroupEntityFilters-windows (auto-generated, category: structmember). Locate
  CGameEntitySystem::m_spawnGroupEntityFilters in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_m_spawnGroupEntityFilters-windows, CGameEntitySystem::m_spawnGroupEntityFilters
disable-model-invocation: true
---

# Find CGameEntitySystem_m_spawnGroupEntityFilters-windows

Target: `CGameEntitySystem::m_spawnGroupEntityFilters` (structmember) in the module loaded in THIS session.
...
Write `CGameEntitySystem_m_spawnGroupEntityFilters.{platform}.yaml` with EXACTLY these fields:
