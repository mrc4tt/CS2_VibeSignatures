---
name: find-CLoopModeGame_OnClientPreOutput-decompiles
description: |
  Agent fallback for CLoopModeGame_OnClientPreOutput-decompiles (auto-generated, category: func). Locate
  CLoopModeGame::OnClientPreOutput in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnClientPreOutput-decompiles, CLoopModeGame::OnClientPreOutput
disable-model-invocation: true
---

# Find CLoopModeGame_OnClientPreOutput-decompiles

Target: `CLoopModeGame::OnClientPreOutput` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_OnClientPreOutput.{platform}.yaml` with EXACTLY these fields:
