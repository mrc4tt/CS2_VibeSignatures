...
description: |
  ...
  CLoopModeGame_OnClientPreOutput-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnClientPreOutput-decompiles, CLoopModeGame_OnClientPreOutput-decompiles
disable-model-invocation: true
---

# Find CLoopModeGame_OnClientPreOutput-decompiles

Target: `CLoopModeGame_OnClientPreOutput-decompiles` (func) in the module loaded in THIS session.
