...
description: |
  ...
  CLoopTypeBase_ActivateLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_ActivateLoop, CLoopTypeBase_ActivateLoop
disable-model-invocation: true
---

# Find CLoopTypeBase_ActivateLoop

Target: `CLoopTypeBase_ActivateLoop` (vfunc) in the module loaded in THIS session.
