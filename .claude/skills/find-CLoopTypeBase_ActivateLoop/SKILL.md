...
description: |
  Agent fallback for CLoopTypeBase_ActivateLoop (auto-generated, category: vfunc). Locate
  CLoopTypeBase::ActivateLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_ActivateLoop, CLoopTypeBase::ActivateLoop
disable-model-invocation: true
---

# Find CLoopTypeBase_ActivateLoop

Target: `CLoopTypeBase::ActivateLoop` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeBase_ActivateLoop.{platform}.yaml` with EXACTLY these fields:
