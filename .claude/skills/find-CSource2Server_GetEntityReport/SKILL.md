...
description: |
  ...
  CSource2Server_GetEntityReport in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetEntityReport, CSource2Server_GetEntityReport
disable-model-invocation: true
---

# Find CSource2Server_GetEntityReport

Target: `CSource2Server_GetEntityReport` (vfunc) in the module loaded in THIS session.
