...
description: |
  Agent fallback for CSource2Server_GetEntityReport (auto-generated, category: vfunc). Locate
  CSource2Server::GetEntityReport in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetEntityReport, CSource2Server::GetEntityReport
disable-model-invocation: true
---

# Find CSource2Server_GetEntityReport

Target: `CSource2Server::GetEntityReport` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GetEntityReport.{platform}.yaml` with EXACTLY these fields:
