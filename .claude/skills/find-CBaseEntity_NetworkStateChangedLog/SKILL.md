...
description: |
  ...
  CBaseEntity_NetworkStateChangedLog in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_NetworkStateChangedLog, CBaseEntity_NetworkStateChangedLog
disable-model-invocation: true
---

# Find CBaseEntity_NetworkStateChangedLog

Target: `CBaseEntity_NetworkStateChangedLog` (vfunc) in the module loaded in THIS session.
