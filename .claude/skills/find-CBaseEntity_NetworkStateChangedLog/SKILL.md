...
description: |
  Agent fallback for CBaseEntity_NetworkStateChangedLog (auto-generated, category: vfunc). Locate
  CBaseEntity::NetworkStateChangedLog in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_NetworkStateChangedLog, CBaseEntity::NetworkStateChangedLog
disable-model-invocation: true
---

# Find CBaseEntity_NetworkStateChangedLog

Target: `CBaseEntity::NetworkStateChangedLog` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_NetworkStateChangedLog.{platform}.yaml` with EXACTLY these fields:
