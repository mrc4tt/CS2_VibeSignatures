...
description: |
  Agent fallback for CHLTVBroadcast_RecordSnapshot (auto-generated, category: func). Locate
  CHLTVBroadcast::RecordSnapshot in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHLTVBroadcast_RecordSnapshot, CHLTVBroadcast::RecordSnapshot
disable-model-invocation: true
---

# Find CHLTVBroadcast_RecordSnapshot

Target: `CHLTVBroadcast::RecordSnapshot` (func) in the module loaded in THIS session.
...
Write `CHLTVBroadcast_RecordSnapshot.{platform}.yaml` with EXACTLY these fields:
