...
description: |
  ...
  CHLTVBroadcast_RecordSnapshot in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHLTVBroadcast_RecordSnapshot, CHLTVBroadcast_RecordSnapshot
disable-model-invocation: true
---

# Find CHLTVBroadcast_RecordSnapshot

Target: `CHLTVBroadcast_RecordSnapshot` (func) in the module loaded in THIS session.
