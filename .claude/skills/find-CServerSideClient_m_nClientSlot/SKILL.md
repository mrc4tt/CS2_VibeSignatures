---
name: find-CServerSideClient_m_nClientSlot
description: |
...
# Find CServerSideClient_m_nClientSlot

Target: `CServerSideClient::m_nClientSlot` (structmember) in the CS2 server module.
