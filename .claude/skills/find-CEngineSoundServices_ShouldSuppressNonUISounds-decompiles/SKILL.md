---
name: find-CEngineSoundServices_ShouldSuppressNonUISounds-decompiles
description: |
  Agent fallback for CEngineSoundServices_ShouldSuppressNonUISounds-decompiles (auto-generated, category: func). Locate
  CEngineSoundServices_ShouldSuppressNonUISounds in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineSoundServices_ShouldSuppressNonUISounds-decompiles, CEngineSoundServices_ShouldSuppressNonUISounds
disable-model-invocation: true
---

# Find CEngineSoundServices_ShouldSuppressNonUISounds-decompiles

Target: `CEngineSoundServices_ShouldSuppressNonUISounds` (func) in the module loaded in THIS session.
...
Write `CEngineSoundServices_ShouldSuppressNonUISounds.{platform}.yaml` with EXACTLY these fields:
