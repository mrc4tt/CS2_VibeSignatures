...
description: |
  ...
  CEngineSoundServices_ShouldSuppressNonUISounds-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineSoundServices_ShouldSuppressNonUISounds-decompiles, CEngineSoundServices_ShouldSuppressNonUISounds-decompiles
disable-model-invocation: true
---

# Find CEngineSoundServices_ShouldSuppressNonUISounds-decompiles

Target: `CEngineSoundServices_ShouldSuppressNonUISounds-decompiles` (func) in the module loaded in THIS session.
