---
name: find-CNetworkGameClient_HookClientStringTable
description: |
  Agent fallback for CNetworkGameClient_HookClientStringTable (auto-generated, category: vfunc). Locate
  CNetworkGameClient::HookClientStringTable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_HookClientStringTable, CNetworkGameClient::HookClientStringTable
disable-model-invocation: true
---

# Find CNetworkGameClient_HookClientStringTable

Target: `CNetworkGameClient::HookClientStringTable` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_HookClientStringTable.{platform}.yaml` with EXACTLY these fields:
