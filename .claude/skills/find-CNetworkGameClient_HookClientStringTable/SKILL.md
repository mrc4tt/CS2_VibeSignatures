...
description: |
  ...
  CNetworkGameClient_HookClientStringTable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_HookClientStringTable, CNetworkGameClient_HookClientStringTable
disable-model-invocation: true
---

# Find CNetworkGameClient_HookClientStringTable

Target: `CNetworkGameClient_HookClientStringTable` (vfunc) in the module loaded in THIS session.
