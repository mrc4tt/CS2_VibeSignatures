...
description: |
  Agent fallback for g_pNavMesh (auto-generated, category: func). Locate
  g_pNavMesh in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: g_pNavMesh, g_pNavMesh
disable-model-invocation: true
---

# Find g_pNavMesh

Target: `g_pNavMesh` (func) in the module loaded in THIS session.
...
Write `g_pNavMesh.{platform}.yaml` with EXACTLY these fields:
