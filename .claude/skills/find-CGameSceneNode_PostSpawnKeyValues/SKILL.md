...
description: |
  Agent fallback for CGameSceneNode_PostSpawnKeyValues (auto-generated, category: vfunc). Locate
  CGameSceneNode::PostSpawnKeyValues in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_PostSpawnKeyValues, CGameSceneNode::PostSpawnKeyValues
disable-model-invocation: true
---

# Find CGameSceneNode_PostSpawnKeyValues

Target: `CGameSceneNode::PostSpawnKeyValues` (vfunc) in the module loaded in THIS session.
...
Write `CGameSceneNode_PostSpawnKeyValues.{platform}.yaml` with EXACTLY these fields:
