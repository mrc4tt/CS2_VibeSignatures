...
description: |
  ...
  CGameSceneNode_PostSpawnKeyValues in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_PostSpawnKeyValues, CGameSceneNode_PostSpawnKeyValues
disable-model-invocation: true
---

# Find CGameSceneNode_PostSpawnKeyValues

Target: `CGameSceneNode_PostSpawnKeyValues` (vfunc) in the module loaded in THIS session.
