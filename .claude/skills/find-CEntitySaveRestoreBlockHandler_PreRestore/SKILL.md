...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_PreRestore (auto-generated, category: vfunc). Locate
  CEntitySaveRestoreBlockHandler::PreRestore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_PreRestore, CEntitySaveRestoreBlockHandler::PreRestore
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_PreRestore

Target: `CEntitySaveRestoreBlockHandler::PreRestore` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_PreRestore.{platform}.yaml` with EXACTLY these fields:
