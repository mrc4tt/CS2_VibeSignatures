...
description: |
  ...
  CEntitySaveRestoreBlockHandler_PreRestore in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_PreRestore, CEntitySaveRestoreBlockHandler_PreRestore
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_PreRestore

Target: `CEntitySaveRestoreBlockHandler_PreRestore` (vfunc) in the module loaded in THIS session.
