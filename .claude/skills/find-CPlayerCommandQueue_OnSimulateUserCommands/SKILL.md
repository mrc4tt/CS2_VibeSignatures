...
description: |
  ...
  CPlayerCommandQueue_OnSimulateUserCommands in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayerCommandQueue_OnSimulateUserCommands, CPlayerCommandQueue_OnSimulateUserCommands
disable-model-invocation: true
---

# Find CPlayerCommandQueue_OnSimulateUserCommands

Target: `CPlayerCommandQueue_OnSimulateUserCommands` (vfunc) in the module loaded in THIS session.
