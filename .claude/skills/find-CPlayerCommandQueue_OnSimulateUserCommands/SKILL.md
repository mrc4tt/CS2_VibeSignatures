---
name: find-CPlayerCommandQueue_OnSimulateUserCommands
description: |
  Agent fallback for CPlayerCommandQueue_OnSimulateUserCommands (auto-generated, category: vfunc). Locate
  CPlayerCommandQueue::OnSimulateUserCommands in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayerCommandQueue_OnSimulateUserCommands, CPlayerCommandQueue::OnSimulateUserCommands
disable-model-invocation: true
---

# Find CPlayerCommandQueue_OnSimulateUserCommands

Target: `CPlayerCommandQueue::OnSimulateUserCommands` (vfunc) in the module loaded in THIS session.
...
Write `CPlayerCommandQueue_OnSimulateUserCommands.{platform}.yaml` with EXACTLY these fields:
