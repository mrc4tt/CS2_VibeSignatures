...
description: |
  Agent fallback for CNetworkGameClient_OnReceivedUncompressedPacket (auto-generated, category: vfunc). Locate
  CNetworkGameClient::OnReceivedUncompressedPacket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_OnReceivedUncompressedPacket, CNetworkGameClient::OnReceivedUncompressedPacket
disable-model-invocation: true
---

# Find CNetworkGameClient_OnReceivedUncompressedPacket

Target: `CNetworkGameClient::OnReceivedUncompressedPacket` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_OnReceivedUncompressedPacket.{platform}.yaml` with EXACTLY these fields:
