...
description: |
  ...
  CNetworkGameClient_OnReceivedUncompressedPacket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_OnReceivedUncompressedPacket, CNetworkGameClient_OnReceivedUncompressedPacket
disable-model-invocation: true
---

# Find CNetworkGameClient_OnReceivedUncompressedPacket

Target: `CNetworkGameClient_OnReceivedUncompressedPacket` (vfunc) in the module loaded in THIS session.
