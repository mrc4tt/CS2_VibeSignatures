...
description: |
  Agent fallback for CNetworkGameClientBase_vtable (auto-generated, category: func). Locate
  CNetworkGameClientBase_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_vtable, CNetworkGameClientBase_vtable
disable-model-invocation: true
---

# Find CNetworkGameClientBase_vtable

Target: `CNetworkGameClientBase_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_vtable.{platform}.yaml` with EXACTLY these fields:
