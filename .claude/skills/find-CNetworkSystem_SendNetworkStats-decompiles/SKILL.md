---
name: find-CNetworkSystem_SendNetworkStats-decompiles
description: |
  Agent fallback for CNetworkSystem_SendNetworkStats-decompiles (auto-generated, category: func). Locate
  CNetworkSystem::SendNetworkStats in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_SendNetworkStats-decompiles, CNetworkSystem::SendNetworkStats
disable-model-invocation: true
---

# Find CNetworkSystem_SendNetworkStats-decompiles

Target: `CNetworkSystem::SendNetworkStats` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_SendNetworkStats.{platform}.yaml` with EXACTLY these fields:
