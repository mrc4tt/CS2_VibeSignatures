...
description: |
  ...
  CNetworkSystem_SendNetworkStats-decompiles in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_SendNetworkStats-decompiles, CNetworkSystem_SendNetworkStats-decompiles
disable-model-invocation: true
---

# Find CNetworkSystem_SendNetworkStats-decompiles

Target: `CNetworkSystem_SendNetworkStats-decompiles` (func) in the module loaded in THIS session.
