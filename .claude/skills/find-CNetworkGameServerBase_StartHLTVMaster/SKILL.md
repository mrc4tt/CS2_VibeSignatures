...
description: |
  Agent fallback for CNetworkGameServerBase_StartHLTVMaster (auto-generated, category: func). Locate
  CNetworkGameServerBase::StartHLTVMaster in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_StartHLTVMaster, CNetworkGameServerBase::StartHLTVMaster
disable-model-invocation: true
---

# Find CNetworkGameServerBase_StartHLTVMaster

Target: `CNetworkGameServerBase::StartHLTVMaster` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_StartHLTVMaster.{platform}.yaml` with EXACTLY these fields:
