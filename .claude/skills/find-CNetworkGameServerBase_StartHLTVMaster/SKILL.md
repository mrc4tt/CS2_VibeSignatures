...
description: |
  ...
  CNetworkGameServerBase_StartHLTVMaster in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_StartHLTVMaster, CNetworkGameServerBase_StartHLTVMaster
disable-model-invocation: true
---

# Find CNetworkGameServerBase_StartHLTVMaster

Target: `CNetworkGameServerBase_StartHLTVMaster` (func) in the module loaded in THIS session.
