...
description: |
  Agent fallback for CBasePlayerPawn_OnTakeDamage-decompiles (auto-generated, category: vfunc). Locate
  CBasePlayerPawn_OnTakeDamage-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_OnTakeDamage-decompiles, CBasePlayerPawn_OnTakeDamage-decompiles
disable-model-invocation: true
---

# Find CBasePlayerPawn_OnTakeDamage-decompiles

Target: `CBasePlayerPawn_OnTakeDamage-decompiles` (vfunc) in the module loaded in THIS session.
