...
description: |
  ...
  CSource2Server_Save in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Save, CSource2Server_Save
disable-model-invocation: true
---

# Find CSource2Server_Save

Target: `CSource2Server_Save` (vfunc) in the module loaded in THIS session.
