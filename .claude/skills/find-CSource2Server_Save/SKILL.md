...
description: |
  Agent fallback for CSource2Server_Save (auto-generated, category: vfunc). Locate
  CSource2Server::Save in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Save, CSource2Server::Save
disable-model-invocation: true
---

# Find CSource2Server_Save

Target: `CSource2Server::Save` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_Save.{platform}.yaml` with EXACTLY these fields:
