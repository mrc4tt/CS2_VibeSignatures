...
description: |
  Agent fallback for CNetworkMessages_ConfirmAllMessageHandlersInstalled (auto-generated, category: func). Locate
  CNetworkMessages::ConfirmAllMessageHandlersInstalled in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_ConfirmAllMessageHandlersInstalled, CNetworkMessages::ConfirmAllMessageHandlersInstalled
disable-model-invocation: true
---

# Find CNetworkMessages_ConfirmAllMessageHandlersInstalled

Target: `CNetworkMessages::ConfirmAllMessageHandlersInstalled` (func) in the module loaded in THIS session.
...
Write `CNetworkMessages_ConfirmAllMessageHandlersInstalled.{platform}.yaml` with EXACTLY these fields:
