...
description: |
  ...
  CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract, CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract
disable-model-invocation: true
---

# Find CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract

Target: `CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract` (vfunc) in the module loaded in THIS session.
