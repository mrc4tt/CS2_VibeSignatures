...
description: |
  Agent fallback for CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract (auto-generated, category: vfunc). Locate
  CNetworkMessages::AssociateNetMessageWithChannelCategoryAbstract in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract, CNetworkMessages::AssociateNetMessageWithChannelCategoryAbstract
disable-model-invocation: true
---

# Find CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract

Target: `CNetworkMessages::AssociateNetMessageWithChannelCategoryAbstract` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_AssociateNetMessageWithChannelCategoryAbstract.{platform}.yaml` with EXACTLY these fields:
