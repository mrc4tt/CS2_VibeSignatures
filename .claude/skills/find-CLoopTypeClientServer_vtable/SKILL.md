...
description: |
  Agent fallback for CLoopTypeClientServer_vtable (auto-generated, category: func). Locate
  CLoopTypeClientServer_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_vtable, CLoopTypeClientServer_vtable
disable-model-invocation: true
---

# Find CLoopTypeClientServer_vtable

Target: `CLoopTypeClientServer_vtable` (func) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_vtable.{platform}.yaml` with EXACTLY these fields:
