...
description: |
  Agent fallback for ISource2Server_UpdateWhenNotInGame (auto-generated, category: vfunc). Locate
  ISource2Server::UpdateWhenNotInGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ISource2Server_UpdateWhenNotInGame, ISource2Server::UpdateWhenNotInGame
disable-model-invocation: true
---

# Find ISource2Server_UpdateWhenNotInGame

Target: `ISource2Server::UpdateWhenNotInGame` (vfunc) in the module loaded in THIS session.
...
Write `ISource2Server_UpdateWhenNotInGame.{platform}.yaml` with EXACTLY these fields:
