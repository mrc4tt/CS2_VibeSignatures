...
description: |
  ...
  ISource2Server_UpdateWhenNotInGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ISource2Server_UpdateWhenNotInGame, ISource2Server_UpdateWhenNotInGame
disable-model-invocation: true
---

# Find ISource2Server_UpdateWhenNotInGame

Target: `ISource2Server_UpdateWhenNotInGame` (vfunc) in the module loaded in THIS session.
