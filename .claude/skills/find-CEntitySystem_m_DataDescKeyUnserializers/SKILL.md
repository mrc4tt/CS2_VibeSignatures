---
name: find-CEntitySystem_m_DataDescKeyUnserializers
description: |
  Agent fallback for CEntitySystem_m_DataDescKeyUnserializers (auto-generated, category: structmember). Locate
  CEntitySystem::m_DataDescKeyUnserializers in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_DataDescKeyUnserializers, CEntitySystem::m_DataDescKeyUnserializers
disable-model-invocation: true
---

# Find CEntitySystem_m_DataDescKeyUnserializers

Target: `CEntitySystem::m_DataDescKeyUnserializers` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_DataDescKeyUnserializers.{platform}.yaml` with EXACTLY these fields:
