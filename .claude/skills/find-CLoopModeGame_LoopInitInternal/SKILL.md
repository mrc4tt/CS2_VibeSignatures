...
description: |
  ...
  CLoopModeGame_LoopInitInternal in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopInitInternal, CLoopModeGame_LoopInitInternal
disable-model-invocation: true
---

# Find CLoopModeGame_LoopInitInternal

Target: `CLoopModeGame_LoopInitInternal` (func) in the module loaded in THIS session.
