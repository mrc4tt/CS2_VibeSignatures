...
description: |
  Agent fallback for CLoopModeGame_LoopInitInternal (auto-generated, category: func). Locate
  CLoopModeGame::LoopInitInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopInitInternal, CLoopModeGame::LoopInitInternal
disable-model-invocation: true
---

# Find CLoopModeGame_LoopInitInternal

Target: `CLoopModeGame::LoopInitInternal` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_LoopInitInternal.{platform}.yaml` with EXACTLY these fields:
