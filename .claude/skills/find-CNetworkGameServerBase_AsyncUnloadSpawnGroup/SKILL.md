...
description: |
  Agent fallback for CNetworkGameServerBase_AsyncUnloadSpawnGroup (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::AsyncUnloadSpawnGroup in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_AsyncUnloadSpawnGroup, CNetworkGameServerBase::AsyncUnloadSpawnGroup
disable-model-invocation: true
---

# Find CNetworkGameServerBase_AsyncUnloadSpawnGroup

Target: `CNetworkGameServerBase::AsyncUnloadSpawnGroup` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_AsyncUnloadSpawnGroup.{platform}.yaml` with EXACTLY these fields:
