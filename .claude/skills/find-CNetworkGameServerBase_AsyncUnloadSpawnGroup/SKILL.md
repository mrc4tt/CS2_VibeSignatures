...
description: |
  ...
  CNetworkGameServerBase_AsyncUnloadSpawnGroup in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_AsyncUnloadSpawnGroup, CNetworkGameServerBase_AsyncUnloadSpawnGroup
disable-model-invocation: true
---

# Find CNetworkGameServerBase_AsyncUnloadSpawnGroup

Target: `CNetworkGameServerBase_AsyncUnloadSpawnGroup` (vfunc) in the module loaded in THIS session.
