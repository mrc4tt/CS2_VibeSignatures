...
description: |
  Agent fallback for CEngineServiceMgr_GetActiveLoopClientServerMode (auto-generated, category: func). Locate
  CEngineServiceMgr_GetActiveLoopClientServerMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_GetActiveLoopClientServerMode, CEngineServiceMgr_GetActiveLoopClientServerMode
disable-model-invocation: true
---

# Find CEngineServiceMgr_GetActiveLoopClientServerMode

Target: `CEngineServiceMgr_GetActiveLoopClientServerMode` (func) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_GetActiveLoopClientServerMode.{platform}.yaml` with EXACTLY these fields:
