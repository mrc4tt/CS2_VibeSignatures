---
name: find-CInputService_IsClientOnlyCommandAllowed
description: |
  Agent fallback for CInputService_IsClientOnlyCommandAllowed (auto-generated, category: func). Locate
  CInputService::IsClientOnlyCommandAllowed in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_IsClientOnlyCommandAllowed, CInputService::IsClientOnlyCommandAllowed
disable-model-invocation: true
---

# Find CInputService_IsClientOnlyCommandAllowed

Target: `CInputService::IsClientOnlyCommandAllowed` (func) in the module loaded in THIS session.
