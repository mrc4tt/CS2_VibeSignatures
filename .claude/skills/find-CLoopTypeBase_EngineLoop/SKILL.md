...
description: |
  Agent fallback for CLoopTypeBase_EngineLoop (auto-generated, category: vfunc). Locate
  CLoopTypeBase::EngineLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_EngineLoop, CLoopTypeBase::EngineLoop
disable-model-invocation: true
---

# Find CLoopTypeBase_EngineLoop

Target: `CLoopTypeBase::EngineLoop` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeBase_EngineLoop.{platform}.yaml` with EXACTLY these fields:
