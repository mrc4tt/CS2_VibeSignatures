...
description: |
  ...
  CLoopTypeBase_EngineLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_EngineLoop, CLoopTypeBase_EngineLoop
disable-model-invocation: true
---

# Find CLoopTypeBase_EngineLoop

Target: `CLoopTypeBase_EngineLoop` (vfunc) in the module loaded in THIS session.
