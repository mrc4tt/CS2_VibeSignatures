...
description: |
  Agent fallback for CEntityInstance_dtor (auto-generated, category: func). Locate
  CEntityInstance::~CEntityInstance in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_dtor, CEntityInstance::~CEntityInstance
disable-model-invocation: true
---

# Find CEntityInstance_dtor

Target: `CEntityInstance::~CEntityInstance` (func) in the module loaded in THIS session.
...
Write `CEntityInstance_dtor.{platform}.yaml` with EXACTLY these fields:
