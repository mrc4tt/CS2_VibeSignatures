...
description: |
  ...
  CEntityInstance_dtor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_dtor, CEntityInstance_dtor
disable-model-invocation: true
---

# Find CEntityInstance_dtor

Target: `CEntityInstance_dtor` (func) in the module loaded in THIS session.
