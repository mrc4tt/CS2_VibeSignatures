---
name: find-IGameResourceService_SetEntityResourceManifestHandler
description: |
  Agent fallback for IGameResourceService_SetEntityResourceManifestHandler (auto-generated, category: vfunc). Locate
  IGameResourceService::SetEntityResourceManifestHandler in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameResourceService_SetEntityResourceManifestHandler, IGameResourceService::SetEntityResourceManifestHandler
disable-model-invocation: true
---

# Find IGameResourceService_SetEntityResourceManifestHandler

Target: `IGameResourceService::SetEntityResourceManifestHandler` (vfunc) in the module loaded in THIS session.
...
Write `IGameResourceService_SetEntityResourceManifestHandler.{platform}.yaml` with EXACTLY these fields:
