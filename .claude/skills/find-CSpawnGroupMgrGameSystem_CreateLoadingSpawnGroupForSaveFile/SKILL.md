...
description: |
  ...
  CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile, CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile

Target: `CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile` (vfunc) in the module loaded in THIS session.
