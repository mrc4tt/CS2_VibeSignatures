...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::CreateLoadingSpawnGroupForSaveFile in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile, CSpawnGroupMgrGameSystem::CreateLoadingSpawnGroupForSaveFile
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile

Target: `CSpawnGroupMgrGameSystem::CreateLoadingSpawnGroupForSaveFile` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_CreateLoadingSpawnGroupForSaveFile.{platform}.yaml` with EXACTLY these fields:
