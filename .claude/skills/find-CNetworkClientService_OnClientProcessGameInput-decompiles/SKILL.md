...
description: |
  ...
  CNetworkClientService_OnClientProcessGameInput-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_OnClientProcessGameInput-decompiles, CNetworkClientService_OnClientProcessGameInput-decompiles
disable-model-invocation: true
---

# Find CNetworkClientService_OnClientProcessGameInput-decompiles

Target: `CNetworkClientService_OnClientProcessGameInput-decompiles` (func) in the module loaded in THIS session.
