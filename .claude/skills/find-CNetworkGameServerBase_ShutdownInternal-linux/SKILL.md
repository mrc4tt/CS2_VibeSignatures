...
description: |
  ...
  CNetworkGameServerBase_ShutdownInternal-linux in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ShutdownInternal-linux, CNetworkGameServerBase_ShutdownInternal-linux
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ShutdownInternal-linux

Target: `CNetworkGameServerBase_ShutdownInternal-linux` (func) in the module loaded in THIS session.
