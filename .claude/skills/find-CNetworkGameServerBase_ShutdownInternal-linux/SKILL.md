...
description: |
  Agent fallback for CNetworkGameServerBase_ShutdownInternal-linux (auto-generated, category: func). Locate
  CNetworkGameServerBase::ShutdownInternal in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ShutdownInternal-linux, CNetworkGameServerBase::ShutdownInternal
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ShutdownInternal-linux

Target: `CNetworkGameServerBase::ShutdownInternal` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_ShutdownInternal.{platform}.yaml` with EXACTLY these fields:
