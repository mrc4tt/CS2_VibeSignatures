---
name: find-CEngineServer_GetPlayerInfo-noinline
description: |
  Agent fallback for CEngineServer_GetPlayerInfo-noinline (auto-generated, category: vfunc). Locate
  CEngineServer::GetPlayerInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetPlayerInfo-noinline, CEngineServer::GetPlayerInfo
disable-model-invocation: true
---

# Find CEngineServer_GetPlayerInfo-noinline

Target: `CEngineServer::GetPlayerInfo` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_GetPlayerInfo.{platform}.yaml` with EXACTLY these fields:
