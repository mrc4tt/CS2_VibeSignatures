...
description: |
  ...
  CEngineServer_GetPlayerInfo-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetPlayerInfo-noinline, CEngineServer_GetPlayerInfo-noinline
disable-model-invocation: true
---

# Find CEngineServer_GetPlayerInfo-noinline

Target: `CEngineServer_GetPlayerInfo-noinline` (vfunc) in the module loaded in THIS session.
