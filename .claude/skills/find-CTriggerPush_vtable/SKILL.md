...
description: |
  Agent fallback for CTriggerPush_vtable (auto-generated, category: func). Locate
  CTriggerPush_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTriggerPush_vtable, CTriggerPush_vtable
disable-model-invocation: true
---

# Find CTriggerPush_vtable

Target: `CTriggerPush_vtable` (func) in the module loaded in THIS session.
...
Write `CTriggerPush_vtable.{platform}.yaml` with EXACTLY these fields:
