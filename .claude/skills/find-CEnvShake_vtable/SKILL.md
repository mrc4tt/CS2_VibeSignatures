...
description: |
  Agent fallback for CEnvShake_vtable (auto-generated, category: func). Locate
  CEnvShake_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEnvShake_vtable, CEnvShake_vtable
disable-model-invocation: true
---

# Find CEnvShake_vtable

Target: `CEnvShake_vtable` (func) in the module loaded in THIS session.
...
Write `CEnvShake_vtable.{platform}.yaml` with EXACTLY these fields:
