...
description: |
  ...
  CEntitySystem_InvokePrecacheCallback in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_InvokePrecacheCallback, CEntitySystem_InvokePrecacheCallback
disable-model-invocation: true
---

# Find CEntitySystem_InvokePrecacheCallback

Target: `CEntitySystem_InvokePrecacheCallback` (vfunc) in the module loaded in THIS session.
