...
description: |
  Agent fallback for CEntitySystem_InvokePrecacheCallback (auto-generated, category: vfunc). Locate
  CEntitySystem::InvokePrecacheCallback in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_InvokePrecacheCallback, CEntitySystem::InvokePrecacheCallback
disable-model-invocation: true
---

# Find CEntitySystem_InvokePrecacheCallback

Target: `CEntitySystem::InvokePrecacheCallback` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_InvokePrecacheCallback.{platform}.yaml` with EXACTLY these fields:
