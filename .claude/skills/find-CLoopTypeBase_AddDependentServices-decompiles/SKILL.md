---
name: find-CLoopTypeBase_AddDependentServices-decompiles
description: |
  Agent fallback for CLoopTypeBase_AddDependentServices-decompiles (auto-generated, category: func). Locate
  CLoopTypeBase::AddDependentServices in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_AddDependentServices-decompiles, CLoopTypeBase::AddDependentServices
disable-model-invocation: true
---

# Find CLoopTypeBase_AddDependentServices-decompiles

Target: `CLoopTypeBase::AddDependentServices` (func) in the module loaded in THIS session.
...
Write `CLoopTypeBase_AddDependentServices.{platform}.yaml` with EXACTLY these fields:
