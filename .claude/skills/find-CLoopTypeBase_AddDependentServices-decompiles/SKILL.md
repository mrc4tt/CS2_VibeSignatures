...
description: |
  ...
  CLoopTypeBase_AddDependentServices-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_AddDependentServices-decompiles, CLoopTypeBase_AddDependentServices-decompiles
disable-model-invocation: true
---

# Find CLoopTypeBase_AddDependentServices-decompiles

Target: `CLoopTypeBase_AddDependentServices-decompiles` (func) in the module loaded in THIS session.
