---
name: find-INetworkGameServer_GetTime
description: |
  Agent fallback for INetworkGameServer_GetTime (auto-generated, category: vfunc). Locate
  INetworkGameServer::GetTime in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetTime, INetworkGameServer::GetTime
disable-model-invocation: true
---

# Find INetworkGameServer_GetTime

Target: `INetworkGameServer::GetTime` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_GetTime.{platform}.yaml` with EXACTLY these fields:
