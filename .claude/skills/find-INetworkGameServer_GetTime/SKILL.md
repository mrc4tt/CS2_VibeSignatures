...
description: |
  ...
  INetworkGameServer_GetTime in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetTime, INetworkGameServer_GetTime
disable-model-invocation: true
---

# Find INetworkGameServer_GetTime

Target: `INetworkGameServer_GetTime` (vfunc) in the module loaded in THIS session.
