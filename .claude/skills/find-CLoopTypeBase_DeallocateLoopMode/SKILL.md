...
description: |
  ...
  CLoopTypeBase_DeallocateLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_DeallocateLoopMode, CLoopTypeBase_DeallocateLoopMode
disable-model-invocation: true
---

# Find CLoopTypeBase_DeallocateLoopMode

Target: `CLoopTypeBase_DeallocateLoopMode` (vfunc) in the module loaded in THIS session.
