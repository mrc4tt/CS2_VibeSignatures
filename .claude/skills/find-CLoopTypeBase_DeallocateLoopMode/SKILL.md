...
description: |
  Agent fallback for CLoopTypeBase_DeallocateLoopMode (auto-generated, category: vfunc). Locate
  CLoopTypeBase::DeallocateLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_DeallocateLoopMode, CLoopTypeBase::DeallocateLoopMode
disable-model-invocation: true
---

# Find CLoopTypeBase_DeallocateLoopMode

Target: `CLoopTypeBase::DeallocateLoopMode` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeBase_DeallocateLoopMode.{platform}.yaml` with EXACTLY these fields:
