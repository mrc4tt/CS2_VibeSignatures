...
description: |
  ...
  CSource2GameClients_OnClientConnected in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_OnClientConnected, CSource2GameClients_OnClientConnected
disable-model-invocation: true
---

# Find CSource2GameClients_OnClientConnected

Target: `CSource2GameClients_OnClientConnected` (vfunc) in the module loaded in THIS session.
