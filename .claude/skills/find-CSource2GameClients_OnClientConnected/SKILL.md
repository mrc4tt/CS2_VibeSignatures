...
description: |
  Agent fallback for CSource2GameClients_OnClientConnected (auto-generated, category: vfunc). Locate
  CSource2GameClients::OnClientConnected in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_OnClientConnected, CSource2GameClients::OnClientConnected
disable-model-invocation: true
---

# Find CSource2GameClients_OnClientConnected

Target: `CSource2GameClients::OnClientConnected` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_OnClientConnected.{platform}.yaml` with EXACTLY these fields:
