---
name: find-CCSPlayer_MovementServices_WaterMove-verified
description: |
  Agent fallback for CCSPlayer_MovementServices_WaterMove-verified (auto-generated, category: func). Locate
  CCSPlayer_MovementServices::WaterMove in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_MovementServices_WaterMove-verified, CCSPlayer_MovementServices::WaterMove
disable-model-invocation: true
---

# Find CCSPlayer_MovementServices_WaterMove-verified

Target: `CCSPlayer_MovementServices::WaterMove` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_MovementServices_WaterMove.{platform}.yaml` with EXACTLY these fields:
