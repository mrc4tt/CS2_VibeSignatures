...
description: |
  Agent fallback for CEntitySystem_CreateEntityByName (auto-generated, category: func). Locate
  CEntitySystem::CreateEntityByName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_CreateEntityByName, CEntitySystem::CreateEntityByName
disable-model-invocation: true
---

# Find CEntitySystem_CreateEntityByName

Target: `CEntitySystem::CreateEntityByName` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_CreateEntityByName.{platform}.yaml` with EXACTLY these fields:
