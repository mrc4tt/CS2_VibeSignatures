...
description: |
  ...
  CEntitySystem_CreateEntityByName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_CreateEntityByName, CEntitySystem_CreateEntityByName
disable-model-invocation: true
---

# Find CEntitySystem_CreateEntityByName

Target: `CEntitySystem_CreateEntityByName` (func) in the module loaded in THIS session.
