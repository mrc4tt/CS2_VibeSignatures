...
description: |
  ...
  CNetworkGameClientBase__ProcessNetworking in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase__ProcessNetworking, CNetworkGameClientBase__ProcessNetworking
disable-model-invocation: true
---

# Find CNetworkGameClientBase__ProcessNetworking

Target: `CNetworkGameClientBase__ProcessNetworking` (vfunc) in the module loaded in THIS session.
