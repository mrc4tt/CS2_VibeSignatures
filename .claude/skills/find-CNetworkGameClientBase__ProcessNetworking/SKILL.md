---
name: find-CNetworkGameClientBase__ProcessNetworking
description: |
  Agent fallback for CNetworkGameClientBase__ProcessNetworking (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::ProcessNetworking in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase__ProcessNetworking, CNetworkGameClientBase::ProcessNetworking
disable-model-invocation: true
---

# Find CNetworkGameClientBase__ProcessNetworking

Target: `CNetworkGameClientBase::ProcessNetworking` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase__ProcessNetworking.{platform}.yaml` with EXACTLY these fields:
