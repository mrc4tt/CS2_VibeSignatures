---
name: find-CBaseAnimGraph_GetAnimationController-decompiles
description: |
  Agent fallback for CBaseAnimGraph_GetAnimationController-decompiles (auto-generated, category: func). Locate
  CBaseAnimGraph::GetAnimationController in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseAnimGraph_GetAnimationController-decompiles, CBaseAnimGraph::GetAnimationController
disable-model-invocation: true
---

# Find CBaseAnimGraph_GetAnimationController-decompiles

Target: `CBaseAnimGraph::GetAnimationController` (func) in the module loaded in THIS session.
...
Write `CBaseAnimGraph_GetAnimationController.{platform}.yaml` with EXACTLY these fields:
