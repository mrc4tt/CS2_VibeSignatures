...
description: |
  ...
  CBaseAnimGraph_GetAnimationController-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseAnimGraph_GetAnimationController-decompiles, CBaseAnimGraph_GetAnimationController-decompiles
disable-model-invocation: true
---

# Find CBaseAnimGraph_GetAnimationController-decompiles

Target: `CBaseAnimGraph_GetAnimationController-decompiles` (func) in the module loaded in THIS session.
