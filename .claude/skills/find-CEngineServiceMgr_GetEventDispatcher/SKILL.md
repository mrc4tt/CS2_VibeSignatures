...
description: |
  Agent fallback for CEngineServiceMgr_GetEventDispatcher (auto-generated, category: func). Locate
  CEngineServiceMgr_GetEventDispatcher in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_GetEventDispatcher, CEngineServiceMgr_GetEventDispatcher
disable-model-invocation: true
---

# Find CEngineServiceMgr_GetEventDispatcher

Target: `CEngineServiceMgr_GetEventDispatcher` (func) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_GetEventDispatcher.{platform}.yaml` with EXACTLY these fields:
