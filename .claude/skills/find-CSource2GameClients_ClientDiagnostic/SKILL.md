...
description: |
  Agent fallback for CSource2GameClients_ClientDiagnostic (auto-generated, category: vfunc). Locate
  CSource2GameClients::ClientDiagnostic in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientDiagnostic, CSource2GameClients::ClientDiagnostic
disable-model-invocation: true
---

# Find CSource2GameClients_ClientDiagnostic

Target: `CSource2GameClients::ClientDiagnostic` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientDiagnostic.{platform}.yaml` with EXACTLY these fields:
