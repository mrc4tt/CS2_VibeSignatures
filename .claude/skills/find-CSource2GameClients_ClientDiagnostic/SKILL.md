...
description: |
  ...
  CSource2GameClients_ClientDiagnostic in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientDiagnostic, CSource2GameClients_ClientDiagnostic
disable-model-invocation: true
---

# Find CSource2GameClients_ClientDiagnostic

Target: `CSource2GameClients_ClientDiagnostic` (vfunc) in the module loaded in THIS session.
