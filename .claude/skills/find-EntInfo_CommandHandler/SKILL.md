...
description: |
  ...
  EntInfo_CommandHandler in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: EntInfo_CommandHandler, EntInfo_CommandHandler
disable-model-invocation: true
---

# Find EntInfo_CommandHandler

Target: `EntInfo_CommandHandler` (func) in the module loaded in THIS session.
