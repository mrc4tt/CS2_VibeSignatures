...
description: |
  ...
  CChicken_Event_Killed in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CChicken_Event_Killed, CChicken_Event_Killed
disable-model-invocation: true
---

# Find CChicken_Event_Killed

Target: `CChicken_Event_Killed` (vfunc) in the module loaded in THIS session.
