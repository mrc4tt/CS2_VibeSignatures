...
description: |
  ...
  CEnvEntityIgniter_Precache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEnvEntityIgniter_Precache, CEnvEntityIgniter_Precache
disable-model-invocation: true
---

# Find CEnvEntityIgniter_Precache

Target: `CEnvEntityIgniter_Precache` (vfunc) in the module loaded in THIS session.
