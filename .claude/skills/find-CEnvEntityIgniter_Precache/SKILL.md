...
description: |
  Agent fallback for CEnvEntityIgniter_Precache (auto-generated, category: vfunc). Locate
  CEnvEntityIgniter::Precache in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEnvEntityIgniter_Precache, CEnvEntityIgniter::Precache
disable-model-invocation: true
---

# Find CEnvEntityIgniter_Precache

Target: `CEnvEntityIgniter::Precache` (vfunc) in the module loaded in THIS session.
...
Write `CEnvEntityIgniter_Precache.{platform}.yaml` with EXACTLY these fields:
