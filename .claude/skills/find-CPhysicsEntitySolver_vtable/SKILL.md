...
description: |
  Agent fallback for CPhysicsEntitySolver_vtable (auto-generated, category: func). Locate
  CPhysicsEntitySolver_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysicsEntitySolver_vtable, CPhysicsEntitySolver_vtable
disable-model-invocation: true
---

# Find CPhysicsEntitySolver_vtable

Target: `CPhysicsEntitySolver_vtable` (func) in the module loaded in THIS session.
...
Write `CPhysicsEntitySolver_vtable.{platform}.yaml` with EXACTLY these fields:
