---
name: find-CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem-linux
description: |
  Agent fallback for CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem-linux (auto-generated, category: vfunc). Locate
  CGameSystemReallocatingFactory<CSpawnGroupMgrGameSystem>::Deallocate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem-linux, CGameSystemReallocatingFactory<CSpawnGroupMgrGameSystem>::Deallocate
disable-model-invocation: true
---

# Find CGameSystemReallocatingFactory_CSpawnGroupMgrGameSystem_DestroyGameSystem-linux

Target: `CGameSystemReallocatingFactory<CSpawnGroupMgrGameSystem>::Deallocate` (vfunc) in the module loaded in THIS session.
