...
description: |
  Agent fallback for IGameSystem_OnServerPreClientUpdate (auto-generated, category: vfunc). Locate
  IGameSystem::ServerPreClientUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerPreClientUpdate, IGameSystem::ServerPreClientUpdate
disable-model-invocation: true
---

# Find IGameSystem_OnServerPreClientUpdate

Target: `IGameSystem::ServerPreClientUpdate` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnServerPreClientUpdate.{platform}.yaml` with EXACTLY these fields:
