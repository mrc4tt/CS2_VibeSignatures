...
description: |
  ...
  IGameSystem_OnServerPreClientUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerPreClientUpdate, IGameSystem_OnServerPreClientUpdate
disable-model-invocation: true
---

# Find IGameSystem_OnServerPreClientUpdate

Target: `IGameSystem_OnServerPreClientUpdate` (vfunc) in the module loaded in THIS session.
