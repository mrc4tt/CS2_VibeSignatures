...
description: |
  Agent fallback for CEntitySystem_OnEntityParentChanged (auto-generated, category: vfunc). Locate
  CEntitySystem::OnEntityParentChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_OnEntityParentChanged, CEntitySystem::OnEntityParentChanged
disable-model-invocation: true
---

# Find CEntitySystem_OnEntityParentChanged

Target: `CEntitySystem::OnEntityParentChanged` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_OnEntityParentChanged.{platform}.yaml` with EXACTLY these fields:
