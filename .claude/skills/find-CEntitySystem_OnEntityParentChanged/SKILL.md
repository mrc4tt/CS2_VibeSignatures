...
description: |
  ...
  CEntitySystem_OnEntityParentChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_OnEntityParentChanged, CEntitySystem_OnEntityParentChanged
disable-model-invocation: true
---

# Find CEntitySystem_OnEntityParentChanged

Target: `CEntitySystem_OnEntityParentChanged` (vfunc) in the module loaded in THIS session.
