---
name: find-CSource2GameEntities_ShouldClientReceiveStringTableUserData
description: |
  Agent fallback for CSource2GameEntities_ShouldClientReceiveStringTableUserData (auto-generated, category: vfunc). Locate
  CSource2GameEntities::ShouldClientReceiveStringTableUserData in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameEntities_ShouldClientReceiveStringTableUserData, CSource2GameEntities::ShouldClientReceiveStringTableUserData
disable-model-invocation: true
---

# Find CSource2GameEntities_ShouldClientReceiveStringTableUserData

Target: `CSource2GameEntities::ShouldClientReceiveStringTableUserData` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameEntities_ShouldClientReceiveStringTableUserData.{platform}.yaml` with EXACTLY these fields:
