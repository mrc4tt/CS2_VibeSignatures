...
description: |
  ...
  CSource2GameEntities_ShouldClientReceiveStringTableUserData in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameEntities_ShouldClientReceiveStringTableUserData, CSource2GameEntities_ShouldClientReceiveStringTableUserData
disable-model-invocation: true
---

# Find CSource2GameEntities_ShouldClientReceiveStringTableUserData

Target: `CSource2GameEntities_ShouldClientReceiveStringTableUserData` (vfunc) in the module loaded in THIS session.
