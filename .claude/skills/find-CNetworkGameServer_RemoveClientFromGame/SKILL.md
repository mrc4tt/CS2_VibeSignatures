...
description: |
  Agent fallback for CNetworkGameServer_RemoveClientFromGame (auto-generated, category: func). Locate
  CNetworkGameServer_RemoveClientFromGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_RemoveClientFromGame, CNetworkGameServer_RemoveClientFromGame
disable-model-invocation: true
---

# Find CNetworkGameServer_RemoveClientFromGame

Target: `CNetworkGameServer_RemoveClientFromGame` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServer_RemoveClientFromGame.{platform}.yaml` with EXACTLY these fields:
