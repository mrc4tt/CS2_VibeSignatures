...
description: |
  ...
  CPhysExplosion_Activate-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysExplosion_Activate-decompiles, CPhysExplosion_Activate-decompiles
disable-model-invocation: true
---

# Find CPhysExplosion_Activate-decompiles

Target: `CPhysExplosion_Activate-decompiles` (vfunc) in the module loaded in THIS session.
