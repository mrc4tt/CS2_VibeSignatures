---
name: find-CPhysExplosion_Activate-decompiles
description: |
  Agent fallback for CPhysExplosion_Activate-decompiles (auto-generated, category: vfunc). Locate
  CPhysExplosion::Activate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysExplosion_Activate-decompiles, CPhysExplosion::Activate
disable-model-invocation: true
---

# Find CPhysExplosion_Activate-decompiles

Target: `CPhysExplosion::Activate` (vfunc) in the module loaded in THIS session.
...
Write `CPhysExplosion_Activate.{platform}.yaml` with EXACTLY these fields:
