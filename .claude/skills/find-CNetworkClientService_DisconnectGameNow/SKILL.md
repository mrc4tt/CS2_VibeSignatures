...
description: |
  ...
  CNetworkClientService_DisconnectGameNow in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_DisconnectGameNow, CNetworkClientService_DisconnectGameNow
disable-model-invocation: true
---

# Find CNetworkClientService_DisconnectGameNow

Target: `CNetworkClientService_DisconnectGameNow` (vfunc) in the module loaded in THIS session.
