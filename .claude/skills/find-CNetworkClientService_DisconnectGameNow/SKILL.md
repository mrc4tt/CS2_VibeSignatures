...
description: |
  Agent fallback for CNetworkClientService_DisconnectGameNow (auto-generated, category: vfunc). Locate
  CNetworkClientService::DisconnectGameNow in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_DisconnectGameNow, CNetworkClientService::DisconnectGameNow
disable-model-invocation: true
---

# Find CNetworkClientService_DisconnectGameNow

Target: `CNetworkClientService::DisconnectGameNow` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_DisconnectGameNow.{platform}.yaml` with EXACTLY these fields:
