---
name: find-CSource2GameClients_ClientDisconnect-decompiles
description: |
  Agent fallback for CSource2GameClients_ClientDisconnect-decompiles (auto-generated, category: vfunc). Locate
  CSource2GameClients::ClientDisconnect in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientDisconnect-decompiles, CSource2GameClients::ClientDisconnect
disable-model-invocation: true
---

# Find CSource2GameClients_ClientDisconnect-decompiles

Target: `CSource2GameClients::ClientDisconnect` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientDisconnect.{platform}.yaml` with EXACTLY these fields:
