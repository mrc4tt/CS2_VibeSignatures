...
description: |
  ...
  CSource2GameClients_ClientDisconnect-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientDisconnect-decompiles, CSource2GameClients_ClientDisconnect-decompiles
disable-model-invocation: true
---

# Find CSource2GameClients_ClientDisconnect-decompiles

Target: `CSource2GameClients_ClientDisconnect-decompiles` (vfunc) in the module loaded in THIS session.
