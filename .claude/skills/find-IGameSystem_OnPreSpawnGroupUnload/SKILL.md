...
description: |
  Agent fallback for IGameSystem_OnPreSpawnGroupUnload (auto-generated, category: vfunc). Locate
  IGameSystem::OnPreSpawnGroupUnload in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnPreSpawnGroupUnload, IGameSystem::OnPreSpawnGroupUnload
disable-model-invocation: true
---

# Find IGameSystem_OnPreSpawnGroupUnload

Target: `IGameSystem::OnPreSpawnGroupUnload` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnPreSpawnGroupUnload.{platform}.yaml` with EXACTLY these fields:
