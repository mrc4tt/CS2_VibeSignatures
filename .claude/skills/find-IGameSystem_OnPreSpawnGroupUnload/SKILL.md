...
description: |
  ...
  IGameSystem_OnPreSpawnGroupUnload in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnPreSpawnGroupUnload, IGameSystem_OnPreSpawnGroupUnload
disable-model-invocation: true
---

# Find IGameSystem_OnPreSpawnGroupUnload

Target: `IGameSystem_OnPreSpawnGroupUnload` (vfunc) in the module loaded in THIS session.
