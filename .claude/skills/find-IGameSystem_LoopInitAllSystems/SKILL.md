...
description: |
  Agent fallback for IGameSystem_LoopInitAllSystems (auto-generated, category: func). Locate
  IGameSystem::LoopInitAllSystems in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_LoopInitAllSystems, IGameSystem::LoopInitAllSystems
disable-model-invocation: true
---

# Find IGameSystem_LoopInitAllSystems
