...
description: |
  ...
  IGameSystem_LoopInitAllSystems in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_LoopInitAllSystems, IGameSystem_LoopInitAllSystems
disable-model-invocation: true
---

# Find IGameSystem_LoopInitAllSystems

Target: `IGameSystem_LoopInitAllSystems` (func) in the module loaded in THIS session.
