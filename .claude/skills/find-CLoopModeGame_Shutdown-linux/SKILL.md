...
description: |
  ...
  CLoopModeGame_Shutdown-linux in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_Shutdown-linux, CLoopModeGame_Shutdown-linux
disable-model-invocation: true
---

# Find CLoopModeGame_Shutdown-linux

Target: `CLoopModeGame_Shutdown-linux` (func) in the module loaded in THIS session.
