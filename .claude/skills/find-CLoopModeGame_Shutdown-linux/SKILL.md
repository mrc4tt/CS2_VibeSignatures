...
description: |
  Agent fallback for CLoopModeGame_Shutdown-linux (auto-generated, category: func). Locate
  CLoopModeGame::Shutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_Shutdown-linux, CLoopModeGame::Shutdown
disable-model-invocation: true
---

# Find CLoopModeGame_Shutdown-linux

Target: `CLoopModeGame::Shutdown` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_Shutdown.{platform}.yaml` with EXACTLY these fields:
