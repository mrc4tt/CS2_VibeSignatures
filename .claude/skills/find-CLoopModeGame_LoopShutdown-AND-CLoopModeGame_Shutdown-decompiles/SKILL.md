...
description: |
  ...
  CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles, CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles
disable-model-invocation: true
---

# Find CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles

Target: `CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles` (func) in the module loaded in THIS session.
