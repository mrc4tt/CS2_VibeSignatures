---
name: find-CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles
description: |
  Agent fallback for CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles (auto-generated, category: func). Locate
  CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles, CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown
disable-model-invocation: true
---

# Find CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown-decompiles

Target: `CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_LoopShutdown-AND-CLoopModeGame_Shutdown.{platform}.yaml` with EXACTLY these fields:
