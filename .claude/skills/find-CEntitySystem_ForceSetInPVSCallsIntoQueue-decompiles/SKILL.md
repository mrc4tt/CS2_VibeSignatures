---
name: find-CEntitySystem_ForceSetInPVSCallsIntoQueue-decompiles
description: |
  Agent fallback for CEntitySystem_ForceSetInPVSCallsIntoQueue-decompiles (auto-generated, category: func). Locate
  CEntitySystem::ForceSetInPVSCallsIntoQueue in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ForceSetInPVSCallsIntoQueue-decompiles, CEntitySystem::ForceSetInPVSCallsIntoQueue
disable-model-invocation: true
---

# Find CEntitySystem_ForceSetInPVSCallsIntoQueue-decompiles

Target: `CEntitySystem::ForceSetInPVSCallsIntoQueue` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_ForceSetInPVSCallsIntoQueue.{platform}.yaml` with EXACTLY these fields:
