...
description: |
  ...
  CSource2GameClients_ClientCommand in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientCommand, CSource2GameClients_ClientCommand
disable-model-invocation: true
---

# Find CSource2GameClients_ClientCommand

Target: `CSource2GameClients_ClientCommand` (vfunc) in the module loaded in THIS session.
