...
description: |
  Agent fallback for CSource2GameClients_ClientCommand (auto-generated, category: vfunc). Locate
  CSource2GameClients::ClientCommand in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_ClientCommand, CSource2GameClients::ClientCommand
disable-model-invocation: true
---

# Find CSource2GameClients_ClientCommand

Target: `CSource2GameClients::ClientCommand` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_ClientCommand.{platform}.yaml` with EXACTLY these fields:
