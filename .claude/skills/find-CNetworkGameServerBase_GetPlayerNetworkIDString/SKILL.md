...
description: |
  ...
  CNetworkGameServerBase_GetPlayerNetworkIDString in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetPlayerNetworkIDString, CNetworkGameServerBase_GetPlayerNetworkIDString
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetPlayerNetworkIDString

Target: `CNetworkGameServerBase_GetPlayerNetworkIDString` (vfunc) in the module loaded in THIS session.
