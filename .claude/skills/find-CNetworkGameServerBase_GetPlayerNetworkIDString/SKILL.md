...
description: |
  Agent fallback for CNetworkGameServerBase_GetPlayerNetworkIDString (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::GetPlayerNetworkIDString in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetPlayerNetworkIDString, CNetworkGameServerBase::GetPlayerNetworkIDString
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetPlayerNetworkIDString

Target: `CNetworkGameServerBase::GetPlayerNetworkIDString` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_GetPlayerNetworkIDString.{platform}.yaml` with EXACTLY these fields:
