...
description: |
  Agent fallback for CGameResourceService_LoadGameResourceManifestNamed (auto-generated, category: vfunc). Locate
  CGameResourceService::LoadGameResourceManifestNamed in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_LoadGameResourceManifestNamed, CGameResourceService::LoadGameResourceManifestNamed
disable-model-invocation: true
---

# Find CGameResourceService_LoadGameResourceManifestNamed

Target: `CGameResourceService::LoadGameResourceManifestNamed` (vfunc) in the module loaded in THIS session.
...
Write `CGameResourceService_LoadGameResourceManifestNamed.{platform}.yaml` with EXACTLY these fields:
