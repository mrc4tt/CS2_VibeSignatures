...
description: |
  ...
  CGameResourceService_LoadGameResourceManifestNamed in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_LoadGameResourceManifestNamed, CGameResourceService_LoadGameResourceManifestNamed
disable-model-invocation: true
---

# Find CGameResourceService_LoadGameResourceManifestNamed

Target: `CGameResourceService_LoadGameResourceManifestNamed` (vfunc) in the module loaded in THIS session.
