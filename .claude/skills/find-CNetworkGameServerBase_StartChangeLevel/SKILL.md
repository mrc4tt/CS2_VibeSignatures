...
description: |
  ...
  CNetworkGameServerBase_StartChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_StartChangeLevel, CNetworkGameServerBase_StartChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameServerBase_StartChangeLevel

Target: `CNetworkGameServerBase_StartChangeLevel` (vfunc) in the module loaded in THIS session.
