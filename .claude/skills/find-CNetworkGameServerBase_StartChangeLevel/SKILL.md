...
description: |
  Agent fallback for CNetworkGameServerBase_StartChangeLevel (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::StartChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_StartChangeLevel, CNetworkGameServerBase::StartChangeLevel
disable-model-invocation: true
---

# Find CNetworkGameServerBase_StartChangeLevel

Target: `CNetworkGameServerBase::StartChangeLevel` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_StartChangeLevel.{platform}.yaml` with EXACTLY these fields:
