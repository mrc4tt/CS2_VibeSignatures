---
name: find-CBaseModelEntity_vtable
description: |
  Agent fallback for CBaseModelEntity_vtable (auto-generated, category: func). Locate
  CBaseModelEntity_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseModelEntity_vtable, CBaseModelEntity_vtable
disable-model-invocation: true
---

# Find CBaseModelEntity_vtable

Target: `CBaseModelEntity_vtable` (func) in the module loaded in THIS session.
...
Write `CBaseModelEntity_vtable.{platform}.yaml` with EXACTLY these fields:
