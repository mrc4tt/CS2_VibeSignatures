---
name: find-GetFrameTimeAmnesty
description: |
  Agent fallback for GetFrameTimeAmnesty (auto-generated, category: func). Locate
  GetFrameTimeAmnesty in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GetFrameTimeAmnesty, GetFrameTimeAmnesty
disable-model-invocation: true
---

# Find GetFrameTimeAmnesty

Target: `GetFrameTimeAmnesty` (func) in the module loaded in THIS session.
...
Write `GetFrameTimeAmnesty.{platform}.yaml` with EXACTLY these fields:
