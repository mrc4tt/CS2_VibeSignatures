...
description: |
  ...
  CNetworkGameServer_DirectUpdate-noinline in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_DirectUpdate-noinline, CNetworkGameServer_DirectUpdate-noinline
disable-model-invocation: true
---

# Find CNetworkGameServer_DirectUpdate-noinline

Target: `CNetworkGameServer_DirectUpdate-noinline` (vfunc) in the module loaded in THIS session.
