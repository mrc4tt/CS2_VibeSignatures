---
name: find-CNetworkGameServer_DirectUpdate-noinline
description: |
  Agent fallback for CNetworkGameServer_DirectUpdate-noinline (auto-generated, category: vfunc). Locate
  CNetworkGameServer::DirectUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_DirectUpdate-noinline, CNetworkGameServer::DirectUpdate
disable-model-invocation: true
---

# Find CNetworkGameServer_DirectUpdate-noinline

Target: `CNetworkGameServer::DirectUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_DirectUpdate.{platform}.yaml` with EXACTLY these fields:
