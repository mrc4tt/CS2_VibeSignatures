...
description: |
  ...
  CNetworkClientService_Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_Init, CNetworkClientService_Init
disable-model-invocation: true
---

# Find CNetworkClientService_Init

Target: `CNetworkClientService_Init` (vfunc) in the module loaded in THIS session.
