...
description: |
  Agent fallback for CNetworkClientService_Init (auto-generated, category: vfunc). Locate
  CNetworkClientService::Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_Init, CNetworkClientService::Init
disable-model-invocation: true
---

# Find CNetworkClientService_Init

Target: `CNetworkClientService::Init` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_Init.{platform}.yaml` with EXACTLY these fields:
