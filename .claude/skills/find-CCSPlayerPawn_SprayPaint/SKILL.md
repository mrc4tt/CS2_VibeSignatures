...
description: |
  ...
  CCSPlayerPawn_SprayPaint in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_SprayPaint, CCSPlayerPawn_SprayPaint
disable-model-invocation: true
---

# Find CCSPlayerPawn_SprayPaint

Target: `CCSPlayerPawn_SprayPaint` (func) in the module loaded in THIS session.
