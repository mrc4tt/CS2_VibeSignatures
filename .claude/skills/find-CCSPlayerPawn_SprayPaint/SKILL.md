...
description: |
  ...
  CCSPlayerPawn::SprayPaint in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_SprayPaint, CCSPlayerPawn::SprayPaint
disable-model-invocation: true
---

# Find CCSPlayerPawn_SprayPaint

Target: `CCSPlayerPawn::SprayPaint` (func) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_SprayPaint.{platform}.yaml` with EXACTLY these fields:
