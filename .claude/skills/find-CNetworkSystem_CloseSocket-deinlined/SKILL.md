---
name: find-CNetworkSystem_CloseSocket-deinlined
description: |
  Agent fallback for CNetworkSystem_CloseSocket-deinlined (auto-generated, category: func). Locate
  CNetworkSystem_CloseSocket-deinlined in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_CloseSocket-deinlined, CNetworkSystem_CloseSocket-deinlined
disable-model-invocation: true
---

# Find CNetworkSystem_CloseSocket-deinlined

Target: `CNetworkSystem_CloseSocket-deinlined` (func) in the module loaded in THIS session.
