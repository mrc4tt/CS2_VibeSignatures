...
description: |
  Agent fallback for CreateEntityTransitionList (auto-generated, category: func). Locate
  CreateEntityTransitionList in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CreateEntityTransitionList, CreateEntityTransitionList
disable-model-invocation: true
---

# Find CreateEntityTransitionList

Target: `CreateEntityTransitionList` (func) in the module loaded in THIS session.
...
Write `CreateEntityTransitionList.{platform}.yaml` with EXACTLY these fields:
