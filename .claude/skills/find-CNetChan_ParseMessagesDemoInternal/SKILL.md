...
description: |
  Agent fallback for CNetChan_ParseMessagesDemoInternal (auto-generated, category: func). Locate
  CNetChan::ParseMessagesDemoInternal in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetChan_ParseMessagesDemoInternal, CNetChan::ParseMessagesDemoInternal
disable-model-invocation: true
---

# Find CNetChan_ParseMessagesDemoInternal

Target: `CNetChan::ParseMessagesDemoInternal` (func) in the module loaded in THIS session.
...
Write `CNetChan_ParseMessagesDemoInternal.{platform}.yaml` with EXACTLY these fields:
