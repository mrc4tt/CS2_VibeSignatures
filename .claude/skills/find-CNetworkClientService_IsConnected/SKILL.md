...
description: |
  ...
  CNetworkClientService_IsConnected in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_IsConnected, CNetworkClientService_IsConnected
disable-model-invocation: true
---

# Find CNetworkClientService_IsConnected

Target: `CNetworkClientService_IsConnected` (vfunc) in the module loaded in THIS session.
