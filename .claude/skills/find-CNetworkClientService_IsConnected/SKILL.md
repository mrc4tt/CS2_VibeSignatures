...
description: |
  Agent fallback for CNetworkClientService_IsConnected (auto-generated, category: vfunc). Locate
  CNetworkClientService::IsConnected in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_IsConnected, CNetworkClientService::IsConnected
disable-model-invocation: true
---

# Find CNetworkClientService_IsConnected

Target: `CNetworkClientService::IsConnected` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_IsConnected.{platform}.yaml` with EXACTLY these fields:
