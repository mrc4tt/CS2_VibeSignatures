---
name: find-CEngineClient_ClientCmd_Unrestricted
description: |
  Agent fallback for CEngineClient_ClientCmd_Unrestricted (auto-generated, category: func). Locate
  CEngineClient_ClientCmd_Unrestricted in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_ClientCmd_Unrestricted, CEngineClient_ClientCmd_Unrestricted
disable-model-invocation: true
---

# Find CEngineClient_ClientCmd_Unrestricted

Target: `CEngineClient_ClientCmd_Unrestricted` (func) in the module loaded in THIS session.
...
Write `CEngineClient_ClientCmd_Unrestricted.{platform}.yaml` with EXACTLY these fields:
