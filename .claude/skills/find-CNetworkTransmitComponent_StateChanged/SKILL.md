...
description: |
  Agent fallback for CNetworkTransmitComponent_StateChanged (auto-generated, category: func). Locate
  CNetworkTransmitComponent::StateChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkTransmitComponent_StateChanged, CNetworkTransmitComponent::StateChanged
disable-model-invocation: true
---

# Find CNetworkTransmitComponent_StateChanged

Target: `CNetworkTransmitComponent::StateChanged` (func) in the module loaded in THIS session.
...
Write `CNetworkTransmitComponent_StateChanged.{platform}.yaml` with EXACTLY these fields:
