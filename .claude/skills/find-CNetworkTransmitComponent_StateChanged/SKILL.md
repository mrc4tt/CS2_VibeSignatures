...
description: |
  ...
  CNetworkTransmitComponent_StateChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkTransmitComponent_StateChanged, CNetworkTransmitComponent_StateChanged
disable-model-invocation: true
---

# Find CNetworkTransmitComponent_StateChanged

Target: `CNetworkTransmitComponent_StateChanged` (func) in the module loaded in THIS session.
