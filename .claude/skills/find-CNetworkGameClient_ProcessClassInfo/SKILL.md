---
name: find-CNetworkGameClient_ProcessClassInfo
description: |
  Agent fallback for CNetworkGameClient_ProcessClassInfo (auto-generated, category: vfunc). Locate
  CNetworkGameClient::ProcessClassInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessClassInfo, CNetworkGameClient::ProcessClassInfo
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessClassInfo

Target: `CNetworkGameClient::ProcessClassInfo` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_ProcessClassInfo.{platform}.yaml` with EXACTLY these fields:
