...
description: |
  ...
  CNetworkGameClient_ProcessClassInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessClassInfo, CNetworkGameClient_ProcessClassInfo
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessClassInfo

Target: `CNetworkGameClient_ProcessClassInfo` (vfunc) in the module loaded in THIS session.
