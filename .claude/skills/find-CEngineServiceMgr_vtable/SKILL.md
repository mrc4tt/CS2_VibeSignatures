...
description: |
  Agent fallback for CEngineServiceMgr_vtable (auto-generated, category: func). Locate
  CEngineServiceMgr_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_vtable, CEngineServiceMgr_vtable
disable-model-invocation: true
---

# Find CEngineServiceMgr_vtable

Target: `CEngineServiceMgr_vtable` (func) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_vtable.{platform}.yaml` with EXACTLY these fields:
