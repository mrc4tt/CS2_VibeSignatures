...
description: |
  ...
  CNetworkMessages_UnserializeFromStream in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_UnserializeFromStream, CNetworkMessages_UnserializeFromStream
disable-model-invocation: true
---

# Find CNetworkMessages_UnserializeFromStream

Target: `CNetworkMessages_UnserializeFromStream` (vfunc) in the module loaded in THIS session.
