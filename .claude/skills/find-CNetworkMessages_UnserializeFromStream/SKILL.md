...
description: |
  Agent fallback for CNetworkMessages_UnserializeFromStream (auto-generated, category: vfunc). Locate
  CNetworkMessages::UnserializeFromStream in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_UnserializeFromStream, CNetworkMessages::UnserializeFromStream
disable-model-invocation: true
---

# Find CNetworkMessages_UnserializeFromStream

Target: `CNetworkMessages::UnserializeFromStream` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_UnserializeFromStream.{platform}.yaml` with EXACTLY these fields:
