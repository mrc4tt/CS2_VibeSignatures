...
description: |
  Agent fallback for CGameEntitySystem_m_pEntity2Networkables-linux (auto-generated, category: structmember). Locate
  CGameEntitySystem::m_pEntity2Networkables in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_m_pEntity2Networkables-linux, CGameEntitySystem::m_pEntity2Networkables
disable-model-invocation: true
---

# Find CGameEntitySystem_m_pEntity2Networkables-linux

Target: `CGameEntitySystem::m_pEntity2Networkables` (structmember) in the module loaded in THIS session.
...
Write `CGameEntitySystem_m_pEntity2Networkables.{platform}.yaml` with EXACTLY these fields:
