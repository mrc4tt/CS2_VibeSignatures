...
description: |
  ...
  CEntityInstance_ReloadPrivateScripts in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ReloadPrivateScripts, CEntityInstance_ReloadPrivateScripts
disable-model-invocation: true
---

# Find CEntityInstance_ReloadPrivateScripts

Target: `CEntityInstance_ReloadPrivateScripts` (vfunc) in the module loaded in THIS session.
