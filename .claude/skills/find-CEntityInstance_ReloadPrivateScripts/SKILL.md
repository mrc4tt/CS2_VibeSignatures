...
description: |
  Agent fallback for CEntityInstance_ReloadPrivateScripts (auto-generated, category: vfunc). Locate
  CEntityInstance::ReloadPrivateScripts in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ReloadPrivateScripts, CEntityInstance::ReloadPrivateScripts
disable-model-invocation: true
---

# Find CEntityInstance_ReloadPrivateScripts

Target: `CEntityInstance::ReloadPrivateScripts` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_ReloadPrivateScripts.{platform}.yaml` with EXACTLY these fields:
