...
description: |
  ...
  IGameSystem_OnRestoreGame in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnRestoreGame, IGameSystem_OnRestoreGame
disable-model-invocation: true
---

# Find IGameSystem_OnRestoreGame

Target: `IGameSystem_OnRestoreGame` (vfunc) in the module loaded in THIS session.
