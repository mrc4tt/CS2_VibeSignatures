...
description: |
  Agent fallback for IGameSystem_OnRestoreGame (auto-generated, category: vfunc). Locate
  IGameSystem::OnRestoreGame in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnRestoreGame, IGameSystem::OnRestoreGame
disable-model-invocation: true
---

# Find IGameSystem_OnRestoreGame

Target: `IGameSystem::OnRestoreGame` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnRestoreGame.{platform}.yaml` with EXACTLY these fields:
