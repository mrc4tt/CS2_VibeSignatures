---
name: find-InitSteamLogin
description: |
  Agent fallback for InitSteamLogin (auto-generated, category: func). Locate
  InitSteamLogin in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: InitSteamLogin, InitSteamLogin
disable-model-invocation: true
---

# Find InitSteamLogin

Target: `InitSteamLogin` (func) in the module loaded in THIS session.
...
Write `InitSteamLogin.{platform}.yaml` with EXACTLY these fields:
