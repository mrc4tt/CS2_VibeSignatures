...
description: |
  Agent fallback for CCSGameRules_GoToIntermission (auto-generated, category: vfunc). Locate
  CCSGameRules::GoToIntermission in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_GoToIntermission, CCSGameRules::GoToIntermission
disable-model-invocation: true
---

# Find CCSGameRules_GoToIntermission

Target: `CCSGameRules::GoToIntermission` (vfunc) in the module loaded in THIS session.
...
Write `CCSGameRules_GoToIntermission.{platform}.yaml` with EXACTLY these fields:
