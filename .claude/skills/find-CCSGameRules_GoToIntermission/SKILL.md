...
description: |
  ...
  CCSGameRules_GoToIntermission in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSGameRules_GoToIntermission, CCSGameRules_GoToIntermission
disable-model-invocation: true
---

# Find CCSGameRules_GoToIntermission

Target: `CCSGameRules_GoToIntermission` (vfunc) in the module loaded in THIS session.
