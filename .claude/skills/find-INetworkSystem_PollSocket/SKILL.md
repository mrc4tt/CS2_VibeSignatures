...
description: |
  ...
  INetworkSystem_PollSocket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_PollSocket, INetworkSystem_PollSocket
disable-model-invocation: true
---

# Find INetworkSystem_PollSocket

Target: `INetworkSystem_PollSocket` (vfunc) in the module loaded in THIS session.
