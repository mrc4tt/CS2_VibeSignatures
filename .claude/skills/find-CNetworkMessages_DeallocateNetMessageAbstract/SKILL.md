...
description: |
  ...
  CNetworkMessages_DeallocateNetMessageAbstract in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_DeallocateNetMessageAbstract, CNetworkMessages_DeallocateNetMessageAbstract
disable-model-invocation: true
---

# Find CNetworkMessages_DeallocateNetMessageAbstract

Target: `CNetworkMessages_DeallocateNetMessageAbstract` (vfunc) in the module loaded in THIS session.
