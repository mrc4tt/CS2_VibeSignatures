...
description: |
  Agent fallback for CNetworkMessages_DeallocateNetMessageAbstract (auto-generated, category: vfunc). Locate
  CNetworkMessages::DeallocateNetMessageAbstract in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_DeallocateNetMessageAbstract, CNetworkMessages::DeallocateNetMessageAbstract
disable-model-invocation: true
---

# Find CNetworkMessages_DeallocateNetMessageAbstract

Target: `CNetworkMessages::DeallocateNetMessageAbstract` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_DeallocateNetMessageAbstract.{platform}.yaml` with EXACTLY these fields:
