...
description: |
  ...
  CPlayer_MovementServices_s_pRunCommandPawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPlayer_MovementServices_s_pRunCommandPawn, CPlayer_MovementServices_s_pRunCommandPawn
disable-model-invocation: true
---

# Find CPlayer_MovementServices_s_pRunCommandPawn

Target: `CPlayer_MovementServices_s_pRunCommandPawn` (func) in the module loaded in THIS session.
