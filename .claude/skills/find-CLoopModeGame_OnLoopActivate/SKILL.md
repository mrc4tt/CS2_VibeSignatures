...
description: |
  ...
  CLoopModeGame_OnLoopActivate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnLoopActivate, CLoopModeGame_OnLoopActivate
disable-model-invocation: true
---

# Find CLoopModeGame_OnLoopActivate

Target: `CLoopModeGame_OnLoopActivate` (vfunc) in the module loaded in THIS session.
