...
description: |
  Agent fallback for CLoopModeGame_OnLoopActivate (auto-generated, category: vfunc). Locate
  CLoopModeGame::OnLoopActivate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnLoopActivate, CLoopModeGame::OnLoopActivate
disable-model-invocation: true
---

# Find CLoopModeGame_OnLoopActivate

Target: `CLoopModeGame::OnLoopActivate` (vfunc) in the module loaded in THIS session.
...
Write `CLoopModeGame_OnLoopActivate.{platform}.yaml` with EXACTLY these fields:
