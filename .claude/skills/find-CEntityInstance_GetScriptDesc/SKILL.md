...
description: |
  ...
  CEntityInstance_GetScriptDesc in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_GetScriptDesc, CEntityInstance_GetScriptDesc
disable-model-invocation: true
---

# Find CEntityInstance_GetScriptDesc

Target: `CEntityInstance_GetScriptDesc` (vfunc) in the module loaded in THIS session.
