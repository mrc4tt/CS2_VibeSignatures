...
description: |
  Agent fallback for CEntityInstance_GetScriptDesc (auto-generated, category: vfunc). Locate
  CEntityInstance::GetScriptDesc in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_GetScriptDesc, CEntityInstance::GetScriptDesc
disable-model-invocation: true
---

# Find CEntityInstance_GetScriptDesc

Target: `CEntityInstance::GetScriptDesc` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_GetScriptDesc.{platform}.yaml` with EXACTLY these fields:
