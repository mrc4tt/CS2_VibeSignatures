...
description: |
  Agent fallback for CBaseEntity_OnSetDormant (auto-generated, category: vfunc). Locate
  CBaseEntity::OnSetDormant in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_OnSetDormant, CBaseEntity::OnSetDormant
disable-model-invocation: true
---

# Find CBaseEntity_OnSetDormant

Target: `CBaseEntity::OnSetDormant` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_OnSetDormant.{platform}.yaml` with EXACTLY these fields:
