...
description: |
  ...
  CBaseEntity_OnSetDormant in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_OnSetDormant, CBaseEntity_OnSetDormant
disable-model-invocation: true
---

# Find CBaseEntity_OnSetDormant

Target: `CBaseEntity_OnSetDormant` (vfunc) in the module loaded in THIS session.
