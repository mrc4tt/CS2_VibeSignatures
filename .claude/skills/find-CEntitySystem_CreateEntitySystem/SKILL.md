...
description: |
  Agent fallback for CEntitySystem_CreateEntitySystem (auto-generated, category: func). Locate
  CEntitySystem_CreateEntitySystem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_CreateEntitySystem, CEntitySystem_CreateEntitySystem
disable-model-invocation: true
---

# Find CEntitySystem_CreateEntitySystem

Target: `CEntitySystem_CreateEntitySystem` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_CreateEntitySystem.{platform}.yaml` with EXACTLY these fields:
