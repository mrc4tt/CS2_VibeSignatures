...
description: |
  Agent fallback for CEntityInstance_NetworkStateChanged (auto-generated, category: vfunc). Locate
  CEntityInstance::NetworkStateChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_NetworkStateChanged, CEntityInstance::NetworkStateChanged
disable-model-invocation: true
---

# Find CEntityInstance_NetworkStateChanged

Target: `CEntityInstance::NetworkStateChanged` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_NetworkStateChanged.{platform}.yaml` with EXACTLY these fields:
