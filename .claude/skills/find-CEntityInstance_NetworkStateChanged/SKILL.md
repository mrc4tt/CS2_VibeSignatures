...
description: |
  ...
  CEntityInstance_NetworkStateChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_NetworkStateChanged, CEntityInstance_NetworkStateChanged
disable-model-invocation: true
---

# Find CEntityInstance_NetworkStateChanged

Target: `CEntityInstance_NetworkStateChanged` (vfunc) in the module loaded in THIS session.
