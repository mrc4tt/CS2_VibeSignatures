...
description: |
  ...
  CLoopTypeBase_LoadDependentServices in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_LoadDependentServices, CLoopTypeBase_LoadDependentServices
disable-model-invocation: true
---

# Find CLoopTypeBase_LoadDependentServices

Target: `CLoopTypeBase_LoadDependentServices` (func) in the module loaded in THIS session.
