...
description: |
  ...
  CEntityInstance_AssignChangeAccessorPathIds in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_AssignChangeAccessorPathIds, CEntityInstance_AssignChangeAccessorPathIds
disable-model-invocation: true
---

# Find CEntityInstance_AssignChangeAccessorPathIds

Target: `CEntityInstance_AssignChangeAccessorPathIds` (vfunc) in the module loaded in THIS session.
