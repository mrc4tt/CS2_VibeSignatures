...
description: |
  Agent fallback for CEntityInstance_AssignChangeAccessorPathIds (auto-generated, category: vfunc). Locate
  CEntityInstance::AssignChangeAccessorPathIds in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_AssignChangeAccessorPathIds, CEntityInstance::AssignChangeAccessorPathIds
disable-model-invocation: true
---

# Find CEntityInstance_AssignChangeAccessorPathIds

Target: `CEntityInstance::AssignChangeAccessorPathIds` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_AssignChangeAccessorPathIds.{platform}.yaml` with EXACTLY these fields:
