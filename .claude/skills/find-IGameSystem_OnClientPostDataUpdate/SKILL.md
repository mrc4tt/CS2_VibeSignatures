...
description: |
  ...
  IGameSystem_OnClientPostDataUpdate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPostDataUpdate, IGameSystem_OnClientPostDataUpdate
disable-model-invocation: true
---

# Find IGameSystem_OnClientPostDataUpdate

Target: `IGameSystem_OnClientPostDataUpdate` (vfunc) in the module loaded in THIS session.
