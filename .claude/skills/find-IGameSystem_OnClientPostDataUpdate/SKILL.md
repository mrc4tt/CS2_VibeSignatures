...
description: |
  Agent fallback for IGameSystem_OnClientPostDataUpdate (auto-generated, category: vfunc). Locate
  IGameSystem::OnClientPostDataUpdate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPostDataUpdate, IGameSystem::OnClientPostDataUpdate
disable-model-invocation: true
---

# Find IGameSystem_OnClientPostDataUpdate

Target: `IGameSystem::OnClientPostDataUpdate` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientPostDataUpdate.{platform}.yaml` with EXACTLY these fields:
