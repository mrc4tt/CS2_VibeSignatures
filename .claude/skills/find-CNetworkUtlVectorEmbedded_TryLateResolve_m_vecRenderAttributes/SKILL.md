...
description: |
  Agent fallback for CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes (auto-generated, category: func). Locate
  CNetworkUtlVectorEmbedded<CRenderAttribute>::TryLateResolve in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes, CNetworkUtlVectorEmbedded<CRenderAttribute>::TryLateResolve
disable-model-invocation: true
---

# Find CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes

Target: `CNetworkUtlVectorEmbedded<CRenderAttribute>::TryLateResolve` (func) in the module loaded in THIS session.
...
Write `CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes.{platform}.yaml` with EXACTLY these fields:
