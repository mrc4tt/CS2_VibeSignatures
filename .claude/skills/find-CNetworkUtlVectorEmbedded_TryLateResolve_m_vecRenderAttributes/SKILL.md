...
description: |
  ...
  CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes, CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes
disable-model-invocation: true
---

# Find CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes

Target: `CNetworkUtlVectorEmbedded_TryLateResolve_m_vecRenderAttributes` (func) in the module loaded in THIS session.
