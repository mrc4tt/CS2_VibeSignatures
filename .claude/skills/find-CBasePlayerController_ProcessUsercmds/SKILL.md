...
description: |
  ...
  ProcessUsercmds in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_ProcessUsercmds, ProcessUsercmds
disable-model-invocation: true
---

# Find CBasePlayerController_ProcessUsercmds

Target: `ProcessUsercmds` (func) in the module loaded in THIS session.
...
Write `CBasePlayerController_ProcessUsercmds.{platform}.yaml` with EXACTLY these fields:
