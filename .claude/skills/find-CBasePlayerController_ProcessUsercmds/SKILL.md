...
description: |
  ...
  CBasePlayerController_ProcessUsercmds in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_ProcessUsercmds, CBasePlayerController_ProcessUsercmds
disable-model-invocation: true
---

# Find CBasePlayerController_ProcessUsercmds

Target: `CBasePlayerController_ProcessUsercmds` (func) in the module loaded in THIS session.
