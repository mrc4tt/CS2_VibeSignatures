...
description: |
  ...
  CNetworkServerService_Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_Init, CNetworkServerService_Init
disable-model-invocation: true
---

# Find CNetworkServerService_Init

Target: `CNetworkServerService_Init` (vfunc) in the module loaded in THIS session.
