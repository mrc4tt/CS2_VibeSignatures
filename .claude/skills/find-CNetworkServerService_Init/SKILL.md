...
description: |
  Agent fallback for CNetworkServerService_Init (auto-generated, category: vfunc). Locate
  CNetworkServerService::Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_Init, CNetworkServerService::Init
disable-model-invocation: true
---

# Find CNetworkServerService_Init

Target: `CNetworkServerService::Init` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkServerService_Init.{platform}.yaml` with EXACTLY these fields:
