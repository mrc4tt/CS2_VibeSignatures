---
name: find-CCSPlayerController_GetThinkFunction-decompiles
description: |
  Agent fallback for CCSPlayerController_GetThinkFunction-decompiles (auto-generated, category: func). Locate
  CCSPlayerController::GetThinkFunction in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_GetThinkFunction-decompiles, CCSPlayerController::GetThinkFunction
disable-model-invocation: true
---

# Find CCSPlayerController_GetThinkFunction-decompiles

Target: `CCSPlayerController::GetThinkFunction` (func) in the module loaded in THIS session.
...
Write `CCSPlayerController_GetThinkFunction.{platform}.yaml` with EXACTLY these fields:
