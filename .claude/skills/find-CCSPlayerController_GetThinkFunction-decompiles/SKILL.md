...
description: |
  ...
  CCSPlayerController_GetThinkFunction-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_GetThinkFunction-decompiles, CCSPlayerController_GetThinkFunction-decompiles
disable-model-invocation: true
---

# Find CCSPlayerController_GetThinkFunction-decompiles

Target: `CCSPlayerController_GetThinkFunction-decompiles` (func) in the module loaded in THIS session.
