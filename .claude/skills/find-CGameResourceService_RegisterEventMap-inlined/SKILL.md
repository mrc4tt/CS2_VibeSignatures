...
description: |
  ...
  CGameResourceService_RegisterEventMap-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_RegisterEventMap-inlined, CGameResourceService_RegisterEventMap-inlined
disable-model-invocation: true
---

# Find CGameResourceService_RegisterEventMap-inlined

Target: `CGameResourceService_RegisterEventMap-inlined` (vfunc) in the module loaded in THIS session.
