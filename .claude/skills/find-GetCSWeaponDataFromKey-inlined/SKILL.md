...
description: |
  ...
  GetCSWeaponDataFromKey-inlined in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GetCSWeaponDataFromKey-inlined, GetCSWeaponDataFromKey-inlined
disable-model-invocation: true
---

# Find GetCSWeaponDataFromKey-inlined

Target: `GetCSWeaponDataFromKey-inlined` (func) in the module loaded in THIS session.
