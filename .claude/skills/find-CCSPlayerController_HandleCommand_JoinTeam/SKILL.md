---
name: find-CCSPlayerController_HandleCommand_JoinTeam
description: |
...
# Find CCSPlayerController_HandleCommand_JoinTeam

Target: `CCSPlayerController::HandleCommand_JoinTeam` (func) in the CS2 server module.
