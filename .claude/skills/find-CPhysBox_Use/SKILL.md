...
description: |
  Agent fallback for CPhysBox_Use (auto-generated, category: vfunc). Locate
  CPhysBox::Use in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysBox_Use, CPhysBox::Use
disable-model-invocation: true
---

# Find CPhysBox_Use

Target: `CPhysBox::Use` (vfunc) in the module loaded in THIS session.
...
Write `CPhysBox_Use.{platform}.yaml` with EXACTLY these fields:
