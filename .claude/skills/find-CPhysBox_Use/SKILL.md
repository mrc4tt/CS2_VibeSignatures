...
description: |
  ...
  CPhysBox_Use in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysBox_Use, CPhysBox_Use
disable-model-invocation: true
---

# Find CPhysBox_Use

Target: `CPhysBox_Use` (vfunc) in the module loaded in THIS session.
