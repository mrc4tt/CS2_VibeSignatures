...
description: |
  Agent fallback for CEntitySystem_m_Accessors (auto-generated, category: structmember). Locate
  CEntitySystem::m_Accessors in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_Accessors, CEntitySystem::m_Accessors
disable-model-invocation: true
---

# Find CEntitySystem_m_Accessors

Target: `CEntitySystem::m_Accessors` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_Accessors.{platform}.yaml` with EXACTLY these fields:
