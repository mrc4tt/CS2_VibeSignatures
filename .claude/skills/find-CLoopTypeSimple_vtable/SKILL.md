...
description: |
  Agent fallback for CLoopTypeSimple_vtable (auto-generated, category: func). Locate
  CLoopTypeSimple_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeSimple_vtable, CLoopTypeSimple_vtable
disable-model-invocation: true
---

# Find CLoopTypeSimple_vtable

Target: `CLoopTypeSimple_vtable` (func) in the module loaded in THIS session.
...
Write `CLoopTypeSimple_vtable.{platform}.yaml` with EXACTLY these fields:
