...
description: |
  Agent fallback for CCSPlayer_ItemServices_CanAcquire (auto-generated, category: func). Locate
  CCSPlayer_ItemServices::CanAcquire in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_ItemServices_CanAcquire, CCSPlayer_ItemServices::CanAcquire
disable-model-invocation: true
---

# Find CCSPlayer_ItemServices_CanAcquire

Target: `CCSPlayer_ItemServices::CanAcquire` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_ItemServices_CanAcquire.{platform}.yaml` with EXACTLY these fields:
