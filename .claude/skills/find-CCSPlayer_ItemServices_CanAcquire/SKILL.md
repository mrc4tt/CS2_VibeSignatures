...
description: |
  ...
  CCSPlayer_ItemServices_CanAcquire in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_ItemServices_CanAcquire, CCSPlayer_ItemServices_CanAcquire
disable-model-invocation: true
---

# Find CCSPlayer_ItemServices_CanAcquire

Target: `CCSPlayer_ItemServices_CanAcquire` (func) in the module loaded in THIS session.
