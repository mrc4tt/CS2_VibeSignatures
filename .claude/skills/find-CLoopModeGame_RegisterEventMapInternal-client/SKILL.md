...
description: |
  Agent fallback for CLoopModeGame_RegisterEventMapInternal-client (auto-generated, category: func). Locate
  CLoopModeGame::RegisterEventMapInternal in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_RegisterEventMapInternal-client, CLoopModeGame::RegisterEventMapInternal
disable-model-invocation: true
---

# Find CLoopModeGame_RegisterEventMapInternal-client
