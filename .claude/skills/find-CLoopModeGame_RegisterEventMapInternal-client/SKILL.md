...
description: |
  ...
  CLoopModeGame_RegisterEventMapInternal-client in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_RegisterEventMapInternal-client, CLoopModeGame_RegisterEventMapInternal-client
disable-model-invocation: true
---

# Find CLoopModeGame_RegisterEventMapInternal-client

Target: `CLoopModeGame_RegisterEventMapInternal-client` (func) in the module loaded in THIS session.
