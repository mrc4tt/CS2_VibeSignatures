...
description: |
  Agent fallback for CNetworkMessages_SerializeMessageInternal (auto-generated, category: vfunc). Locate
  CNetworkMessages::SerializeMessageInternal in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_SerializeMessageInternal, CNetworkMessages::SerializeMessageInternal
disable-model-invocation: true
---

# Find CNetworkMessages_SerializeMessageInternal

Target: `CNetworkMessages::SerializeMessageInternal` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkMessages_SerializeMessageInternal.{platform}.yaml` with EXACTLY these fields:
