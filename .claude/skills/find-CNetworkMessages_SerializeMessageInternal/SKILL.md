...
description: |
  ...
  CNetworkMessages_SerializeMessageInternal in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_SerializeMessageInternal, CNetworkMessages_SerializeMessageInternal
disable-model-invocation: true
---

# Find CNetworkMessages_SerializeMessageInternal

Target: `CNetworkMessages_SerializeMessageInternal` (vfunc) in the module loaded in THIS session.
