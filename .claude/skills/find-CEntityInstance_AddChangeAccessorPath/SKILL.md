...
description: |
  Agent fallback for CEntityInstance_AddChangeAccessorPath (auto-generated, category: vfunc). Locate
  CEntityInstance::AddChangeAccessorPath in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_AddChangeAccessorPath, CEntityInstance::AddChangeAccessorPath
disable-model-invocation: true
---

# Find CEntityInstance_AddChangeAccessorPath

Target: `CEntityInstance::AddChangeAccessorPath` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_AddChangeAccessorPath.{platform}.yaml` with EXACTLY these fields:
