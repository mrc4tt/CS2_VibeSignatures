...
description: |
  ...
  CEntityInstance_AddChangeAccessorPath in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_AddChangeAccessorPath, CEntityInstance_AddChangeAccessorPath
disable-model-invocation: true
---

# Find CEntityInstance_AddChangeAccessorPath

Target: `CEntityInstance_AddChangeAccessorPath` (vfunc) in the module loaded in THIS session.
