---
name: find-C_GameRules_vtable
description: |
  Agent fallback for C_GameRules_vtable (auto-generated, category: func). Locate
  C_GameRules_vtable in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_GameRules_vtable, C_GameRules_vtable
disable-model-invocation: true
---

# Find C_GameRules_vtable

Target: `C_GameRules_vtable` (func) in the module loaded in THIS session.
...
Write `C_GameRules_vtable.{platform}.yaml` with EXACTLY these fields:
