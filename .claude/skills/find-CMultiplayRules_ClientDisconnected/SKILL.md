...
description: |
  ...
  CMultiplayRules_ClientDisconnected in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMultiplayRules_ClientDisconnected, CMultiplayRules_ClientDisconnected
disable-model-invocation: true
---

# Find CMultiplayRules_ClientDisconnected

Target: `CMultiplayRules_ClientDisconnected` (vfunc) in the module loaded in THIS session.
