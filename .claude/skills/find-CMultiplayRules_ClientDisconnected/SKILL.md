...
description: |
  Agent fallback for CMultiplayRules_ClientDisconnected (auto-generated, category: vfunc). Locate
  ...
  Trigger: CMultiplayRules_ClientDisconnected, CMultiplayRules::ClientDisconnected
disable-model-invocation: true
---

# Find CMultiplayRules_ClientDisconnected
