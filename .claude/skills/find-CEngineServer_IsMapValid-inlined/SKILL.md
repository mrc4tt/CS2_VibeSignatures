...
description: |
  ...
  CEngineServer_IsMapValid-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_IsMapValid-inlined, CEngineServer_IsMapValid-inlined
disable-model-invocation: true
---

# Find CEngineServer_IsMapValid-inlined

Target: `CEngineServer_IsMapValid-inlined` (vfunc) in the module loaded in THIS session.
