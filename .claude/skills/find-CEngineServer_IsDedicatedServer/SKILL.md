---
name: find-CEngineServer_IsDedicatedServer
description: |
  Agent fallback for CEngineServer_IsDedicatedServer (auto-generated, category: func). Locate
  CEngineServer_IsDedicatedServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_IsDedicatedServer, CEngineServer_IsDedicatedServer
disable-model-invocation: true
---

# Find CEngineServer_IsDedicatedServer

Target: `CEngineServer_IsDedicatedServer` (func) in the module loaded in THIS session.
...
Write `CEngineServer_IsDedicatedServer.{platform}.yaml` with EXACTLY these fields:
