...
description: |
  ...
  CTriggerGravity_GravityTouch in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTriggerGravity_GravityTouch, CTriggerGravity_GravityTouch
disable-model-invocation: true
---

# Find CTriggerGravity_GravityTouch

Target: `CTriggerGravity_GravityTouch` (func) in the module loaded in THIS session.
