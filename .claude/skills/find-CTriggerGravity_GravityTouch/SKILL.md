...
description: |
  Agent fallback for CTriggerGravity_GravityTouch (auto-generated, category: func). Locate
  CTriggerGravity::GravityTouch in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTriggerGravity_GravityTouch, CTriggerGravity::GravityTouch
disable-model-invocation: true
---

# Find CTriggerGravity_GravityTouch

Target: `CTriggerGravity::GravityTouch` (func) in the module loaded in THIS session.
...
Write `CTriggerGravity_GravityTouch.{platform}.yaml` with EXACTLY these fields:
