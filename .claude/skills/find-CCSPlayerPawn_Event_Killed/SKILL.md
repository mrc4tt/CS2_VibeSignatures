...
description: |
  ...
  CCSPlayerPawn_Event_Killed in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_Event_Killed, CCSPlayerPawn_Event_Killed
disable-model-invocation: true
---

# Find CCSPlayerPawn_Event_Killed

Target: `CCSPlayerPawn_Event_Killed` (vfunc) in the module loaded in THIS session.
