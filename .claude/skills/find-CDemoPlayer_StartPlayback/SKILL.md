...
description: |
  ...
  CDemoPlayer_StartPlayback in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_StartPlayback, CDemoPlayer_StartPlayback
disable-model-invocation: true
---

# Find CDemoPlayer_StartPlayback

Target: `CDemoPlayer_StartPlayback` (vfunc) in the module loaded in THIS session.
