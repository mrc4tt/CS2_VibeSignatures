...
description: |
  Agent fallback for CEngineServer_DumpNetStats (auto-generated, category: vfunc). Locate
  CEngineServer::DumpNetStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_DumpNetStats, CEngineServer::DumpNetStats
disable-model-invocation: true
---

# Find CEngineServer_DumpNetStats

Target: `CEngineServer::DumpNetStats` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_DumpNetStats.{platform}.yaml` with EXACTLY these fields:
