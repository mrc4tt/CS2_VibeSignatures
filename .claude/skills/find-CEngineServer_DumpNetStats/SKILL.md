...
description: |
  ...
  CEngineServer_DumpNetStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_DumpNetStats, CEngineServer_DumpNetStats
disable-model-invocation: true
---

# Find CEngineServer_DumpNetStats

Target: `CEngineServer_DumpNetStats` (vfunc) in the module loaded in THIS session.
