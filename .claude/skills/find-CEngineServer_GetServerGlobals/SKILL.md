---
name: find-CEngineServer_GetServerGlobals
description: |
  Agent fallback for CEngineServer_GetServerGlobals (auto-generated, category: func). Locate
  CEngineServer_GetServerGlobals in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetServerGlobals, CEngineServer_GetServerGlobals
disable-model-invocation: true
---

# Find CEngineServer_GetServerGlobals

Target: `CEngineServer_GetServerGlobals` (func) in the module loaded in THIS session.
...
Write `CEngineServer_GetServerGlobals.{platform}.yaml` with EXACTLY these fields:
