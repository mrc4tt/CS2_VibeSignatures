...
description: |
  Agent fallback for CNetworkSystem_PollSocket (auto-generated, category: vfunc). Locate
...
Target: `CNetworkSystem_PollSocket` (vfunc) in the module loaded in THIS session.
