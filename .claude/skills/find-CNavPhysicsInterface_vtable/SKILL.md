...
description: |
  Agent fallback for CNavPhysicsInterface_vtable (auto-generated, category: func). Locate
  CNavPhysicsInterface_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNavPhysicsInterface_vtable, CNavPhysicsInterface_vtable
disable-model-invocation: true
---

# Find CNavPhysicsInterface_vtable

Target: `CNavPhysicsInterface_vtable` (func) in the module loaded in THIS session.
...
Write `CNavPhysicsInterface_vtable.{platform}.yaml` with EXACTLY these fields:
