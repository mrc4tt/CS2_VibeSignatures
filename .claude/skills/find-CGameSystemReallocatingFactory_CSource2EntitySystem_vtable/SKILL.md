...
# Find CGameSystemReallocatingFactory_CSource2EntitySystem_vtable

Target: `CGameSystemReallocatingFactory_CSource2EntitySystem_vtable` (func) in the module loaded in THIS session.
