...
description: |
  ...
  CSource2Server_ServerConVarChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_ServerConVarChanged, CSource2Server_ServerConVarChanged
disable-model-invocation: true
---

# Find CSource2Server_ServerConVarChanged

Target: `CSource2Server_ServerConVarChanged` (vfunc) in the module loaded in THIS session.
