...
description: |
  Agent fallback for CSource2Server_ServerConVarChanged (auto-generated, category: vfunc). Locate
  CSource2Server::ServerConVarChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_ServerConVarChanged, CSource2Server::ServerConVarChanged
disable-model-invocation: true
---

# Find CSource2Server_ServerConVarChanged

Target: `CSource2Server::ServerConVarChanged` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_ServerConVarChanged.{platform}.yaml` with EXACTLY these fields:
