---
name: find-CFlashbangProjectile_Spawn_NetworkStateChangedNotify
description: |
  Agent fallback for CFlashbangProjectile_Spawn_NetworkStateChangedNotify (auto-generated, category: func). Locate
  CFlashbangProjectile_Spawn_NetworkStateChangedNotify in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlashbangProjectile_Spawn_NetworkStateChangedNotify, CFlashbangProjectile_Spawn_NetworkStateChangedNotify
disable-model-invocation: true
---

# Find CFlashbangProjectile_Spawn_NetworkStateChangedNotify

Target: `CFlashbangProjectile_Spawn_NetworkStateChangedNotify` (func) in the module loaded in THIS session.
...
Write `CFlashbangProjectile_Spawn_NetworkStateChangedNotify.{platform}.yaml` with EXACTLY these fields:
