...
description: |
  Agent fallback for s_GameEventManager (auto-generated, category: func). Locate
  s_GameEventManager in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: s_GameEventManager, s_GameEventManager
disable-model-invocation: true
---

# Find s_GameEventManager

Target: `s_GameEventManager` (func) in the module loaded in THIS session.
...
Write `s_GameEventManager.{platform}.yaml` with EXACTLY these fields:
