---
name: find-IsCommandWhitelisted
description: |
  Locate IsCommandWhitelisted in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "IsCommandWhitelisted" (symbol IsCommandWhitelisted). The gamedata consumer stores a BYTE SIGNATURE for this entry - ALWAYS emit the func
  ...
  Trigger: IsCommandWhitelisted, IsCommandWhitelisted
disable-model-invocation: true
---

# Find IsCommandWhitelisted

Target: `IsCommandWhitelisted` (func) in the CS2 server module.
