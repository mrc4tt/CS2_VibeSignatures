---
name: find-CWorldRendererMgr_CreateWorld_Internal
description: |
  Agent fallback for CWorldRendererMgr_CreateWorld_Internal (auto-generated, category: func). Locate
  CWorldRendererMgr::CreateWorld_Internal in the CS2 worldrenderer module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CWorldRendererMgr_CreateWorld_Internal, CWorldRendererMgr::CreateWorld_Internal
disable-model-invocation: true
---

# Find CWorldRendererMgr_CreateWorld_Internal

Target: `CWorldRendererMgr::CreateWorld_Internal` (func) in the module loaded in THIS session.
...
Write `CWorldRendererMgr_CreateWorld_Internal.{platform}.yaml` with EXACTLY these fields:
