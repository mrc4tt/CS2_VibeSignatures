...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_PreSave (auto-generated, category: vfunc). Locate
  CEntitySaveRestoreBlockHandler_PreSave in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_PreSave, CEntitySaveRestoreBlockHandler_PreSave
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_PreSave

Target: `CEntitySaveRestoreBlockHandler_PreSave` (vfunc) in the module loaded in THIS session.
