...
description: |
  Agent fallback for CEnvEntityIgniter_vtable (auto-generated, category: func). Locate
  CEnvEntityIgniter_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEnvEntityIgniter_vtable, CEnvEntityIgniter_vtable
disable-model-invocation: true
---

# Find CEnvEntityIgniter_vtable

Target: `CEnvEntityIgniter_vtable` (func) in the module loaded in THIS session.
...
Write `CEnvEntityIgniter_vtable.{platform}.yaml` with EXACTLY these fields:
