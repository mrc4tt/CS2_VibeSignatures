...
description: |
  ...
  IGameSystem_OnClientAdvanceTick in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientAdvanceTick, IGameSystem_OnClientAdvanceTick
disable-model-invocation: true
---

# Find IGameSystem_OnClientAdvanceTick

Target: `IGameSystem_OnClientAdvanceTick` (vfunc) in the module loaded in THIS session.
