...
description: |
  Agent fallback for IGameSystem_OnClientAdvanceTick (auto-generated, category: vfunc). Locate
  IGameSystem::ClientAdvanceTick in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientAdvanceTick, IGameSystem::ClientAdvanceTick
disable-model-invocation: true
---

# Find IGameSystem_OnClientAdvanceTick

Target: `IGameSystem::ClientAdvanceTick` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientAdvanceTick.{platform}.yaml` with EXACTLY these fields:
