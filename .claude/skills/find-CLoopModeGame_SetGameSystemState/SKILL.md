...
description: |
  Agent fallback for CLoopModeGame_SetGameSystemState (auto-generated, category: func). Locate
  CLoopModeGame::SetGameSystemState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_SetGameSystemState, CLoopModeGame::SetGameSystemState
disable-model-invocation: true
---

# Find CLoopModeGame_SetGameSystemState

Target: `CLoopModeGame::SetGameSystemState` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_SetGameSystemState.{platform}.yaml` with EXACTLY these fields:
