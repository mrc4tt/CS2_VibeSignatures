...
description: |
  ...
  CLoopModeGame_SetGameSystemState in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_SetGameSystemState, CLoopModeGame_SetGameSystemState
disable-model-invocation: true
---

# Find CLoopModeGame_SetGameSystemState

Target: `CLoopModeGame_SetGameSystemState` (func) in the module loaded in THIS session.
