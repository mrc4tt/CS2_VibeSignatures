...
description: |
  ...
  CEntityIdentity_AcceptInput in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityIdentity_AcceptInput, CEntityIdentity_AcceptInput
disable-model-invocation: true
---

# Find CEntityIdentity_AcceptInput

Target: `CEntityIdentity_AcceptInput` (func) in the module loaded in THIS session.
