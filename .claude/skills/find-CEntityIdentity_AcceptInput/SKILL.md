...
description: |
  Agent fallback for CEntityIdentity_AcceptInput (auto-generated, category: func). Locate
  CEntityIdentity::AcceptInput in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityIdentity_AcceptInput, CEntityIdentity::AcceptInput
disable-model-invocation: true
---

# Find CEntityIdentity_AcceptInput

Target: `CEntityIdentity::AcceptInput` (func) in the module loaded in THIS session.
...
Write `CEntityIdentity_AcceptInput.{platform}.yaml` with EXACTLY these fields:
