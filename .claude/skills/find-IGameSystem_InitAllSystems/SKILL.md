...
description: |
  ...
  IGameSystem_InitAllSystems in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_InitAllSystems, IGameSystem_InitAllSystems
disable-model-invocation: true
---

# Find IGameSystem_InitAllSystems

Target: `IGameSystem_InitAllSystems` (func) in the module loaded in THIS session.
