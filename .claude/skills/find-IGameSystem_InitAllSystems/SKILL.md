...
description: |
  Agent fallback for IGameSystem_InitAllSystems (auto-generated, category: func). Locate
  IGameSystem::InitAllSystems in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_InitAllSystems, IGameSystem::InitAllSystems
disable-model-invocation: true
---

# Find IGameSystem_InitAllSystems

Target: `IGameSystem::InitAllSystems` (func) in the module loaded in THIS session.
...
Write `IGameSystem_InitAllSystems.{platform}.yaml` with EXACTLY these fields:
