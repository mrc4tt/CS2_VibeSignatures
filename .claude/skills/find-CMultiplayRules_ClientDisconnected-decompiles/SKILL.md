...
description: |
  ...
  CMultiplayRules_ClientDisconnected-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMultiplayRules_ClientDisconnected-decompiles, CMultiplayRules_ClientDisconnected-decompiles
disable-model-invocation: true
---

# Find CMultiplayRules_ClientDisconnected-decompiles

Target: `CMultiplayRules_ClientDisconnected-decompiles` (vfunc) in the module loaded in THIS session.
