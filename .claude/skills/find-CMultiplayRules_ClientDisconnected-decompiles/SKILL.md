---
name: find-CMultiplayRules_ClientDisconnected-decompiles
description: |
  Agent fallback for CMultiplayRules_ClientDisconnected-decompiles (auto-generated, category: vfunc). Locate
  CMultiplayRules::ClientDisconnected in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMultiplayRules_ClientDisconnected-decompiles, CMultiplayRules::ClientDisconnected
disable-model-invocation: true
---

# Find CMultiplayRules_ClientDisconnected-decompiles

Target: `CMultiplayRules::ClientDisconnected` (vfunc) in the module loaded in THIS session.
...
Write `CMultiplayRules_ClientDisconnected.{platform}.yaml` with EXACTLY these fields:
