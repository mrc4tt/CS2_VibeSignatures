...
description: |
  Agent fallback for CEntitySystem_m_EntityPostSpawnCallback (auto-generated, category: structmember). Locate
  CEntitySystem::m_EntityPostSpawnCallback in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_EntityPostSpawnCallback, CEntitySystem::m_EntityPostSpawnCallback
disable-model-invocation: true
---

# Find CEntitySystem_m_EntityPostSpawnCallback

Target: `CEntitySystem::m_EntityPostSpawnCallback` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_EntityPostSpawnCallback.{platform}.yaml` with EXACTLY these fields:
