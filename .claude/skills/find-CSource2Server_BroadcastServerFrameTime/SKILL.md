...
description: |
  Agent fallback for CSource2Server_BroadcastServerFrameTime (auto-generated, category: vfunc). Locate
  CSource2Server::BroadcastServerFrameTime in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_BroadcastServerFrameTime, CSource2Server::BroadcastServerFrameTime
disable-model-invocation: true
---

# Find CSource2Server_BroadcastServerFrameTime

Target: `CSource2Server::BroadcastServerFrameTime` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_BroadcastServerFrameTime.{platform}.yaml` with EXACTLY these fields:
