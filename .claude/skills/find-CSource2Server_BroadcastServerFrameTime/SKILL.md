...
description: |
  ...
  CSource2Server_BroadcastServerFrameTime in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_BroadcastServerFrameTime, CSource2Server_BroadcastServerFrameTime
disable-model-invocation: true
---

# Find CSource2Server_BroadcastServerFrameTime

Target: `CSource2Server_BroadcastServerFrameTime` (vfunc) in the module loaded in THIS session.
