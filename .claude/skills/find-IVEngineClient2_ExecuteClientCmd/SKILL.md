...
description: |
  ...
  IVEngineClient2_ExecuteClientCmd in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IVEngineClient2_ExecuteClientCmd, IVEngineClient2_ExecuteClientCmd
disable-model-invocation: true
---

# Find IVEngineClient2_ExecuteClientCmd

Target: `IVEngineClient2_ExecuteClientCmd` (vfunc) in the module loaded in THIS session.
