...
description: |
  Agent fallback for IVEngineClient2_ExecuteClientCmd (auto-generated, category: vfunc). Locate
  IVEngineClient2::ExecuteClientCmd in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IVEngineClient2_ExecuteClientCmd, IVEngineClient2::ExecuteClientCmd
disable-model-invocation: true
---

# Find IVEngineClient2_ExecuteClientCmd

Target: `IVEngineClient2::ExecuteClientCmd` (vfunc) in the module loaded in THIS session.
...
Write `IVEngineClient2_ExecuteClientCmd.{platform}.yaml` with EXACTLY these fields:
