...
description: |
  Agent fallback for INetworkGameServer_GetServerNetworkAddress (auto-generated, category: vfunc). Locate
  INetworkGameServer::GetServerNetworkAddress in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetServerNetworkAddress, INetworkGameServer::GetServerNetworkAddress
disable-model-invocation: true
---

# Find INetworkGameServer_GetServerNetworkAddress

Target: `INetworkGameServer::GetServerNetworkAddress` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_GetServerNetworkAddress.{platform}.yaml` with EXACTLY these fields:
