...
description: |
  ...
  INetworkGameServer_GetServerNetworkAddress in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetServerNetworkAddress, INetworkGameServer_GetServerNetworkAddress
disable-model-invocation: true
---

# Find INetworkGameServer_GetServerNetworkAddress

Target: `INetworkGameServer_GetServerNetworkAddress` (vfunc) in the module loaded in THIS session.
