...
description: |
  ...
  CNetworkGameServer_CreateNewClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_CreateNewClient, CNetworkGameServer_CreateNewClient
disable-model-invocation: true
---

# Find CNetworkGameServer_CreateNewClient

Target: `CNetworkGameServer_CreateNewClient` (vfunc) in the module loaded in THIS session.
