...
description: |
  Agent fallback for CNetworkGameServer_CreateNewClient (auto-generated, category: vfunc). Locate
  CNetworkGameServer::CreateNewClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_CreateNewClient, CNetworkGameServer::CreateNewClient
disable-model-invocation: true
---

# Find CNetworkGameServer_CreateNewClient

Target: `CNetworkGameServer::CreateNewClient` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_CreateNewClient.{platform}.yaml` with EXACTLY these fields:
