...
description: |
  Agent fallback for CSource2Server_ShouldTimeoutClient (auto-generated, category: vfunc). Locate
  CSource2Server::ShouldTimeoutClient in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_ShouldTimeoutClient, CSource2Server::ShouldTimeoutClient
disable-model-invocation: true
---

# Find CSource2Server_ShouldTimeoutClient

Target: `CSource2Server::ShouldTimeoutClient` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_ShouldTimeoutClient.{platform}.yaml` with EXACTLY these fields:
