...
description: |
  ...
  CSource2Server_ShouldTimeoutClient in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_ShouldTimeoutClient, CSource2Server_ShouldTimeoutClient
disable-model-invocation: true
---

# Find CSource2Server_ShouldTimeoutClient

Target: `CSource2Server_ShouldTimeoutClient` (vfunc) in the module loaded in THIS session.
