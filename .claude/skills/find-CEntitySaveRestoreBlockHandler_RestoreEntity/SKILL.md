...
description: |
  ...
  CEntitySaveRestoreBlockHandler_RestoreEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_RestoreEntity, CEntitySaveRestoreBlockHandler_RestoreEntity
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_RestoreEntity

Target: `CEntitySaveRestoreBlockHandler_RestoreEntity` (func) in the module loaded in THIS session.
