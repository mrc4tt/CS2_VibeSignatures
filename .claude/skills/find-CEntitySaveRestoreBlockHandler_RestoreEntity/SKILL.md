...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_RestoreEntity (auto-generated, category: func). Locate
  CEntitySaveRestoreBlockHandler::RestoreEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_RestoreEntity, CEntitySaveRestoreBlockHandler::RestoreEntity
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_RestoreEntity

Target: `CEntitySaveRestoreBlockHandler::RestoreEntity` (func) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_RestoreEntity.{platform}.yaml` with EXACTLY these fields:
