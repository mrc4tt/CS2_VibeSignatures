...
description: |
  Agent fallback for CEntitySystem_m_vSpawnOriginOffset (auto-generated, category: structmember). Locate
  CEntitySystem::m_vSpawnOriginOffset in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_vSpawnOriginOffset, CEntitySystem::m_vSpawnOriginOffset
disable-model-invocation: true
---

# Find CEntitySystem_m_vSpawnOriginOffset

Target: `CEntitySystem::m_vSpawnOriginOffset` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_vSpawnOriginOffset.{platform}.yaml` with EXACTLY these fields:
