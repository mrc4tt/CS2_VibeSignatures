...
description: |
  ...
  CGameRules_GetChatPrefix in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_GetChatPrefix, CGameRules_GetChatPrefix
disable-model-invocation: true
---

# Find CGameRules_GetChatPrefix

Target: `CGameRules_GetChatPrefix` (vfunc) in the module loaded in THIS session.
