...
description: |
  Agent fallback for CGameRules_GetChatPrefix (auto-generated, category: vfunc). Locate
  CGameRules::GetChatPrefix in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_GetChatPrefix, CGameRules::GetChatPrefix
disable-model-invocation: true
---

# Find CGameRules_GetChatPrefix

Target: `CGameRules::GetChatPrefix` (vfunc) in the module loaded in THIS session.
...
Write `CGameRules_GetChatPrefix.{platform}.yaml` with EXACTLY these fields:
