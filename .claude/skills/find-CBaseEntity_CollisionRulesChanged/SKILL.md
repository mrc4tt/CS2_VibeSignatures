...
description: |
  ...
  CBaseEntity_CollisionRulesChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_CollisionRulesChanged, CBaseEntity_CollisionRulesChanged
disable-model-invocation: true
---

# Find CBaseEntity_CollisionRulesChanged

Target: `CBaseEntity_CollisionRulesChanged` (vfunc) in the module loaded in THIS session.
