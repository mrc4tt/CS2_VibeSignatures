...
description: |
  Agent fallback for CBaseEntity_CollisionRulesChanged (auto-generated, category: vfunc). Locate
  CBaseEntity::CollisionRulesChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_CollisionRulesChanged, CBaseEntity::CollisionRulesChanged
disable-model-invocation: true
---

# Find CBaseEntity_CollisionRulesChanged

Target: `CBaseEntity::CollisionRulesChanged` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_CollisionRulesChanged.{platform}.yaml` with EXACTLY these fields:
