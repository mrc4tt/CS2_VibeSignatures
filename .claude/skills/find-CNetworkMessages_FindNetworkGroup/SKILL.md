...
description: |
  Agent fallback for CNetworkMessages_FindNetworkGroup (auto-generated, category: func). Locate
  CNetworkMessages_FindNetworkGroup in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkMessages_FindNetworkGroup, CNetworkMessages_FindNetworkGroup
disable-model-invocation: true
---

# Find CNetworkMessages_FindNetworkGroup

Target: `CNetworkMessages_FindNetworkGroup` (func) in the module loaded in THIS session.
...
Write `CNetworkMessages_FindNetworkGroup.{platform}.yaml` with EXACTLY these fields:
