...
description: |
  ...
  CCSPlayerController_InitialSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_InitialSpawn, CCSPlayerController_InitialSpawn
disable-model-invocation: true
---

# Find CCSPlayerController_InitialSpawn

Target: `CCSPlayerController_InitialSpawn` (vfunc) in the module loaded in THIS session.
