---
name: find-CCSPlayerController_InitialSpawn
description: |
  Agent fallback for CCSPlayerController_InitialSpawn (auto-generated, category: vfunc). Locate
  CCSPlayerController::InitialSpawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_InitialSpawn, CCSPlayerController::InitialSpawn
disable-model-invocation: true
---

# Find CCSPlayerController_InitialSpawn

Target: `CCSPlayerController::InitialSpawn` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayerController_InitialSpawn.{platform}.yaml` with EXACTLY these fields:
