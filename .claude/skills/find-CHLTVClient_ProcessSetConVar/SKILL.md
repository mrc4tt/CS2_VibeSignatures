...
description: |
  ...
  CHLTVClient_ProcessSetConVar in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHLTVClient_ProcessSetConVar, CHLTVClient_ProcessSetConVar
disable-model-invocation: true
---

# Find CHLTVClient_ProcessSetConVar

Target: `CHLTVClient_ProcessSetConVar` (vfunc) in the module loaded in THIS session.
