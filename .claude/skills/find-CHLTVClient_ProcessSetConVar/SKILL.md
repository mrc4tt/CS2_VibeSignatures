...
description: |
  Agent fallback for CHLTVClient_ProcessSetConVar (auto-generated, category: vfunc). Locate
  CHLTVClient::ProcessSetConVar in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CHLTVClient_ProcessSetConVar, CHLTVClient::ProcessSetConVar
disable-model-invocation: true
---

# Find CHLTVClient_ProcessSetConVar

Target: `CHLTVClient::ProcessSetConVar` (vfunc) in the module loaded in THIS session.
...
Write `CHLTVClient_ProcessSetConVar.{platform}.yaml` with EXACTLY these fields:
