...
description: |
  ...
  IGameSystemFactory_SetGlobalPtr in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystemFactory_SetGlobalPtr, IGameSystemFactory_SetGlobalPtr
disable-model-invocation: true
---

# Find IGameSystemFactory_SetGlobalPtr

Target: `IGameSystemFactory_SetGlobalPtr` (vfunc) in the module loaded in THIS session.
