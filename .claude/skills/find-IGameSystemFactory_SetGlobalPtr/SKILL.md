...
description: |
  Agent fallback for IGameSystemFactory_SetGlobalPtr (auto-generated, category: vfunc). Locate
  IGameSystemFactory::SetGlobalPtr in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystemFactory_SetGlobalPtr, IGameSystemFactory::SetGlobalPtr
disable-model-invocation: true
---

# Find IGameSystemFactory_SetGlobalPtr

Target: `IGameSystemFactory::SetGlobalPtr` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystemFactory_SetGlobalPtr.{platform}.yaml` with EXACTLY these fields:
