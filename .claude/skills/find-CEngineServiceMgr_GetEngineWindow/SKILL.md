---
name: find-CEngineServiceMgr_GetEngineWindow
description: |
  Agent fallback for CEngineServiceMgr_GetEngineWindow (auto-generated, category: func). Locate
  CEngineServiceMgr_GetEngineWindow in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_GetEngineWindow, CEngineServiceMgr_GetEngineWindow
disable-model-invocation: true
---

# Find CEngineServiceMgr_GetEngineWindow

Target: `CEngineServiceMgr_GetEngineWindow` (func) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_GetEngineWindow.{platform}.yaml` with EXACTLY these fields:
