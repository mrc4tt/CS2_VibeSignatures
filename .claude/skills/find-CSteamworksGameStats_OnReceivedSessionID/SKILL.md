...
description: |
  ...
  CSteamworksGameStats_OnReceivedSessionID in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSteamworksGameStats_OnReceivedSessionID, CSteamworksGameStats_OnReceivedSessionID
disable-model-invocation: true
---

# Find CSteamworksGameStats_OnReceivedSessionID

Target: `CSteamworksGameStats_OnReceivedSessionID` (func) in the module loaded in THIS session.
