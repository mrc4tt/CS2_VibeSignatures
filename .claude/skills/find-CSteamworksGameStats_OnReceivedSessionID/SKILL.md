...
description: |
  Agent fallback for CSteamworksGameStats_OnReceivedSessionID (auto-generated, category: func). Locate
  CSteamworksGameStats::OnReceivedSessionID in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSteamworksGameStats_OnReceivedSessionID, CSteamworksGameStats::OnReceivedSessionID
disable-model-invocation: true
---

# Find CSteamworksGameStats_OnReceivedSessionID

Target: `CSteamworksGameStats::OnReceivedSessionID` (func) in the module loaded in THIS session.
...
Write `CSteamworksGameStats_OnReceivedSessionID.{platform}.yaml` with EXACTLY these fields:
