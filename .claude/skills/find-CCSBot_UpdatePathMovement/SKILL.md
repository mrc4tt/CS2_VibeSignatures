...
description: |
  ...
  CCSBot::UpdatePathMovement in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBot_UpdatePathMovement, CCSBot::UpdatePathMovement
disable-model-invocation: true
---

# Find CCSBot_UpdatePathMovement

Target: `CCSBot::UpdatePathMovement` (func) in the module loaded in THIS session.
...
Write `CCSBot_UpdatePathMovement.{platform}.yaml` with EXACTLY these fields:
