...
description: |
  ...
  CCSBot_UpdatePathMovement in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBot_UpdatePathMovement, CCSBot_UpdatePathMovement
disable-model-invocation: true
---

# Find CCSBot_UpdatePathMovement

Target: `CCSBot_UpdatePathMovement` (func) in the module loaded in THIS session.
