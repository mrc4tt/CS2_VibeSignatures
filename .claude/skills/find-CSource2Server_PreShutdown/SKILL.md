...
description: |
  ...
  CSource2Server_PreShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_PreShutdown, CSource2Server_PreShutdown
disable-model-invocation: true
---

# Find CSource2Server_PreShutdown

Target: `CSource2Server_PreShutdown` (vfunc) in the module loaded in THIS session.
