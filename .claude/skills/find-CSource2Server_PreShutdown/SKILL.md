...
description: |
  Agent fallback for CSource2Server_PreShutdown (auto-generated, category: vfunc). Locate
  CSource2Server::PreShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_PreShutdown, CSource2Server::PreShutdown
disable-model-invocation: true
---

# Find CSource2Server_PreShutdown

Target: `CSource2Server::PreShutdown` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_PreShutdown.{platform}.yaml` with EXACTLY these fields:
