...
description: |
  ...
  CEntitySystem_OnRemoveEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_OnRemoveEntity, CEntitySystem_OnRemoveEntity
disable-model-invocation: true
---

# Find CEntitySystem_OnRemoveEntity

Target: `CEntitySystem_OnRemoveEntity` (vfunc) in the module loaded in THIS session.
