...
description: |
  Agent fallback for CEntitySystem_OnRemoveEntity (auto-generated, category: vfunc). Locate
  CEntitySystem::OnRemoveEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_OnRemoveEntity, CEntitySystem::OnRemoveEntity
disable-model-invocation: true
---

# Find CEntitySystem_OnRemoveEntity

Target: `CEntitySystem::OnRemoveEntity` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_OnRemoveEntity.{platform}.yaml` with EXACTLY these fields:
