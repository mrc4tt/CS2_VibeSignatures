...
description: |
  Agent fallback for CEntity2SaveRestore_vtable (auto-generated, category: func). Locate
  CEntity2SaveRestore_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntity2SaveRestore_vtable, CEntity2SaveRestore_vtable
disable-model-invocation: true
---

# Find CEntity2SaveRestore_vtable

Target: `CEntity2SaveRestore_vtable` (func) in the module loaded in THIS session.
...
Write `CEntity2SaveRestore_vtable.{platform}.yaml` with EXACTLY these fields:
