...
description: |
  Agent fallback for CEngineServer_IsLogEnabled (auto-generated, category: func). Locate
  CEngineServer_IsLogEnabled in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_IsLogEnabled, CEngineServer_IsLogEnabled
disable-model-invocation: true
---

# Find CEngineServer_IsLogEnabled

Target: `CEngineServer_IsLogEnabled` (func) in the module loaded in THIS session.
...
Write `CEngineServer_IsLogEnabled.{platform}.yaml` with EXACTLY these fields:
