...
description: |
  ...
  CEntityInstance_ScriptEntityIO in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ScriptEntityIO, CEntityInstance_ScriptEntityIO
disable-model-invocation: true
---

# Find CEntityInstance_ScriptEntityIO

Target: `CEntityInstance_ScriptEntityIO` (vfunc) in the module loaded in THIS session.
