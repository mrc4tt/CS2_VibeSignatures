...
description: |
  Agent fallback for CEntityInstance_ScriptEntityIO (auto-generated, category: vfunc). Locate
  CEntityInstance::ScriptEntityIO in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_ScriptEntityIO, CEntityInstance::ScriptEntityIO
disable-model-invocation: true
---

# Find CEntityInstance_ScriptEntityIO

Target: `CEntityInstance::ScriptEntityIO` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_ScriptEntityIO.{platform}.yaml` with EXACTLY these fields:
