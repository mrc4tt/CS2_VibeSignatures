...
description: |
  Agent fallback for CSource2Server_Shutdown-decompiles (auto-generated, category: vfunc). Locate
  CSource2Server::Shutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Shutdown-decompiles, CSource2Server::Shutdown
disable-model-invocation: true
---

# Find CSource2Server_Shutdown-decompiles

Target: `CSource2Server::Shutdown` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_Shutdown.{platform}.yaml` with EXACTLY these fields:
