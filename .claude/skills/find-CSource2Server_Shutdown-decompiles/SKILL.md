...
description: |
  ...
  CSource2Server_Shutdown-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_Shutdown-decompiles, CSource2Server_Shutdown-decompiles
disable-model-invocation: true
---

# Find CSource2Server_Shutdown-decompiles

Target: `CSource2Server_Shutdown-decompiles` (vfunc) in the module loaded in THIS session.
