...
description: |
  ...
  ILoopMode_LoopShutdown in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_LoopShutdown, ILoopMode_LoopShutdown
disable-model-invocation: true
---

# Find ILoopMode_LoopShutdown

Target: `ILoopMode_LoopShutdown` (vfunc) in the module loaded in THIS session.
