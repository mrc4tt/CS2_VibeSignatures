...
description: |
  Agent fallback for ILoopMode_LoopShutdown (auto-generated, category: vfunc). Locate
  ILoopMode::LoopShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_LoopShutdown, ILoopMode::LoopShutdown
disable-model-invocation: true
---

# Find ILoopMode_LoopShutdown

Target: `ILoopMode::LoopShutdown` (vfunc) in the module loaded in THIS session.
...
Write `ILoopMode_LoopShutdown.{platform}.yaml` with EXACTLY these fields:
