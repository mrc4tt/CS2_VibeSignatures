...
description: |
  Agent fallback for CGameClientConnectPrerequisite_ctor (auto-generated, category: func). Locate
  CGameClientConnectPrerequisite::CGameClientConnectPrerequisite in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameClientConnectPrerequisite_ctor, CGameClientConnectPrerequisite::CGameClientConnectPrerequisite
disable-model-invocation: true
---

# Find CGameClientConnectPrerequisite_ctor

Target: `CGameClientConnectPrerequisite::CGameClientConnectPrerequisite` (func) in the module loaded in THIS session.
...
Write `CGameClientConnectPrerequisite_ctor.{platform}.yaml` with EXACTLY these fields:
