...
description: |
  ...
  CGameClientConnectPrerequisite_ctor in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameClientConnectPrerequisite_ctor, CGameClientConnectPrerequisite_ctor
disable-model-invocation: true
---

# Find CGameClientConnectPrerequisite_ctor

Target: `CGameClientConnectPrerequisite_ctor` (func) in the module loaded in THIS session.
