---
name: find-CCSPointScript_OnCustomHudClicked
description: |
  Locate CCSPointScript_OnCustomHudClicked in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "CCSPointScript_OnCustomHudClicked" (symbol CCSPointScript_OnCustomHudClicked). The gamedata consumer stores a BYTE SIGNATURE for this entry - ALWAYS emit the func
  ...
  Trigger: CCSPointScript_OnCustomHudClicked, CCSPointScript_OnCustomHudClicked
disable-model-invocation: true
---

# Find CCSPointScript_OnCustomHudClicked

Target: `CCSPointScript_OnCustomHudClicked` (func) in the CS2 server module.
