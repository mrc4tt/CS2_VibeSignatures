...
description: |
  ...
  CBaseEntity_ctor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_ctor, CBaseEntity_ctor
disable-model-invocation: true
---

# Find CBaseEntity_ctor

Target: `CBaseEntity_ctor` (func) in the module loaded in THIS session.
