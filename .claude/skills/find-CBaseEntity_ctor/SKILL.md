...
description: |
  ...
  CBaseEntity::CBaseEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_ctor, CBaseEntity::CBaseEntity
disable-model-invocation: true
---

# Find CBaseEntity_ctor

Target: `CBaseEntity::CBaseEntity` (func) in the module loaded in THIS session.
...
Write `CBaseEntity_ctor.{platform}.yaml` with EXACTLY these fields:
