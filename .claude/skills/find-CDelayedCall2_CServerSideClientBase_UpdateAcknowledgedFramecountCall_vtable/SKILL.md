...
description: |
  Agent fallback for CDelayedCall2_CServerSideClientBase_UpdateAcknowledgedFramecountCall_vtable (auto-generated, category: func). Locate
  CDelayedCall2_CServerSideClientBase_UpdateAcknowledgedFramecountCall_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDelayedCall2_CServerSideClientBase_UpdateAcknowledgedFramecountCall_vtable, CDelayedCall2_CServerSideClientBase_UpdateAcknowledgedFramecountCall_vtable
disable-model-invocation: true
---

# Find CDelayedCall2_CServerSideClientBase_UpdateAcknowledgedFramecountCall_vtable

Target: `CDelayedCall2_CServerSideClientBase_UpdateAcknowledgedFramecountCall_vtable` (func) in the module loaded in THIS session.
...
Write `CDelayedCall2_CServerSideClientBase_UpdateAcknowledgedFramecountCall_vtable.{platform}.yaml` with EXACTLY these fields:
