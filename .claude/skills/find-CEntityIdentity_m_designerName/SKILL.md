---
name: find-CEntityIdentity_m_designerName
description: |
...
# Find CEntityIdentity_m_designerName

Target: `CEntityIdentity::m_designerName` (structmember) in the CS2 server module.
