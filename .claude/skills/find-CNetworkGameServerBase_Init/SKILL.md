...
description: |
  Agent fallback for CNetworkGameServerBase_Init (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_Init, CNetworkGameServerBase::Init
disable-model-invocation: true
---

# Find CNetworkGameServerBase_Init

Target: `CNetworkGameServerBase::Init` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_Init.{platform}.yaml` with EXACTLY these fields:
