...
description: |
  ...
  CNetworkGameServerBase_Init in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_Init, CNetworkGameServerBase_Init
disable-model-invocation: true
---

# Find CNetworkGameServerBase_Init

Target: `CNetworkGameServerBase_Init` (vfunc) in the module loaded in THIS session.
