...
description: |
  ...
  CEntitySystem_ExecuteQueuedDeletion in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ExecuteQueuedDeletion, CEntitySystem_ExecuteQueuedDeletion
disable-model-invocation: true
---

# Find CEntitySystem_ExecuteQueuedDeletion

Target: `CEntitySystem_ExecuteQueuedDeletion` (func) in the module loaded in THIS session.
