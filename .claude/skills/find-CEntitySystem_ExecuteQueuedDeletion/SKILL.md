...
description: |
  Agent fallback for CEntitySystem_ExecuteQueuedDeletion (auto-generated, category: func). Locate
  CEntitySystem::ExecuteQueuedDeletion in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ExecuteQueuedDeletion, CEntitySystem::ExecuteQueuedDeletion
disable-model-invocation: true
---

# Find CEntitySystem_ExecuteQueuedDeletion

Target: `CEntitySystem::ExecuteQueuedDeletion` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_ExecuteQueuedDeletion.{platform}.yaml` with EXACTLY these fields:
