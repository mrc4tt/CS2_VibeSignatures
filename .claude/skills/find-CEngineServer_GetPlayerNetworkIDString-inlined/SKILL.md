...
description: |
  ...
  CEngineServer_GetPlayerNetworkIDString-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetPlayerNetworkIDString-inlined, CEngineServer_GetPlayerNetworkIDString-inlined
disable-model-invocation: true
---

# Find CEngineServer_GetPlayerNetworkIDString-inlined

Target: `CEngineServer_GetPlayerNetworkIDString-inlined` (func) in the module loaded in THIS session.
