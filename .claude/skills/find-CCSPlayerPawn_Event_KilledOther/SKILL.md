...
description: |
  ...
  CCSPlayerPawn_Event_KilledOther in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_Event_KilledOther, CCSPlayerPawn_Event_KilledOther
disable-model-invocation: true
---

# Find CCSPlayerPawn_Event_KilledOther

Target: `CCSPlayerPawn_Event_KilledOther` (vfunc) in the module loaded in THIS session.
