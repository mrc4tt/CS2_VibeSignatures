---
name: find-CCSPlayerPawn_Event_KilledOther
description: |
  Agent fallback for CCSPlayerPawn_Event_KilledOther (auto-generated, category: vfunc). Locate
  CCSPlayerPawn::Event_KilledOther in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_Event_KilledOther, CCSPlayerPawn::Event_KilledOther
disable-model-invocation: true
---

# Find CCSPlayerPawn_Event_KilledOther

Target: `CCSPlayerPawn::Event_KilledOther` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_Event_KilledOther.{platform}.yaml` with EXACTLY these fields:
