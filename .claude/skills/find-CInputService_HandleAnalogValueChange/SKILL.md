---
name: find-CInputService_HandleAnalogValueChange
description: |
  Agent fallback for CInputService_HandleAnalogValueChange (auto-generated, category: func). Locate
  CInputService_HandleAnalogValueChange in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_HandleAnalogValueChange, CInputService_HandleAnalogValueChange
disable-model-invocation: true
---

# Find CInputService_HandleAnalogValueChange

Target: `CInputService_HandleAnalogValueChange` (func) in the module loaded in THIS session.
...
Write `CInputService_HandleAnalogValueChange.{platform}.yaml` with EXACTLY these fields:
