...
description: |
  Agent fallback for CNetworkGameClient_ProcessPacketEntities-windows (auto-generated, category: func). Locate
  CNetworkGameClient::ProcessPacketEntities in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessPacketEntities-windows, CNetworkGameClient::ProcessPacketEntities
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessPacketEntities-windows

Target: `CNetworkGameClient::ProcessPacketEntities` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClient_ProcessPacketEntities.{platform}.yaml` with EXACTLY these fields:
