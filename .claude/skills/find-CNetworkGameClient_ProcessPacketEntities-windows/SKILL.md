...
description: |
  ...
  CNetworkGameClient_ProcessPacketEntities-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessPacketEntities-windows, CNetworkGameClient_ProcessPacketEntities-windows
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessPacketEntities-windows

Target: `CNetworkGameClient_ProcessPacketEntities-windows` (func) in the module loaded in THIS session.
