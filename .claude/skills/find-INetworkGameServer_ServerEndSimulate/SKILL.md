...
description: |
  Agent fallback for INetworkGameServer_ServerEndSimulate (auto-generated, category: vfunc). Locate
  INetworkGameServer::ServerEndSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_ServerEndSimulate, INetworkGameServer::ServerEndSimulate
disable-model-invocation: true
---

# Find INetworkGameServer_ServerEndSimulate

Target: `INetworkGameServer::ServerEndSimulate` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_ServerEndSimulate.{platform}.yaml` with EXACTLY these fields:
