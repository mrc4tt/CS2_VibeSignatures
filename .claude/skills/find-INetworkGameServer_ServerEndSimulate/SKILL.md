...
description: |
  ...
  INetworkGameServer_ServerEndSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_ServerEndSimulate, INetworkGameServer_ServerEndSimulate
disable-model-invocation: true
---

# Find INetworkGameServer_ServerEndSimulate

Target: `INetworkGameServer_ServerEndSimulate` (vfunc) in the module loaded in THIS session.
