---
name: find-CBaseEntity_EmitSoundFilter_SoundName
description: |
  Locate CBaseEntity_EmitSoundFilter_SoundName in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "CBaseEntity_EmitSoundFilter_SoundName" (symbol CBaseEntity_EmitSoundFilter_SoundName). The gamedata consumer stores a BYTE SIGNATURE for this entry - ALWAYS emit the func
  ...
  Trigger: CBaseEntity_EmitSoundFilter_SoundName, CBaseEntity_EmitSoundFilter_SoundName
disable-model-invocation: true
---

# Find CBaseEntity_EmitSoundFilter_SoundName

Target: `CBaseEntity_EmitSoundFilter_SoundName` (func) in the CS2 server module.
