---
name: find-CGameRules_SetGamePaused
description: |
  Agent fallback for CGameRules_SetGamePaused (auto-generated, category: vfunc). Locate
  CGameRules::SetGamePaused in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_SetGamePaused, CGameRules::SetGamePaused
disable-model-invocation: true
---

# Find CGameRules_SetGamePaused

Target: `CGameRules::SetGamePaused` (vfunc) in the module loaded in THIS session.
...
Write `CGameRules_SetGamePaused.{platform}.yaml` with EXACTLY these fields:
