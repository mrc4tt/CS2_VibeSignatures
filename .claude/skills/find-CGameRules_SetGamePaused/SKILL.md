...
description: |
  ...
  CGameRules_SetGamePaused in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRules_SetGamePaused, CGameRules_SetGamePaused
disable-model-invocation: true
---

# Find CGameRules_SetGamePaused

Target: `CGameRules_SetGamePaused` (vfunc) in the module loaded in THIS session.
