...
description: |
  Agent fallback for CServerSideClientBase_vtable (auto-generated, category: func). Locate
  CServerSideClientBase_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_vtable, CServerSideClientBase_vtable
disable-model-invocation: true
---

# Find CServerSideClientBase_vtable

Target: `CServerSideClientBase_vtable` (func) in the module loaded in THIS session.
...
Write `CServerSideClientBase_vtable.{platform}.yaml` with EXACTLY these fields:
