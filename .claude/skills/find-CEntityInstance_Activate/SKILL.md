...
description: |
  ...
  CEntityInstance_Activate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Activate, CEntityInstance_Activate
disable-model-invocation: true
---

# Find CEntityInstance_Activate

Target: `CEntityInstance_Activate` (vfunc) in the module loaded in THIS session.
