...
description: |
  Agent fallback for CEntityInstance_Activate (auto-generated, category: vfunc). Locate
  CEntityInstance::Activate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_Activate, CEntityInstance::Activate
disable-model-invocation: true
---

# Find CEntityInstance_Activate

Target: `CEntityInstance::Activate` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_Activate.{platform}.yaml` with EXACTLY these fields:
