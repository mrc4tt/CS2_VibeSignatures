...
description: |
  Agent fallback for CNetworkGameClient_ProcessReadPacketEntitiesWorkItems (auto-generated, category: vfunc). Locate
  CNetworkGameClient::ProcessReadPacketEntitiesWorkItems in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessReadPacketEntitiesWorkItems, CNetworkGameClient::ProcessReadPacketEntitiesWorkItems
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessReadPacketEntitiesWorkItems

Target: `CNetworkGameClient::ProcessReadPacketEntitiesWorkItems` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_ProcessReadPacketEntitiesWorkItems.{platform}.yaml` with EXACTLY these fields:
