...
description: |
  ...
  CNetworkGameClient_ProcessReadPacketEntitiesWorkItems in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_ProcessReadPacketEntitiesWorkItems, CNetworkGameClient_ProcessReadPacketEntitiesWorkItems
disable-model-invocation: true
---

# Find CNetworkGameClient_ProcessReadPacketEntitiesWorkItems

Target: `CNetworkGameClient_ProcessReadPacketEntitiesWorkItems` (vfunc) in the module loaded in THIS session.
