...
description: |
  Agent fallback for CEntitySystem_FindComponentTypeByName (auto-generated, category: func). Locate
  CEntitySystem::FindComponentTypeByName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_FindComponentTypeByName, CEntitySystem::FindComponentTypeByName
disable-model-invocation: true
---

# Find CEntitySystem_FindComponentTypeByName

Target: `CEntitySystem::FindComponentTypeByName` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_FindComponentTypeByName.{platform}.yaml` with EXACTLY these fields:
