...
description: |
  ...
  CEntitySystem_FindComponentTypeByName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_FindComponentTypeByName, CEntitySystem_FindComponentTypeByName
disable-model-invocation: true
---

# Find CEntitySystem_FindComponentTypeByName

Target: `CEntitySystem_FindComponentTypeByName` (func) in the module loaded in THIS session.
