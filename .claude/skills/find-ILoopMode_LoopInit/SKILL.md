...
description: |
  ...
  ILoopMode_LoopInit in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_LoopInit, ILoopMode_LoopInit
disable-model-invocation: true
---

# Find ILoopMode_LoopInit

Target: `ILoopMode_LoopInit` (vfunc) in the module loaded in THIS session.
