...
description: |
  Agent fallback for CGameResourceService_AllocGameResourceManifest (auto-generated, category: vfunc). Locate
...
Target: `CGameResourceService_AllocGameResourceManifest` (vfunc) in the module loaded in THIS session.
