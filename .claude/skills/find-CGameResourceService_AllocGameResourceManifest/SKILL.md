...
description: |
  Agent fallback for CGameResourceService_AllocGameResourceManifest (auto-generated, category: func). Locate
  CGameResourceService_AllocGameResourceManifest in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_AllocGameResourceManifest, CGameResourceService_AllocGameResourceManifest
disable-model-invocation: true
---

# Find CGameResourceService_AllocGameResourceManifest

Target: `CGameResourceService_AllocGameResourceManifest` (func) in the module loaded in THIS session.
...
Write `CGameResourceService_AllocGameResourceManifest.{platform}.yaml` with EXACTLY these fields:
