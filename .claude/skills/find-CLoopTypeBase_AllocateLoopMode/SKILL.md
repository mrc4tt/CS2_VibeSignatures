...
description: |
  ...
  CLoopTypeBase_AllocateLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_AllocateLoopMode, CLoopTypeBase_AllocateLoopMode
disable-model-invocation: true
---

# Find CLoopTypeBase_AllocateLoopMode

Target: `CLoopTypeBase_AllocateLoopMode` (vfunc) in the module loaded in THIS session.
