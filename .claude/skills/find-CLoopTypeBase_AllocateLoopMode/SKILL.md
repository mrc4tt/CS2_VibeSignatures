...
description: |
  Agent fallback for CLoopTypeBase_AllocateLoopMode (auto-generated, category: vfunc). Locate
  CLoopTypeBase::AllocateLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_AllocateLoopMode, CLoopTypeBase::AllocateLoopMode
disable-model-invocation: true
---

# Find CLoopTypeBase_AllocateLoopMode

Target: `CLoopTypeBase::AllocateLoopMode` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeBase_AllocateLoopMode.{platform}.yaml` with EXACTLY these fields:
