...
description: |
  ...
  SC_DumpWorld_CommandHandler-decompiles in the CS2 scenesystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SC_DumpWorld_CommandHandler-decompiles, SC_DumpWorld_CommandHandler-decompiles
disable-model-invocation: true
---

# Find SC_DumpWorld_CommandHandler-decompiles

Target: `SC_DumpWorld_CommandHandler-decompiles` (func) in the module loaded in THIS session.
