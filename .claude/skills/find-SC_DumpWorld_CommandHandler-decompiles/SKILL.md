...
description: |
  Agent fallback for SC_DumpWorld_CommandHandler-decompiles (auto-generated, category: func). Locate
  SC_DumpWorld_CommandHandler in the CS2 scenesystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SC_DumpWorld_CommandHandler-decompiles, SC_DumpWorld_CommandHandler
disable-model-invocation: true
---

# Find SC_DumpWorld_CommandHandler-decompiles

Target: `SC_DumpWorld_CommandHandler` (func) in the module loaded in THIS session.
...
Write `SC_DumpWorld_CommandHandler.{platform}.yaml` with EXACTLY these fields:
