...
description: |
  Agent fallback for CNetworkGameClientBase_DisconnectGame (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::DisconnectGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_DisconnectGame, CNetworkGameClientBase::DisconnectGame
disable-model-invocation: true
---

# Find CNetworkGameClientBase_DisconnectGame

Target: `CNetworkGameClientBase::DisconnectGame` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_DisconnectGame.{platform}.yaml` with EXACTLY these fields:
