...
description: |
  ...
  CNetworkGameClientBase_DisconnectGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_DisconnectGame, CNetworkGameClientBase_DisconnectGame
disable-model-invocation: true
---

# Find CNetworkGameClientBase_DisconnectGame

Target: `CNetworkGameClientBase_DisconnectGame` (vfunc) in the module loaded in THIS session.
