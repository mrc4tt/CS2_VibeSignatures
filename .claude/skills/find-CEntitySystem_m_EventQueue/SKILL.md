...
description: |
  Agent fallback for CEntitySystem_m_EventQueue (auto-generated, category: structmember). Locate
  CEntitySystem::m_EventQueue in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_EventQueue, CEntitySystem::m_EventQueue
disable-model-invocation: true
---

# Find CEntitySystem_m_EventQueue

Target: `CEntitySystem::m_EventQueue` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_EventQueue.{platform}.yaml` with EXACTLY these fields:
