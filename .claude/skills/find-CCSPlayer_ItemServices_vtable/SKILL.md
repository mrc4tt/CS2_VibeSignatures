...
description: |
  ...
  CCSPlayer_ItemServices_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_ItemServices_vtable, CCSPlayer_ItemServices_vtable
disable-model-invocation: true
---

# Find CCSPlayer_ItemServices_vtable

Target: `CCSPlayer_ItemServices_vtable` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_ItemServices_vtable.{platform}.yaml` with EXACTLY these fields:
