...
description: |
  ...
  C_ServerVoiceHandler::OnServerVoiceData in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_ServerVoiceHandler_OnServerVoiceData-decompiles, C_ServerVoiceHandler::OnServerVoiceData
disable-model-invocation: true
---

# Find C_ServerVoiceHandler_OnServerVoiceData-decompiles

Target: `C_ServerVoiceHandler::OnServerVoiceData` (func) in the module loaded in THIS session.
...
Write `C_ServerVoiceHandler_OnServerVoiceData.{platform}.yaml` with EXACTLY these fields:
