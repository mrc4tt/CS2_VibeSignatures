...
description: |
  ...
  C_ServerVoiceHandler_OnServerVoiceData-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: C_ServerVoiceHandler_OnServerVoiceData-decompiles, C_ServerVoiceHandler_OnServerVoiceData-decompiles
disable-model-invocation: true
---

# Find C_ServerVoiceHandler_OnServerVoiceData-decompiles

Target: `C_ServerVoiceHandler_OnServerVoiceData-decompiles` (func) in the module loaded in THIS session.
