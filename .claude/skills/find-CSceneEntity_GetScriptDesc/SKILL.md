...
description: |
  ...
  CSceneEntity_GetScriptDesc in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSceneEntity_GetScriptDesc, CSceneEntity_GetScriptDesc
disable-model-invocation: true
---

# Find CSceneEntity_GetScriptDesc

Target: `CSceneEntity_GetScriptDesc` (vfunc) in the module loaded in THIS session.
