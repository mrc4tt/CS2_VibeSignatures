...
description: |
  Agent fallback for CSceneEntity_GetScriptDesc (auto-generated, category: vfunc). Locate
  CSceneEntity::GetScriptDesc in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSceneEntity_GetScriptDesc, CSceneEntity::GetScriptDesc
disable-model-invocation: true
---

# Find CSceneEntity_GetScriptDesc

Target: `CSceneEntity::GetScriptDesc` (vfunc) in the module loaded in THIS session.
...
Write `CSceneEntity_GetScriptDesc.{platform}.yaml` with EXACTLY these fields:
