...
description: |
  ...
  CDemoRecorder_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoRecorder_vtable, CDemoRecorder_vtable
disable-model-invocation: true
---

# Find CDemoRecorder_vtable

Target: `CDemoRecorder_vtable` (func) in the module loaded in THIS session.
...
Write `CDemoRecorder_vtable.{platform}.yaml` with EXACTLY these fields:
