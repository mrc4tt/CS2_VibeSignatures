...
description: |
  ...
  TraceAttack-windows in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: TraceAttack-windows, TraceAttack-windows
disable-model-invocation: true
---

# Find TraceAttack-windows

Target: `TraceAttack-windows` (func) in the module loaded in THIS session.
