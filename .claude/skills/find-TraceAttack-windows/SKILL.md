...
description: |
  Agent fallback for TraceAttack-windows (auto-generated, category: func). Locate
  TraceAttack in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: TraceAttack-windows, TraceAttack
disable-model-invocation: true
---

# Find TraceAttack-windows

Target: `TraceAttack` (func) in the module loaded in THIS session.
...
Write `TraceAttack.{platform}.yaml` with EXACTLY these fields:
