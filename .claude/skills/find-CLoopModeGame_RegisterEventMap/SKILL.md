...
description: |
  Agent fallback for CLoopModeGame_RegisterEventMap (auto-generated, category: vfunc). Locate
  CLoopModeGame::RegisterEventMap in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_RegisterEventMap, CLoopModeGame::RegisterEventMap
disable-model-invocation: true
---

# Find CLoopModeGame_RegisterEventMap

Target: `CLoopModeGame::RegisterEventMap` (vfunc) in the module loaded in THIS session.
...
Write `CLoopModeGame_RegisterEventMap.{platform}.yaml` with EXACTLY these fields:
