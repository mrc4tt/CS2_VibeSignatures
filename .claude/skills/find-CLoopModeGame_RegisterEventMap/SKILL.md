...
description: |
  ...
  CLoopModeGame_RegisterEventMap in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_RegisterEventMap, CLoopModeGame_RegisterEventMap
disable-model-invocation: true
---

# Find CLoopModeGame_RegisterEventMap

Target: `CLoopModeGame_RegisterEventMap` (vfunc) in the module loaded in THIS session.
