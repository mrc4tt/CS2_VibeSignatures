...
description: |
  ...
  CSource2Server_UpdateWhenNotInGame in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_UpdateWhenNotInGame, CSource2Server_UpdateWhenNotInGame
disable-model-invocation: true
---

# Find CSource2Server_UpdateWhenNotInGame

Target: `CSource2Server_UpdateWhenNotInGame` (vfunc) in the module loaded in THIS session.
