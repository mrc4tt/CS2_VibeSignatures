...
description: |
  Agent fallback for CSource2Server_UpdateWhenNotInGame (auto-generated, category: vfunc). Locate
  CSource2Server::UpdateWhenNotInGame in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_UpdateWhenNotInGame, CSource2Server::UpdateWhenNotInGame
disable-model-invocation: true
---

# Find CSource2Server_UpdateWhenNotInGame

Target: `CSource2Server::UpdateWhenNotInGame` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_UpdateWhenNotInGame.{platform}.yaml` with EXACTLY these fields:
