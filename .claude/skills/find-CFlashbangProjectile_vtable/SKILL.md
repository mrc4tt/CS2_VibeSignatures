...
description: |
  Agent fallback for CFlashbangProjectile_vtable (auto-generated, category: func). Locate
  CFlashbangProjectile_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlashbangProjectile_vtable, CFlashbangProjectile_vtable
disable-model-invocation: true
---

# Find CFlashbangProjectile_vtable

Target: `CFlashbangProjectile_vtable` (func) in the module loaded in THIS session.
...
Write `CFlashbangProjectile_vtable.{platform}.yaml` with EXACTLY these fields:
