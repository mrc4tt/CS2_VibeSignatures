---
name: find-CServerSideClient_m_UserIDString
description: |
  Locate CServerSideClient::m_UserIDString in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "CServerSideClient::m_UserIDString" (symbol CServerSideClient_m_UserIDString). This is a STRUCT MEMBER OFFSET (schema netvar), not a function. Resolve the
  ...
  Trigger: CServerSideClient_m_UserIDString, CServerSideClient::m_UserIDString
disable-model-invocation: true
---

# Find CServerSideClient_m_UserIDString

Target: `CServerSideClient::m_UserIDString` (structmember) in the CS2 server module.
