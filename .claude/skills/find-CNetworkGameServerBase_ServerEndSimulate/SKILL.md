...
description: |
  ...
  CNetworkGameServerBase_ServerEndSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerEndSimulate, CNetworkGameServerBase_ServerEndSimulate
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerEndSimulate

Target: `CNetworkGameServerBase_ServerEndSimulate` (vfunc) in the module loaded in THIS session.
