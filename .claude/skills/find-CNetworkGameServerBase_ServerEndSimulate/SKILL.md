...
description: |
  Agent fallback for CNetworkGameServerBase_ServerEndSimulate (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::ServerEndSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerEndSimulate, CNetworkGameServerBase::ServerEndSimulate
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerEndSimulate

Target: `CNetworkGameServerBase::ServerEndSimulate` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_ServerEndSimulate.{platform}.yaml` with EXACTLY these fields:
