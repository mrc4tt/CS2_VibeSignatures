---
name: find-INetworkGameServer_SetGameSpawnGroupMgr
description: |
  Agent fallback for INetworkGameServer_SetGameSpawnGroupMgr (auto-generated, category: func). Locate
  INetworkGameServer_SetGameSpawnGroupMgr in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_SetGameSpawnGroupMgr, INetworkGameServer_SetGameSpawnGroupMgr
disable-model-invocation: true
---

# Find INetworkGameServer_SetGameSpawnGroupMgr

Target: `INetworkGameServer_SetGameSpawnGroupMgr` (func) in the module loaded in THIS session.
...
Write `INetworkGameServer_SetGameSpawnGroupMgr.{platform}.yaml` with EXACTLY these fields:
