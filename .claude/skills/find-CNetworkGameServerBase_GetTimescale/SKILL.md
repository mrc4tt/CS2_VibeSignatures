---
name: find-CNetworkGameServerBase_GetTimescale
description: |
  Agent fallback for CNetworkGameServerBase_GetTimescale (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::GetTimescale in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetTimescale, CNetworkGameServerBase::GetTimescale
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetTimescale

Target: `CNetworkGameServerBase::GetTimescale` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_GetTimescale.{platform}.yaml` with EXACTLY these fields:
