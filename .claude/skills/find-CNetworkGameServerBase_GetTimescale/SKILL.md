...
description: |
  ...
  CNetworkGameServerBase_GetTimescale in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_GetTimescale, CNetworkGameServerBase_GetTimescale
disable-model-invocation: true
---

# Find CNetworkGameServerBase_GetTimescale

Target: `CNetworkGameServerBase_GetTimescale` (vfunc) in the module loaded in THIS session.
