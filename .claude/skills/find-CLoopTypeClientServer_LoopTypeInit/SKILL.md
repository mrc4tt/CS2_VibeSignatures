...
description: |
  ...
  CLoopTypeClientServer_LoopTypeInit in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_LoopTypeInit, CLoopTypeClientServer_LoopTypeInit
disable-model-invocation: true
---

# Find CLoopTypeClientServer_LoopTypeInit

Target: `CLoopTypeClientServer_LoopTypeInit` (vfunc) in the module loaded in THIS session.
