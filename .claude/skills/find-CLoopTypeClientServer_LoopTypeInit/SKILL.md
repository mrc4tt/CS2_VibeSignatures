...
description: |
  Agent fallback for CLoopTypeClientServer_LoopTypeInit (auto-generated, category: vfunc). Locate
  CLoopTypeClientServer::LoopTypeInit in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_LoopTypeInit, CLoopTypeClientServer::LoopTypeInit
disable-model-invocation: true
---

# Find CLoopTypeClientServer_LoopTypeInit

Target: `CLoopTypeClientServer::LoopTypeInit` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_LoopTypeInit.{platform}.yaml` with EXACTLY these fields:
