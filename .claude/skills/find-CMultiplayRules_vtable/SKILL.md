...
description: |
  Agent fallback for CMultiplayRules_vtable (auto-generated, category: func). Locate
  CMultiplayRules_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CMultiplayRules_vtable, CMultiplayRules_vtable
disable-model-invocation: true
---

# Find CMultiplayRules_vtable

Target: `CMultiplayRules_vtable` (func) in the module loaded in THIS session.
...
Write `CMultiplayRules_vtable.{platform}.yaml` with EXACTLY these fields:
