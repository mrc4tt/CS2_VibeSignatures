...
description: |
  ...
  CSource2Client_ProcessGameInput in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_ProcessGameInput, CSource2Client_ProcessGameInput
disable-model-invocation: true
---

# Find CSource2Client_ProcessGameInput

Target: `CSource2Client_ProcessGameInput` (vfunc) in the module loaded in THIS session.
