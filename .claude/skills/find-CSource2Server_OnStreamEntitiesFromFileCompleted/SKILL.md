...
description: |
  ...
  CSource2Server_OnStreamEntitiesFromFileCompleted in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_OnStreamEntitiesFromFileCompleted, CSource2Server_OnStreamEntitiesFromFileCompleted
disable-model-invocation: true
---

# Find CSource2Server_OnStreamEntitiesFromFileCompleted

Target: `CSource2Server_OnStreamEntitiesFromFileCompleted` (vfunc) in the module loaded in THIS session.
