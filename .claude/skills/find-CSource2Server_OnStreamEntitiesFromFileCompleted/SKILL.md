...
description: |
  Agent fallback for CSource2Server_OnStreamEntitiesFromFileCompleted (auto-generated, category: vfunc). Locate
  CSource2Server::OnStreamEntitiesFromFileCompleted in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_OnStreamEntitiesFromFileCompleted, CSource2Server::OnStreamEntitiesFromFileCompleted
disable-model-invocation: true
---

# Find CSource2Server_OnStreamEntitiesFromFileCompleted

Target: `CSource2Server::OnStreamEntitiesFromFileCompleted` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_OnStreamEntitiesFromFileCompleted.{platform}.yaml` with EXACTLY these fields:
