...
description: |
  ...
  CEngineServer_UnloadSpawnGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_UnloadSpawnGroup, CEngineServer_UnloadSpawnGroup
disable-model-invocation: true
---

# Find CEngineServer_UnloadSpawnGroup

Target: `CEngineServer_UnloadSpawnGroup` (vfunc) in the module loaded in THIS session.
