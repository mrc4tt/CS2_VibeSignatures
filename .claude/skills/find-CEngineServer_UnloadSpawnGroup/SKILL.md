...
description: |
  Agent fallback for CEngineServer_UnloadSpawnGroup (auto-generated, category: vfunc). Locate
  CEngineServer::UnloadSpawnGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_UnloadSpawnGroup, CEngineServer::UnloadSpawnGroup
disable-model-invocation: true
---

# Find CEngineServer_UnloadSpawnGroup

Target: `CEngineServer::UnloadSpawnGroup` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_UnloadSpawnGroup.{platform}.yaml` with EXACTLY these fields:
