...
description: |
  ...
  CEngineServer_CreateFakeClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_CreateFakeClient, CEngineServer_CreateFakeClient
disable-model-invocation: true
---

# Find CEngineServer_CreateFakeClient

Target: `CEngineServer_CreateFakeClient` (vfunc) in the module loaded in THIS session.
