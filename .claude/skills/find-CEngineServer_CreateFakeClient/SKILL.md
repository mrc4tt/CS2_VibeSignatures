...
description: |
  Agent fallback for CEngineServer_CreateFakeClient (auto-generated, category: vfunc). Locate
  CEngineServer::CreateFakeClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_CreateFakeClient, CEngineServer::CreateFakeClient
disable-model-invocation: true
---

# Find CEngineServer_CreateFakeClient

Target: `CEngineServer::CreateFakeClient` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_CreateFakeClient.{platform}.yaml` with EXACTLY these fields:
