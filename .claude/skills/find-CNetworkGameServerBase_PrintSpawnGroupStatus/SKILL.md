...
description: |
  ...
  CNetworkGameServerBase_PrintSpawnGroupStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_PrintSpawnGroupStatus, CNetworkGameServerBase_PrintSpawnGroupStatus
disable-model-invocation: true
---

# Find CNetworkGameServerBase_PrintSpawnGroupStatus

Target: `CNetworkGameServerBase_PrintSpawnGroupStatus` (vfunc) in the module loaded in THIS session.
