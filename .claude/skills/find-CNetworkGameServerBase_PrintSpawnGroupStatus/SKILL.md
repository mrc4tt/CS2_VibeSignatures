...
description: |
  Agent fallback for CNetworkGameServerBase_PrintSpawnGroupStatus (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::PrintSpawnGroupStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_PrintSpawnGroupStatus, CNetworkGameServerBase::PrintSpawnGroupStatus
disable-model-invocation: true
---

# Find CNetworkGameServerBase_PrintSpawnGroupStatus

Target: `CNetworkGameServerBase::PrintSpawnGroupStatus` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_PrintSpawnGroupStatus.{platform}.yaml` with EXACTLY these fields:
