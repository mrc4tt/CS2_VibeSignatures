...
description: |
  ...
  CCSPlayerPawn_ProcessSuicideAsKillReward in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_ProcessSuicideAsKillReward, CCSPlayerPawn_ProcessSuicideAsKillReward
disable-model-invocation: true
---

# Find CCSPlayerPawn_ProcessSuicideAsKillReward

Target: `CCSPlayerPawn_ProcessSuicideAsKillReward` (func) in the module loaded in THIS session.
