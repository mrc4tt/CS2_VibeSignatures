...
description: |
  ...
  Trigger: CCSPlayerPawn_ProcessSuicideAsKillReward, CCSPlayerPawn::ProcessSuicideAsKillReward
disable-model-invocation: true
---

# Find CCSPlayerPawn_ProcessSuicideAsKillReward
