...
description: |
  Agent fallback for CViewRender_vtable (auto-generated, category: func). Locate
  CViewRender_vtable in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CViewRender_vtable, CViewRender_vtable
disable-model-invocation: true
---

# Find CViewRender_vtable

Target: `CViewRender_vtable` (func) in the module loaded in THIS session.
...
Write `CViewRender_vtable.{platform}.yaml` with EXACTLY these fields:
