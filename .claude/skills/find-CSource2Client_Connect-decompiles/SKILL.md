...
description: |
  Agent fallback for CSource2Client_Connect-decompiles (auto-generated, category: vfunc). Locate
  CSource2Client::Connect in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_Connect-decompiles, CSource2Client::Connect
disable-model-invocation: true
---

# Find CSource2Client_Connect-decompiles

Target: `CSource2Client::Connect` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Client_Connect.{platform}.yaml` with EXACTLY these fields:
