...
description: |
  ...
  CSource2Client_Connect-decompiles in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_Connect-decompiles, CSource2Client_Connect-decompiles
disable-model-invocation: true
---

# Find CSource2Client_Connect-decompiles

Target: `CSource2Client_Connect-decompiles` (vfunc) in the module loaded in THIS session.
