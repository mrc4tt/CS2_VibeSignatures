---
name: find-PhysCollisionDust
description: |
  Agent fallback for PhysCollisionDust (auto-generated, category: func). Locate
  PhysCollisionDust in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: PhysCollisionDust, PhysCollisionDust
disable-model-invocation: true
---

# Find PhysCollisionDust

Target: `PhysCollisionDust` (func) in the module loaded in THIS session.
...
Write `PhysCollisionDust.{platform}.yaml` with EXACTLY these fields:
