---
name: find-INetworkGameServer_GetTimescale
description: |
  Agent fallback for INetworkGameServer_GetTimescale (auto-generated, category: vfunc). Locate
  INetworkGameServer::GetTimescale in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetTimescale, INetworkGameServer::GetTimescale
disable-model-invocation: true
---

# Find INetworkGameServer_GetTimescale

Target: `INetworkGameServer::GetTimescale` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_GetTimescale.{platform}.yaml` with EXACTLY these fields:
