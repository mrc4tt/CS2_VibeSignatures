...
description: |
  ...
  INetworkGameServer_GetTimescale in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetTimescale, INetworkGameServer_GetTimescale
disable-model-invocation: true
---

# Find INetworkGameServer_GetTimescale

Target: `INetworkGameServer_GetTimescale` (vfunc) in the module loaded in THIS session.
