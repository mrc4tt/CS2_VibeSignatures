...
description: |
  ...
  CClientInput_CreateMove in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CClientInput_CreateMove, CClientInput_CreateMove
disable-model-invocation: true
---

# Find CClientInput_CreateMove

Target: `CClientInput_CreateMove` (vfunc) in the module loaded in THIS session.
