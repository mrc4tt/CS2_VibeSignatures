---
name: find-CClientInput_CreateMove
description: |
  Agent fallback for CClientInput_CreateMove (auto-generated, category: vfunc). Locate
  CClientInput::CreateMove in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CClientInput_CreateMove, CClientInput::CreateMove
disable-model-invocation: true
---

# Find CClientInput_CreateMove

Target: `CClientInput::CreateMove` (vfunc) in the module loaded in THIS session.
...
Write `CClientInput_CreateMove.{platform}.yaml` with EXACTLY these fields:
