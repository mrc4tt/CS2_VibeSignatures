---
name: find-CLoopModeLevelLoad_MaybeSwitchToGameLoop
description: |
  Agent fallback for CLoopModeLevelLoad_MaybeSwitchToGameLoop (auto-generated, category: func). Locate
  CLoopModeLevelLoad::MaybeSwitchToGameLoop in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeLevelLoad_MaybeSwitchToGameLoop, CLoopModeLevelLoad::MaybeSwitchToGameLoop
disable-model-invocation: true
---

# Find CLoopModeLevelLoad_MaybeSwitchToGameLoop

Target: `CLoopModeLevelLoad::MaybeSwitchToGameLoop` (func) in the module loaded in THIS session.
...
Write `CLoopModeLevelLoad_MaybeSwitchToGameLoop.{platform}.yaml` with EXACTLY these fields:
