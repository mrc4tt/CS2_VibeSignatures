---
name: find-CWaitForInitialSpawnGroupsPrerequisite_vtable
description: |
  Agent fallback for CWaitForInitialSpawnGroupsPrerequisite_vtable (auto-generated, category: func). Locate
  CWaitForInitialSpawnGroupsPrerequisite_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CWaitForInitialSpawnGroupsPrerequisite_vtable, CWaitForInitialSpawnGroupsPrerequisite_vtable
disable-model-invocation: true
---

# Find CWaitForInitialSpawnGroupsPrerequisite_vtable

Target: `CWaitForInitialSpawnGroupsPrerequisite_vtable` (func) in the module loaded in THIS session.
...
Write `CWaitForInitialSpawnGroupsPrerequisite_vtable.{platform}.yaml` with EXACTLY these fields:
