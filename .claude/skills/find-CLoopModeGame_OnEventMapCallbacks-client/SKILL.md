...
description: |
  ...
  CLoopModeGame_OnEventMapCallbacks-client in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnEventMapCallbacks-client, CLoopModeGame_OnEventMapCallbacks-client
disable-model-invocation: true
---

# Find CLoopModeGame_OnEventMapCallbacks-client

Target: `CLoopModeGame_OnEventMapCallbacks-client` (func) in the module loaded in THIS session.
