...
description: |
  Agent fallback for CLoopModeGame_OnEventMapCallbacks-client (auto-generated, category: func). Locate
  CLoopModeGame_OnEventMapCallbacks in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnEventMapCallbacks-client, CLoopModeGame_OnEventMapCallbacks
disable-model-invocation: true
---

# Find CLoopModeGame_OnEventMapCallbacks-client
