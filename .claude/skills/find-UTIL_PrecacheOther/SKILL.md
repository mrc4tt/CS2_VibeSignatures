...
description: |
  Agent fallback for UTIL_PrecacheOther (auto-generated, category: func). Locate
  UTIL_PrecacheOther in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: UTIL_PrecacheOther, UTIL_PrecacheOther
disable-model-invocation: true
---

# Find UTIL_PrecacheOther

Target: `UTIL_PrecacheOther` (func) in the module loaded in THIS session.
...
Write `UTIL_PrecacheOther.{platform}.yaml` with EXACTLY these fields:
