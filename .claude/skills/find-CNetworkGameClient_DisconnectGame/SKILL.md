...
description: |
  ...
  CNetworkGameClient_DisconnectGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_DisconnectGame, CNetworkGameClient_DisconnectGame
disable-model-invocation: true
---

# Find CNetworkGameClient_DisconnectGame

Target: `CNetworkGameClient_DisconnectGame` (vfunc) in the module loaded in THIS session.
