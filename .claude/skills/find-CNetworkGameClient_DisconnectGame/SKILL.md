...
description: |
  Agent fallback for CNetworkGameClient_DisconnectGame (auto-generated, category: vfunc). Locate
  CNetworkGameClient::DisconnectGame in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_DisconnectGame, CNetworkGameClient::DisconnectGame
disable-model-invocation: true
---

# Find CNetworkGameClient_DisconnectGame

Target: `CNetworkGameClient::DisconnectGame` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_DisconnectGame.{platform}.yaml` with EXACTLY these fields:
