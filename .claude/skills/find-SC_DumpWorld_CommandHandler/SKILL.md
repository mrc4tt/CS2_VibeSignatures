...
description: |
  Agent fallback for SC_DumpWorld_CommandHandler (auto-generated, category: func). Locate
  ...
  Trigger: SC_DumpWorld_CommandHandler, SC_DumpWorld_CommandHandler
disable-model-invocation: true
---

# Find SC_DumpWorld_CommandHandler
