...
description: |
  Agent fallback for CGameClientConnectPrerequisite_vtable (auto-generated, category: func). Locate
  CGameClientConnectPrerequisite_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameClientConnectPrerequisite_vtable, CGameClientConnectPrerequisite_vtable
disable-model-invocation: true
---

# Find CGameClientConnectPrerequisite_vtable

Target: `CGameClientConnectPrerequisite_vtable` (func) in the module loaded in THIS session.
...
Write `CGameClientConnectPrerequisite_vtable.{platform}.yaml` with EXACTLY these fields:
