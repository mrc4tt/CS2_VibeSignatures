...
description: |
  ...
  CNetworkGameClientBase_ServerCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ServerCmd, CNetworkGameClientBase_ServerCmd
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ServerCmd

Target: `CNetworkGameClientBase_ServerCmd` (vfunc) in the module loaded in THIS session.
