---
name: find-CNetworkGameClientBase_ServerCmd
description: |
  Agent fallback for CNetworkGameClientBase_ServerCmd (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::ServerCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ServerCmd, CNetworkGameClientBase::ServerCmd
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ServerCmd

Target: `CNetworkGameClientBase::ServerCmd` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ServerCmd.{platform}.yaml` with EXACTLY these fields:
