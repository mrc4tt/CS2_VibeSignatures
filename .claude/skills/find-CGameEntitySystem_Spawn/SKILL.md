...
description: |
  Agent fallback for CGameEntitySystem_Spawn (auto-generated, category: vfunc). Locate
  ...
  Trigger: CGameEntitySystem_Spawn, CGameEntitySystem::Spawn
disable-model-invocation: true
---

# Find CGameEntitySystem_Spawn
