...
description: |
  ...
  CGameEntitySystem_Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_Spawn, CGameEntitySystem_Spawn
disable-model-invocation: true
---

# Find CGameEntitySystem_Spawn

Target: `CGameEntitySystem_Spawn` (vfunc) in the module loaded in THIS session.
