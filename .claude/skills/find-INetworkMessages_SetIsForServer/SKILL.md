...
description: |
  Agent fallback for INetworkMessages_SetIsForServer (auto-generated, category: vfunc). Locate
  INetworkMessages::SetIsForServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_SetIsForServer, INetworkMessages::SetIsForServer
disable-model-invocation: true
---

# Find INetworkMessages_SetIsForServer

Target: `INetworkMessages::SetIsForServer` (vfunc) in the module loaded in THIS session.
...
Write `INetworkMessages_SetIsForServer.{platform}.yaml` with EXACTLY these fields:
