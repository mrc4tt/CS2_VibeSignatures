...
description: |
  ...
  INetworkMessages_SetIsForServer in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkMessages_SetIsForServer, INetworkMessages_SetIsForServer
disable-model-invocation: true
---

# Find INetworkMessages_SetIsForServer

Target: `INetworkMessages_SetIsForServer` (vfunc) in the module loaded in THIS session.
