...
description: |
  ...
  CDemoRecorder_ParseMessage-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoRecorder_ParseMessage-decompiles, CDemoRecorder_ParseMessage-decompiles
disable-model-invocation: true
---

# Find CDemoRecorder_ParseMessage-decompiles

Target: `CDemoRecorder_ParseMessage-decompiles` (vfunc) in the module loaded in THIS session.
