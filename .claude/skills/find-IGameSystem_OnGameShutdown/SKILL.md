...
description: |
  ...
  IGameSystem_OnGameShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGameShutdown, IGameSystem_OnGameShutdown
disable-model-invocation: true
---

# Find IGameSystem_OnGameShutdown

Target: `IGameSystem_OnGameShutdown` (vfunc) in the module loaded in THIS session.
