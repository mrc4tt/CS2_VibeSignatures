...
description: |
  Agent fallback for IGameSystem_OnGameShutdown (auto-generated, category: vfunc). Locate
  IGameSystem::GameShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGameShutdown, IGameSystem::GameShutdown
disable-model-invocation: true
---

# Find IGameSystem_OnGameShutdown

Target: `IGameSystem::GameShutdown` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnGameShutdown.{platform}.yaml` with EXACTLY these fields:
