...
description: |
  ...
  INetworkSystem_OpenSocket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_OpenSocket, INetworkSystem_OpenSocket
disable-model-invocation: true
---

# Find INetworkSystem_OpenSocket

Target: `INetworkSystem_OpenSocket` (vfunc) in the module loaded in THIS session.
