---
name: find-INetworkSystem_OpenSocket
description: |
  Agent fallback for INetworkSystem_OpenSocket (auto-generated, category: vfunc). Locate
  INetworkSystem::OpenSocket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_OpenSocket, INetworkSystem::OpenSocket
disable-model-invocation: true
---

# Find INetworkSystem_OpenSocket

Target: `INetworkSystem::OpenSocket` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_OpenSocket.{platform}.yaml` with EXACTLY these fields:
