...
description: |
  ...
  CNetworkClientService_OnEventMapCallbacks-engine in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_OnEventMapCallbacks-engine, CNetworkClientService_OnEventMapCallbacks-engine
disable-model-invocation: true
---

# Find CNetworkClientService_OnEventMapCallbacks-engine

Target: `CNetworkClientService_OnEventMapCallbacks-engine` (func) in the module loaded in THIS session.
