...
description: |
  Agent fallback for CNetworkClientService_OnEventMapCallbacks-engine (auto-generated, category: func). Locate
  CNetworkClientService_OnEventMapCallbacks in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_OnEventMapCallbacks-engine, CNetworkClientService_OnEventMapCallbacks
disable-model-invocation: true
---

# Find CNetworkClientService_OnEventMapCallbacks-engine

Target: `CNetworkClientService_OnEventMapCallbacks` (func) in the module loaded in THIS session.
...
Write `CNetworkClientService_OnEventMapCallbacks.{platform}.yaml` with EXACTLY these fields:
