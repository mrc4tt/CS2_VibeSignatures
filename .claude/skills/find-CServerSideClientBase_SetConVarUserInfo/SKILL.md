---
name: find-CServerSideClientBase_SetConVarUserInfo
description: |
  Agent fallback for CServerSideClientBase_SetConVarUserInfo (auto-generated, category: func). Locate
  CServerSideClientBase::SetConVarUserInfo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CServerSideClientBase_SetConVarUserInfo, CServerSideClientBase::SetConVarUserInfo
disable-model-invocation: true
---

# Find CServerSideClientBase_SetConVarUserInfo

Target: `CServerSideClientBase::SetConVarUserInfo` (func) in the module loaded in THIS session.
