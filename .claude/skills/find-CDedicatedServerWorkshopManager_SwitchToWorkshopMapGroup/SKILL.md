...
description: |
  ...
  CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup, CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup
disable-model-invocation: true
---

# Find CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup

Target: `CDedicatedServerWorkshopManager_SwitchToWorkshopMapGroup` (func) in the module loaded in THIS session.
