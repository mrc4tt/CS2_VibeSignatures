---
name: find-GameStateAPI_RegisterAPIs-extract-apis
description: |
  Agent fallback for GameStateAPI_RegisterAPIs-extract-apis (auto-generated, category: func). Locate
  GameStateAPI_RegisterAPIs-extract-apis in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: GameStateAPI_RegisterAPIs-extract-apis, GameStateAPI_RegisterAPIs-extract-apis
disable-model-invocation: true
---

# Find GameStateAPI_RegisterAPIs-extract-apis

Target: `GameStateAPI_RegisterAPIs-extract-apis` (func) in the module loaded in THIS session.
...
Write `GameStateAPI_RegisterAPIs-extract-apis.{platform}.yaml` with EXACTLY these fields:
