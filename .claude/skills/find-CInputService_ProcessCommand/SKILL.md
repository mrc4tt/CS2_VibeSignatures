...
description: |
  ...
  CInputService_ProcessCommand in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_ProcessCommand, CInputService_ProcessCommand
disable-model-invocation: true
---

# Find CInputService_ProcessCommand

Target: `CInputService_ProcessCommand` (func) in the module loaded in THIS session.
