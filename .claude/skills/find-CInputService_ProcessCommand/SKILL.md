---
name: find-CInputService_ProcessCommand
description: |
  Agent fallback for CInputService_ProcessCommand (auto-generated, category: func). Locate
  CInputService::ProcessCommand in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_ProcessCommand, CInputService::ProcessCommand
disable-model-invocation: true
---

# Find CInputService_ProcessCommand

Target: `CInputService::ProcessCommand` (func) in the module loaded in THIS session.
...
Write `CInputService_ProcessCommand.{platform}.yaml` with EXACTLY these fields:
