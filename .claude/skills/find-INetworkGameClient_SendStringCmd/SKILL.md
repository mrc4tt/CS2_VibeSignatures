...
description: |
  Agent fallback for INetworkGameClient_SendStringCmd (auto-generated, category: func). Locate
  INetworkGameClient_SendStringCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameClient_SendStringCmd, INetworkGameClient_SendStringCmd
disable-model-invocation: true
---

# Find INetworkGameClient_SendStringCmd

Target: `INetworkGameClient_SendStringCmd` (func) in the module loaded in THIS session.
...
Write `INetworkGameClient_SendStringCmd.{platform}.yaml` with EXACTLY these fields:
