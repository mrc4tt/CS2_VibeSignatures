...
description: |
  ...
  CNetworkGameClientBase_DeferActivate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_DeferActivate, CNetworkGameClientBase_DeferActivate
disable-model-invocation: true
---

# Find CNetworkGameClientBase_DeferActivate

Target: `CNetworkGameClientBase_DeferActivate` (func) in the module loaded in THIS session.
