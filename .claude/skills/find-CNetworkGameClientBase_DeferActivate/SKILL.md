...
description: |
  Agent fallback for CNetworkGameClientBase_DeferActivate (auto-generated, category: func). Locate
  CNetworkGameClientBase::DeferActivate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_DeferActivate, CNetworkGameClientBase::DeferActivate
disable-model-invocation: true
---

# Find CNetworkGameClientBase_DeferActivate

Target: `CNetworkGameClientBase::DeferActivate` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_DeferActivate.{platform}.yaml` with EXACTLY these fields:
