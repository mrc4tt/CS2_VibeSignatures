...
description: |
  ...
  CFlashbangProjectile_Detonate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlashbangProjectile_Detonate, CFlashbangProjectile_Detonate
disable-model-invocation: true
---

# Find CFlashbangProjectile_Detonate

Target: `CFlashbangProjectile_Detonate` (vfunc) in the module loaded in THIS session.
