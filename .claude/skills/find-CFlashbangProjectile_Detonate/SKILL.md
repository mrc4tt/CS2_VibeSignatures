---
name: find-CFlashbangProjectile_Detonate
description: |
  Agent fallback for CFlashbangProjectile_Detonate (auto-generated, category: vfunc). Locate
  CFlashbangProjectile::Detonate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CFlashbangProjectile_Detonate, CFlashbangProjectile::Detonate
disable-model-invocation: true
---

# Find CFlashbangProjectile_Detonate

Target: `CFlashbangProjectile::Detonate` (vfunc) in the module loaded in THIS session.
...
Write `CFlashbangProjectile_Detonate.{platform}.yaml` with EXACTLY these fields:
