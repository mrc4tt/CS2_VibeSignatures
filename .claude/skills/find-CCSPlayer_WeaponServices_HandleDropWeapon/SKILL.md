...
description: |
  ...
  CCSPlayer_WeaponServices_HandleDropWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_WeaponServices_HandleDropWeapon, CCSPlayer_WeaponServices_HandleDropWeapon
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_HandleDropWeapon

Target: `CCSPlayer_WeaponServices_HandleDropWeapon` (func) in the module loaded in THIS session.
