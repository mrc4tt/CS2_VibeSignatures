...
description: |
  ...
  CCSPlayer_WeaponServices::HandleDropWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_WeaponServices_HandleDropWeapon, CCSPlayer_WeaponServices::HandleDropWeapon
disable-model-invocation: true
---

# Find CCSPlayer_WeaponServices_HandleDropWeapon

Target: `CCSPlayer_WeaponServices::HandleDropWeapon` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_WeaponServices_HandleDropWeapon.{platform}.yaml` with EXACTLY these fields:
