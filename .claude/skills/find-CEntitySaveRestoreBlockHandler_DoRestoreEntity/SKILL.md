...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_DoRestoreEntity (auto-generated, category: func). Locate
  CEntitySaveRestoreBlockHandler::DoRestoreEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_DoRestoreEntity, CEntitySaveRestoreBlockHandler::DoRestoreEntity
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_DoRestoreEntity

Target: `CEntitySaveRestoreBlockHandler::DoRestoreEntity` (func) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_DoRestoreEntity.{platform}.yaml` with EXACTLY these fields:
