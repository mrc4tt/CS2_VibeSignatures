...
description: |
  ...
  CEntitySaveRestoreBlockHandler_DoRestoreEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_DoRestoreEntity, CEntitySaveRestoreBlockHandler_DoRestoreEntity
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_DoRestoreEntity

Target: `CEntitySaveRestoreBlockHandler_DoRestoreEntity` (func) in the module loaded in THIS session.
