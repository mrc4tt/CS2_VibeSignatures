...
description: |
  ...
  CLoopTypeBase_GenerateServiceDependencies-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_GenerateServiceDependencies-windows, CLoopTypeBase_GenerateServiceDependencies-windows
disable-model-invocation: true
---

# Find CLoopTypeBase_GenerateServiceDependencies-windows

Target: `CLoopTypeBase_GenerateServiceDependencies-windows` (func) in the module loaded in THIS session.
