---
name: find-CLoopTypeBase_GenerateServiceDependencies-windows
description: |
  Agent fallback for CLoopTypeBase_GenerateServiceDependencies-windows (auto-generated, category: func). Locate
  CLoopTypeBase::GenerateServiceDependencies in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_GenerateServiceDependencies-windows, CLoopTypeBase::GenerateServiceDependencies
disable-model-invocation: true
---

# Find CLoopTypeBase_GenerateServiceDependencies-windows

Target: `CLoopTypeBase::GenerateServiceDependencies` (func) in the module loaded in THIS session.
...
Write `CLoopTypeBase_GenerateServiceDependencies.{platform}.yaml` with EXACTLY these fields:
