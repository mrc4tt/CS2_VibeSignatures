...
description: |
  ...
  CNetworkGameClientBase_Connect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_Connect, CNetworkGameClientBase_Connect
disable-model-invocation: true
---

# Find CNetworkGameClientBase_Connect

Target: `CNetworkGameClientBase_Connect` (vfunc) in the module loaded in THIS session.
