...
description: |
  Agent fallback for CNetworkGameClientBase_Connect (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::Connect in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_Connect, CNetworkGameClientBase::Connect
disable-model-invocation: true
---

# Find CNetworkGameClientBase_Connect

Target: `CNetworkGameClientBase::Connect` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_Connect.{platform}.yaml` with EXACTLY these fields:
