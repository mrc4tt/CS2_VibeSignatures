...
description: |
  ...
  CEngineServer_ShowFrameTimeReport in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ShowFrameTimeReport, CEngineServer_ShowFrameTimeReport
disable-model-invocation: true
---

# Find CEngineServer_ShowFrameTimeReport

Target: `CEngineServer_ShowFrameTimeReport` (vfunc) in the module loaded in THIS session.
