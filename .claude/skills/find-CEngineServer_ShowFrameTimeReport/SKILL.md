...
description: |
  Agent fallback for CEngineServer_ShowFrameTimeReport (auto-generated, category: vfunc). Locate
  CEngineServer::ShowFrameTimeReport in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ShowFrameTimeReport, CEngineServer::ShowFrameTimeReport
disable-model-invocation: true
---

# Find CEngineServer_ShowFrameTimeReport

Target: `CEngineServer::ShowFrameTimeReport` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_ShowFrameTimeReport.{platform}.yaml` with EXACTLY these fields:
