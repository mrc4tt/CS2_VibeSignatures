...
description: |
  ...
  IGameSystem_OnOutOfGameFrameBoundary in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnOutOfGameFrameBoundary, IGameSystem_OnOutOfGameFrameBoundary
disable-model-invocation: true
---

# Find IGameSystem_OnOutOfGameFrameBoundary

Target: `IGameSystem_OnOutOfGameFrameBoundary` (vfunc) in the module loaded in THIS session.
