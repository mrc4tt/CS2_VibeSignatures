...
description: |
  Agent fallback for IGameSystem_OnOutOfGameFrameBoundary (auto-generated, category: vfunc). Locate
  IGameSystem::OnOutOfGameFrameBoundary in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnOutOfGameFrameBoundary, IGameSystem::OnOutOfGameFrameBoundary
disable-model-invocation: true
---

# Find IGameSystem_OnOutOfGameFrameBoundary

Target: `IGameSystem::OnOutOfGameFrameBoundary` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnOutOfGameFrameBoundary.{platform}.yaml` with EXACTLY these fields:
