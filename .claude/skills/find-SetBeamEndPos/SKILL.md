---
name: find-SetBeamEndPos
description: |
  Locate SetBeamEndPos in CS2 server.dll / libserver.so via IDA Pro MCP and emit a fresh, minimal-unique
  signature or offset for the local gamedata entry "SetBeamEndPos" (symbol SetBeamEndPos). The gamedata consumer stores a BYTE SIGNATURE for this entry - ALWAYS emit the func
  ...
  Trigger: SetBeamEndPos, SetBeamEndPos
disable-model-invocation: true
---

# Find SetBeamEndPos

Target: `SetBeamEndPos` (func) in the CS2 server module.
