...
description: |
  ...
  IEngineServiceMgr_GetAddonCount in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_GetAddonCount, IEngineServiceMgr_GetAddonCount
disable-model-invocation: true
---

# Find IEngineServiceMgr_GetAddonCount

Target: `IEngineServiceMgr_GetAddonCount` (vfunc) in the module loaded in THIS session.
