---
name: find-IEngineServiceMgr_GetAddonCount
description: |
  Agent fallback for IEngineServiceMgr_GetAddonCount (auto-generated, category: vfunc). Locate
  IEngineServiceMgr::GetAddonCount in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IEngineServiceMgr_GetAddonCount, IEngineServiceMgr::GetAddonCount
disable-model-invocation: true
---

# Find IEngineServiceMgr_GetAddonCount

Target: `IEngineServiceMgr::GetAddonCount` (vfunc) in the module loaded in THIS session.
...
Write `IEngineServiceMgr_GetAddonCount.{platform}.yaml` with EXACTLY these fields:
