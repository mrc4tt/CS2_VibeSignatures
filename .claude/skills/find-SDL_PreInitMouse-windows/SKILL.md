---
name: find-SDL_PreInitMouse-windows
description: |
  Agent fallback for SDL_PreInitMouse-windows (auto-generated, category: func). Locate
  SDL_PreInitMouse-windows in the CS2 SDL3 module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: SDL_PreInitMouse-windows, SDL_PreInitMouse-windows
disable-model-invocation: true
---

# Find SDL_PreInitMouse-windows

Target: `SDL_PreInitMouse-windows` (func) in the module loaded in THIS session.
