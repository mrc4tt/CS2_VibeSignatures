---
name: find-CNetworkClientService_OnClientProcessGameInput
description: |
  Agent fallback for CNetworkClientService_OnClientProcessGameInput (auto-generated, category: func). Locate
  CNetworkClientService::OnClientProcessGameInput in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_OnClientProcessGameInput, CNetworkClientService::OnClientProcessGameInput
disable-model-invocation: true
---

# Find CNetworkClientService_OnClientProcessGameInput

Target: `CNetworkClientService::OnClientProcessGameInput` (func) in the module loaded in THIS session.
...
Write `CNetworkClientService_OnClientProcessGameInput.{platform}.yaml` with EXACTLY these fields:
