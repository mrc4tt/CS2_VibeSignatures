...
description: |
  ...
  CNetworkClientService_OnClientProcessGameInput in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_OnClientProcessGameInput, CNetworkClientService_OnClientProcessGameInput
disable-model-invocation: true
---

# Find CNetworkClientService_OnClientProcessGameInput

Target: `CNetworkClientService_OnClientProcessGameInput` (func) in the module loaded in THIS session.
