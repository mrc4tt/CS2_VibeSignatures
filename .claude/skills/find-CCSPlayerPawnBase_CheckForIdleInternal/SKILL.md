...
description: |
  ...
  CCSPlayerPawnBase::CheckForIdleInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawnBase_CheckForIdleInternal, CCSPlayerPawnBase::CheckForIdleInternal
disable-model-invocation: true
---

# Find CCSPlayerPawnBase_CheckForIdleInternal

Target: `CCSPlayerPawnBase::CheckForIdleInternal` (func) in the module loaded in THIS session.
...
Write `CCSPlayerPawnBase_CheckForIdleInternal.{platform}.yaml` with EXACTLY these fields:
