...
description: |
  ...
  CCSPlayerPawnBase_CheckForIdleInternal in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawnBase_CheckForIdleInternal, CCSPlayerPawnBase_CheckForIdleInternal
disable-model-invocation: true
---

# Find CCSPlayerPawnBase_CheckForIdleInternal

Target: `CCSPlayerPawnBase_CheckForIdleInternal` (func) in the module loaded in THIS session.
