---
name: find-CEntitySystem_ExecuteQueuedCreation-decompiles
description: |
  Agent fallback for CEntitySystem_ExecuteQueuedCreation-decompiles (auto-generated, category: func). Locate
  CEntitySystem::ExecuteQueuedCreation in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ExecuteQueuedCreation-decompiles, CEntitySystem::ExecuteQueuedCreation
disable-model-invocation: true
---

# Find CEntitySystem_ExecuteQueuedCreation-decompiles

Target: `CEntitySystem::ExecuteQueuedCreation` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_ExecuteQueuedCreation.{platform}.yaml` with EXACTLY these fields:
