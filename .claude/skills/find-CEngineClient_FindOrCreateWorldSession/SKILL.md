...
description: |
  ...
  CEngineClient_FindOrCreateWorldSession in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_FindOrCreateWorldSession, CEngineClient_FindOrCreateWorldSession
disable-model-invocation: true
---

# Find CEngineClient_FindOrCreateWorldSession

Target: `CEngineClient_FindOrCreateWorldSession` (vfunc) in the module loaded in THIS session.
