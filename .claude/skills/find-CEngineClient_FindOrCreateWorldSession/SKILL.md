...
description: |
  Agent fallback for CEngineClient_FindOrCreateWorldSession (auto-generated, category: vfunc). Locate
  CEngineClient::FindOrCreateWorldSession in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_FindOrCreateWorldSession, CEngineClient::FindOrCreateWorldSession
disable-model-invocation: true
---

# Find CEngineClient_FindOrCreateWorldSession

Target: `CEngineClient::FindOrCreateWorldSession` (vfunc) in the module loaded in THIS session.
...
Write `CEngineClient_FindOrCreateWorldSession.{platform}.yaml` with EXACTLY these fields:
