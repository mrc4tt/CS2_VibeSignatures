...
description: |
  Agent fallback for CLoopTypeBase_GetClientServerMode (auto-generated, category: func). Locate
  CLoopTypeBase_GetClientServerMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_GetClientServerMode, CLoopTypeBase_GetClientServerMode
disable-model-invocation: true
---

# Find CLoopTypeBase_GetClientServerMode

Target: `CLoopTypeBase_GetClientServerMode` (func) in the module loaded in THIS session.
...
Write `CLoopTypeBase_GetClientServerMode.{platform}.yaml` with EXACTLY these fields:
