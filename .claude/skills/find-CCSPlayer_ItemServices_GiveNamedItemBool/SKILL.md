...
description: |
  Agent fallback for CCSPlayer_ItemServices_GiveNamedItemBool (auto-generated, category: vfunc). Locate
  CCSPlayer_ItemServices::GiveNamedItemBool in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_ItemServices_GiveNamedItemBool, CCSPlayer_ItemServices::GiveNamedItemBool
disable-model-invocation: true
---

# Find CCSPlayer_ItemServices_GiveNamedItemBool

Target: `CCSPlayer_ItemServices::GiveNamedItemBool` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayer_ItemServices_GiveNamedItemBool.{platform}.yaml` with EXACTLY these fields:
