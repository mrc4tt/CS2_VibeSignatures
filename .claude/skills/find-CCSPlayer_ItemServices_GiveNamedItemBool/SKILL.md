...
description: |
  ...
  CCSPlayer_ItemServices_GiveNamedItemBool in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_ItemServices_GiveNamedItemBool, CCSPlayer_ItemServices_GiveNamedItemBool
disable-model-invocation: true
---

# Find CCSPlayer_ItemServices_GiveNamedItemBool

Target: `CCSPlayer_ItemServices_GiveNamedItemBool` (vfunc) in the module loaded in THIS session.
