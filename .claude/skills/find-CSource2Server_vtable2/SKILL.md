...
description: |
  Agent fallback for CSource2Server_vtable2 (auto-generated, category: func). Locate
  CSource2Server_vtable2 in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_vtable2, CSource2Server_vtable2
disable-model-invocation: true
---

# Find CSource2Server_vtable2

Target: `CSource2Server_vtable2` (func) in the module loaded in THIS session.
...
Write `CSource2Server_vtable2.{platform}.yaml` with EXACTLY these fields:
