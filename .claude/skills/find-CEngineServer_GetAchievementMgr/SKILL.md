...
description: |
  Agent fallback for CEngineServer_GetAchievementMgr (auto-generated, category: func). Locate
  CEngineServer_GetAchievementMgr in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetAchievementMgr, CEngineServer_GetAchievementMgr
disable-model-invocation: true
---

# Find CEngineServer_GetAchievementMgr

Target: `CEngineServer_GetAchievementMgr` (func) in the module loaded in THIS session.
...
Write `CEngineServer_GetAchievementMgr.{platform}.yaml` with EXACTLY these fields:
