...
description: |
  Agent fallback for CGameEventManager_FireEventClientSide (auto-generated, category: vfunc). Locate
  CGameEventManager::FireEventClientSide in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEventManager_FireEventClientSide, CGameEventManager::FireEventClientSide
disable-model-invocation: true
---

# Find CGameEventManager_FireEventClientSide

Target: `CGameEventManager::FireEventClientSide` (vfunc) in the module loaded in THIS session.
...
Write `CGameEventManager_FireEventClientSide.{platform}.yaml` with EXACTLY these fields:
