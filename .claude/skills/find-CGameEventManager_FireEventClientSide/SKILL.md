...
description: |
  ...
  CGameEventManager_FireEventClientSide in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEventManager_FireEventClientSide, CGameEventManager_FireEventClientSide
disable-model-invocation: true
---

# Find CGameEventManager_FireEventClientSide

Target: `CGameEventManager_FireEventClientSide` (vfunc) in the module loaded in THIS session.
