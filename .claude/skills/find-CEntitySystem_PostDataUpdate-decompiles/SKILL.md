---
name: find-CEntitySystem_PostDataUpdate-decompiles
description: |
  Agent fallback for CEntitySystem_PostDataUpdate-decompiles (auto-generated, category: vfunc). Locate
  CEntitySystem::PostDataUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_PostDataUpdate-decompiles, CEntitySystem::PostDataUpdate
disable-model-invocation: true
---

# Find CEntitySystem_PostDataUpdate-decompiles

Target: `CEntitySystem::PostDataUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySystem_PostDataUpdate.{platform}.yaml` with EXACTLY these fields:
