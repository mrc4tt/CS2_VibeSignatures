...
description: |
  ...
  CEntitySystem_PostDataUpdate-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_PostDataUpdate-decompiles, CEntitySystem_PostDataUpdate-decompiles
disable-model-invocation: true
---

# Find CEntitySystem_PostDataUpdate-decompiles

Target: `CEntitySystem_PostDataUpdate-decompiles` (vfunc) in the module loaded in THIS session.
