...
description: |
  ...
  CEngineServiceMgr_RegisterLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_RegisterLoopMode, CEngineServiceMgr_RegisterLoopMode
disable-model-invocation: true
---

# Find CEngineServiceMgr_RegisterLoopMode

Target: `CEngineServiceMgr_RegisterLoopMode` (vfunc) in the module loaded in THIS session.
