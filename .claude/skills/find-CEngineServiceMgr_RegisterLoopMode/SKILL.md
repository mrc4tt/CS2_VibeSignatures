...
description: |
  Agent fallback for CEngineServiceMgr_RegisterLoopMode (auto-generated, category: vfunc). Locate
  CEngineServiceMgr::RegisterLoopMode in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServiceMgr_RegisterLoopMode, CEngineServiceMgr::RegisterLoopMode
disable-model-invocation: true
---

# Find CEngineServiceMgr_RegisterLoopMode

Target: `CEngineServiceMgr::RegisterLoopMode` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServiceMgr_RegisterLoopMode.{platform}.yaml` with EXACTLY these fields:
