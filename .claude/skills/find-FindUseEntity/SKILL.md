...
description: |
  Agent fallback for FindUseEntity (auto-generated, category: func). Locate
  FindUseEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: FindUseEntity, FindUseEntity
disable-model-invocation: true
---

# Find FindUseEntity

Target: `FindUseEntity` (func) in the module loaded in THIS session.
...
Write `FindUseEntity.{platform}.yaml` with EXACTLY these fields:
