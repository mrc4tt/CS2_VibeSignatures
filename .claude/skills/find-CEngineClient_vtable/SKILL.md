...
description: |
  ...
  CEngineClient_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_vtable, CEngineClient_vtable
disable-model-invocation: true
---

# Find CEngineClient_vtable

Target: `CEngineClient_vtable` (func) in the module loaded in THIS session.
...
Write `CEngineClient_vtable.{platform}.yaml` with EXACTLY these fields:
