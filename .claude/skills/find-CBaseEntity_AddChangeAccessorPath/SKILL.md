---
name: find-CBaseEntity_AddChangeAccessorPath
description: |
  Agent fallback for CBaseEntity_AddChangeAccessorPath (auto-generated, category: vfunc). Locate
  CBaseEntity::AddChangeAccessorPath in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_AddChangeAccessorPath, CBaseEntity::AddChangeAccessorPath
disable-model-invocation: true
---

# Find CBaseEntity_AddChangeAccessorPath

Target: `CBaseEntity::AddChangeAccessorPath` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_AddChangeAccessorPath.{platform}.yaml` with EXACTLY these fields:
