...
description: |
  ...
  CBaseEntity_AddChangeAccessorPath in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_AddChangeAccessorPath, CBaseEntity_AddChangeAccessorPath
disable-model-invocation: true
---

# Find CBaseEntity_AddChangeAccessorPath

Target: `CBaseEntity_AddChangeAccessorPath` (vfunc) in the module loaded in THIS session.
