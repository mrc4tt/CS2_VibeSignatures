...
description: |
  ...
  CNetworkGameClient_Clear in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_Clear, CNetworkGameClient_Clear
disable-model-invocation: true
---

# Find CNetworkGameClient_Clear

Target: `CNetworkGameClient_Clear` (vfunc) in the module loaded in THIS session.
