...
description: |
  Agent fallback for CNetworkGameClient_Clear (auto-generated, category: vfunc). Locate
  CNetworkGameClient::Clear in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_Clear, CNetworkGameClient::Clear
disable-model-invocation: true
---

# Find CNetworkGameClient_Clear

Target: `CNetworkGameClient::Clear` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClient_Clear.{platform}.yaml` with EXACTLY these fields:
