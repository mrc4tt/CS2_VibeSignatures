...
description: |
  ...
  CNetworkGameServerBase_WriteDeltaEntities in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_WriteDeltaEntities, CNetworkGameServerBase_WriteDeltaEntities
disable-model-invocation: true
---

# Find CNetworkGameServerBase_WriteDeltaEntities

Target: `CNetworkGameServerBase_WriteDeltaEntities` (func) in the module loaded in THIS session.
