...
description: |
  Agent fallback for CNetworkGameServerBase_WriteDeltaEntities (auto-generated, category: func). Locate
  CNetworkGameServerBase::WriteDeltaEntities in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_WriteDeltaEntities, CNetworkGameServerBase::WriteDeltaEntities
disable-model-invocation: true
---

# Find CNetworkGameServerBase_WriteDeltaEntities

Target: `CNetworkGameServerBase::WriteDeltaEntities` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_WriteDeltaEntities.{platform}.yaml` with EXACTLY these fields:
