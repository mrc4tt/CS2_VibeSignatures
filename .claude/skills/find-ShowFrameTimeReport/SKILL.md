---
name: find-ShowFrameTimeReport
description: |
  Agent fallback for ShowFrameTimeReport (auto-generated, category: func). Locate
  ShowFrameTimeReport in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ShowFrameTimeReport, ShowFrameTimeReport
disable-model-invocation: true
---

# Find ShowFrameTimeReport

Target: `ShowFrameTimeReport` (func) in the module loaded in THIS session.
...
Write `ShowFrameTimeReport.{platform}.yaml` with EXACTLY these fields:
