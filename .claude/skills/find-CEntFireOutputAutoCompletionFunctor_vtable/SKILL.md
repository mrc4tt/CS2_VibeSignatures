...
description: |
  Agent fallback for CEntFireOutputAutoCompletionFunctor_vtable (auto-generated, category: func). Locate
  CEntFireOutputAutoCompletionFunctor_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntFireOutputAutoCompletionFunctor_vtable, CEntFireOutputAutoCompletionFunctor_vtable
disable-model-invocation: true
---

# Find CEntFireOutputAutoCompletionFunctor_vtable

Target: `CEntFireOutputAutoCompletionFunctor_vtable` (func) in the module loaded in THIS session.
...
Write `CEntFireOutputAutoCompletionFunctor_vtable.{platform}.yaml` with EXACTLY these fields:
