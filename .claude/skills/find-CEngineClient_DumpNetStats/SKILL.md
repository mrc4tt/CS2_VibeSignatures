...
description: |
  Agent fallback for CEngineClient_DumpNetStats (auto-generated, category: vfunc). Locate
  CEngineClient::DumpNetStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_DumpNetStats, CEngineClient::DumpNetStats
disable-model-invocation: true
---

# Find CEngineClient_DumpNetStats

Target: `CEngineClient::DumpNetStats` (vfunc) in the module loaded in THIS session.
...
Write `CEngineClient_DumpNetStats.{platform}.yaml` with EXACTLY these fields:
