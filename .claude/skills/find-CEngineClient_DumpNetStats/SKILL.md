...
description: |
  ...
  CEngineClient_DumpNetStats in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_DumpNetStats, CEngineClient_DumpNetStats
disable-model-invocation: true
---

# Find CEngineClient_DumpNetStats

Target: `CEngineClient_DumpNetStats` (vfunc) in the module loaded in THIS session.
