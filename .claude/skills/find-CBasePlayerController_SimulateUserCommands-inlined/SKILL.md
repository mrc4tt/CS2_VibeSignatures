---
name: find-CBasePlayerController_SimulateUserCommands-inlined
description: |
  Agent fallback for CBasePlayerController_SimulateUserCommands-inlined (auto-generated, category: vfunc). Locate
  CBasePlayerController_SimulateUserCommands-inlined in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_SimulateUserCommands-inlined, CBasePlayerController_SimulateUserCommands-inlined
disable-model-invocation: true
---

# Find CBasePlayerController_SimulateUserCommands-inlined

Target: `CBasePlayerController_SimulateUserCommands-inlined` (vfunc) in the module loaded in THIS session.
