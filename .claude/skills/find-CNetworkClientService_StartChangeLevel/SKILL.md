...
description: |
  ...
  CNetworkClientService_StartChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_StartChangeLevel, CNetworkClientService_StartChangeLevel
disable-model-invocation: true
---

# Find CNetworkClientService_StartChangeLevel

Target: `CNetworkClientService_StartChangeLevel` (vfunc) in the module loaded in THIS session.
