...
description: |
  Agent fallback for CNetworkClientService_StartChangeLevel (auto-generated, category: vfunc). Locate
  CNetworkClientService::StartChangeLevel in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_StartChangeLevel, CNetworkClientService::StartChangeLevel
disable-model-invocation: true
---

# Find CNetworkClientService_StartChangeLevel

Target: `CNetworkClientService::StartChangeLevel` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_StartChangeLevel.{platform}.yaml` with EXACTLY these fields:
