---
name: find-CCSBot_Upkeep-decompiles
description: |
  Agent fallback for CCSBot_Upkeep-decompiles (auto-generated, category: func). Locate
  CCSBot::Upkeep in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBot_Upkeep-decompiles, CCSBot::Upkeep
disable-model-invocation: true
---

# Find CCSBot_Upkeep-decompiles

Target: `CCSBot::Upkeep` (func) in the module loaded in THIS session.
...
Write `CCSBot_Upkeep.{platform}.yaml` with EXACTLY these fields:
