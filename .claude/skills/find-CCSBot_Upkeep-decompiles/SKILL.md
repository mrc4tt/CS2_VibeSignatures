...
description: |
  ...
  CCSBot_Upkeep-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBot_Upkeep-decompiles, CCSBot_Upkeep-decompiles
disable-model-invocation: true
---

# Find CCSBot_Upkeep-decompiles

Target: `CCSBot_Upkeep-decompiles` (func) in the module loaded in THIS session.
