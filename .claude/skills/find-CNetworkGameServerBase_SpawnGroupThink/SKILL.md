...
description: |
  Agent fallback for CNetworkGameServerBase_SpawnGroupThink (auto-generated, category: func). Locate
  CNetworkGameServerBase::SpawnGroupThink in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SpawnGroupThink, CNetworkGameServerBase::SpawnGroupThink
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SpawnGroupThink

Target: `CNetworkGameServerBase::SpawnGroupThink` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_SpawnGroupThink.{platform}.yaml` with EXACTLY these fields:
