...
description: |
  ...
  CNetworkGameServerBase_SpawnGroupThink in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_SpawnGroupThink, CNetworkGameServerBase_SpawnGroupThink
disable-model-invocation: true
---

# Find CNetworkGameServerBase_SpawnGroupThink

Target: `CNetworkGameServerBase_SpawnGroupThink` (func) in the module loaded in THIS session.
