...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::SpawnGroupSpawnEntities in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities, CSpawnGroupMgrGameSystem::SpawnGroupSpawnEntities
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities

Target: `CSpawnGroupMgrGameSystem::SpawnGroupSpawnEntities` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities.{platform}.yaml` with EXACTLY these fields:
