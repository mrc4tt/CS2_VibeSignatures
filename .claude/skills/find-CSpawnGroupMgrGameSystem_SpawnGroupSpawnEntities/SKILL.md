...
description: |
  ...
  CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities, CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities

Target: `CSpawnGroupMgrGameSystem_SpawnGroupSpawnEntities` (vfunc) in the module loaded in THIS session.
