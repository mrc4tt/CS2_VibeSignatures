...
description: |
  ...
  CEngineServer_ClientCommandKeyValues in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ClientCommandKeyValues, CEngineServer_ClientCommandKeyValues
disable-model-invocation: true
---

# Find CEngineServer_ClientCommandKeyValues

Target: `CEngineServer_ClientCommandKeyValues` (vfunc) in the module loaded in THIS session.
