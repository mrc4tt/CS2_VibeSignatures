...
description: |
  Agent fallback for CEngineServer_ClientCommandKeyValues (auto-generated, category: vfunc). Locate
  CEngineServer::ClientCommandKeyValues in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_ClientCommandKeyValues, CEngineServer::ClientCommandKeyValues
disable-model-invocation: true
---

# Find CEngineServer_ClientCommandKeyValues

Target: `CEngineServer::ClientCommandKeyValues` (vfunc) in the module loaded in THIS session.
...
Write `CEngineServer_ClientCommandKeyValues.{platform}.yaml` with EXACTLY these fields:
