...
description: |
  Agent fallback for CEntitySystem_ctor (auto-generated, category: func). Locate
  CEntitySystem::CEntitySystem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ctor, CEntitySystem::CEntitySystem
disable-model-invocation: true
---

# Find CEntitySystem_ctor

Target: `CEntitySystem::CEntitySystem` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_ctor.{platform}.yaml` with EXACTLY these fields:
