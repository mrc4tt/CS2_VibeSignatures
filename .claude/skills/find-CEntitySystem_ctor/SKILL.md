...
description: |
  ...
  CEntitySystem_ctor in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ctor, CEntitySystem_ctor
disable-model-invocation: true
---

# Find CEntitySystem_ctor

Target: `CEntitySystem_ctor` (func) in the module loaded in THIS session.
