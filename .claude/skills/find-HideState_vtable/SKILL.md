...
description: |
  Agent fallback for HideState_vtable (auto-generated, category: func). Locate
  HideState_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: HideState_vtable, HideState_vtable
disable-model-invocation: true
---

# Find HideState_vtable

Target: `HideState_vtable` (func) in the module loaded in THIS session.
...
Write `HideState_vtable.{platform}.yaml` with EXACTLY these fields:
