...
description: |
  Agent fallback for CNetworkGameClient_OnSource1Source1LegacyGameEvent-decompiles (auto-generated, category: func). Locate
  CNetworkGameClient::OnSource1Source1LegacyGameEvent in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_OnSource1Source1LegacyGameEvent-decompiles, CNetworkGameClient::OnSource1Source1LegacyGameEvent
disable-model-invocation: true
---

# Find CNetworkGameClient_OnSource1Source1LegacyGameEvent-decompiles

Target: `CNetworkGameClient::OnSource1Source1LegacyGameEvent` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClient_OnSource1Source1LegacyGameEvent.{platform}.yaml` with EXACTLY these fields:
