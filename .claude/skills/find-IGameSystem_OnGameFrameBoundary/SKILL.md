...
description: |
  Agent fallback for IGameSystem_OnGameFrameBoundary (auto-generated, category: vfunc). Locate
  IGameSystem::OnGameFrameBoundary in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGameFrameBoundary, IGameSystem::OnGameFrameBoundary
disable-model-invocation: true
---

# Find IGameSystem_OnGameFrameBoundary

Target: `IGameSystem::OnGameFrameBoundary` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnGameFrameBoundary.{platform}.yaml` with EXACTLY these fields:
