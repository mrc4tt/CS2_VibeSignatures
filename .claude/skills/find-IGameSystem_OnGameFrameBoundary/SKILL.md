...
description: |
  ...
  IGameSystem_OnGameFrameBoundary in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGameFrameBoundary, IGameSystem_OnGameFrameBoundary
disable-model-invocation: true
---

# Find IGameSystem_OnGameFrameBoundary

Target: `IGameSystem_OnGameFrameBoundary` (vfunc) in the module loaded in THIS session.
