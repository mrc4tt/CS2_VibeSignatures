---
name: find-g_pGameEntitySystem
description: |
  Agent fallback for g_pGameEntitySystem (auto-generated, category: func). Locate
  g_pGameEntitySystem in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: g_pGameEntitySystem, g_pGameEntitySystem
disable-model-invocation: true
---

# Find g_pGameEntitySystem

Target: `g_pGameEntitySystem` (func) in the module loaded in THIS session.
...
Write `g_pGameEntitySystem.{platform}.yaml` with EXACTLY these fields:
