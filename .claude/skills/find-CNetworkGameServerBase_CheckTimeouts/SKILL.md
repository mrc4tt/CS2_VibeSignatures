...
description: |
  ...
  CNetworkGameServerBase_CheckTimeouts in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_CheckTimeouts, CNetworkGameServerBase_CheckTimeouts
disable-model-invocation: true
---

# Find CNetworkGameServerBase_CheckTimeouts

Target: `CNetworkGameServerBase_CheckTimeouts` (func) in the module loaded in THIS session.
