...
description: |
  Agent fallback for CNetworkGameServerBase_CheckTimeouts (auto-generated, category: func). Locate
  CNetworkGameServerBase::CheckTimeouts in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_CheckTimeouts, CNetworkGameServerBase::CheckTimeouts
disable-model-invocation: true
---

# Find CNetworkGameServerBase_CheckTimeouts

Target: `CNetworkGameServerBase::CheckTimeouts` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_CheckTimeouts.{platform}.yaml` with EXACTLY these fields:
