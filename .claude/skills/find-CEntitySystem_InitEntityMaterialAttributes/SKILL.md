---
name: find-CEntitySystem_InitEntityMaterialAttributes
description: |
  Agent fallback for CEntitySystem_InitEntityMaterialAttributes (auto-generated, category: func). Locate
  CEntitySystem_InitEntityMaterialAttributes in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_InitEntityMaterialAttributes, CEntitySystem_InitEntityMaterialAttributes
disable-model-invocation: true
---

# Find CEntitySystem_InitEntityMaterialAttributes

Target: `CEntitySystem_InitEntityMaterialAttributes` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_InitEntityMaterialAttributes.{platform}.yaml` with EXACTLY these fields:
