...
description: |
  Agent fallback for CBaseEntity_VPhysicsCollision (auto-generated, category: vfunc). Locate
  CBaseEntity::VPhysicsCollision in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_VPhysicsCollision, CBaseEntity::VPhysicsCollision
disable-model-invocation: true
---

# Find CBaseEntity_VPhysicsCollision

Target: `CBaseEntity::VPhysicsCollision` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_VPhysicsCollision.{platform}.yaml` with EXACTLY these fields:
