...
description: |
  ...
  CBaseEntity_VPhysicsCollision in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_VPhysicsCollision, CBaseEntity_VPhysicsCollision
disable-model-invocation: true
---

# Find CBaseEntity_VPhysicsCollision

Target: `CBaseEntity_VPhysicsCollision` (vfunc) in the module loaded in THIS session.
