...
description: |
  ...
  CGameResourceService_DescribeContents in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_DescribeContents, CGameResourceService_DescribeContents
disable-model-invocation: true
---

# Find CGameResourceService_DescribeContents

Target: `CGameResourceService_DescribeContents` (vfunc) in the module loaded in THIS session.
