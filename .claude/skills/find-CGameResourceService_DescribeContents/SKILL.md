...
description: |
  Agent fallback for CGameResourceService_DescribeContents (auto-generated, category: vfunc). Locate
  CGameResourceService::DescribeContents in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameResourceService_DescribeContents, CGameResourceService::DescribeContents
disable-model-invocation: true
---

# Find CGameResourceService_DescribeContents

Target: `CGameResourceService::DescribeContents` (vfunc) in the module loaded in THIS session.
...
Write `CGameResourceService_DescribeContents.{platform}.yaml` with EXACTLY these fields:
