...
description: |
  Agent fallback for CSource2Server_GetLevelsFromSaveFile (auto-generated, category: vfunc). Locate
  CSource2Server::GetLevelsFromSaveFile in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetLevelsFromSaveFile, CSource2Server::GetLevelsFromSaveFile
disable-model-invocation: true
---

# Find CSource2Server_GetLevelsFromSaveFile

Target: `CSource2Server::GetLevelsFromSaveFile` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_GetLevelsFromSaveFile.{platform}.yaml` with EXACTLY these fields:
