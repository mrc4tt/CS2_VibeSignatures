...
description: |
  ...
  CSource2Server_GetLevelsFromSaveFile in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_GetLevelsFromSaveFile, CSource2Server_GetLevelsFromSaveFile
disable-model-invocation: true
---

# Find CSource2Server_GetLevelsFromSaveFile

Target: `CSource2Server_GetLevelsFromSaveFile` (vfunc) in the module loaded in THIS session.
