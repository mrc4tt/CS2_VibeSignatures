...
description: |
  Agent fallback for CNetworkGameServerBase_KickClient (auto-generated, category: func). Locate
  CNetworkGameServerBase_KickClient in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_KickClient, CNetworkGameServerBase_KickClient
disable-model-invocation: true
---

# Find CNetworkGameServerBase_KickClient

Target: `CNetworkGameServerBase_KickClient` (func) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_KickClient.{platform}.yaml` with EXACTLY these fields:
