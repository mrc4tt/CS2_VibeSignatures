---
name: find-CEntityInstance_UpdateOnRemove-decompiles
description: |
  Agent fallback for CEntityInstance_UpdateOnRemove-decompiles (auto-generated, category: vfunc). Locate
  CEntityInstance::UpdateOnRemove in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_UpdateOnRemove-decompiles, CEntityInstance::UpdateOnRemove
disable-model-invocation: true
---

# Find CEntityInstance_UpdateOnRemove-decompiles

Target: `CEntityInstance::UpdateOnRemove` (vfunc) in the module loaded in THIS session.
...
Write `CEntityInstance_UpdateOnRemove.{platform}.yaml` with EXACTLY these fields:
