...
description: |
  ...
  CEntityInstance_UpdateOnRemove-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_UpdateOnRemove-decompiles, CEntityInstance_UpdateOnRemove-decompiles
disable-model-invocation: true
---

# Find CEntityInstance_UpdateOnRemove-decompiles

Target: `CEntityInstance_UpdateOnRemove-decompiles` (vfunc) in the module loaded in THIS session.
