...
description: |
  ...
  CNetworkSerializerBindingBuildFilter_GetFieldPriority in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSerializerBindingBuildFilter_GetFieldPriority, CNetworkSerializerBindingBuildFilter_GetFieldPriority
disable-model-invocation: true
---

# Find CNetworkSerializerBindingBuildFilter_GetFieldPriority

Target: `CNetworkSerializerBindingBuildFilter_GetFieldPriority` (vfunc) in the module loaded in THIS session.
