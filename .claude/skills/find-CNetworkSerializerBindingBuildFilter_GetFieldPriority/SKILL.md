...
description: |
  Agent fallback for CNetworkSerializerBindingBuildFilter_GetFieldPriority (auto-generated, category: vfunc). Locate
  CNetworkSerializerBindingBuildFilter::GetFieldPriority in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSerializerBindingBuildFilter_GetFieldPriority, CNetworkSerializerBindingBuildFilter::GetFieldPriority
disable-model-invocation: true
---

# Find CNetworkSerializerBindingBuildFilter_GetFieldPriority

Target: `CNetworkSerializerBindingBuildFilter::GetFieldPriority` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkSerializerBindingBuildFilter_GetFieldPriority.{platform}.yaml` with EXACTLY these fields:
