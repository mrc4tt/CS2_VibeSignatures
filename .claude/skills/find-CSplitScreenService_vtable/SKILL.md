...
description: |
  Agent fallback for CSplitScreenService_vtable (auto-generated, category: func). Locate
  CSplitScreenService_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSplitScreenService_vtable, CSplitScreenService_vtable
disable-model-invocation: true
---

# Find CSplitScreenService_vtable

Target: `CSplitScreenService_vtable` (func) in the module loaded in THIS session.
...
Write `CSplitScreenService_vtable.{platform}.yaml` with EXACTLY these fields:
