...
description: |
  Agent fallback for CBasePlayerPawn_PhysicsSimulate (auto-generated, category: vfunc). Locate
  CBasePlayerPawn::PhysicsSimulate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_PhysicsSimulate, CBasePlayerPawn::PhysicsSimulate
disable-model-invocation: true
---

# Find CBasePlayerPawn_PhysicsSimulate

Target: `CBasePlayerPawn::PhysicsSimulate` (vfunc) in the module loaded in THIS session.
...
Write `CBasePlayerPawn_PhysicsSimulate.{platform}.yaml` with EXACTLY these fields:
