...
description: |
  ...
  CBasePlayerPawn_PhysicsSimulate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_PhysicsSimulate, CBasePlayerPawn_PhysicsSimulate
disable-model-invocation: true
---

# Find CBasePlayerPawn_PhysicsSimulate

Target: `CBasePlayerPawn_PhysicsSimulate` (vfunc) in the module loaded in THIS session.
