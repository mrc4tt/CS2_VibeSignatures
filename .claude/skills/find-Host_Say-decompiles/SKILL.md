---
name: find-Host_Say-decompiles
description: |
  Agent fallback for Host_Say-decompiles (auto-generated, category: func). Locate
  Host_Say in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: Host_Say-decompiles, Host_Say
disable-model-invocation: true
---

# Find Host_Say-decompiles

Target: `Host_Say` (func) in the module loaded in THIS session.
...
Write `Host_Say.{platform}.yaml` with EXACTLY these fields:
