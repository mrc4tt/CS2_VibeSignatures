...
description: |
  ...
  Host_Say-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: Host_Say-decompiles, Host_Say-decompiles
disable-model-invocation: true
---

# Find Host_Say-decompiles

Target: `Host_Say-decompiles` (func) in the module loaded in THIS session.
