---
name: find-CNetworkSystem_RemoveNetChannel
description: |
  Agent fallback for CNetworkSystem_RemoveNetChannel (auto-generated, category: vfunc). Locate
  ...
  Trigger: CNetworkSystem_RemoveNetChannel, CNetworkSystem_RemoveNetChannel
disable-model-invocation: true
---

# Find CNetworkSystem_RemoveNetChannel

Target: `CNetworkSystem_RemoveNetChannel` (vfunc) in the module loaded in THIS session.
