...
description: |
  ...
  CNetworkServerService_OnKickByIdHLTV in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_OnKickByIdHLTV, CNetworkServerService_OnKickByIdHLTV
disable-model-invocation: true
---

# Find CNetworkServerService_OnKickByIdHLTV

Target: `CNetworkServerService_OnKickByIdHLTV` (func) in the module loaded in THIS session.
