...
description: |
  Agent fallback for CNetworkServerService_OnKickByIdHLTV (auto-generated, category: func). Locate
  CNetworkServerService::OnKickByIdHLTV in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkServerService_OnKickByIdHLTV, CNetworkServerService::OnKickByIdHLTV
disable-model-invocation: true
---

# Find CNetworkServerService_OnKickByIdHLTV

Target: `CNetworkServerService::OnKickByIdHLTV` (func) in the module loaded in THIS session.
...
Write `CNetworkServerService_OnKickByIdHLTV.{platform}.yaml` with EXACTLY these fields:
