...
description: |
  Agent fallback for CNetworkGameServerBase_ServerSimulate-windows (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::ServerSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerSimulate-windows, CNetworkGameServerBase::ServerSimulate
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerSimulate-windows

Target: `CNetworkGameServerBase::ServerSimulate` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_ServerSimulate.{platform}.yaml` with EXACTLY these fields:
