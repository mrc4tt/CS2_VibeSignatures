...
description: |
  ...
  CNetworkGameServerBase_ServerSimulate-windows in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_ServerSimulate-windows, CNetworkGameServerBase_ServerSimulate-windows
disable-model-invocation: true
---

# Find CNetworkGameServerBase_ServerSimulate-windows

Target: `CNetworkGameServerBase_ServerSimulate-windows` (vfunc) in the module loaded in THIS session.
