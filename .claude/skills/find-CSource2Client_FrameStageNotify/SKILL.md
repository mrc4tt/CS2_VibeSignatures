...
description: |
  ...
  CSource2Client_FrameStageNotify in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Client_FrameStageNotify, CSource2Client_FrameStageNotify
disable-model-invocation: true
---

# Find CSource2Client_FrameStageNotify

Target: `CSource2Client_FrameStageNotify` (vfunc) in the module loaded in THIS session.
