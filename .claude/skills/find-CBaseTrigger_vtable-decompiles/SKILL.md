...
description: |
  ...
  CBaseTrigger_vtable-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseTrigger_vtable-decompiles, CBaseTrigger_vtable-decompiles
disable-model-invocation: true
---

# Find CBaseTrigger_vtable-decompiles

Target: `CBaseTrigger_vtable-decompiles` (func) in the module loaded in THIS session.
