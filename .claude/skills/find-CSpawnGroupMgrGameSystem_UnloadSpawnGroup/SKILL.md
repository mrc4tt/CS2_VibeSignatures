...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_UnloadSpawnGroup (auto-generated, category: vfunc). Locate
  CSpawnGroupMgrGameSystem::UnloadSpawnGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_UnloadSpawnGroup, CSpawnGroupMgrGameSystem::UnloadSpawnGroup
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_UnloadSpawnGroup

Target: `CSpawnGroupMgrGameSystem::UnloadSpawnGroup` (vfunc) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_UnloadSpawnGroup.{platform}.yaml` with EXACTLY these fields:
