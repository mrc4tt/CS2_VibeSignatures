...
description: |
  ...
  CSpawnGroupMgrGameSystem_UnloadSpawnGroup in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_UnloadSpawnGroup, CSpawnGroupMgrGameSystem_UnloadSpawnGroup
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_UnloadSpawnGroup

Target: `CSpawnGroupMgrGameSystem_UnloadSpawnGroup` (vfunc) in the module loaded in THIS session.
