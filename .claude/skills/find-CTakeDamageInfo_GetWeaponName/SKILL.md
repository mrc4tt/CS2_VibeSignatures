...
description: |
  Agent fallback for CTakeDamageInfo_GetWeaponName (auto-generated, category: func). Locate
  CTakeDamageInfo_GetWeaponName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CTakeDamageInfo_GetWeaponName, CTakeDamageInfo_GetWeaponName
disable-model-invocation: true
---

# Find CTakeDamageInfo_GetWeaponName

Target: `CTakeDamageInfo_GetWeaponName` (func) in the module loaded in THIS session.
...
Write `CTakeDamageInfo_GetWeaponName.{platform}.yaml` with EXACTLY these fields:
