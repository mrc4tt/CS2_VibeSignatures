...
description: |
  Agent fallback for INetworkGameServer_ServerAdvanceTick (auto-generated, category: vfunc). Locate
  INetworkGameServer::ServerAdvanceTick in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_ServerAdvanceTick, INetworkGameServer::ServerAdvanceTick
disable-model-invocation: true
---

# Find INetworkGameServer_ServerAdvanceTick

Target: `INetworkGameServer::ServerAdvanceTick` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_ServerAdvanceTick.{platform}.yaml` with EXACTLY these fields:
