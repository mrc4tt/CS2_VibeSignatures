...
description: |
  ...
  INetworkGameServer_ServerAdvanceTick in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_ServerAdvanceTick, INetworkGameServer_ServerAdvanceTick
disable-model-invocation: true
---

# Find INetworkGameServer_ServerAdvanceTick

Target: `INetworkGameServer_ServerAdvanceTick` (vfunc) in the module loaded in THIS session.
