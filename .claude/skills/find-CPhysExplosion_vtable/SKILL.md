...
description: |
  Agent fallback for CPhysExplosion_vtable (auto-generated, category: func). Locate
  CPhysExplosion_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPhysExplosion_vtable, CPhysExplosion_vtable
disable-model-invocation: true
---

# Find CPhysExplosion_vtable

Target: `CPhysExplosion_vtable` (func) in the module loaded in THIS session.
...
Write `CPhysExplosion_vtable.{platform}.yaml` with EXACTLY these fields:
