...
description: |
  ...
  IGameSystem_OnClientPostAdvanceTick in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPostAdvanceTick, IGameSystem_OnClientPostAdvanceTick
disable-model-invocation: true
---

# Find IGameSystem_OnClientPostAdvanceTick

Target: `IGameSystem_OnClientPostAdvanceTick` (vfunc) in the module loaded in THIS session.
