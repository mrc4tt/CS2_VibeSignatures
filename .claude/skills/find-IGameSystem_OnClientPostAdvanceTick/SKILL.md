...
description: |
  Agent fallback for IGameSystem_OnClientPostAdvanceTick (auto-generated, category: vfunc). Locate
  IGameSystem::ClientPostAdvanceTick in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientPostAdvanceTick, IGameSystem::ClientPostAdvanceTick
disable-model-invocation: true
---

# Find IGameSystem_OnClientPostAdvanceTick

Target: `IGameSystem::ClientPostAdvanceTick` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientPostAdvanceTick.{platform}.yaml` with EXACTLY these fields:
