...
description: |
  Agent fallback for CEntitySystem_RegisterAccessor (auto-generated, category: func). Locate
  CEntitySystem::RegisterAccessor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_RegisterAccessor, CEntitySystem::RegisterAccessor
disable-model-invocation: true
---

# Find CEntitySystem_RegisterAccessor

Target: `CEntitySystem::RegisterAccessor` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_RegisterAccessor.{platform}.yaml` with EXACTLY these fields:
