...
description: |
  ...
  CEntitySystem_RegisterAccessor in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_RegisterAccessor, CEntitySystem_RegisterAccessor
disable-model-invocation: true
---

# Find CEntitySystem_RegisterAccessor

Target: `CEntitySystem_RegisterAccessor` (func) in the module loaded in THIS session.
