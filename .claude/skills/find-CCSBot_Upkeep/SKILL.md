...
description: |
  ...
  CCSBot_Upkeep in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSBot_Upkeep, CCSBot_Upkeep
disable-model-invocation: true
---

# Find CCSBot_Upkeep

Target: `CCSBot_Upkeep` (func) in the module loaded in THIS session.
