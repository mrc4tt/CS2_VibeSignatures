...
description: |
  Agent fallback for CNetworkSystem_PrintNetworkStats (auto-generated, category: vfunc). Locate
...
Target: `CNetworkSystem_PrintNetworkStats` (vfunc) in the module loaded in THIS session.
