---
name: find-CNetworkSystem_PrintNetworkStats
description: |
  Agent fallback for CNetworkSystem_PrintNetworkStats (auto-generated, category: func). Locate
  CNetworkSystem_PrintNetworkStats in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_PrintNetworkStats, CNetworkSystem_PrintNetworkStats
disable-model-invocation: true
---

# Find CNetworkSystem_PrintNetworkStats

Target: `CNetworkSystem_PrintNetworkStats` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_PrintNetworkStats.{platform}.yaml` with EXACTLY these fields:
