...
description: |
  ...
  CBasePlayerController_SetConnectedState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_SetConnectedState, CBasePlayerController_SetConnectedState
disable-model-invocation: true
---

# Find CBasePlayerController_SetConnectedState

Target: `CBasePlayerController_SetConnectedState` (func) in the module loaded in THIS session.
