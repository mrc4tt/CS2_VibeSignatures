...
description: |
  ...
  CBasePlayerController::SetConnectedState in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_SetConnectedState, CBasePlayerController::SetConnectedState
disable-model-invocation: true
---

# Find CBasePlayerController_SetConnectedState

Target: `CBasePlayerController::SetConnectedState` (func) in the module loaded in THIS session.
...
Write `CBasePlayerController_SetConnectedState.{platform}.yaml` with EXACTLY these fields:
