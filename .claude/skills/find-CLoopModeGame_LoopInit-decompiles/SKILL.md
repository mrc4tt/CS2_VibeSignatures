...
description: |
  Agent fallback for CLoopModeGame_LoopInit-decompiles (auto-generated, category: vfunc). Locate
  CLoopModeGame::LoopInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopInit-decompiles, CLoopModeGame::LoopInit
disable-model-invocation: true
---

# Find CLoopModeGame_LoopInit-decompiles

Target: `CLoopModeGame::LoopInit` (vfunc) in the module loaded in THIS session.
...
Write `CLoopModeGame_LoopInit.{platform}.yaml` with EXACTLY these fields:
