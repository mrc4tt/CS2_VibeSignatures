...
description: |
  ...
  CLoopModeGame_LoopInit-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopInit-decompiles, CLoopModeGame_LoopInit-decompiles
disable-model-invocation: true
---

# Find CLoopModeGame_LoopInit-decompiles

Target: `CLoopModeGame_LoopInit-decompiles` (vfunc) in the module loaded in THIS session.
