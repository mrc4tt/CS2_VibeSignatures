...
description: |
  ...
  IGameSystem_OnServerAdvanceTick in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerAdvanceTick, IGameSystem_OnServerAdvanceTick
disable-model-invocation: true
---

# Find IGameSystem_OnServerAdvanceTick

Target: `IGameSystem_OnServerAdvanceTick` (vfunc) in the module loaded in THIS session.
