...
description: |
  Agent fallback for IGameSystem_OnServerAdvanceTick (auto-generated, category: vfunc). Locate
  IGameSystem::ServerAdvanceTick in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnServerAdvanceTick, IGameSystem::ServerAdvanceTick
disable-model-invocation: true
---

# Find IGameSystem_OnServerAdvanceTick

Target: `IGameSystem::ServerAdvanceTick` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnServerAdvanceTick.{platform}.yaml` with EXACTLY these fields:
