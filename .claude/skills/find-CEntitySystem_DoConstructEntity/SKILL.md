...
description: |
  Agent fallback for CEntitySystem_DoConstructEntity (auto-generated, category: func). Locate
  CEntitySystem::DoConstructEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_DoConstructEntity, CEntitySystem::DoConstructEntity
disable-model-invocation: true
---

# Find CEntitySystem_DoConstructEntity

Target: `CEntitySystem::DoConstructEntity` (func) in the module loaded in THIS session.
...
Write `CEntitySystem_DoConstructEntity.{platform}.yaml` with EXACTLY these fields:
