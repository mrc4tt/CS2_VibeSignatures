...
description: |
  ...
  CEntitySystem_DoConstructEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_DoConstructEntity, CEntitySystem_DoConstructEntity
disable-model-invocation: true
---

# Find CEntitySystem_DoConstructEntity

Target: `CEntitySystem_DoConstructEntity` (func) in the module loaded in THIS session.
