...
description: |
  Agent fallback for CNetworkGameClientBase_ClockDrift_AdjustFrameTime (auto-generated, category: func). Locate
  CNetworkGameClientBase::ClockDrift_AdjustFrameTime in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ClockDrift_AdjustFrameTime, CNetworkGameClientBase::ClockDrift_AdjustFrameTime
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ClockDrift_AdjustFrameTime

Target: `CNetworkGameClientBase::ClockDrift_AdjustFrameTime` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ClockDrift_AdjustFrameTime.{platform}.yaml` with EXACTLY these fields:
