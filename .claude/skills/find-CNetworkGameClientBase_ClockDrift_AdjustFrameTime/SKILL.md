...
description: |
  ...
  CNetworkGameClientBase_ClockDrift_AdjustFrameTime in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ClockDrift_AdjustFrameTime, CNetworkGameClientBase_ClockDrift_AdjustFrameTime
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ClockDrift_AdjustFrameTime

Target: `CNetworkGameClientBase_ClockDrift_AdjustFrameTime` (func) in the module loaded in THIS session.
