...
description: |
  Agent fallback for CEntityKeyValues_Initialized (auto-generated, category: func). Locate
  CEntityKeyValues::Initialized in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityKeyValues_Initialized, CEntityKeyValues::Initialized
disable-model-invocation: true
---

# Find CEntityKeyValues_Initialized

Target: `CEntityKeyValues::Initialized` (func) in the module loaded in THIS session.
...
Write `CEntityKeyValues_Initialized.{platform}.yaml` with EXACTLY these fields:
