...
description: |
  ...
  CEntityKeyValues_Initialized in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityKeyValues_Initialized, CEntityKeyValues_Initialized
disable-model-invocation: true
---

# Find CEntityKeyValues_Initialized

Target: `CEntityKeyValues_Initialized` (func) in the module loaded in THIS session.
