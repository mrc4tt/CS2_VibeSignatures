...
description: |
  Agent fallback for INetworkGameServer_GetClientConnectionType (auto-generated, category: vfunc). Locate
  INetworkGameServer::GetClientConnectionType in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetClientConnectionType, INetworkGameServer::GetClientConnectionType
disable-model-invocation: true
---

# Find INetworkGameServer_GetClientConnectionType

Target: `INetworkGameServer::GetClientConnectionType` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_GetClientConnectionType.{platform}.yaml` with EXACTLY these fields:
