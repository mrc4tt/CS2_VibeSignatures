...
description: |
  ...
  INetworkGameServer_GetClientConnectionType in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_GetClientConnectionType, INetworkGameServer_GetClientConnectionType
disable-model-invocation: true
---

# Find INetworkGameServer_GetClientConnectionType

Target: `INetworkGameServer_GetClientConnectionType` (vfunc) in the module loaded in THIS session.
