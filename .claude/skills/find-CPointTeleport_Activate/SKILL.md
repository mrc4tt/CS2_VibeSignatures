...
description: |
  Agent fallback for CPointTeleport_Activate (auto-generated, category: vfunc). Locate
  CPointTeleport::Activate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPointTeleport_Activate, CPointTeleport::Activate
disable-model-invocation: true
---

# Find CPointTeleport_Activate

Target: `CPointTeleport::Activate` (vfunc) in the module loaded in THIS session.
...
Write `CPointTeleport_Activate.{platform}.yaml` with EXACTLY these fields:
