...
description: |
  ...
  CPointTeleport_Activate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CPointTeleport_Activate, CPointTeleport_Activate
disable-model-invocation: true
---

# Find CPointTeleport_Activate

Target: `CPointTeleport_Activate` (vfunc) in the module loaded in THIS session.
