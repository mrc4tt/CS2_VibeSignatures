...
description: |
  Agent fallback for IGameSystem_OnClientDisconnect (auto-generated, category: vfunc). Locate
  IGameSystem::OnClientDisconnect in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientDisconnect, IGameSystem::OnClientDisconnect
disable-model-invocation: true
---

# Find IGameSystem_OnClientDisconnect

Target: `IGameSystem::OnClientDisconnect` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientDisconnect.{platform}.yaml` with EXACTLY these fields:
