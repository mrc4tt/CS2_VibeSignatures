...
description: |
  ...
  IGameSystem_OnClientDisconnect in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientDisconnect, IGameSystem_OnClientDisconnect
disable-model-invocation: true
---

# Find IGameSystem_OnClientDisconnect

Target: `IGameSystem_OnClientDisconnect` (vfunc) in the module loaded in THIS session.
