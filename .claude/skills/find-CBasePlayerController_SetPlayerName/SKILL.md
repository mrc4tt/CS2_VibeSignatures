...
description: |
  ...
  CBasePlayerController_SetPlayerName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_SetPlayerName, CBasePlayerController_SetPlayerName
disable-model-invocation: true
---

# Find CBasePlayerController_SetPlayerName

Target: `CBasePlayerController_SetPlayerName` (func) in the module loaded in THIS session.
