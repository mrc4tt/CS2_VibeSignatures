...
description: |
  Agent fallback for CBasePlayerController_SetPlayerName (auto-generated, category: func). Locate
  CBasePlayerController::SetPlayerName in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerController_SetPlayerName, CBasePlayerController::SetPlayerName
disable-model-invocation: true
---

# Find CBasePlayerController_SetPlayerName

Target: `CBasePlayerController::SetPlayerName` (func) in the module loaded in THIS session.
...
Write `CBasePlayerController_SetPlayerName.{platform}.yaml` with EXACTLY these fields:
