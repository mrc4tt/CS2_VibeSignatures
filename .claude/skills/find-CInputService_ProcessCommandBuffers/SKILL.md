---
name: find-CInputService_ProcessCommandBuffers
description: |
  Agent fallback for CInputService_ProcessCommandBuffers (auto-generated, category: func). Locate
  CInputService_ProcessCommandBuffers in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CInputService_ProcessCommandBuffers, CInputService_ProcessCommandBuffers
disable-model-invocation: true
---

# Find CInputService_ProcessCommandBuffers

Target: `CInputService_ProcessCommandBuffers` (func) in the module loaded in THIS session.
...
Write `CInputService_ProcessCommandBuffers.{platform}.yaml` with EXACTLY these fields:
