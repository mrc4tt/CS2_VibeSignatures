...
description: |
  Agent fallback for IGameSystem_OnGameInit (auto-generated, category: vfunc). Locate
  IGameSystem::GameInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGameInit, IGameSystem::GameInit
disable-model-invocation: true
---

# Find IGameSystem_OnGameInit

Target: `IGameSystem::GameInit` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnGameInit.{platform}.yaml` with EXACTLY these fields:
