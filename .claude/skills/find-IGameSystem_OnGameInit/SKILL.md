...
description: |
  ...
  IGameSystem_OnGameInit in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnGameInit, IGameSystem_OnGameInit
disable-model-invocation: true
---

# Find IGameSystem_OnGameInit

Target: `IGameSystem_OnGameInit` (vfunc) in the module loaded in THIS session.
