...
description: |
  Agent fallback for DecalPlacementInfo_ctor-decompiles (auto-generated, category: func). Locate
  DecalPlacementInfo::DecalPlacementInfo in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: DecalPlacementInfo_ctor-decompiles, DecalPlacementInfo::DecalPlacementInfo
disable-model-invocation: true
---

# Find DecalPlacementInfo_ctor-decompiles

Target: `DecalPlacementInfo::DecalPlacementInfo` (func) in the module loaded in THIS session.
...
Write `DecalPlacementInfo_ctor.{platform}.yaml` with EXACTLY these fields:
