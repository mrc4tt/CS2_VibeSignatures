...
description: |
  ...
  DecalPlacementInfo_ctor-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: DecalPlacementInfo_ctor-decompiles, DecalPlacementInfo_ctor-decompiles
disable-model-invocation: true
---

# Find DecalPlacementInfo_ctor-decompiles

Target: `DecalPlacementInfo_ctor-decompiles` (func) in the module loaded in THIS session.
