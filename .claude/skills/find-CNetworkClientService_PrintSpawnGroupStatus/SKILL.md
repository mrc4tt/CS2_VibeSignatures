...
description: |
  ...
  CNetworkClientService_PrintSpawnGroupStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_PrintSpawnGroupStatus, CNetworkClientService_PrintSpawnGroupStatus
disable-model-invocation: true
---

# Find CNetworkClientService_PrintSpawnGroupStatus

Target: `CNetworkClientService_PrintSpawnGroupStatus` (vfunc) in the module loaded in THIS session.
