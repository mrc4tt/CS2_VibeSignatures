...
description: |
  Agent fallback for CNetworkClientService_PrintSpawnGroupStatus (auto-generated, category: vfunc). Locate
  CNetworkClientService::PrintSpawnGroupStatus in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_PrintSpawnGroupStatus, CNetworkClientService::PrintSpawnGroupStatus
disable-model-invocation: true
---

# Find CNetworkClientService_PrintSpawnGroupStatus

Target: `CNetworkClientService::PrintSpawnGroupStatus` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_PrintSpawnGroupStatus.{platform}.yaml` with EXACTLY these fields:
