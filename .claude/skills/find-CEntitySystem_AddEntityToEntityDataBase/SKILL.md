...
description: |
  ...
  CEntitySystem_AddEntityToEntityDataBase in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_AddEntityToEntityDataBase, CEntitySystem_AddEntityToEntityDataBase
disable-model-invocation: true
---

# Find CEntitySystem_AddEntityToEntityDataBase

Target: `CEntitySystem_AddEntityToEntityDataBase` (func) in the module loaded in THIS session.
