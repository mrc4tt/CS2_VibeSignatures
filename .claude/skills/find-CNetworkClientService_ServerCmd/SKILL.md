...
description: |
  ...
  CNetworkClientService_ServerCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_ServerCmd, CNetworkClientService_ServerCmd
disable-model-invocation: true
---

# Find CNetworkClientService_ServerCmd

Target: `CNetworkClientService_ServerCmd` (vfunc) in the module loaded in THIS session.
