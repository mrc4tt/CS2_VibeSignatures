...
description: |
  Agent fallback for CNetworkClientService_ServerCmd (auto-generated, category: vfunc). Locate
  CNetworkClientService::ServerCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkClientService_ServerCmd, CNetworkClientService::ServerCmd
disable-model-invocation: true
---

# Find CNetworkClientService_ServerCmd

Target: `CNetworkClientService::ServerCmd` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkClientService_ServerCmd.{platform}.yaml` with EXACTLY these fields:
