...
description: |
  ...
  CNetworkGameClientBase_ProcessCreateStringTable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessCreateStringTable, CNetworkGameClientBase_ProcessCreateStringTable
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessCreateStringTable

Target: `CNetworkGameClientBase_ProcessCreateStringTable` (vfunc) in the module loaded in THIS session.
