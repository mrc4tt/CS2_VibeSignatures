---
name: find-CNetworkGameClientBase_ProcessCreateStringTable
description: |
  Agent fallback for CNetworkGameClientBase_ProcessCreateStringTable (auto-generated, category: vfunc). Locate
  CNetworkGameClientBase::ProcessCreateStringTable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_ProcessCreateStringTable, CNetworkGameClientBase::ProcessCreateStringTable
disable-model-invocation: true
---

# Find CNetworkGameClientBase_ProcessCreateStringTable

Target: `CNetworkGameClientBase::ProcessCreateStringTable` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_ProcessCreateStringTable.{platform}.yaml` with EXACTLY these fields:
