...
description: |
  ...
  CGameEntitySystem_ctor in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_ctor, CGameEntitySystem_ctor
disable-model-invocation: true
---

# Find CGameEntitySystem_ctor

Target: `CGameEntitySystem_ctor` (func) in the module loaded in THIS session.
