...
description: |
  Agent fallback for CGameEntitySystem_ctor (auto-generated, category: func). Locate
  CGameEntitySystem::CGameEntitySystem in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameEntitySystem_ctor, CGameEntitySystem::CGameEntitySystem
disable-model-invocation: true
---

# Find CGameEntitySystem_ctor

Target: `CGameEntitySystem::CGameEntitySystem` (func) in the module loaded in THIS session.
...
Write `CGameEntitySystem_ctor.{platform}.yaml` with EXACTLY these fields:
