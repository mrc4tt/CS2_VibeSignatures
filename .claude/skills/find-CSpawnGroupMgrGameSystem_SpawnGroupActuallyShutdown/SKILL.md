...
description: |
  Agent fallback for CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown (auto-generated, category: func). Locate
  CSpawnGroupMgrGameSystem::SpawnGroupActuallyShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown, CSpawnGroupMgrGameSystem::SpawnGroupActuallyShutdown
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown

Target: `CSpawnGroupMgrGameSystem::SpawnGroupActuallyShutdown` (func) in the module loaded in THIS session.
...
Write `CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown.{platform}.yaml` with EXACTLY these fields:
