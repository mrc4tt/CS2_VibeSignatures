...
description: |
  ...
  CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown, CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown
disable-model-invocation: true
---

# Find CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown

Target: `CSpawnGroupMgrGameSystem_SpawnGroupActuallyShutdown` (func) in the module loaded in THIS session.
