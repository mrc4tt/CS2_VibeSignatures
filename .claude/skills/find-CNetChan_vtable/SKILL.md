...
description: |
  Agent fallback for CNetChan_vtable (auto-generated, category: func). Locate
  CNetChan_vtable in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetChan_vtable, CNetChan_vtable
disable-model-invocation: true
---

# Find CNetChan_vtable

Target: `CNetChan_vtable` (func) in the module loaded in THIS session.
...
Write `CNetChan_vtable.{platform}.yaml` with EXACTLY these fields:
