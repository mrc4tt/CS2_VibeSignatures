---
name: find-CCSPlayerPawn_CreatePlayerPawnServices
description: |
  Agent fallback for CCSPlayerPawn_CreatePlayerPawnServices (auto-generated, category: vfunc). Locate
  CCSPlayerPawn::CreatePlayerPawnServices in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_CreatePlayerPawnServices, CCSPlayerPawn::CreatePlayerPawnServices
disable-model-invocation: true
---

# Find CCSPlayerPawn_CreatePlayerPawnServices

Target: `CCSPlayerPawn::CreatePlayerPawnServices` (vfunc) in the module loaded in THIS session.
...
Write `CCSPlayerPawn_CreatePlayerPawnServices.{platform}.yaml` with EXACTLY these fields:
