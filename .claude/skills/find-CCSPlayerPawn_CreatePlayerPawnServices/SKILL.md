...
description: |
  ...
  CCSPlayerPawn_CreatePlayerPawnServices in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerPawn_CreatePlayerPawnServices, CCSPlayerPawn_CreatePlayerPawnServices
disable-model-invocation: true
---

# Find CCSPlayerPawn_CreatePlayerPawnServices

Target: `CCSPlayerPawn_CreatePlayerPawnServices` (vfunc) in the module loaded in THIS session.
