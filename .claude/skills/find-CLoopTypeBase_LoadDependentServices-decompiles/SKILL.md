---
name: find-CLoopTypeBase_LoadDependentServices-decompiles
description: |
  Agent fallback for CLoopTypeBase_LoadDependentServices-decompiles (auto-generated, category: func). Locate
  CLoopTypeBase::LoadDependentServices in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_LoadDependentServices-decompiles, CLoopTypeBase::LoadDependentServices
disable-model-invocation: true
---

# Find CLoopTypeBase_LoadDependentServices-decompiles

Target: `CLoopTypeBase::LoadDependentServices` (func) in the module loaded in THIS session.
...
Write `CLoopTypeBase_LoadDependentServices.{platform}.yaml` with EXACTLY these fields:
