...
description: |
  ...
  CLoopTypeBase_LoadDependentServices-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeBase_LoadDependentServices-decompiles, CLoopTypeBase_LoadDependentServices-decompiles
disable-model-invocation: true
---

# Find CLoopTypeBase_LoadDependentServices-decompiles

Target: `CLoopTypeBase_LoadDependentServices-decompiles` (func) in the module loaded in THIS session.
