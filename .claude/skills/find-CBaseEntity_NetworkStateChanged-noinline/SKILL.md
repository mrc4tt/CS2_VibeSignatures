...
description: |
  ...
  CBaseEntity_NetworkStateChanged-noinline in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_NetworkStateChanged-noinline, CBaseEntity_NetworkStateChanged-noinline
disable-model-invocation: true
---

# Find CBaseEntity_NetworkStateChanged-noinline

Target: `CBaseEntity_NetworkStateChanged-noinline` (vfunc) in the module loaded in THIS session.
