---
name: find-CBaseEntity_NetworkStateChanged-noinline
description: |
  Agent fallback for CBaseEntity_NetworkStateChanged-noinline (auto-generated, category: vfunc). Locate
  CBaseEntity::NetworkStateChanged in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_NetworkStateChanged-noinline, CBaseEntity::NetworkStateChanged
disable-model-invocation: true
---

# Find CBaseEntity_NetworkStateChanged-noinline

Target: `CBaseEntity::NetworkStateChanged` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_NetworkStateChanged.{platform}.yaml` with EXACTLY these fields:
