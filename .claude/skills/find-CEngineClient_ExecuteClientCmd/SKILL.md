---
name: find-CEngineClient_ExecuteClientCmd
description: |
  Agent fallback for CEngineClient_ExecuteClientCmd (auto-generated, category: func). Locate
  CEngineClient_ExecuteClientCmd in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_ExecuteClientCmd, CEngineClient_ExecuteClientCmd
disable-model-invocation: true
---

# Find CEngineClient_ExecuteClientCmd

Target: `CEngineClient_ExecuteClientCmd` (func) in the module loaded in THIS session.
...
Write `CEngineClient_ExecuteClientCmd.{platform}.yaml` with EXACTLY these fields:
