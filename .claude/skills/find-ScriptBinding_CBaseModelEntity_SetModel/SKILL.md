...
description: |
  ...
  ScriptBinding_CBaseModelEntity_SetModel in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ScriptBinding_CBaseModelEntity_SetModel, ScriptBinding_CBaseModelEntity_SetModel
disable-model-invocation: true
---

# Find ScriptBinding_CBaseModelEntity_SetModel

Target: `ScriptBinding_CBaseModelEntity_SetModel` (func) in the module loaded in THIS session.
