---
name: find-ScriptBinding_CBaseModelEntity_SetModel
description: |
  Agent fallback for ScriptBinding_CBaseModelEntity_SetModel (auto-generated, category: func). Locate
  CS_Script_SetModel in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ScriptBinding_CBaseModelEntity_SetModel, CS_Script_SetModel
disable-model-invocation: true
---

# Find ScriptBinding_CBaseModelEntity_SetModel

Target: `CS_Script_SetModel` (func) in the module loaded in THIS session.
...
Write `ScriptBinding_CBaseModelEntity_SetModel.{platform}.yaml` with EXACTLY these fields:
