---
name: find-CLoopTypeSimpleService_vtable
description: |
  Agent fallback for CLoopTypeSimpleService_vtable (auto-generated, category: func). Locate
  CLoopTypeSimpleService_vtable in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeSimpleService_vtable, CLoopTypeSimpleService_vtable
disable-model-invocation: true
---

# Find CLoopTypeSimpleService_vtable

Target: `CLoopTypeSimpleService_vtable` (func) in the module loaded in THIS session.
...
Write `CLoopTypeSimpleService_vtable.{platform}.yaml` with EXACTLY these fields:
