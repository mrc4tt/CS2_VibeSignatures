...
description: |
  ...
  CNetworkGameServer_PreWorldUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_PreWorldUpdate, CNetworkGameServer_PreWorldUpdate
disable-model-invocation: true
---

# Find CNetworkGameServer_PreWorldUpdate

Target: `CNetworkGameServer_PreWorldUpdate` (vfunc) in the module loaded in THIS session.
