...
description: |
  Agent fallback for CNetworkGameServer_PreWorldUpdate (auto-generated, category: vfunc). Locate
  CNetworkGameServer::PreWorldUpdate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServer_PreWorldUpdate, CNetworkGameServer::PreWorldUpdate
disable-model-invocation: true
---

# Find CNetworkGameServer_PreWorldUpdate

Target: `CNetworkGameServer::PreWorldUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServer_PreWorldUpdate.{platform}.yaml` with EXACTLY these fields:
