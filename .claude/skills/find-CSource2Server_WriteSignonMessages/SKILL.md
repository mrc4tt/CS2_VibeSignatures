...
description: |
  ...
  CSource2Server_WriteSignonMessages in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_WriteSignonMessages, CSource2Server_WriteSignonMessages
disable-model-invocation: true
---

# Find CSource2Server_WriteSignonMessages

Target: `CSource2Server_WriteSignonMessages` (vfunc) in the module loaded in THIS session.
