...
description: |
  Agent fallback for CSource2Server_WriteSignonMessages (auto-generated, category: vfunc). Locate
  CSource2Server::WriteSignonMessages in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2Server_WriteSignonMessages, CSource2Server::WriteSignonMessages
disable-model-invocation: true
---

# Find CSource2Server_WriteSignonMessages

Target: `CSource2Server::WriteSignonMessages` (vfunc) in the module loaded in THIS session.
...
Write `CSource2Server_WriteSignonMessages.{platform}.yaml` with EXACTLY these fields:
