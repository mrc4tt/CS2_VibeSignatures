...
description: |
  ...
  CGameSceneNode_PostDataUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_PostDataUpdate, CGameSceneNode_PostDataUpdate
disable-model-invocation: true
---

# Find CGameSceneNode_PostDataUpdate

Target: `CGameSceneNode_PostDataUpdate` (vfunc) in the module loaded in THIS session.
