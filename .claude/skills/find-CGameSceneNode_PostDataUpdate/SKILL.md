...
description: |
  Agent fallback for CGameSceneNode_PostDataUpdate (auto-generated, category: vfunc). Locate
  CGameSceneNode::PostDataUpdate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameSceneNode_PostDataUpdate, CGameSceneNode::PostDataUpdate
disable-model-invocation: true
---

# Find CGameSceneNode_PostDataUpdate

Target: `CGameSceneNode::PostDataUpdate` (vfunc) in the module loaded in THIS session.
...
Write `CGameSceneNode_PostDataUpdate.{platform}.yaml` with EXACTLY these fields:
