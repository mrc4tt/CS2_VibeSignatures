...
description: |
  Agent fallback for CGameRulesGameSystem_vtable (auto-generated, category: func). Locate
  CGameRulesGameSystem_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CGameRulesGameSystem_vtable, CGameRulesGameSystem_vtable
disable-model-invocation: true
---

# Find CGameRulesGameSystem_vtable

Target: `CGameRulesGameSystem_vtable` (func) in the module loaded in THIS session.
...
Write `CGameRulesGameSystem_vtable.{platform}.yaml` with EXACTLY these fields:
