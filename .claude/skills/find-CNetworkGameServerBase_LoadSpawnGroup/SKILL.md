...
description: |
  ...
  CNetworkGameServerBase_LoadSpawnGroup in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_LoadSpawnGroup, CNetworkGameServerBase_LoadSpawnGroup
disable-model-invocation: true
---

# Find CNetworkGameServerBase_LoadSpawnGroup

Target: `CNetworkGameServerBase_LoadSpawnGroup` (vfunc) in the module loaded in THIS session.
