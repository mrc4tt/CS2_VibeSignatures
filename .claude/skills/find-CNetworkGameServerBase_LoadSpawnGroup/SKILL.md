...
description: |
  Agent fallback for CNetworkGameServerBase_LoadSpawnGroup (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::LoadSpawnGroup in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_LoadSpawnGroup, CNetworkGameServerBase::LoadSpawnGroup
disable-model-invocation: true
---

# Find CNetworkGameServerBase_LoadSpawnGroup

Target: `CNetworkGameServerBase::LoadSpawnGroup` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_LoadSpawnGroup.{platform}.yaml` with EXACTLY these fields:
