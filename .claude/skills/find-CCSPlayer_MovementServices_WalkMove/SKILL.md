...
description: |
  ...
  CCSPlayer_MovementServices_WalkMove in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_MovementServices_WalkMove, CCSPlayer_MovementServices_WalkMove
disable-model-invocation: true
---

# Find CCSPlayer_MovementServices_WalkMove

Target: `CCSPlayer_MovementServices_WalkMove` (func) in the module loaded in THIS session.
