...
description: |
  ...
  CSteam3Server_SendUpdatedServerDetails-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSteam3Server_SendUpdatedServerDetails-decompiles, CSteam3Server_SendUpdatedServerDetails-decompiles
disable-model-invocation: true
---

# Find CSteam3Server_SendUpdatedServerDetails-decompiles

Target: `CSteam3Server_SendUpdatedServerDetails-decompiles` (func) in the module loaded in THIS session.
