...
description: |
  Agent fallback for CSteam3Server_SendUpdatedServerDetails-decompiles (auto-generated, category: func). Locate
  CSteam3Server::SendUpdatedServerDetails in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSteam3Server_SendUpdatedServerDetails-decompiles, CSteam3Server::SendUpdatedServerDetails
disable-model-invocation: true
---

# Find CSteam3Server_SendUpdatedServerDetails-decompiles

Target: `CSteam3Server::SendUpdatedServerDetails` (func) in the module loaded in THIS session.
...
Write `CSteam3Server_SendUpdatedServerDetails.{platform}.yaml` with EXACTLY these fields:
