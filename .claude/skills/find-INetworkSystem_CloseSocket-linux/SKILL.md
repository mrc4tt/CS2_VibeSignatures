---
name: find-INetworkSystem_CloseSocket-linux
description: |
  Agent fallback for INetworkSystem_CloseSocket-linux (auto-generated, category: vfunc). Locate
  INetworkSystem::CloseSocket in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkSystem_CloseSocket-linux, INetworkSystem::CloseSocket
disable-model-invocation: true
---

# Find INetworkSystem_CloseSocket-linux

Target: `INetworkSystem::CloseSocket` (vfunc) in the module loaded in THIS session.
...
Write `INetworkSystem_CloseSocket.{platform}.yaml` with EXACTLY these fields:
