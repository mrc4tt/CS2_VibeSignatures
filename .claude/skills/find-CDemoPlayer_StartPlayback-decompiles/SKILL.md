...
description: |
  ...
  CDemoPlayer_StartPlayback-decompiles in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_StartPlayback-decompiles, CDemoPlayer_StartPlayback-decompiles
disable-model-invocation: true
---

# Find CDemoPlayer_StartPlayback-decompiles

Target: `CDemoPlayer_StartPlayback-decompiles` (vfunc) in the module loaded in THIS session.
