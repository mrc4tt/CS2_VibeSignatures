...
description: |
  Agent fallback for CDemoPlayer_StartPlayback-decompiles (auto-generated, category: vfunc). Locate
  CDemoPlayer::StartPlayback in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CDemoPlayer_StartPlayback-decompiles, CDemoPlayer::StartPlayback
disable-model-invocation: true
---

# Find CDemoPlayer_StartPlayback-decompiles

Target: `CDemoPlayer::StartPlayback` (vfunc) in the module loaded in THIS session.
...
Write `CDemoPlayer_StartPlayback.{platform}.yaml` with EXACTLY these fields:
