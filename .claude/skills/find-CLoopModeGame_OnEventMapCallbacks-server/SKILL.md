...
description: |
  ...
  CLoopModeGame_OnEventMapCallbacks-server in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnEventMapCallbacks-server, CLoopModeGame_OnEventMapCallbacks-server
disable-model-invocation: true
---

# Find CLoopModeGame_OnEventMapCallbacks-server

Target: `CLoopModeGame_OnEventMapCallbacks-server` (func) in the module loaded in THIS session.
