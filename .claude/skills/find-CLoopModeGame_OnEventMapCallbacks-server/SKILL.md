...
description: |
  Agent fallback for CLoopModeGame_OnEventMapCallbacks-server (auto-generated, category: func). Locate
  CLoopModeGame_OnEventMapCallbacks in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_OnEventMapCallbacks-server, CLoopModeGame_OnEventMapCallbacks
disable-model-invocation: true
---

# Find CLoopModeGame_OnEventMapCallbacks-server

Target: `CLoopModeGame_OnEventMapCallbacks` (func) in the module loaded in THIS session.
...
Write `CLoopModeGame_OnEventMapCallbacks.{platform}.yaml` with EXACTLY these fields:
