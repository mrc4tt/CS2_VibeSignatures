...
description: |
  Agent fallback for CEntitySpawner_CPlayerSprayDecal_Spawn (auto-generated, category: func). Locate
  CEntitySpawner<CPlayerSprayDecal>::Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySpawner_CPlayerSprayDecal_Spawn, CEntitySpawner<CPlayerSprayDecal>::Spawn
disable-model-invocation: true
---

# Find CEntitySpawner_CPlayerSprayDecal_Spawn

Target: `CEntitySpawner<CPlayerSprayDecal>::Spawn` (func) in the module loaded in THIS session.
...
Write `CEntitySpawner_CPlayerSprayDecal_Spawn.{platform}.yaml` with EXACTLY these fields:
