...
description: |
  ...
  CEntitySpawner_CPlayerSprayDecal_Spawn in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySpawner_CPlayerSprayDecal_Spawn, CEntitySpawner_CPlayerSprayDecal_Spawn
disable-model-invocation: true
---

# Find CEntitySpawner_CPlayerSprayDecal_Spawn

Target: `CEntitySpawner_CPlayerSprayDecal_Spawn` (func) in the module loaded in THIS session.
