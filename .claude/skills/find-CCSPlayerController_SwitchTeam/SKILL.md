...
description: |
  ...
  CCSPlayerController_SwitchTeam in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_SwitchTeam, CCSPlayerController_SwitchTeam
disable-model-invocation: true
---

# Find CCSPlayerController_SwitchTeam

Target: `CCSPlayerController_SwitchTeam` (func) in the module loaded in THIS session.
