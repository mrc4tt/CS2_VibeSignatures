...
description: |
  ...
  CCSPlayerController::SwitchTeam in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayerController_SwitchTeam, CCSPlayerController::SwitchTeam
disable-model-invocation: true
---

# Find CCSPlayerController_SwitchTeam

Target: `CCSPlayerController::SwitchTeam` (func) in the module loaded in THIS session.
...
Write `CCSPlayerController_SwitchTeam.{platform}.yaml` with EXACTLY these fields:
