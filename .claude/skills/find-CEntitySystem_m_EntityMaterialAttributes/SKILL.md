---
name: find-CEntitySystem_m_EntityMaterialAttributes
description: |
  Agent fallback for CEntitySystem_m_EntityMaterialAttributes (auto-generated, category: structmember). Locate
  CEntitySystem::m_EntityMaterialAttributes in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_m_EntityMaterialAttributes, CEntitySystem::m_EntityMaterialAttributes
disable-model-invocation: true
---

# Find CEntitySystem_m_EntityMaterialAttributes

Target: `CEntitySystem::m_EntityMaterialAttributes` (structmember) in the module loaded in THIS session.
...
Write `CEntitySystem_m_EntityMaterialAttributes.{platform}.yaml` with EXACTLY these fields:
