...
uv run ida_analyze_bin.py -configyaml=_scratch.yaml -gamever <deinlined_ver>  -oldgamever none -modules=<mod> -oldgamever none -debug
uv run ida_analyze_bin.py -configyaml=_scratch.yaml -gamever <inlined_ver>  -oldgamever none  -modules=<mod> -oldgamever none -debug
```
