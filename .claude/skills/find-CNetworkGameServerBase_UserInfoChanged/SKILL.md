---
name: find-CNetworkGameServerBase_UserInfoChanged
description: |
  Agent fallback for CNetworkGameServerBase_UserInfoChanged (auto-generated, category: vfunc). Locate
  CNetworkGameServerBase::UserInfoChanged in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_UserInfoChanged, CNetworkGameServerBase::UserInfoChanged
disable-model-invocation: true
---

# Find CNetworkGameServerBase_UserInfoChanged

Target: `CNetworkGameServerBase::UserInfoChanged` (vfunc) in the module loaded in THIS session.
...
Write `CNetworkGameServerBase_UserInfoChanged.{platform}.yaml` with EXACTLY these fields:
