...
description: |
  ...
  CNetworkGameServerBase_UserInfoChanged in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameServerBase_UserInfoChanged, CNetworkGameServerBase_UserInfoChanged
disable-model-invocation: true
---

# Find CNetworkGameServerBase_UserInfoChanged

Target: `CNetworkGameServerBase_UserInfoChanged` (vfunc) in the module loaded in THIS session.
