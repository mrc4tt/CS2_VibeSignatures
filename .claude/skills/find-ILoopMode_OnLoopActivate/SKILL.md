...
description: |
  ...
  ILoopMode_OnLoopActivate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_OnLoopActivate, ILoopMode_OnLoopActivate
disable-model-invocation: true
---

# Find ILoopMode_OnLoopActivate

Target: `ILoopMode_OnLoopActivate` (vfunc) in the module loaded in THIS session.
