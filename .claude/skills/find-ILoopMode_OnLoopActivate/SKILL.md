...
description: |
  Agent fallback for ILoopMode_OnLoopActivate (auto-generated, category: vfunc). Locate
  ILoopMode::OnLoopActivate in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: ILoopMode_OnLoopActivate, ILoopMode::OnLoopActivate
disable-model-invocation: true
---

# Find ILoopMode_OnLoopActivate

Target: `ILoopMode::OnLoopActivate` (vfunc) in the module loaded in THIS session.
...
Write `ILoopMode_OnLoopActivate.{platform}.yaml` with EXACTLY these fields:
