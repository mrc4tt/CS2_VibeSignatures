...
description: |
  ...
  CBaseEntity_SetOwner in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_SetOwner, CBaseEntity_SetOwner
disable-model-invocation: true
---

# Find CBaseEntity_SetOwner

Target: `CBaseEntity_SetOwner` (vfunc) in the module loaded in THIS session.
