...
description: |
  Agent fallback for CBaseEntity_SetOwner (auto-generated, category: vfunc). Locate
  CBaseEntity::SetOwner in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBaseEntity_SetOwner, CBaseEntity::SetOwner
disable-model-invocation: true
---

# Find CBaseEntity_SetOwner

Target: `CBaseEntity::SetOwner` (vfunc) in the module loaded in THIS session.
...
Write `CBaseEntity_SetOwner.{platform}.yaml` with EXACTLY these fields:
