...
description: |
  ...
  CCSPlayer_MovementServices_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CCSPlayer_MovementServices_vtable, CCSPlayer_MovementServices_vtable
disable-model-invocation: true
---

# Find CCSPlayer_MovementServices_vtable

Target: `CCSPlayer_MovementServices_vtable` (func) in the module loaded in THIS session.
...
Write `CCSPlayer_MovementServices_vtable.{platform}.yaml` with EXACTLY these fields:
