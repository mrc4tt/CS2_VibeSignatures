...
description: |
  ...
  CLoopModeGame_LoopInit in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopModeGame_LoopInit, CLoopModeGame_LoopInit
disable-model-invocation: true
---

# Find CLoopModeGame_LoopInit

Target: `CLoopModeGame_LoopInit` (vfunc) in the module loaded in THIS session.
