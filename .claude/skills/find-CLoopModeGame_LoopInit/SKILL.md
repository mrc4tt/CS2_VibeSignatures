...
description: |
  Agent fallback for CLoopModeGame_LoopInit (auto-generated, category: vfunc). Locate
  ...
  Trigger: CLoopModeGame_LoopInit, CLoopModeGame::LoopInit
disable-model-invocation: true
---

# Find CLoopModeGame_LoopInit
