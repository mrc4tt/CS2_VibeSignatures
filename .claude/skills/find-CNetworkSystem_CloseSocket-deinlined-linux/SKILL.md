---
name: find-CNetworkSystem_CloseSocket-deinlined-linux
description: |
  Agent fallback for CNetworkSystem_CloseSocket-deinlined-linux (auto-generated, category: func). Locate
  CNetworkSystem_CloseSocket in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_CloseSocket-deinlined-linux, CNetworkSystem_CloseSocket
disable-model-invocation: true
---

# Find CNetworkSystem_CloseSocket-deinlined-linux

Target: `CNetworkSystem_CloseSocket` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_CloseSocket.{platform}.yaml` with EXACTLY these fields:
