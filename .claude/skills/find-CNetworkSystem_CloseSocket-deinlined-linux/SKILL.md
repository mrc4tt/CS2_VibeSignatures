...
description: |
  ...
  CNetworkSystem_CloseSocket-deinlined-linux in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_CloseSocket-deinlined-linux, CNetworkSystem_CloseSocket-deinlined-linux
disable-model-invocation: true
---

# Find CNetworkSystem_CloseSocket-deinlined-linux

Target: `CNetworkSystem_CloseSocket-deinlined-linux` (func) in the module loaded in THIS session.
