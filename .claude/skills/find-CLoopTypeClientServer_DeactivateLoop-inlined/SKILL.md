...
description: |
  ...
  CLoopTypeClientServer_DeactivateLoop-inlined in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_DeactivateLoop-inlined, CLoopTypeClientServer_DeactivateLoop-inlined
disable-model-invocation: true
---

# Find CLoopTypeClientServer_DeactivateLoop-inlined

Target: `CLoopTypeClientServer_DeactivateLoop-inlined` (vfunc) in the module loaded in THIS session.
