...
description: |
  Agent fallback for CEntityInstance_vtable (auto-generated, category: func). Locate
  CEntityInstance_vtable in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntityInstance_vtable, CEntityInstance_vtable
disable-model-invocation: true
---

# Find CEntityInstance_vtable

Target: `CEntityInstance_vtable` (func) in the module loaded in THIS session.
...
Write `CEntityInstance_vtable.{platform}.yaml` with EXACTLY these fields:
