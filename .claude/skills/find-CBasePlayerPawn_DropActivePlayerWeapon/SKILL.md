...
description: |
  ...
  CBasePlayerPawn_DropActivePlayerWeapon in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CBasePlayerPawn_DropActivePlayerWeapon, CBasePlayerPawn_DropActivePlayerWeapon
disable-model-invocation: true
---

# Find CBasePlayerPawn_DropActivePlayerWeapon

Target: `CBasePlayerPawn_DropActivePlayerWeapon` (vfunc) in the module loaded in THIS session.
