...
description: |
  ...
  CNetworkGameClient_RecordEntityBandwidth in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_RecordEntityBandwidth, CNetworkGameClient_RecordEntityBandwidth
disable-model-invocation: true
---

# Find CNetworkGameClient_RecordEntityBandwidth

Target: `CNetworkGameClient_RecordEntityBandwidth` (func) in the module loaded in THIS session.
