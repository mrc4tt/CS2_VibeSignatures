...
description: |
  Agent fallback for CNetworkGameClient_RecordEntityBandwidth (auto-generated, category: func). Locate
  CNetworkGameClient::RecordEntityBandwidth in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClient_RecordEntityBandwidth, CNetworkGameClient::RecordEntityBandwidth
disable-model-invocation: true
---

# Find CNetworkGameClient_RecordEntityBandwidth

Target: `CNetworkGameClient::RecordEntityBandwidth` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClient_RecordEntityBandwidth.{platform}.yaml` with EXACTLY these fields:
