...
description: |
  Agent fallback for CSource2GameClients_StartHLTVServer (auto-generated, category: vfunc). Locate
  CSource2GameClients::StartHLTVServer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_StartHLTVServer, CSource2GameClients::StartHLTVServer
disable-model-invocation: true
---

# Find CSource2GameClients_StartHLTVServer

Target: `CSource2GameClients::StartHLTVServer` (vfunc) in the module loaded in THIS session.
...
Write `CSource2GameClients_StartHLTVServer.{platform}.yaml` with EXACTLY these fields:
