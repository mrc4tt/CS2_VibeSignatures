...
description: |
  ...
  CSource2GameClients_StartHLTVServer in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CSource2GameClients_StartHLTVServer, CSource2GameClients_StartHLTVServer
disable-model-invocation: true
---

# Find CSource2GameClients_StartHLTVServer

Target: `CSource2GameClients_StartHLTVServer` (vfunc) in the module loaded in THIS session.
