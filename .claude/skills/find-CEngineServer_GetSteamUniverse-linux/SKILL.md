...
description: |
  Agent fallback for CEngineServer_GetSteamUniverse-linux (auto-generated, category: vfunc). Locate
  ...
  Trigger: CEngineServer_GetSteamUniverse-linux, CEngineServer::GetSteamUniverse
disable-model-invocation: true
---

# Find CEngineServer_GetSteamUniverse-linux
