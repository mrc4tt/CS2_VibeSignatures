...
description: |
  ...
  CEngineServer_GetSteamUniverse-linux in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineServer_GetSteamUniverse-linux, CEngineServer_GetSteamUniverse-linux
disable-model-invocation: true
---

# Find CEngineServer_GetSteamUniverse-linux

Target: `CEngineServer_GetSteamUniverse-linux` (vfunc) in the module loaded in THIS session.
