...
description: |
  ...
  INetworkGameServer_ServerPostSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_ServerPostSimulate, INetworkGameServer_ServerPostSimulate
disable-model-invocation: true
---

# Find INetworkGameServer_ServerPostSimulate

Target: `INetworkGameServer_ServerPostSimulate` (vfunc) in the module loaded in THIS session.
