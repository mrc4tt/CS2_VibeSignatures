...
description: |
  Agent fallback for INetworkGameServer_ServerPostSimulate (auto-generated, category: vfunc). Locate
  INetworkGameServer::ServerPostSimulate in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: INetworkGameServer_ServerPostSimulate, INetworkGameServer::ServerPostSimulate
disable-model-invocation: true
---

# Find INetworkGameServer_ServerPostSimulate

Target: `INetworkGameServer::ServerPostSimulate` (vfunc) in the module loaded in THIS session.
...
Write `INetworkGameServer_ServerPostSimulate.{platform}.yaml` with EXACTLY these fields:
