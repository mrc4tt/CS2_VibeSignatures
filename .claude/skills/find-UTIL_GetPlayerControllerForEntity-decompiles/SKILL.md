...
description: |
  ...
  UTIL_GetPlayerControllerForEntity-decompiles in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: UTIL_GetPlayerControllerForEntity-decompiles, UTIL_GetPlayerControllerForEntity-decompiles
disable-model-invocation: true
---

# Find UTIL_GetPlayerControllerForEntity-decompiles

Target: `UTIL_GetPlayerControllerForEntity-decompiles` (func) in the module loaded in THIS session.
