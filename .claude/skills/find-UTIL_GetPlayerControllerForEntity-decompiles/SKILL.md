---
name: find-UTIL_GetPlayerControllerForEntity-decompiles
description: |
  Agent fallback for UTIL_GetPlayerControllerForEntity-decompiles (auto-generated, category: func). Locate
  UTIL_GetPlayerControllerForEntity in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: UTIL_GetPlayerControllerForEntity-decompiles, UTIL_GetPlayerControllerForEntity
disable-model-invocation: true
---

# Find UTIL_GetPlayerControllerForEntity-decompiles

Target: `UTIL_GetPlayerControllerForEntity` (func) in the module loaded in THIS session.
...
Write `UTIL_GetPlayerControllerForEntity.{platform}.yaml` with EXACTLY these fields:
