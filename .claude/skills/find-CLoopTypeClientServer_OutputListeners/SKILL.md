...
description: |
  Agent fallback for CLoopTypeClientServer_OutputListeners (auto-generated, category: vfunc). Locate
  CLoopTypeClientServer::OutputListeners in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_OutputListeners, CLoopTypeClientServer::OutputListeners
disable-model-invocation: true
---

# Find CLoopTypeClientServer_OutputListeners

Target: `CLoopTypeClientServer::OutputListeners` (vfunc) in the module loaded in THIS session.
...
Write `CLoopTypeClientServer_OutputListeners.{platform}.yaml` with EXACTLY these fields:
