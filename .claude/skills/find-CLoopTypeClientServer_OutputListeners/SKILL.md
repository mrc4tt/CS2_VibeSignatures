...
description: |
  ...
  CLoopTypeClientServer_OutputListeners in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CLoopTypeClientServer_OutputListeners, CLoopTypeClientServer_OutputListeners
disable-model-invocation: true
---

# Find CLoopTypeClientServer_OutputListeners

Target: `CLoopTypeClientServer_OutputListeners` (vfunc) in the module loaded in THIS session.
