...
description: |
  ...
  CEntitySaveRestoreBlockHandler_ReadRestoreHeaders in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_ReadRestoreHeaders, CEntitySaveRestoreBlockHandler_ReadRestoreHeaders
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_ReadRestoreHeaders

Target: `CEntitySaveRestoreBlockHandler_ReadRestoreHeaders` (vfunc) in the module loaded in THIS session.
