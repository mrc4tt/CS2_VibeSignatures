...
description: |
  Agent fallback for CEntitySaveRestoreBlockHandler_ReadRestoreHeaders (auto-generated, category: vfunc). Locate
  CEntitySaveRestoreBlockHandler::ReadRestoreHeaders in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySaveRestoreBlockHandler_ReadRestoreHeaders, CEntitySaveRestoreBlockHandler::ReadRestoreHeaders
disable-model-invocation: true
---

# Find CEntitySaveRestoreBlockHandler_ReadRestoreHeaders

Target: `CEntitySaveRestoreBlockHandler::ReadRestoreHeaders` (vfunc) in the module loaded in THIS session.
...
Write `CEntitySaveRestoreBlockHandler_ReadRestoreHeaders.{platform}.yaml` with EXACTLY these fields:
