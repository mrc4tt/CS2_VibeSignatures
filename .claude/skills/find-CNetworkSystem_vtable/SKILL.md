...
description: |
  Agent fallback for CNetworkSystem_vtable (auto-generated, category: func). Locate
  CNetworkSystem_vtable in the CS2 networksystem module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkSystem_vtable, CNetworkSystem_vtable
disable-model-invocation: true
---

# Find CNetworkSystem_vtable

Target: `CNetworkSystem_vtable` (func) in the module loaded in THIS session.
...
Write `CNetworkSystem_vtable.{platform}.yaml` with EXACTLY these fields:
