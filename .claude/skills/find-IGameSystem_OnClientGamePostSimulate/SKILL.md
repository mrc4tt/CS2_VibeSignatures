...
description: |
  Agent fallback for IGameSystem_OnClientGamePostSimulate (auto-generated, category: vfunc). Locate
  IGameSystem::ClientGamePostSimulate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientGamePostSimulate, IGameSystem::ClientGamePostSimulate
disable-model-invocation: true
---

# Find IGameSystem_OnClientGamePostSimulate

Target: `IGameSystem::ClientGamePostSimulate` (vfunc) in the module loaded in THIS session.
...
Write `IGameSystem_OnClientGamePostSimulate.{platform}.yaml` with EXACTLY these fields:
