...
description: |
  ...
  IGameSystem_OnClientGamePostSimulate in the CS2 client module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: IGameSystem_OnClientGamePostSimulate, IGameSystem_OnClientGamePostSimulate
disable-model-invocation: true
---

# Find IGameSystem_OnClientGamePostSimulate

Target: `IGameSystem_OnClientGamePostSimulate` (vfunc) in the module loaded in THIS session.
