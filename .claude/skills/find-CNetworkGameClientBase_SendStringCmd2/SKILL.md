---
name: find-CNetworkGameClientBase_SendStringCmd2
description: |
  Agent fallback for CNetworkGameClientBase_SendStringCmd2 (auto-generated, category: func). Locate
  CNetworkGameClientBase::SendStringCmd2 in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_SendStringCmd2, CNetworkGameClientBase::SendStringCmd2
disable-model-invocation: true
---

# Find CNetworkGameClientBase_SendStringCmd2

Target: `CNetworkGameClientBase::SendStringCmd2` (func) in the module loaded in THIS session.
...
Write `CNetworkGameClientBase_SendStringCmd2.{platform}.yaml` with EXACTLY these fields:
