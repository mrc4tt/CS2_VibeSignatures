...
description: |
  ...
  CNetworkGameClientBase_SendStringCmd2 in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CNetworkGameClientBase_SendStringCmd2, CNetworkGameClientBase_SendStringCmd2
disable-model-invocation: true
---

# Find CNetworkGameClientBase_SendStringCmd2

Target: `CNetworkGameClientBase_SendStringCmd2` (func) in the module loaded in THIS session.
