...
description: |
  ...
  CEntitySystem_ForceSetInPVSCallsIntoQueue in the CS2 server module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEntitySystem_ForceSetInPVSCallsIntoQueue, CEntitySystem_ForceSetInPVSCallsIntoQueue
disable-model-invocation: true
---

# Find CEntitySystem_ForceSetInPVSCallsIntoQueue

Target: `CEntitySystem_ForceSetInPVSCallsIntoQueue` (func) in the module loaded in THIS session.
