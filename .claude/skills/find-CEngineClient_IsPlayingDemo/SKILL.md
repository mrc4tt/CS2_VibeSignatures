...
description: |
  ...
  CEngineClient_IsPlayingDemo in the CS2 engine module via IDA Pro MCP and emit a fresh,
  ...
  Trigger: CEngineClient_IsPlayingDemo, CEngineClient_IsPlayingDemo
disable-model-invocation: true
---

# Find CEngineClient_IsPlayingDemo

Target: `CEngineClient_IsPlayingDemo` (func) in the module loaded in THIS session.
...
Write `CEngineClient_IsPlayingDemo.{platform}.yaml` with EXACTLY these fields:
