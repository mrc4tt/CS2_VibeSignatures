...
REPOSITORY_CONTRACT_PREFIXES = (
    ...
    "test_ida_analyze_bin.TestConfigSkillDependencyGraph.test_config_module_skills_have_no_expected_input_order_gaps",
    "test_igamesystem_slot_dispatch_preprocessor.TestGamePostInitConfig",
