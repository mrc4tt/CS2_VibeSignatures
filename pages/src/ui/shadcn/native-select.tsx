...
// Local change: `wrapperClassName`. The <select> sits inside a positioned
// wrapper (for the chevron), so a flex layout that wants the control to grow
// has to reach the wrapper, which `className` does not.
