  ...
  en: {
    translation: {
      ...
      check: {
        ...
        identified: 'This is **{{plugin}}** — {{shared}} of its {{keys}} keys are names that plugin ships.',
        comparing: 'Comparing against {{plugin}}.',
        ...
        isCurrent: 'Up to date: this file matches build {{build}}',
        isBehind: 'Out of date: this file is build {{build}}, {{builds}} build(s) behind {{newest}}',
        matchDetail: '{{matched}} of {{comparable}} comparable keys match {{build}} exactly.',
  ...
  da: {
    translation: {
      ...
      check: {
        ...
        identified: 'Det er **{{plugin}}** — {{shared}} af dens {{keys}} nøgler er navne det plugin sender.',
        comparing: 'Sammenligner med {{plugin}}.',
        ...
        isCurrent: 'Opdateret: filen svarer til build {{build}}',
        isBehind: 'Forældet: filen er build {{build}}, {{builds}} build(s) bagud for {{newest}}',
        matchDetail: '{{matched}} af {{comparable}} sammenlignelige nøgler matcher {{build}} præcist.',
